...
ifneq ($(filter __MSDC_SD_SDIO__, $(strip $(MODULE_DEFS))),)
    SRC_LIST += hal\storage\mc\src\sd.c
endif

ifneq ($(filter __MSDC2_SD_SDIO__, $(strip $(MODULE_DEFS))),)
    SRC_LIST += hal\storage\mc\src\sd2.c
endif

ifneq ($(filter __MSDC2_SD_MMC__, $(strip $(MODULE_DEFS))),)
    SRC_LIST += hal\storage\mc\src\sd_drv.c \
                hal\storage\mc\src\sd2.c \
                hal\storage\mc\src\sd_adap.c 
endif
