...
SRC_LIST += plutommi\mtkapp\Megaphone\MegaphoneSrc\Megaphone.c
endif
...
INC_DIR += plutommi\Service\PlaylistcacheSrv
SRC_LIST += plutommi\mtkapp\AudioPlayer\AudioPlayerSrc\AudioPlayerWalk.c
endif

ifneq ($(filter __KARAOKE_SUPPORT__, $(strip $(MODULE_DEFS))),)
INC_DIR += plutommi\mtkapp\Karaoke\KaraokeInc 
SRC_LIST += plutommi\mtkapp\Karaoke\KaraokeSrc\Karaoke.c 
endif

ifneq ($(filter __LINE_IN_SUPPORT__, $(strip $(MODULE_DEFS))),)
INC_DIR += plutommi\mtkapp\Linein\LineinInc 
SRC_LIST += plutommi\mtkapp\Linein\LineinSrc\Linein.c 
endif
