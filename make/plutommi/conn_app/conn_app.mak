...
ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifneq ($(filter __MMI_BT_ANTI_LOST_BY_RSSI__, $(strip $(MODULE_DEFS))),)
        SRC_LIST += plutommi\mtkapp\connectivity\connectivitysrc\btcommon\BTMMIAntilostScr.c
    endif
...
INC_DIR += plutommi\mmi\BT_UCM\ucmbtinc
endif
