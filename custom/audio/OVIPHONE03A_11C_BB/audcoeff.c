...
kal_uint8 custom_cfg_hw_aud_output_path(  kal_uint8 speaker_id )
{
   ...
   case AUDIO_DEVICE_SPEAKER/*AUDIO_OUT_SPEAKER1*/:
      audio_device_out = (L1SP_LOUD_SPEAKER| L1SP_SPEAKER2);//L1SP_SPEAKER1;
      break;
   case AUDIO_DEVICE_SPEAKER2/*AUDIO_OUT_SPEAKER2*/:
      audio_device_out = (L1SP_LOUD_SPEAKER| L1SP_SPEAKER2);//L1SP_SPEAKER2;
      break;
   case AUDIO_DEVICE_LOUDSPEAKER/*AUDIO_OUT_LOUDSPEAKER*/:
      audio_device_out = (L1SP_LOUD_SPEAKER| L1SP_SPEAKER2);//L1SP_LOUD_SPEAKER;
      break;
