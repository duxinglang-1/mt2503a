...
#OPT_PROJECT
OPT_PROJECT    			= AURI  # OPT Project Name
OPT_CUSTOMER    		= AURI   # OPT Customer Name
OPT_CUSTOMER_DRV 		= AURI  # 区分驱动的不同
OPT_CUSTOMER_VERSION = AURI # OPT Customer More info.

#OPT_MMI
OPT_MMI_RESOURCE		= MMI_RESOURCE_DEFAULT  # MMI_RESOURCE_DEFAULT,NONE
OPT_AUDIO_RESOURCE	= AUDIO_DEFAULT # AUDIO_DEFAULT,NONE
OPT_USE_COMMON_IMG	= TRUE  # TRUE,FALSE
OPT_IMAGE_COMMON		= PLUTO_COMMON_240X320 # PLUTO_COMMON_240X320,NONE
OPT_IMAGE_RESOURCE	= PLUTO_DEFAULT  # PLUTO_DEFAULT,  NONE


#OPT_DRIVER
OPT_CODEGEN			= CODEGEN_AURI   # CODEGEN_DEFAULT,CODEGEN_AURI, NONE
OPT_RF_RESOURCE		= RF_RESOURCE_DEFAULT   # RF_RESOURCE_DEFAULT, NONE
OPT_NVRAM_VERSION	= NVRAM_VERSION_DEFAULT # NVRAM_VERSION_DEFAULT,NVRAM_VERSION_M13,NONE


MOTION_SENSOR_SAMPLING_RATE = SAM_416HZ

#AUGUST_ALL_FUNC_SUPPORT = TRUE


# Generated at 2016-07-18 19:53:14
# ------------------------------ ARM
RVCT_VERSION = V31
  # Description:
  #   ARM RVCT Version
...
# ------------------------------ LCD
LCD_MODULE = OVIPHONE03A_11C_LCM
  # Description:
...
TOUCH_PANEL_SUPPORT = CTP_MSTAR_MSG21XX_TRUE_MULTIPLE
  # Description:
...
CMMB_CAS_2GPP_VER = NONE
  ...
  # Option Values:
  #   NONE: Disable this feature
  #   V10: Support 2G CMMB Post paid version 1.0 (Support 寮�鎴?鎺堟潈,need 2G CMMB Chip Support,Such as IF206)
  # Switch-ability:
  #   Non-switchable
...
UNIFIED_PUSH_FEATURES = SERVICE_ONLY
  # Description:
...
WIFI_SCAN_ONLY_AT_SUPPORT = TRUE
  # Description:
...
COM_DEFS_FOR_OVIPHONE03A_11C_LCM = COLOR_LCD OVIPHONE03A_11C_LCM TFT_MAINLCD
