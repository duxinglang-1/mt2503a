 ...
 */
    ...
    #define STACK_POOL_SHARING_SIZE  (85720 * STACK_POOL_COEFFECIENT/100) 
    #define STACK_POOL_SIZE  (STACK_POOL_SHARING_SIZE + 32188 + 0)
    #define STACK_POOL_COEFFECIENT_FACTORY (100 - 0 /*15*/)
    #define STACK_POOL_SHARING_SIZE_FACTORY (33782 * STACK_POOL_COEFFECIENT_FACTORY/100)
    #define STACK_POOL_SIZE_FACTORY  (STACK_POOL_SHARING_SIZE_FACTORY + 11208 + 0)
    #define GLOBAL_MEM_SIZE  (240680 + 22308 - (85720 * (100-STACK_POOL_COEFFECIENT)/100))
    #define GLOBAL_MEM_SIZE_FACTORY  (146040 + 7576 - (33782 * (100-STACK_POOL_COEFFECIENT_FACTORY)/100))
    #define FACTORY_REMAIN_MEM_SIZE  (GLOBAL_MEM_SIZE - GLOBAL_MEM_SIZE_FACTORY)
    #define TOTAL_TASK_STACK_SIZE  (85720 + 32188 + 0)
    #define GLOBAL_DEBUG_MEM_SIZE  (1268)
    #define GLOBAL_HISR_SHARED_IRAM_STACK_SIZE  (1536)
    #define GLOBAL_TOTAL_CREATED_TASK_NUMBER    (53)
#endif  
