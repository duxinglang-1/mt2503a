 ...
 * Author:
 * -------
 *   Carlos Yeh (mtk02377)     system auto generator v1.70 -> p1.71 -> p1.72 -> p1.74 -> p1.75 + sysGenUtility v0.42 -> p0.43 -> p0.44 -> p0.45 -> p0.49
 *
 *============================================================================
 *             HISTORY
 ...
 *  [6261 driver] support MT6261
 *  IOT FOTA support new package Format
 * 	Patch back iot fota
 *
