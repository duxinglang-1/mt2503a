...
extern kal_uint32 Image$$ZIMAGE_ER$$Base;
extern kal_uint32 Image$$ZIMAGE_ER$$RO$$Base;
extern kal_uint32 Image$$ZIMAGE_ER$$Length;
extern kal_uint32 Image$$ZIMAGE_ER$$RO$$Length;
extern kal_uint32 Image$$ZIMAGE_ER$$ZI$$Limit;
...
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC_BODY$$ZI$$Limit;
...
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC_BODY$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$ZI$$Limit;
...
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$ZI$$Limit;
...
{
    region->addr = (kal_uint32)&Image$$ZIMAGE_ER$$Base;
    region->len = (kal_uint32)&Image$$ZIMAGE_ER$$ZI$$Limit - region->addr;
}
void custom_query_zimage_RO_region(EXTSRAM_REGION_INFO_T *region)
{
    region->addr = (kal_uint32)&Image$$ZIMAGE_ER$$RO$$Base;
    region->len = (kal_uint32)0x0;
    region->len += (kal_uint32)&Image$$ZIMAGE_ER$$RO$$Length;
...
{
    region->addr = (kal_uint32)&Image$$DYNAMIC_COMP_DAF$$Base;
    region->len = (kal_uint32)&Image$$DYNAMIC_COMP_VEENC_BODY$$Base + 0xbf60 - region->addr;
}
...
void custom_get_MaxAvailableMemorySegment(kal_uint32 **Return_begin_addr, kal_uint32 *Return_segment_size)
{
...

    {
        ...
        LastRegionEnd   = (kal_uint32)&Image$$ZIMAGE_ER$$ZI$$Limit;
...
{
    region[0].addr = (kal_uint32)&Image$$ZIMAGE_ER$$Base;
    region[0].len = (kal_uint32)&Image$$ZIMAGE_ER$$ZI$$Limit - region[0].addr;
    region[1].addr = (kal_uint32)&Image$$ALICE$$Base;
    region[1].len = (kal_uint32)&Image$$ALICE$$ZI$$Limit - region[1].addr;
    {
    ...
    region[2].addr = aliceCompressedBase;
    region[2].len = aliceCompressedLength;
    }
    ...
    region[8].addr = 0x0;
    region[8].len = 0x200;
    region[9].addr = (kal_uint32)&Image$$CACHED_EXTSRAM$$Base;
    region[9].len = (kal_uint32)&Image$$EXTSRAM_GADGET$$ZI$$Limit - region[9].addr;
    region[10].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI_MMIPOOL$$Base;
    region[10].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW$$ZI$$Limit - region[10].addr;
    region[10].addr = MAP2CREGVA(region[10].addr);
    region[11].addr = (kal_uint32)&Image$$DYNAMIC_COMP_DAF$$Base;
    region[11].len = (kal_uint32)&Image$$DYNAMIC_COMP_VEENC_BODY$$Base + 0xbf60 - region[11].addr;
    region[12].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_RW$$Base;
    region[12].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI$$ZI$$Limit - region[12].addr;
    region[13].addr = (kal_uint32)&Image$$INTSRAM_CODE$$Base;
    region[13].len = 0x1200;
    region[14].addr = (kal_uint32)&Image$$INTSRAM_DATA$$Base;
    region[14].len = 0xe00;
...
*
*************************************************************************/
static EXTSRAM_REGION_INFO_T TOTAL_CODE_REGION[8];
...
kal_bool custom_check_code_address(kal_uint32 address)
{
    ...
    TOTAL_CODE_REGION[2].addr = (kal_uint32)&Image$$ZIMAGE_ER$$RO$$Base;
    TOTAL_CODE_REGION[2].len = (kal_uint32)&Image$$ZIMAGE_ER$$RO$$Length;
    TOTAL_CODE_REGION[3].addr = (kal_uint32)&Image$$EMIINIT_CODE$$RO$$Base;
    TOTAL_CODE_REGION[3].len = (kal_uint32)&Image$$EMIINIT_CODE$$RO$$Length;
    TOTAL_CODE_REGION[4].addr = (kal_uint32)&Image$$INTSRAM_CODE$$RO$$Base;
    TOTAL_CODE_REGION[4].len = (kal_uint32)&Image$$INTSRAM_CODE$$RO$$Length;
    TOTAL_CODE_REGION[5].addr = (kal_uint32)&Image$$ALICE$$RO$$Base;
    TOTAL_CODE_REGION[5].len = (kal_uint32)&Image$$ALICE$$RO$$Length;
    TOTAL_CODE_REGION[6].addr = 0x0;
    TOTAL_CODE_REGION[6].len = 0x200;
    TOTAL_CODE_REGION[7].addr = (kal_uint32)&Image$$DYNAMIC_COMP_DAF$$RO$$Base;
    TOTAL_CODE_REGION[7].len = (kal_uint32)&Image$$DYNAMIC_COMP_VEENC_BODY$$RO$$Base + 0xbf60 - TOTAL_CODE_REGION[7].addr;
