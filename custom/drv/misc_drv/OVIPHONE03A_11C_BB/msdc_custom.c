...
static  const kal_uint32 msdc_custom = (MSDC2_HOT_PLUG|MSDC2_WP);
...
kal_uint8 MSDC_GetIOCtrlParam(void)
{
	...
	{
		MSDC_ODC_12MA,//zhilin modify for 6261_EVB WIFI	// driving capacity of CMD/BS and SCLK
		MSDC_ODC_12MA,//zhilin modify for 6261_EVB WIFI	// driving capacity of data lines
...
kal_uint8 MSDC2_GetIOCtrlParam(void)
{
	kal_uint8 reg = 0;
	// it only apply to the SD card io control
	msdc_io_ctrl_struct msdc_io_ctrl_sd_custom = 
