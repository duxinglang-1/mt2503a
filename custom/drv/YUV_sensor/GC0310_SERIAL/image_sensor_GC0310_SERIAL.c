 ...
 * Description:
 * ------------
 *   Image sensor driver function on 11C
 *
 * Author:
 * -------
 * -------
...
static kal_uint32 GC0310_SERIALPowerOn(void)
{
    ...
    GC0310_SERIAL_TRACE("SENSOR ID: %x", SensorId);
...
{
    MM_ERROR_CODE_ENUM GC0310_SERIALSensorClose(void);
    kal_uint32 SensorId;
...
static MM_ERROR_CODE_ENUM GC0310_SERIALSensorFeatureCtrl(kal_uint32 Id, void *In, void *Out, kal_uint32 OutLen, kal_uint32 *RealOutLen)
{
    ...
    {
        return GC0310_SERIALWebcamFeatureCtrl(Id, In, Out, OutLen, RealOutLen);
    }
    switch (Id)
    {
