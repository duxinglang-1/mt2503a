...
//DRV_WriteReg16(RG_VCORE_VOSEL,(DRV_Reg16(RG_VCORE_VOSEL)& ~((0x1<<10)|(0x1<<0))));
//DRV_WriteReg16(VIO_18_REG,(DRV_Reg16(VIO_18_REG)& ~((0x1<<10)|(0x1<<0))));

//*RG_VCORE_VOSEL= *RG_VCORE_VOSEL & ~((0x1<<10)|(0x1<<0));
//*VIO_18_REG =  *VIO_18_REG & ~((0x1<<10)|(0x1<<0));
