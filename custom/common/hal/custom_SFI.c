...
#if defined(__SERIAL_FLASH_INIT_IN_EXTBOOTLOADER__) && defined(__EXT_BOOTLOADER__) // MT6250 MT6260/61 only: if SF is init in ExtBootloader & this is the ext bootloader
...
#if defined(MT6251) || defined(MT6253L)|| defined(MT6252) ||defined(MT6255) ||defined(MT6250) ||defined(MT6280) ||defined(MT6260) || defined(MT6261)
#if defined(__SERIAL_FLASH_INIT_IN_EXTBOOTLOADER__) && defined(__EXT_BOOTLOADER__) // MT6250 MT6260/61 only: if SF is init in ExtBootloader & this is the ext bootloader
...
#endif //defined(MT6251) || defined(MT6253L)|| defined(MT6252) ||defined(MT6255) ||defined(MT6250) ||defined(MT6280) ||defined(MT6260) || defined(MT6261)
...
#if defined(MT6251) || defined(MT6253L) || defined(MT6252) || defined(MT6255)||defined(MT6280)||defined(MT6250)|| defined(MT6261)
    #error "Undefined BB chips of SFC 130MHz"
#elif defined(MT6260)
...
#elif defined(MT6250) || defined(MT6280) ||defined(MT6260) || defined(MT6261)
//MT6250 and MT6280 and MT6260/61 SFC PLL setting will be done by PLL owner
#else
	#error "Undefined BB chips"
#endif //defined(MT6251)
...
#elif defined(MT6251) || defined(MT6255) || defined(MT6260) || defined(MT6261)
  return 0;  
#else
	#error "Undefined BB chips"
