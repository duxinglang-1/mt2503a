...
/*************************************************************************
 * In some area (MAUI_03519049), customer need to handle reject cause 11 as 15 for specific network and IMSI
 * here define two plmn list for this purpose.
 * 
 *************************************************************************/

const char *REPLACE_LU_REJECT_CAUSE_NW_PLMN[] = {"46000F", REPLACE_LU_REJ_CAUSE_NW_PLMN_SET_END};
const kal_uint32 LU_REJECT_CAUSE_NW_PLMN_NUM = sizeof(REPLACE_LU_REJECT_CAUSE_NW_PLMN)/sizeof(char *);

const char *REPLACE_LU_REJECT_CAUSE_IMSI[] = {"46002F", REPLACE_LU_REJ_CAUSE_IMSI_SET_END};
const kal_uint32 LU_REJECT_CAUSE_IMSI_NUM = sizeof(REPLACE_LU_REJECT_CAUSE_IMSI)/sizeof(char *);

/*****************************************************************************
* FUNCTION
*  mm_custom_replace_lu_rej_11_to_15
* DESCRIPTION
*  This function is used to query if replace LU rej cause from 11 to 15 for special usage
*
* PARAMETERS
*  Which setting
* RETURNS
...
*  None
*****************************************************************************/
kal_bool mm_custom_replace_lu_rej_11_to_15(void)
{
    #ifdef __MM_REPLACE_LU_REJ_CAUSE_11_TO_15__
        return KAL_TRUE;
    #else
        return KAL_FALSE;
    #endif
...
const char ADD_CUSTOM_PLMN_IN_MANUAL_RECOVERY_SEARCH [] = "21407F";
#elif __MM_IGNORE_PLAY_EQPLMN__
const char *IGNORE_EQPLMN_OPERATOR[] = {"26006F", IGNORE_EQPLMN_OPERATOR_SET_END};
const char ADD_CUSTOM_PLMN_IN_MANUAL_RECOVERY_SEARCH [] = INVALID_CUSTOM_PLMN_IN_MANUAL_RECOVERY_SEARCH;
#else
