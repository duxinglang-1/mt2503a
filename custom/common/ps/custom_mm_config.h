...
extern const char *IGNORE_EQPLMN_OPERATOR[];
extern const kal_uint32 IGNORE_EQPLMN_OPERATOR_NUM;

#define INVALID_CUSTOM_PLMN_IN_MANUAL_RECOVERY_SEARCH "FFFFFF"
extern const char ADD_CUSTOM_PLMN_IN_MANUAL_RECOVERY_SEARCH[];

#define REPLACE_LU_REJ_CAUSE_NW_PLMN_SET_END "FFFFFF"
extern const char *REPLACE_LU_REJECT_CAUSE_NW_PLMN[];
extern const kal_uint32 LU_REJECT_CAUSE_NW_PLMN_NUM;

#define REPLACE_LU_REJ_CAUSE_IMSI_SET_END "FFFFF"
extern const char *REPLACE_LU_REJECT_CAUSE_IMSI[];
extern const kal_uint32 LU_REJECT_CAUSE_IMSI_NUM;
...
extern kal_bool mm_custom_replace_lu_rej_11_to_15(void);
