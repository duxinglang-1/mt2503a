...
#elif (defined(MT6261FM))
const kal_uint16 FMDrv_DesenseBitMap[16]= // 2014.4.21 update
{
	0x0000,/* 89.0~87.5*/0x0000,/* 90.6~89.1*/0xC000,/* 92.2~90.7*/0x0000,/*  93.8~92.3*/
	0x0000,/* 95.4~93.9*/0x0020,/* 97.0~95.5*/0x0000,/* 98.6~97.1*/0x0000,/* 100.2~98.7*/
	0x0000,/* 101.8~1003*/0x0000,/* 103.4~101.9*/0x0020,/* 105.0~103.5*/0x0000,/* 106.6~105.1*/
	0x0700,/* 108.2~106.7*/0x0000,0x0000,0x0000
};
#endif
...
void FMDrv_FSPI_Digital_Reset(void)
	{
	kal_uint16 dataRead;
