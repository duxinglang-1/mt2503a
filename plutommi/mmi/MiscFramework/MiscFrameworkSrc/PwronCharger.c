    ...
    switch (p->status)
    {
        ...
        case PMIC_CHARGER_IN:
        {
            ...
            mmi_usb_set_background_still(MMI_FALSE);
				...
				{
					extern void Leds_Aw9106_charge(void);
					extern int g_charge_led_on;
					g_charge_led_on = 0;
					Leds_Aw9106_charge();
				}
				#endif
        ...
        case PMIC_CHARGER_OUT:
        {
			...
			#if defined(LED_AW9106_SUPPORT)
			{
				extern void Leds_Aw9106_charge_out(void);
				extern int g_charge_led_on;
				g_charge_led_on = 0;
				Leds_Aw9106_charge_out();
			}			
			#endif
        ...
        case PMIC_CHARGE_COMPLETE:  /* battery full charged. */
        {
         ...
         MMI_TRACE(MMI_COMMON_TRC_G8_DEV, TRC_MMI_CHARBAT_AFTER_POWER_ON, 
			...
			#if defined(LED_AW9106_SUPPORT)
			{
				extern void Leds_Aw9106_charge_complete(void);
				Leds_Aw9106_charge_complete();
			}			
			#endif
            break;
        }
