...
void mmi_netset_refresh_wlan_status(U8 wlan_status)
{
	...
	case SRV_DTCNT_WLAN_STATUS_INACTIVE:
	 #if 1	//xb test 2020-02-27
	 	{
	 		char tmpbuf[128] = {0};
			CHAR *buildtimestr;
			
	 		buildtimestr = (CHAR*) build_date_time();
			mmi_wcscpy((WCHAR*) gWLANProviderName, (WCHAR*)L"FIFO ");
			mmi_asc_to_wcs((WCHAR*)tmpbuf, (CHAR*)buildtimestr);
			mmi_wcscat((WCHAR*) gWLANProviderName, (WCHAR*)tmpbuf);
	 	}
	 #else
