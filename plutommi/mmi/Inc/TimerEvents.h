...
/* ADD-E 20120417 FOR CMMBCAS2GPP*/
		...
		GT_WRT_SOC_PULSE_TIMER,
		GT_NETWORK_FAIL_TIMER,
		GT_WRT_IMEI_REQ_TIMER,
		GT_WRT_FALL_DETECT_SCR_TIMER,
		GT_WRT_CHECK_FALL_DETECT_TIMER,
		GT_WRT_CHECK_NET_TIMER,
#endif
	...
	TIMER_ID_TEMP_LED2,
	TIMER_ID_TEMP_LED3,
	TIMER_ID_TEMP_LED_CHARGE,
#endif
#if 1//defined(__AUGUST_ALL_FUNC_SUPPORT__)
	AUGUST_TIMER_ID_START,
	AUGUST_TIMER_ID_END = AUGUST_TIMER_ID_START +30,
#endif
