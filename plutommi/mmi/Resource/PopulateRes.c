...
#if defined(__FOTA_ENABLE__) || defined(__CARD_DOWNLOAD__) || defined(__ZIMAGE_SUPPORT__) || defined(__FAST_LOGO__) || defined(__FUNET_ENABLE__) || defined(__FUDIFFNET_ENABLE__) 
...
#if defined (__BG_IMAGE__) || defined (__FUNET_ENABLE__) || defined (__FUDIFFNET_ENABLE__)
...
#if defined (__BG_IMAGE__) || defined(__FUNET_ENABLE__) || defined (__FUDIFFNET_ENABLE__) || defined (__DISPLAY_LEVEL_GDI_ONLY__)
/*****************************************************************************
 * FUNCTION
 *  PopulateFOTAImage
 * DESCRIPTION
