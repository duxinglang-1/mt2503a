...
#if !(defined(__MMI_LANG_SM_CHINESE__)&& defined(__MMI_FONT_THIRD_ROM_SUPPORT__))
        ADD_FONT_RESOURCE(
            i,
...
*/
        ...
        ADD_FONT_RESOURCE(
            i,
            CUST_IMG_PATH_ROOT "\\\\..\\\\..\\\\Fonts\\\\Etrump\\\\MTKSansSerifMyanmarZWF.ttf", 0, MMI_RES_FLAG_FONT_IS_ENFB, 1);
#endif

#if defined(__MMI_LANG_KHMER__)
        ADD_FONT_RESOURCE(
            i,
            CUST_IMG_PATH_ROOT "\\\\..\\\\..\\\\Fonts\\\\Etrump\\\\MTKSansSerifKhmerF_OTTB_SE.ttf", 0, MMI_RES_FLAG_FONT_IS_ENFB, 1);
#endif
