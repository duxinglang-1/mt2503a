...
const S16 coordinate_set151[] = 
{
    ...
    MMI_POP_UP_DIALOG_X + 2 * UI_POPUP_BORDER_SIZE, MMI_POP_UP_DIALOG_Y + UI_POPUP_BORDER_SIZE, MMI_POP_UP_DIALOG_WIDTH - UI_POPUP_BORDER_SIZE*4, MMI_POP_UP_DIALOG_HEIGHT - UI_POPUP_BORDER_SIZE*4,
        DM_ALLIGNED_AREA_EQUAL_SPACE_TOP_AND_BOTTOM | DM_ALLIGNED_AREA_NO_BACK_FILL |
        DM_ALLIGNED_AREA_MULTILINE_SCROLL_IF_REQUIRED,
	#else
