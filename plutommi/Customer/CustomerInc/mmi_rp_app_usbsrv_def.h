...
typedef enum
{
    USB_SHUTDOWN_SCR_TIMER = 15110 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    EVT_ID_USB_PERMIT_CFG = 15110 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_APP_USBSRV_VXML_LAYOUT_MAX
} mmi_rp_app_usbsrv_vxml_layout_enum;
...
typedef enum
{
    NVRAM_DEFAULT_USB_APP = 15110 + 1, /* BASE_ID + 1 */        /*         BYTE */ 
