...
typedef enum
{
    MENU_ID_CAMERA_TO_VDOREC_APP = 34154 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_CAMERA_APP = 34154 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_CAM_FILENAME_SEQ_NO = 34154 + 1, /* BASE_ID + 1 */    /*        SHORT */ 
...
typedef enum
{
    IMG_ID_CAMERA_APP_ICON = 34154 + 1, /* BASE_ID + 1 */
    ...
    IMG_ID_CAMERA_OSD_EV_HEAD_P,
    IMG_ID_CAMERA_OSD_EV_HEAD_0,
    IMG_ID_CAMERA_OSD_EV_HEAD_N,
