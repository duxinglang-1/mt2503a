...
typedef enum
{
    MENU_ID_NTP_APP = 43619 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_NTP_APP = 43619 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_NTP_APP = 43619 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_APP_NTP_VXML_LAYOUT_MAX
} mmi_rp_app_ntp_vxml_layout_enum;
...
typedef enum
{
    IMG_ID_NTP_ICON = 43619 + 1, /* BASE_ID + 1 */
