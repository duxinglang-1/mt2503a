...
typedef enum
{
    MENU_ID_EDITOR_OPT_INPUT_METHOD = 26088 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_HANDWRITING_SETTING = 26088 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_PHNSET_HANDWRITING = 26088 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_IME_SMART_MODE_CONFIG = 26088 + 1, /* BASE_ID + 1 */   /*         BYTE */ 
...
typedef enum
{
    IMG_ID_IME_VK_CHANGE_MODE = 26088 + 1, /* BASE_ID + 1 */
