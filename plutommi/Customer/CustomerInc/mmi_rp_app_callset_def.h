...
typedef enum
{
    STR_ID_CALLSET_CALL_CENTER = 37631 + 1, /* BASE_ID + 1 */
    STR_ID_CALLSET_CALL_SETTING,
    STR_ID_UCM_CALL_DIALER,
    STR_ID_CALLSET_MORE,
...
typedef enum
{
    GRP_ID_CALLSET_COMMON = 37631 + 1, /* BASE_ID + 1 */
    GRP_ID_CALLSET_CF,
    GRP_ID_CALLSET_CB,
    GRP_ID_CALLSET_CTR,
...
typedef enum
{
    IMG_ID_CALLSET_CALL_SETTING = 37631 + 1, /* BASE_ID + 1 */
