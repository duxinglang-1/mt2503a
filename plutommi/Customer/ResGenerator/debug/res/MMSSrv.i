...
# 397 "temp/res/MMSSrv.c"
    <STRING id="STR_ID_UMMS_MMS_SERVICE"/>


<!------------------------------------------------------ MMS TEMPLATE RESOURCES ------------------------------------------------------------->
# 486 "temp/res/MMSSrv.c"
<!------------------------------------------------------ MMS TEMPLATE RESOURCES END ------------------------------------------------------------->

        <IMAGE id="IMG_ID_SRV_MMS_VIEWER_APP" > "..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\MMS\\\\SB_mms.bmp"</IMAGE>




    <IMAGE id="MMA_IMG_LETTER_CREATED" > "..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\MMS\\\\draft\\\\mmsdraft.bmp"</IMAGE>

    <IMAGE id="MMA_IMG_CORRUPT" > "..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\MMS\\\\message\\\\MMS_corrupted.bmp"</IMAGE>
    ...
    <IMAGE id="MMA_IMG_LETTER" > "..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\MMS\\\\message\\\\mms_message.bmp"</IMAGE>
    <IMAGE id="MMA_IMG_LETTER_READ" > "..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\MMS\\\\message\\\\mms_messageread.bmp"</IMAGE>

    <IMAGE id="MMA_IMG_NOTIF" > "..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\MMS\\\\notification\\\\notification.bmp"</IMAGE>
# 607 "temp/res/MMSSrv.c"
    <MENUITEM id="MENU_ID_FMGR_FWD_MMS" str="STR_GLOBAL_AS_MULTIMEDIA_MSG"/>
# 616 "temp/res/MMSSrv.c"
</APP>

<FILE_TYPES>

    <FILE_OPTION_HDLR option="MENU_ID_FMGR_FWD_MMS" enabler="mmi_umms_fmgr_forward_mms_enabler" handler="mmi_umms_fmgr_to_mms_hdlr"/>
# 629 "temp/res/MMSSrv.c"
</FILE_TYPES>
