...
# 589 "temp/res/PhoneSetting.c"
    <!-- font size setting menu ---------------------------------------------------------->
# 601 "temp/res/PhoneSetting.c"
    <!-- UART setting string -->
...
# 678 "temp/res/PhoneSetting.c"
    <!-- Dial style string -->
# 689 "temp/res/PhoneSetting.c"
...
# 778 "temp/res/PhoneSetting.c"
    <!-- main menu style string-->
# 812 "temp/res/PhoneSetting.c"
...
# 861 "temp/res/PhoneSetting.c"
    <!-- image ------------------------------------------------------------------------------------>
    <!--------------------------------------------------------------------------------------------->

    <!-- phone setting image----------------------------------------------------------------------->
    <IMAGE id = "IMG_SETTING_PHONE">"..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\SubMenu\\\\Settings\\\\SB_SPH.bmp"</IMAGE>
    ...
    <IMAGE id = "IMG_SCR_SETTING_CAPTION">"..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\TitleBar\\\\TB_ST.PNG"</IMAGE>
...
# 1017 "temp/res/PhoneSetting.c"
        <MENUITEM_ID>MENU_IDLE_SCR_DISP</MENUITEM_ID>
# 1041 "temp/res/PhoneSetting.c"
