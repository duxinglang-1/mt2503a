...
* DESCRIPTION
*  Automatically generated populate function for mmi_rp_app_fmrdo_populate
* PARAMETERS
*  void
* RETURNS
*  void
*****************************************************************************/
void mmi_rp_app_fmrdo_populate(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/******************** Menu Hilite/Hint Handlers - begin ********************/
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_FMRDO_MAIN, mmi_fmrdo_highlight_menu);
