...
typedef enum
{
# 504 "../../framework/commonscreens/commonscreensinc/CommonScreensResDef.h"
    COMMONSCREENS_IME_DICTIONARY,
...
typedef enum
{
    ...
    COMMONSCREENS_KEYPAD_HANDWRITING,
...
# 176 "temp/res/editor.c"
        <IMAGE id="IMG_ID_IME_VK_CHANGE_MODE" >"..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\UIElement\\\\VK3\\\\PopupList_ChangeMode.png"</IMAGE>
        <IMAGE id="IMG_ID_IME_VK_CHANGE_SETTING" >"..\\\\..\\\\Customer\\\\Images""\\\\PLUTO_ENCODE""\\\\MainLCD\\\\UIElement\\\\VK3\\\\PopupList_Setting.png"</IMAGE>

    <!------------------------------------------------------Menu Resource Area------------------------------------------------------>
# 358 "temp/res/editor.c"
            <MENUITEM id="MENU_ID_EDITOR_OPT_INPUT_METHOD" str="STR_GLOBAL_INPUT_METHOD" group="MENU_GROUP_EDITOR"/>
# 367 "temp/res/editor.c"
