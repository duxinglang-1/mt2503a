...
<APP id="APP_MRE" name="STR_ID_APP_MRE">
    ...
    #if defined(__MMI_MRE_APP_TWITTER__) || defined(__MMI_MRE_APP_FACEBOOK_V2_STANDARD__)   
    #if defined(ISP_SUPPORT) || defined(__DIRECT_SENSOR_SUPPORT__) 		
    		#if defined(__MMI_MRE_APP_YAHOOMV2__) && !defined(__GDI_MEMORY_PROFILE_2__)
            <MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + $(MAX_MED_CAM_CAP_LCD_EXT_MEM_SIZE_DISABLE_JAIA) + $(LCD_WIDTH) * $(LCD_HEIGHT) * 2" inc="vmopt.h,med_global.h"/>
		    #else
		    		<MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + $(MAX_MED_CAM_CAP_LCD_EXT_MEM_SIZE_DISABLE_JAIA)" inc="vmopt.h,med_global.h"/>   		
		    #endif
		#else
    		#if defined(__MMI_MRE_APP_YAHOOMV2__) && !defined(__GDI_MEMORY_PROFILE_2__)
            <MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + $(LCD_WIDTH) * $(LCD_HEIGHT) * 2" inc="vmopt.h"/>
		    #else
		...
		#if defined(__MMI_MRE_APP_TWITTER__) || defined(__MMI_MRE_APP_FACEBOOK_V2_STANDARD__)
				#if defined(__MMI_MRE_APP_YAHOOMV2__) && !defined(__GDI_MEMORY_PROFILE_2__)
		        <MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + 100*1024 + $(MAX_MED_CAM_CAP_LCD_EXT_MEM_SIZE_DISABLE_JAIA) + $(LCD_WIDTH) * $(LCD_HEIGHT) * 2" inc="vmopt.h,med_global.h"/>
		    #else
		    		<MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + 100*1024 + $(MAX_MED_CAM_CAP_LCD_EXT_MEM_SIZE_DISABLE_JAIA)" inc="vmopt.h,med_global.h"/>    		
		    #endif
		#else
				#if defined(__MMI_MRE_APP_YAHOOMV2__) && !defined(__GDI_MEMORY_PROFILE_2__)
            <MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + 100*1024 + $(LCD_WIDTH) * $(LCD_HEIGHT) * " inc="vmopt.h"/>
		    #else
		    		<MEMORY heap="$(MRE_SYS_ASM_APP_MEMPOOL_SIZE) + 100*10242" inc="vmopt.h"/>
		    #endif				
		#endif
#else
...
#if defined( __MRE_CUST_PACKAGE_OVERSEA__)||defined(__MRE_CUST_PACKAGE_FB21__)
 <STRING id = "STR_MRE_SANDBOX_SLIM_NOT_USE"/>
#endif
    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
...
#elif defined(__MMI_MRE_MAIN_MENU__)||defined(__MMI_MRE_SUB_MENU__) ||defined(__MMI_MAINMENU_SPREAD_SUPPORT__)
     <IMAGE id="IMG_ID_AM_APP_MRE_DEFAULT">CUST_IMG_PATH"\\\\MainLCD\\\\MREAPP\\\\AM_App_Default.gif"</IMAGE>
#else
     <IMAGE id="IMG_ID_AM_APP_MRE_DEFAULT">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>
#endif
...
<ThirdROMBIN id="MREAPPYM2SL">"mre\custom\romapp\yahoo\ThirdROM\yahoomessengerv2_qqvga_SSL_vsm"</ThirdROMBIN>
            ...
            #else
                <ThirdROMBIN id="MREAPPTWITR">"mre\custom\romapp\twitter\third_ROM\Twitter_QVGA_Key_Touch_1M"</ThirdROMBIN>
                <ThirdROMBIN id="MREAPPTWVSM">"mre\custom\romapp\twitter\third_ROM\VSM\native_SSL\Twitter_QVGA_Key_Touch_1M_VSM"</ThirdROMBIN>
            #endif
            ...
            #else
                <ThirdROMBIN id="MREAPPTWITR">"mre\custom\romapp\twitter\third_ROM\Twitter_QVGA_Key_Touch_1M"</ThirdROMBIN>
                <ThirdROMBIN id="MREAPPTWVSM">"mre\custom\romapp\twitter\third_ROM\VSM\lib_SSL\Twitter_QVGA_Key_Touch_1M_VSM"</ThirdROMBIN>
            #endif
