...
/* heap */
typedef union {
    kal_uint8 APP_BLUETOOTH[ASM_HEAP_SIZE_APP_BLUETOOTH + 4];
    ...
    kal_uint8 APP_TENCENT_MCARE[ASM_HEAP_SIZE_APP_TENCENT_MCARE + 4];
    kal_uint8 APP_TENCENT_MCARE_BG[ASM_HEAP_SIZE_APP_TENCENT_MCARE_BG + 4];
    kal_uint8 APP_VDOPLY[ASM_HEAP_SIZE_APP_VDOPLY + 4];
    ...
    kal_uint8 SRV_MDI_VDOREC[ASM_HEAP_SIZE_SRV_MDI_VDOREC + 4];
    kal_uint8 SRV_MDI_VDOREC_CIF[ASM_HEAP_SIZE_SRV_MDI_VDOREC_CIF + 4];
    kal_uint8 dummy;
...
typedef union {
    ...
    kal_uint8 APP_VDOPLY[ASM_EXTRA_BASE_SIZE_APP_VDOPLY + 4];
    kal_uint8 dummy;
} app_asm_pool_extra_base_union;

/* base */
typedef union {
    kal_uint8 APP_BLUETOOTH[ASM_BASE_SIZE_APP_BLUETOOTH + 4];
    ...
    kal_uint8 APP_TENCENT_MCARE[ASM_BASE_SIZE_APP_TENCENT_MCARE + 4];
    kal_uint8 APP_TENCENT_MCARE_BG[ASM_BASE_SIZE_APP_TENCENT_MCARE_BG + 4];
    kal_uint8 APP_VDOPLY[ASM_BASE_SIZE_APP_VDOPLY + 4];
    ...
    kal_uint8 SRV_MDI_VDOREC[ASM_BASE_SIZE_SRV_MDI_VDOREC + 4];
    kal_uint8 SRV_MDI_VDOREC_CIF[ASM_BASE_SIZE_SRV_MDI_VDOREC_CIF + 4];
    kal_uint8 dummy;
} app_asm_pool_base_union;

/* fg */
typedef union {
    kal_uint8 APP_BLUETOOTH[ASM_FG_SIZE_APP_BLUETOOTH + 4];
    ...
    kal_uint8 APP_TENCENT_MCARE[ASM_FG_SIZE_APP_TENCENT_MCARE + 4];
    kal_uint8 APP_TENCENT_MCARE_BG[ASM_FG_SIZE_APP_TENCENT_MCARE_BG + 4];
    kal_uint8 APP_VDOPLY[ASM_FG_SIZE_APP_VDOPLY + 4];
    ...
    kal_uint8 SRV_MDI_VDOREC[ASM_FG_SIZE_SRV_MDI_VDOREC + 4];
    kal_uint8 SRV_MDI_VDOREC_CIF[ASM_FG_SIZE_SRV_MDI_VDOREC_CIF + 4];
    kal_uint8 dummy;
} app_asm_pool_fg_union;

/* total */
typedef union {
    kal_uint8 APP_BLUETOOTH[ASM_TOTAL_SIZE_APP_BLUETOOTH + 4];
    ...
    kal_uint8 APP_TENCENT_MCARE[ASM_TOTAL_SIZE_APP_TENCENT_MCARE + 4];
    kal_uint8 APP_TENCENT_MCARE_BG[ASM_TOTAL_SIZE_APP_TENCENT_MCARE_BG + 4];
    kal_uint8 APP_VDOPLY[ASM_TOTAL_SIZE_APP_VDOPLY + 4];
    ...
    kal_uint8 SRV_MDI_VDOREC[ASM_TOTAL_SIZE_SRV_MDI_VDOREC + 4];
    kal_uint8 SRV_MDI_VDOREC_CIF[ASM_TOTAL_SIZE_SRV_MDI_VDOREC_CIF + 4];
    kal_uint8 dummy;
...
typedef union {
    ...
    kal_uint8 APP_TENCENT_MCARE_BG[ASM_APP_FG_SIZE_APP_TENCENT_MCARE_BG + 4];
    kal_uint8 APP_VDOPLY[ASM_APP_FG_SIZE_APP_VDOPLY + 4];
    ...
    kal_uint8 SRV_MDI_VDOREC[ASM_APP_FG_SIZE_SRV_MDI_VDOREC + 4];
    kal_uint8 SRV_MDI_VDOREC_CIF[ASM_APP_FG_SIZE_SRV_MDI_VDOREC_CIF + 4];
    kal_uint8 dummy;
...
typedef union {
    kal_uint8 APP_BLUETOOTH[APPLIB_MEM_AP_POOL_SIZE_CONFIG(ASM_TOTAL_SIZE_APP_BLUETOOTH)];
    ...
    kal_uint8 APP_TENCENT_MCARE[APPLIB_MEM_AP_POOL_SIZE_CONFIG(ASM_TOTAL_SIZE_APP_TENCENT_MCARE)];
    kal_uint8 APP_TENCENT_MCARE_BG[APPLIB_MEM_AP_POOL_SIZE_CONFIG(ASM_TOTAL_SIZE_APP_TENCENT_MCARE_BG)];
    kal_uint8 APP_VDOPLY[APPLIB_MEM_AP_POOL_SIZE_CONFIG(ASM_TOTAL_SIZE_APP_VDOPLY)];
    ...
    kal_uint8 CONC_APP_TENCENT_MCARE_BG_APP_IDLE[APPLIB_MEM_AP_POOL_SIZE_CONFIG(ASM_CONC_TOTAL_SIZE_APP_TENCENT_MCARE_BG_APP_IDLE)];
