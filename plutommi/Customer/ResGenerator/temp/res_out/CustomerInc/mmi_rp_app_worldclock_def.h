...
typedef enum
{
    ORGANIZER_WORLDCLOCK_MENU = 37430 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_WCLOCK_CITY_NONE = 37430 + 1, /* BASE_ID + 1 */
    STR_WCLOCK_CITY1,
    STR_WCLOCK_CITY2,
    STR_WCLOCK_CITY3,
    STR_WCLOCK_CITY4,
...
typedef enum
{
    CURRENT_CITY = 37430 + 1, /* BASE_ID + 1 */                 /*         BYTE */ 
    FOREIGN_CITY,                                               /*         BYTE */ 
...
typedef enum
{
    WORLD_CLOCK_IMAGE1 = 37430 + 1, /* BASE_ID + 1 */
