...
typedef enum
{
    MENU_CONN_BT_POWER = 33206 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_BT_MENU_TITLE = 33206 + 1, /* BASE_ID + 1 */
    STR_BT_CM_SETPATH,
    ...
    STR_BT_NO_CARD,
    STR_BT_WRITE_FILE_FAIL,
    STR_BT_RECEIVE_FAIL,
    STR_BT_SEND_ALL_SENT,
    STR_BT_SEND_PARTIAL_1,
    STR_BT_SEND_PARTIAL,
...
typedef enum
{
    SCR_EXTDEV_BT_BEGIN = 33206 + 1, /* BASE_ID + 1 */
    GRP_ID_BT_CM,
...
typedef enum
{
    BT_LP2_TESTING_TIMER = 33206 + 1, /* BASE_ID + 1 */
    BT_LP2_DELAY_TIMER,
...
typedef enum
{
    EVT_ID_SPPC_CONNECT_CNF = 33206 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_BT_RECEIVE_DRIVE = 33206 + 1, /* BASE_ID + 1 */       /*         BYTE */ 
...
typedef enum
{
    IMG_BT_MENU_TITLE = 33206 + 1, /* BASE_ID + 1 */
    IMG_BT_SCH_TITLE,
    IMG_BT_DEV_PRT,
    IMG_BT_DEV_LAP,
    IMG_BT_DEV_MOB,
