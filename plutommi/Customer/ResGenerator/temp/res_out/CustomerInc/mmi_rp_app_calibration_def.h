...
typedef enum
{
    SCR_CALIBRATION_SETTING = 41307 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_CALIBRATION_MENU_ICON = 41307 + 1, /* BASE_ID + 1 */
    IMG_CALIBRATION_TOP_LEFT,
    IMG_CALIBRAION_BOTTOM_RIGHT,
    IMG_CALIBRATION_CENTER,
    MMI_RP_APP_CALIBRATION_IMG_MAX
}mmi_rp_app_calibration_img_enum;
