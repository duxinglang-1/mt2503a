...
typedef enum
{
    MENU_ID_SNDREC_MAIN = 35098 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_SNDREC_MAIN = 35098 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SNDREC_START_BASE = 35098 + 1, /* BASE_ID + 1 */
    GRP_ID_SNDREC_MAIN,
...
typedef enum
{
    SNDREC_TIMER_FILELIST_SEEK = 35098 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_AUTO_VM_SETTING_VM_SUPPORT = 35098 + 1, /* BASE_ID + 1 */       /*         BYTE */ 
...
typedef enum
{
    IMG_ID_SNDREC_MAIN_ICON = 35098 + 1, /* BASE_ID + 1 */
