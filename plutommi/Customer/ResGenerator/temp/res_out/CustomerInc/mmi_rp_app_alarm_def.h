...
typedef enum
{
    ORGANIZER_ALARM_MENU = 43547 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ALARMS_SNOOZE_STRINGID = 43547 + 1, /* BASE_ID + 1 */
    ALARM_REPEAT_STRING,
    ALARM_ONCE_STRING,
    ALARM_HOURLY_STRING,
...
typedef enum
{
    SCR_ID_ALM_LIST = 43547 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ALARM_ALERT_NOTIFYDURATION_TIMER = 43547 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ALARMS_EDIT_SOFTKEY_IMAGEID = 43547 + 1, /* BASE_ID + 1 */
