...
enum {
    ...
    /* APP_BLUETOOTH */
    ASM_HEAP_SIZE_APP_BLUETOOTH = (OPPC_MAX_OBEX_PACKET_LENGTH),
    ASM_BASE_SIZE_APP_BLUETOOTH = (ASM_HEAP_SIZE_APP_BLUETOOTH),
    ASM_FG_SIZE_APP_BLUETOOTH = (0),
    ASM_TOTAL_SIZE_APP_BLUETOOTH = (ASM_BASE_SIZE_APP_BLUETOOTH + ASM_FG_SIZE_APP_BLUETOOTH),
    ...
    /* APP_TENCENT_MCARE */
    ASM_HEAP_SIZE_APP_TENCENT_MCARE = (650*1024),
    ASM_BASE_SIZE_APP_TENCENT_MCARE = (ASM_HEAP_SIZE_APP_TENCENT_MCARE),
    ASM_FG_SIZE_APP_TENCENT_MCARE = (0),
    ASM_TOTAL_SIZE_APP_TENCENT_MCARE = (ASM_BASE_SIZE_APP_TENCENT_MCARE + ASM_FG_SIZE_APP_TENCENT_MCARE),

    /* APP_TENCENT_MCARE_BG */
    ASM_HEAP_SIZE_APP_TENCENT_MCARE_BG = (330*1024),
    ASM_BASE_SIZE_APP_TENCENT_MCARE_BG = (ASM_HEAP_SIZE_APP_TENCENT_MCARE_BG),
    ASM_APP_FG_SIZE_APP_TENCENT_MCARE_BG = (320*1024),
    ASM_FG_SIZE_APP_TENCENT_MCARE_BG = (ASM_APP_FG_SIZE_APP_TENCENT_MCARE_BG),
    ASM_TOTAL_SIZE_APP_TENCENT_MCARE_BG = (ASM_BASE_SIZE_APP_TENCENT_MCARE_BG + ASM_FG_SIZE_APP_TENCENT_MCARE_BG),
    ...
    /* SRV_MDI_VDOREC */
    ASM_HEAP_SIZE_SRV_MDI_VDOREC = (0),
    ASM_BASE_SIZE_SRV_MDI_VDOREC = (MAX_MED_VID_BG_EXT_MEM_SIZE),
    ASM_APP_FG_SIZE_SRV_MDI_VDOREC = (MAX_MED_VID_ENC_EXT_MEM_SIZE),
    ASM_FG_SIZE_SRV_MDI_VDOREC = (ASM_APP_FG_SIZE_SRV_MDI_VDOREC),
    ASM_TOTAL_SIZE_SRV_MDI_VDOREC = (ASM_BASE_SIZE_SRV_MDI_VDOREC + ASM_FG_SIZE_SRV_MDI_VDOREC),

    /* SRV_MDI_VDOREC_CIF */
    ASM_HEAP_SIZE_SRV_MDI_VDOREC_CIF = (0),
    ASM_BASE_SIZE_SRV_MDI_VDOREC_CIF = (MAX_MED_VID_BG_EXT_MEM_SIZE),
    ASM_APP_FG_SIZE_SRV_MDI_VDOREC_CIF = (MAX_MED_VID_ENC_CIF_EXT_MEM_SIZE),
    ASM_FG_SIZE_SRV_MDI_VDOREC_CIF = (ASM_APP_FG_SIZE_SRV_MDI_VDOREC_CIF),
    ASM_TOTAL_SIZE_SRV_MDI_VDOREC_CIF = (ASM_BASE_SIZE_SRV_MDI_VDOREC_CIF + ASM_FG_SIZE_SRV_MDI_VDOREC_CIF),

    /* total number of APP declared */
    ASM_TOTAL_NUM_APP = (39),
    ...
    ASM_CONC_TOTAL_SIZE_APP_TENCENT_MCARE_BG_APP_IDLE = (max(ASM_BASE_SIZE_APP_TENCENT_MCARE_BG + ASM_FG_SIZE_APP_TENCENT_MCARE_BG, ASM_BASE_SIZE_APP_TENCENT_MCARE_BG + ASM_BASE_SIZE_APP_IDLE + ASM_FG_SIZE_APP_IDLE)),
