...
typedef enum
{
    MENU_ID_NETSET_MAIN = 41631 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_NETSET_NETWORK_SELECTION = 41631 + 1, /* BASE_ID + 1 */
    ...
    STR_ID_NETSET_WLAN_OFF,
    STR_ID_NETSET_WLAN_ON,
    STR_ID_NETSET_INVALID_WLAN,
...
typedef enum
{
    GRP_ID_NETSET_MAIN = 41631 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_SETTING_NETWORK = 41631 + 1, /* BASE_ID + 1 */
