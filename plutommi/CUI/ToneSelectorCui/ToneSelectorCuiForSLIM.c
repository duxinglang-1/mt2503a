...
static void cui_tone_selector_creat_tone_list(mmi_event_struct* evt);
...
static mmi_ret cui_tone_selector_group_proc(mmi_event_struct* evt)
{
    ...
    switch(evt->evt_id)
    {
        ...
        {            
            ...
            {
                cui_tone_selector_creat_tone_list(evt);
            }     
            break;
        }
...
{    
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    cui_menu_id = menu_evt->sender_id;
    ...
    /* When entry in history do not set highlighter */
...
/*****************************************************************************
 * FUNCTION
 *  cui_tone_selector_bt_music_disconnect_callback
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
static void cui_tone_selector_bt_music_disconnect_callback(MMI_BOOL result)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static void cui_tone_selector_preview_play_tone(void)
{
    ...
    {
        mmi_bt_music_disconnect(cui_tone_selector_bt_music_disconnect_callback);
        return;
    }
#endif
