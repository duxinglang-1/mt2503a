...
#define PHB_APP_CLOUD_ASM_BUFF_SIZE (100*1024)
#else
#define PHB_APP_CLOUD_ASM_BUFF_SIZE (0)
#endif
#endif
/**
 * CUI group event
...
} mmi_phb_pbapc_num_struct;

typedef struct
{
    U8 num_count;
    U16 name[MMI_PHB_NAME_FIELD_LENGTH + 1];
    mmi_phb_pbapc_num_struct num[4];
} mmi_phb_pbapc_phb_info_struct;
/*****************************************************************************
 * FUNCTION
 ...
 *  void
 *****************************************************************************/
extern void cui_phb_save_contact_set_phb_info(mmi_id phb_save_sg_id, mmi_phb_pbapc_phb_info_struct *phb_info);
#endif
...
#define MMI_PHB_PBAPC_MAX_NAME_LEN          (30)

#define MMI_PHB_PBAPC_MAX_NUM_LEN           (42)

typedef enum
{
    MMI_PHB_PBAPC_SEL_RESULT = 0,

    MMI_PHB_PBAPC_SEL_REQ_CLOSE,

    MMI_PHB_PBAPC_SEL_TYPE_TOTAL
} mmi_phb_pbapc_sel_evt_enum;

typedef enum
{
    MMI_PHB_PBAPC_SEL_RET_OK = 0,
    MMI_PHB_PBAPC_SEL_RET_CANCEL,

    MMI_PHB_PBAPC_SEL_RET_TOTAL
} mmi_phb_pbapc_sel_ret_enum;

typedef enum
{
    MMI_PHB_PBAPC_CONTACT_LOCAL = 0,
    MMI_PHB_PBAPC_CONTACT_BT,

    MMI_PHB_PBACP_CONTACT_TYPE_TOTAL
} mmi_phb_pbapc_contact_enum;
...
typedef struct
{
    ...
    mmi_phb_pbapc_sel_evt_enum rsp_type;
    void *rsp;
    void *cb_user_data;
} cui_phb_pbapc_select_contact_rsp_struct;


typedef struct
{
    mmi_phb_pbapc_sel_ret_enum ret;

    mmi_phb_pbapc_contact_enum contact_type;

    U16 name[MMI_PHB_PBAPC_MAX_NAME_LEN + 1];

    U16 number[MMI_PHB_PBAPC_MAX_NUM_LEN + 1];

    /* only if contact_type = MMI_PHB_PBAPC_CONTACT_LOCAL */
    mmi_phb_contact_id contact_id;
    mmi_phb_sub_id sub_id;

    /* only if contact_type = MMI_PHB_PBAPC_CONTACT_BT */
    srv_phb_pbap_storage_enum storage;
    U16 entry_index;
    U8 num_type;
} cui_phb_pbapc_select_contact_ret_struct;


typedef struct
{
    mmi_phb_pbapc_sel_ret_enum ret;
} cui_phb_pbapc_select_contact_req_close_struct;

/*****************************************************************************
 * FUNCTION
 *  cui_phb_pbapc_select_contact_create
 * DESCRIPTION
 * 
 * PARAMETERS
 * 
 ...
 * 
 *****************************************************************************/
extern mmi_ret cui_phb_pbapc_select_contact_create(mmi_id parent_id);


/*****************************************************************************
 * FUNCTION
 *  cui_phb_pbapc_select_contact_run
 * DESCRIPTION
 * 
 * PARAMETERS
 * 
 ...
 * 
 *****************************************************************************/
extern void cui_phb_pbapc_select_contact_run(mmi_id sel_contact_gid);


/*****************************************************************************
 * FUNCTION
 *  cui_phb_pbapc_select_contact_set_user_data
 * DESCRIPTION
 * 
 * PARAMETERS
 * 
 ...
 * 
 *****************************************************************************/
extern void cui_phb_pbapc_select_contact_set_user_data(mmi_id sel_contact_gid, void *user_data);


/*****************************************************************************
 * FUNCTION
 *  cui_phb_pbapc_select_contact_close
 * DESCRIPTION
 * 
 * PARAMETERS
 * 
 ...
 * 
 *****************************************************************************/
extern void cui_phb_pbapc_select_contact_close(mmi_id sel_contact_gid);

#endif /* defined(__MMI_BT_PBAP_CLIENT__) */

#ifdef __MMI_TELEPHONY_SUPPORT__
    #ifndef __MMI_LOCAL_PHB_SUPPORT__
        #define __MMI_LOCAL_PHB_SUPPORT__
    #endif
#else
    #ifdef __MMI_LOCAL_PHB_SUPPORT__
        #undef __MMI_LOCAL_PHB_SUPPORT__
    #endif
