...
void *g_phonebook_mem_ptr = NULL;
BOOL phb_list_select_end_key_press = MMI_FALSE;
...
extern mmi_ret mmi_phb_editor_set_scrn_proc(mmi_event_struct *param);
#endif
#endif
#ifdef __MMI_SNS_CONTACTS__
extern mmi_ret mmi_phb_sns_scrn_leave_proc(mmi_event_struct *param);
#endif
...
mmi_phb_save_contact_cntx_struct* cui_phb_save_contact_create_cntx(void)
{
    ...
    save_cntx = (mmi_phb_save_contact_cntx_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_save_contact_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
    ...
    save_cntx->contact = (mmi_phb_contact_info_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_contact_info_struct), SRV_PHB_MEMORY_TYPE_ADM);
    ...
    save_cntx->res = (mmi_phb_caller_res_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_caller_res_struct), SRV_PHB_MEMORY_TYPE_ADM);
    #endif
	#endif
...
void cui_phb_save_contact_release_cntx(mmi_phb_save_contact_cntx_struct *save_cntx)
{
    ...
    if (save_cntx != NULL)
    {
        ...
        {
            mmi_phb_mem_free(save_cntx->contact);
        ...
        {
            mmi_phb_mem_free(save_cntx->res);
            save_cntx->res = NULL;
        }
		#endif
		#endif
		...
		if (mmi_phonebook_app_mem_get_ptr() == NULL)
			{
				...
				kal_prompt_trace(MOD_MMI,"[phonebook]cui_phb_save_contact_create,malloc");
				...
				{	
					...
					//MMI_TRACE(MMI_PHB_TRACE_GROUP, TRC_MMI_PHB_LANUCH, -1);
					return;
				}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_phb_convert_number_type_from_vcard
 * DESCRIPTION
 ...
 *  vcard_tel_type_enum
 *****************************************************************************/
mmi_phb_num_type_enum mmi_phb_convert_number_type_from_vcard(vcard_tel_type_enum type)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/*****************************************************************************
 * FUNCTION
 *  cui_phb_save_contact_set_phb_info
 * DESCRIPTION
 *  Phonebook Cui - save a contact info to phonebook, save number info
 * PARAMETERS
 * 
 ...
 *  void
 *****************************************************************************/
void cui_phb_save_contact_set_phb_info(mmi_id phb_save_sg_id, mmi_phb_pbapc_phb_info_struct *phb_info)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    save_cntx = (mmi_phb_save_contact_cntx_struct *)mmi_phb_cntx_mgr_get_data(handle);
#ifdef __MMI_PHB_OPTIONAL_FIELD__
    for (i = 1; i < phb_info->num_count; ++i)
    {
        mmi_wcsncpy(save_cntx->contact->opt_num[i - 1].number, phb_info->num[i].number, MMI_PHB_NUMBER_LENGTH);
        save_cntx->contact->opt_num[i - 1].number[MMI_PHB_NUMBER_LENGTH] = L'\0';
        save_cntx->contact->opt_num[i - 1].type = mmi_phb_convert_number_type_from_vcard(phb_info->num[i].type);
    }
...
/* under construction !*/
        ...
        case EVT_ID_GROUP_DEINIT:
        {
			...
			if (g_phonebook_memory_pool_ptr)
			{
				...
				kal_prompt_trace(MOD_MMI,"[phonebook]cui_phb_save_contact_proc free");
...
MMI_ID cui_phb_select_image_create(MMI_ID group_id, U32 type)
{
    ...
    user_data = mmi_phb_mem_malloc(sizeof(mmi_phb_select_image_struct), SRV_PHB_MEMORY_TYPE_ADM);
...
mmi_phb_list_cntx_struct* cui_phb_list_select_contact_create_cntx(U8 list_type)
{
    ...
    list_cntx = (mmi_phb_list_cntx_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_list_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
    ...
    list_cntx->contact_array = (U16 *) mmi_phb_mem_malloc(sizeof(U16) * MMI_PHB_ENTRIES ,SRV_PHB_MEMORY_TYPE_ADM);
	...
	#else
	list_cntx->storage = PHB_STORAGE_MAX;
	#endif
    ...
    {
        list_cntx->mark_array = (U16 *) mmi_phb_mem_malloc(sizeof(U16) * MMI_PHB_ENTRIES ,SRV_PHB_MEMORY_TYPE_ADM);
        list_cntx->mark_field = (U8 *) mmi_phb_mem_malloc(sizeof(U8) * MMI_PHB_ENTRIES ,SRV_PHB_MEMORY_TYPE_ADM);
    ...
    {
        list_cntx->group_array = (U8*) mmi_phb_mem_malloc(sizeof(U8) * MMI_PHB_GROUP_TOTAL_COUNT, SRV_PHB_MEMORY_TYPE_ADM);
    }
	#endif
	#endif
    ...
    {
    	list_cntx->sns_friend_list = (mmi_phb_sns_friend_list_struct*)mmi_phb_mem_malloc(sizeof(mmi_phb_sns_friend_list_struct), SRV_PHB_MEMORY_TYPE_CTR);
    	memset(list_cntx->sns_friend_list, 0, sizeof(mmi_phb_sns_friend_list_struct));
    	list_cntx->sns_favorite_list = (mmi_phb_sns_favorite_list_struct*)mmi_phb_mem_malloc(sizeof(mmi_phb_sns_favorite_list_struct), SRV_PHB_MEMORY_TYPE_CTR);
    	memset(list_cntx->sns_favorite_list, 0, sizeof(mmi_phb_sns_favorite_list_struct));
        sns_favorite = (CHAR*)mmi_phb_mem_malloc(sizeof(CHAR) * MMI_PHB_SNS_FAVORITE_MAX_NUM * SRV_SNS_MAX_LEN_ID, SRV_PHB_MEMORY_TYPE_ADM);
...
static void cui_phb_list_select_contact_release_cntx(mmi_phb_list_cntx_struct *list_cntx)
{
    ...
    if (list_cntx != NULL)
    {
        ...
        {
            mmi_phb_mem_free(list_cntx->contact_array);
        ...
        {
            mmi_phb_mem_free(list_cntx->mark_array);
            list_cntx->mark_array = NULL;
        }
        if (list_cntx->mark_field != NULL)
        {
            mmi_phb_mem_free(list_cntx->mark_field);
            list_cntx->mark_field = NULL;
        }
        if (list_cntx->group_array != NULL)
        {
            mmi_phb_mem_free(list_cntx->group_array);
    	...
    	if (list_cntx->sns_friend_list != NULL)
    	{
    	    ...
    	    mmi_phb_mem_free(list_cntx->sns_friend_list);
    	...
    	if (list_cntx->sns_favorite_list != NULL)
    	{
    	    ...
    	    mmi_phb_mem_free(list_cntx->sns_favorite_list);
            list_cntx->sns_favorite_list = NULL;
    	}
        sns_favorite = list_cntx->sns_favorite[0];
        if (sns_favorite != NULL)
        {
            mmi_phb_mem_free(sns_favorite);
        }
    #endif
        mmi_phb_mem_free(list_cntx);
    }
}
...
mmi_id cui_phb_list_select_contact_create(mmi_id parent_id)
{
	...
	if (mmi_phonebook_app_mem_get_ptr() == NULL)
		{
			g_phonebook_memory_pool_ptr = mmi_phonebook_app_mem_pool_malloc(MMI_PHONEBOOK_MEM_POOL_SIZE);		
			kal_prompt_trace(MOD_MMI,"[phonebook]cui_phb_list_select_contact_create malloc");
			if (g_phonebook_memory_pool_ptr == NULL)
			{	
				mmi_frm_appmem_prompt_to_release_mem(
					APPLIB_MEM_AP_ID_PHONEBOOK,
...
mmi_ret cui_phb_list_select_contact_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        case EVT_ID_GROUP_GOBACK_IN_END_KEY:
        case EVT_ID_GROUP_DELETE_REQ_IN_END_KEY:
            phb_list_select_end_key_press = MMI_TRUE;
            break;
	#endif
		...
		#ifdef __MMI_PHONEBOOK_MEM_SLIM__
			//if(phb_list_select_end_key_press == MMI_TRUE)
			{
		    ...
		    if (g_phonebook_memory_pool_ptr)
			  {
				...
				g_phonebook_memory_pool_ptr = NULL;
  				...
  				phb_list_select_end_key_press = MMI_FALSE;
			}
		 #endif
            break;
...
static mmi_phb_view_contact_cntx_struct* cui_phb_view_contact_create_cntx(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    view_cntx = (mmi_phb_view_contact_cntx_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_view_contact_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
     ...
     */
    view_cntx->contact = (mmi_phb_contact_info_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_contact_info_struct), SRV_PHB_MEMORY_TYPE_ADM);
    ...
    #ifdef __MMI_PHB_SLIM_NEW__
    #ifdef __MMI_PHB_CALLER_RES__ 
    view_cntx->res = (mmi_phb_caller_res_struct *) mmi_phb_mem_malloc(sizeof(mmi_phb_caller_res_struct), SRV_PHB_MEMORY_TYPE_ADM);
    #endif
	#endif
...
static void cui_phb_view_contact_release_cntx(mmi_id phb_view_sg_id)
{
    ...
    if (view_cntx != NULL)
    {
        ...
        {
            mmi_phb_mem_free(view_cntx->contact);
        ...
        {
            mmi_phb_mem_free(view_cntx->res);
            view_cntx->res = NULL;
        }
		#endif
		#endif
...
static void cui_phb_view_contact_entry(mmi_phb_view_contact_cntx_struct *view_cntx)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
	mmi_scrn_essential_struct scrn_data;
#endif
...
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
	scrn_data.group_id = view_cntx->sg_id;
	scrn_data.scrn_id = SCR_ENTRY_VIEW;
	scrn_data.user_data = view_cntx;
	mmi_phb_entry_op_view_entry(&scrn_data);
#else
    mmi_frm_scrn_first_enter(
        view_cntx->sg_id,
        SCR_ENTRY_VIEW,
...
static mmi_ret cui_phb_view_contact_proc(mmi_event_struct *evt)
{
	...
	#ifdef __MMI_PHONEBOOK_MEM_SLIM__		
			if (g_phonebook_view_memory_pool_ptr)
			{
				mmi_phonebook_app_mem_pool_free(g_phonebook_view_memory_pool_ptr);
				kal_prompt_trace(MOD_MMI,"[phonebook]cui_phb_view_contact_proc free");
				g_phonebook_view_memory_pool_ptr = NULL;
			}
	#endif
            break;
...
mmi_id cui_phb_view_contact(mmi_id parent_id, U16 store_index)
{
    ...
    if (mmi_phb_check_ready(MMI_TRUE))
    {
		...
		if (mmi_phonebook_app_mem_get_ptr() == NULL)
			{
				g_phonebook_view_memory_pool_ptr = mmi_phonebook_app_mem_pool_malloc(MMI_PHONEBOOK_MEM_POOL_SIZE);		
				kal_prompt_trace(MOD_MMI,"[phonebook]cui_phb_view_contact malloc");
				if (g_phonebook_view_memory_pool_ptr == NULL)
				{	
					mmi_frm_appmem_prompt_to_release_mem(
						APPLIB_MEM_AP_ID_PHONEBOOK,
						0,
...
mmi_id cui_phb_direct_dial_create(mmi_id parent_id)
{
    ...
    if (mmi_phb_check_ready(MMI_TRUE))
    {
        user_data = mmi_phb_mem_malloc(sizeof(mmi_phb_dialer_direct_dial_cntx_struct), SRV_PHB_MEMORY_TYPE_ADM);
...
extern mmi_ret mmi_phb_pbapc_menu_cui_proc(mmi_event_struct *evt);
#endif
...
mmi_ret mmi_phb_launch_proc(mmi_event_struct *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        #endif /* defined(__MMI_BT_PBAP_CLIENT__) */
#ifdef __MMI_PHONEBOOK_MEM_SLIM__		
		if (g_phonebook_mem_ptr)
			{
				mmi_phonebook_app_mem_pool_free(g_phonebook_mem_ptr);
				kal_prompt_trace(MOD_MMI,"[phonebook]mmi_phb_launch_proc free");
				g_phonebook_mem_ptr = NULL;
			}
#endif		
	...
	#ifdef __MMI_LOCAL_PHB_SUPPORT__
	#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
			mmi_phb_editor_set_scrn_proc(evt);
	#endif
	#endif
            break;
...
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__	
#ifdef __MMI_SNS_CONTACTS__
	menu_cui_proc = mmi_phb_sns_scrn_leave_proc(evt);
	if (menu_cui_proc == MMI_RET_OK)
    {
        return MMI_RET_OK;
    }
...
static void mmi_phb_app_mem_stop_callback(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	if (g_phb_cntx_mgr.adm_id)
    {
    
        kal_adm_delete(g_phb_cntx_mgr.adm_id);
        g_phb_cntx_mgr.adm_id = 0;
    }
    if (g_phb_cntx_mgr.asm_pool != NULL)
    {
        applib_mem_ap_free((void*)g_phb_cntx_mgr.asm_pool);
        g_phb_cntx_mgr.asm_pool = NULL;
    }

    mmi_phb_cntx_mgr_clear_history();

    /*Notify MMI that this application is already stopped */
    applib_mem_ap_notify_stop_finished(APPLIB_MEM_AP_ID_PHB,KAL_TRUE);
...
void mmi_phb_launch(void)
{
	...
	if (mmi_phonebook_app_mem_get_ptr() == NULL)
		{
			g_phonebook_mem_ptr = mmi_phonebook_app_mem_pool_malloc(MMI_PHONEBOOK_MEM_POOL_SIZE);		
			kal_prompt_trace(MOD_MMI,"[phonebook]mmi_phb_launch malloc");
			if (g_phonebook_mem_ptr == NULL)
			{	
				mmi_frm_appmem_prompt_to_release_mem(
					APPLIB_MEM_AP_ID_PHONEBOOK,
					0,
	...
	0,
	mmi_phb_app_mem_stop_callback);
		mmi_phb_launch_init(GRP_ID_ROOT);
	#endif
}
