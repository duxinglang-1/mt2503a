        ...
        case EVT_ID_CUI_FSEDITOR_ABORT:
            ...
            if (param->evt_id == EVT_ID_CUI_FSEDITOR_SUBMMIT)
            {
                ...
                if (context->extension == NULL)
                {
                    ...
                    if (i != len && i >= 0)
                    {
                        ...
                        if (!input_buffer[0])
                        {
                            ...
                            FMGR3_DisplayPopup(context->group_id, STR_GLOBAL_INVALID_FILENAME, MMI_EVENT_FAILURE);
                            break;
                        }
                    }
                }
                ...
                if (!input_buffer[0])
                {
                    ...
                    FMGR3_DisplayPopup(context->group_id, STR_GLOBAL_PLEASE_INPUT_THE_FILENAME, MMI_EVENT_FAILURE);
                    break;
                }
