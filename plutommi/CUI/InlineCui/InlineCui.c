...
#endif /* __MMI_INLINE_ITEM_DATE__ || __MMI_INLINE_ITEM_TIME__ || __MMI_INLINE_ITEM_TIME_PEROID__ */
...
static MMI_BOOL g_cui_inline_lock_softkey = MMI_FALSE;
...
static void cui_inline_format_time_period(
                U8 *string_buffer,
                U8 *hour1,
                U8 *min1,
                U8 *am_pm_flag1,
...
static void cui_inline_entry_screen(void);
...
#if defined(__MMI_PHB_PHOTO_STICKER_SUPPORT__)
void cui_inline_set_item_caption_thumbnail(
					mmi_id gid, 
					U16 item_id, 
					U32 style, 
					PU8 text_p,
...
void cui_inline_set_item_button(mmi_id gid, U16 item_id, PU8 text_p);
...
void cui_inline_free_fullscreen_buffer(void *p);
...
static S32 cui_inline_set_item_radio(mmi_id gid, U16 item_id, S32 first_item, S32 n_items, MMI_BOOL IsSeld, PU8 string);
static void cui_inline_evt_item_radio_selected(S32 select_index);
#endif
#if defined (__MMI_INLINE_ITEM_CHECKBOX__)
static S32 cui_inline_set_item_checkbox(mmi_id gid, U16 item_id, MMI_BOOL IsSeld, PU8 string);
static void cui_inline_evt_item_checkbox_changed(S32 selected);
#endif
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_fullscreen_custom_function
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void cui_inline_fullscreen_custom_function(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    SetLeftSoftkeyFunction(cui_inline_entry_options_screen, KEY_EVENT_UP);
}
...
S32 cui_inline_convert_type_to_cui(S32 pluto_type)
{
    ...
    switch (pluto_type & 0xFF)
    {
        ...
        {
            item_type = CUI_INLINE_ITEM_TYPE_BUTTON;
            break;
        }
#endif
#if defined (__MMI_INLINE_ITEM_CHECKBOX__)
		...
		{
			item_type = CUI_INLINE_ITEM_TYPE_CHECKBOX;
			break;
		}
#endif
#if defined (__MMI_INLINE_ITEM_RADIO__)
		...
		{
			item_type = CUI_INLINE_ITEM_TYPE_RADIO_LIST;
			break;
		}
#endif		
	...
	#if defined(__MMI_PHB_PHOTO_STICKER_SUPPORT__)
		case INLINE_ITEM_TYPE_CAPTION_THUMBNAIL:
		{
			item_type = CUI_INLINE_ITEM_TYPE_CAPTION_THUMBNAIL;
			break;
		}
	#endif /* __MMI_PHB_PHOTO_STICKER_SUPPORT__ */
...
S32 cui_inline_convert_type_to_inline(S32 pluto_type)
{
    ...
    {
#if defined (__MMI_INLINE_ITEM_BUTTON__)
		case CUI_INLINE_ITEM_TYPE_BUTTON:
        {
            item_type = INLINE_ITEM_TYPE_BUTTON;
            break;
        }
#endif
#if defined (__MMI_INLINE_ITEM_CHECKBOX__)
        case CUI_INLINE_ITEM_TYPE_CHECKBOX:
		{
...
#endif
#if defined (__MMI_INLINE_ITEM_RADIO__)
		case CUI_INLINE_ITEM_TYPE_RADIO_LIST:
		{
	...
	#if defined(__MMI_PHB_PHOTO_STICKER_SUPPORT__)
		case CUI_INLINE_ITEM_TYPE_CAPTION_THUMBNAIL:
		{
			item_type = INLINE_ITEM_TYPE_CAPTION_THUMBNAIL;
			break;
		}
	#endif /* __MMI_PHB_PHOTO_STICKER_SUPPORT__ */
                ...
                cui_inline_item_common_data_struct *common_data)
{
	...
	//for slim, remove cui_inline_default_activate_table, and set value with item_id

    if((id == CUI_INLINE_ITEM_TYPE_CAPTION)
#if defined(__MMI_PHB_PHOTO_STICKER_SUPPORT__)	
     ||(id == CUI_INLINE_ITEM_TYPE_CAPTION_THUMBNAIL)
#endif     
     )
    {
	...
	else if ((id == CUI_INLINE_ITEM_TYPE_FULLSCREEN_EDIT)
         ||  (id == CUI_INLINE_ITEM_TYPE_IMAGE_TEXT)
         ||  (id == CUI_INLINE_ITEM_TYPE_CHECKBOX)
         ||  (id == CUI_INLINE_ITEM_TYPE_RADIO_LIST)
         )
    {
        common_data->key_code = KEY_LSK;
		    common_data->key_event = KEY_EVENT_UP;
    }
    else
    {
                ...
                cui_inline_item_data_union *special_data)
{
        ...
        switch (common_data->flag & 0xFF)
        {
			...
			case INLINE_ITEM_TYPE_BUTTON:
            {
                cui_inline_button_struct *p_button_data = (cui_inline_button_struct*) special_data;
                ReConfigureInlineItemButton(
                    &wgui_inline_items[index],
                    p_button_data->text_p);
                break;
            }
#endif
#if defined (__MMI_INLINE_ITEM_CHECKBOX__)
            case INLINE_ITEM_TYPE_CHECKBOX:
			{
				cui_inline_checkbox_struct *p_checkbox_data = (cui_inline_checkbox_struct*) special_data;
				ReconfigureInlineItemCheckBox(
					&wgui_inline_items[index],
					p_checkbox_data->string,
					p_checkbox_data->IsSeld);
				SetInlineCheckboxChangeFunction(
					&wgui_inline_items[index],
					cui_inline_evt_item_checkbox_changed);
				break;
			}
#endif
#if defined (__MMI_INLINE_ITEM_RADIO__)
            case INLINE_ITEM_TYPE_RADIO:
			{
				cui_inline_radio_struct *p_radio_data = (cui_inline_radio_struct*) special_data;
				ReconfigureInlineItemRadio(
					&wgui_inline_items[index], 
					p_radio_data->first_item, 
					p_radio_data->n_items, 
					p_radio_data->IsSeld, 
					p_radio_data->string);
				SetInlineRadioSelectFunction(
					&wgui_inline_items[index], 
					cui_inline_evt_item_radio_selected);
				break;
			}
#endif			
            case INLINE_ITEM_TYPE_CAPTION:
			...
			case INLINE_ITEM_TYPE_CAPTION_THUMBNAIL:
			{
				cui_inline_caption_tn_struct *p_caption_tn_data = (cui_inline_caption_tn_struct*) special_data;

				ReconfigureInlineItemCaptionThumbnail(
					&wgui_inline_items[index],
					p_caption_tn_data->text_p,
					p_caption_tn_data->thumbnail_path,
					p_caption_tn_data->buffer_p,
					p_caption_tn_data->default_id,
					p_caption_tn_data->style);
				break;
			}
		#endif /* __MMI_PHB_PHOTO_STICKER_SUPPORT__ */
            case INLINE_ITEM_TYPE_DISPLAY_ONLY:
            ...
            case INLINE_ITEM_TYPE_TEXT_EDIT:
            {
                cui_inline_text_edit_struct *p_textedit = (cui_inline_text_edit_struct*) special_data;

                if((wgui_inline_items[index].flags & INLINE_ITEM_TYPE_TEXT_EDIT) == 0)
                {
                    SetInlineItemTextEdit(&wgui_inline_items[index], p_textedit->buffer, p_textedit->buffer_size, p_textedit->input_type);
                }
                else
                {
                ...
                ReConfigureInlineItemTextEdit_ext(
                    &wgui_inline_items[index],
                    p_textedit->buffer,
                    p_textedit->buffer_size,
                    p_textedit->input_type,
                    p_textedit->input_extended_type,
                    p_textedit->required_input_mode_set);
                }
                if(p_textedit->default_text_ptr != NULL)
                {
#ifdef __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__                       
                    SetInlineItemTextEditDefaultItemNameIfEmpty_with_string(&wgui_inline_items[index], p_textedit->default_text_ptr);
#endif                    
                }
                else if (get_string(p_textedit->default_text_id) != NULL)
                {
#ifdef __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__                    
                    SetInlineItemTextEditDefaultItemNameIfEmpty_with_string(&wgui_inline_items[index], (U8 *)get_string(p_textedit->default_text_id));
#endif
                }
                break;
            }
            ...
            case INLINE_ITEM_TYPE_FULL_SCREEN_EDIT:
            {
                ...
                if ((p_data->flags & CUI_INLINE_ITEM_IS_FULLSCREEN_OPEN) && (p_data->temp_edit_buffer))
                {
                    S32 l;

                    l = p_data->buffer_size * ENCODING_LENGTH;
                    if (p_data->input_type & INPUT_TYPE_PLUS_CHARACTER_HANDLING)
                    {
                        l += ENCODING_LENGTH;
                    }
                    gui_memcpy((U8*) wgui_inline_full_screen_text_edit_buffer, (U8*) p_data->temp_edit_buffer, l);
                    cui_inline_free_fullscreen_buffer((void*)p_data->temp_edit_buffer);
                    p_data->temp_edit_buffer = NULL;
                    wgui_inline_items[index].flags |= INLINE_ITEM_OPEN;
                }
                if (p_data->flags & CUI_INLINE_ITEM_IS_FULLSCREEN_CHANGE)
                {
                    wgui_inline_items[index].flags |= INLINE_ITEM_CHANGED;
                }
                ...
                SetInlineFullScreenEditCustomFunction(&wgui_inline_items[index], cui_inline_fullscreen_custom_function);
                break;
            }
#if 0            
#if defined (__MMI_INLINE_ITEM_IMAGETEXT__)			
...
/* under construction !*/
            ...
            case INLINE_ITEM_TYPE_DATE:
            {
                ...
                ReConfigureInlineItemDate(
                    &wgui_inline_items[index],
                    (PU8) &p_data->date_data->day_buffer[0],
                    (PU8) &p_data->date_data->month_buffer[0],
                    (PU8) &p_data->date_data->year_buffer[0],
            ...
            case INLINE_ITEM_TYPE_TIME:
            {
                ...
                ReConfigureInlineItemTime(
                    &wgui_inline_items[index],
                    (PU8) &p_data->time_data->hour_buffer[0],
                    (PU8) &p_data->time_data->minute_buffer[0],
...
/* under construction !*/
            ...
            case INLINE_ITEM_TYPE_IP4_EDIT:
            {
                ...
                ReConfigureInlineItemIP4(
                    &wgui_inline_items[index],
                    (PU8) &p_data->ip4_data->b1[0],
                    (PU8) &p_data->ip4_data->b2[0],
                    (PU8) &p_data->ip4_data->b3[0],
                    (PU8) &p_data->ip4_data->b4[0],
    ...
    switch (common_data->flag & 0xFF)
    {
        ...
        case INLINE_ITEM_TYPE_TEXT_EDIT:
        {
            ...
            SetInlineItemTextEdit_ext(
                ...
                p_textedit->input_extended_type,
                p_textedit->required_input_mode_set);
            if (get_string(p_textedit->default_text_id) != NULL)
            {
#ifdef __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__                 
                SetInlineItemTextEditDefaultItemNameIfEmpty(&wgui_inline_items[index], p_textedit->default_text_id);
#endif
            }
            else if(p_textedit->default_text_ptr != NULL)
            {
#ifdef __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__                       
                SetInlineItemTextEditDefaultItemNameIfEmpty_with_string(&wgui_inline_items[index], p_textedit->default_text_ptr);
#endif                    
        ...
        case INLINE_ITEM_TYPE_MULTI_LINE_EDIT:
        {
			...
			p_data->cursor_p = p_data->buffer;
			if (p_data->cursor_p != NULL)
			{
			    SetInlineItemMultiLineCursor_p(&wgui_inline_items[index], p_data->cursor_p);
			}
            break;
        }
 #endif /* defined(__MMI_INLINE_ITEM_MULTILINE_READ_ONLY__) || defined(__MMI_INLINE_ITEM_MULTILINE_EDIT__) */ 		
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_malloc_fullscreen_buffer
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void *cui_inline_malloc_fullscreen_buffer(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return mmi_malloc(CUI_INLINE_FULLSCREEN_EDIT_SIZE);
}


/*****************************************************************************
 * FUNCTION
 *  cui_inline_free_fullscreen_buffer
 * DESCRIPTION
 *  
 * PARAMETERS
 *  p       [?]     
...
void cui_inline_draw_softkey(WGUI_SOFTKEY_ENUM key)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	if (g_cui_inline_lock_softkey == MMI_FALSE)
	{
	    redraw_softkey(key);
	}
}
 ...
 *  void
 *****************************************************************************/
void cui_inline_lock_draw_softkey(MMI_BOOL IsLock)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	g_cui_inline_lock_softkey = IsLock;
}
...
void cui_inline_set_item_convert_app_to_cui(mmi_id gid, U16 item_id, const cui_inline_set_item_struct *app_item)
{
    ...
    switch (app_item->item_flag & 0xff)
    {
        ...
        {
            PU8 text_p = NULL;
            cui_inline_item_button_struct *item_data;
            item_data = (cui_inline_item_button_struct*) (app_item->item_data);
            if (item_data->string_id)
            {
                text_p = (PU8) get_string(item_data->string_id);
            }
            cui_inline_set_item_button(gid, item_id, text_p);
            break;
        }
#endif
#if defined (__MMI_INLINE_ITEM_CHECKBOX__)
        case CUI_INLINE_ITEM_TYPE_CHECKBOX:
		{
			cui_inline_item_checkbox_struct *item_data;
			item_data = (cui_inline_item_checkbox_struct*) (app_item->item_data);
            if (item_data->text_p)
            {
                cui_inline_set_item_checkbox(gid, item_id, item_data->IsSelected, item_data->text_p[0]);
            }
            else
            {
                cui_inline_set_item_checkbox(gid, item_id, item_data->IsSelected, NULL);
            }
            break;
		}
#endif
		...
		case CUI_INLINE_ITEM_TYPE_CAPTION_THUMBNAIL:
		{
			cui_inline_item_caption_tn_struct *item_data;
			PU8 text_p = NULL;

			item_data = (cui_inline_item_caption_tn_struct*) (app_item->item_data);
			if (item_data != NULL)
			{
			    text_p = (PU8) get_string(item_data->string_id);
			}
			cui_inline_set_item_caption_thumbnail(
				gid,
				item_id, 
				item_data->style, 
				text_p,
				item_data->default_id,
...
/* under construction !*/
        ...
        case CUI_INLINE_ITEM_TYPE_DATETIME_SETTING_DISPLAY_ONLY:
        {
          	cui_inline_set_item_displayonly(gid, item_id, NULL, 0);
            break;
        }
        #endif	
        case CUI_INLINE_ITEM_TYPE_DATE:
...
#if defined (__MMI_INLINE_ITEM_RADIO__)
static S32 cui_inline_initialize_radio_list(mmi_id inline_id, S32 curr_index, const cui_inline_set_item_struct *app_item)
{
    S32 i, index;
    U32 item_flag = (app_item->item_flag) & 0xFF;
    cui_inline_item_struct *item = NULL;
	cui_inline_item_radio_list_struct *item_data;
	cui_inline_instance_struct *p_instance = 
		(cui_inline_instance_struct*) mmi_frm_group_get_user_data(inline_id);

	item_data = (cui_inline_item_radio_list_struct*) (app_item->item_data);
	for(i = 0; i < item_data->n_items; i++)
	{
	    index = i + curr_index;
	    item = &((p_instance->cui_inline_items)[index]);
		item->common_data.item_id = app_item->item_id + i;
		item->common_data.flag = app_item->item_flag;
		cui_inline_set_item_type(&(item->common_data), cui_inline_convert_type_to_inline(item_flag));

		p_instance->list_of_icons[index] = app_item->image_id;

        if (item_data->list_of_string)
        {
            cui_inline_set_item_radio(inline_id, 
                (item->common_data).item_id, 
                curr_index, 
                item_data->n_items, 
                (i==item_data->selected_item), 
                item_data->list_of_string[i]);
        }
        else
        {
            cui_inline_set_item_radio(inline_id, 
...
void cui_inline_initialize_items(mmi_id inline_id, const cui_inline_struct *inline_struct)
{
    ...
    {
        U32 item_flag = (inline_struct->items[index].item_flag) & 0xFF;
        U32 pluto_flag = cui_inline_convert_type_to_inline(item_flag);

#if defined (__MMI_INLINE_ITEM_RADIO__)
		if (item_flag == CUI_INLINE_ITEM_TYPE_RADIO_LIST)
		{
		    S32 ret;
		    ret = cui_inline_initialize_radio_list(inline_id, i, &(inline_struct->items[index]));
			i += (ret - 1);
		}
		else
#endif			
		{
			...
			item->common_data.item_id = (inline_struct->items[index]).item_id;
			
			item->common_data.flag = (inline_struct->items[index]).item_flag;
			cui_inline_set_item_type(&(item->common_data), pluto_flag);
			
			p_instance->list_of_icons[i] = inline_struct->items[index].image_id;
			
			cui_inline_set_item_convert_app_to_cui(inline_id, (item->common_data).item_id, &(inline_struct->items[index]));
			cui_inline_set_item_attributes(
				inline_id,
				(item->common_data).item_id,
				CUI_INLINE_SET_ATTRIBUTE,
				(inline_struct->items[index]).item_flag);
		}
		index++;
    }
...
void cui_inline_delete_item_data(cui_inline_item_struct *item_data)
{
    ...
    switch (common_data->flag & 0xff)
    {
        case INLINE_ITEM_TYPE_TEXT_EDIT:
        {
            cui_inline_text_edit_struct *special_data = (cui_inline_text_edit_struct*) & (item_data->special_data);
        ...
        case INLINE_ITEM_TYPE_FULL_SCREEN_EDIT:
        {
            ...
            special_data->buffer = NULL;
            cui_inline_free_fullscreen_buffer(special_data->temp_edit_buffer);
            special_data->temp_edit_buffer = NULL;
            special_data->memory_mode = CUI_INLINE_TEXT_MEMORY_NONE;
            break;
        }
#if 0        
...
S32 cui_inline_set_item_attributes(mmi_id gid, U16 item_id, U8 operation, U32 flag)
{
    ...
    if ((operation == CUI_INLINE_SET_ATTRIBUTE))
    {
        ...
        if (cui_inline_is_edit_main_screen(p_instance->gid))
        {
            ...
            if (flag & CUI_INLINE_ITEM_DOTTED_UNDERLINE)
            {
                SetInlineItemDottedUnderline(&(wgui_inline_items[index]));
            }
			if (flag & CUI_INLINE_ITEM_YEAR_ONLY)
			{
#if 0              
...
/* under construction !*/
            ...
            if (flag & CUI_INLINE_ITEM_DISABLE_CURSOR)
            {
                wgui_inline_text_disable_cursor_display(index);
            }
            ...
            if(flag & CUI_INLINE_ITEM_SELECT_NO_LOOP)
            {
                if((item->common_data.flag & 0xFF) == INLINE_ITEM_TYPE_SELECT)
                {
                wgui_inline_set_selector_no_loop(&(wgui_inline_items[index]), (MMI_BOOL)1);
                }
            }
            ...
            if(flag & CUI_INLINE_ITEM_TEXTEDIT_FIRST_CURSOR)
            {
                ...
                {
                    wgui_inline_set_text_edit_first_cursor(&(wgui_inline_items[index]), (MMI_BOOL)1);
                }
            }
            ...
            if (flag & CUI_INLINE_ITEM_DEFAULT_TEXT)
            {
                ...
                switch ((item->common_data.flag) & 0xFF)
                {
                    case INLINE_ITEM_TYPE_TEXT_EDIT:
                    {
                        cui_inline_text_edit_struct *item_data =
                            (cui_inline_text_edit_struct*) (&((p_instance->cui_inline_items[index]).special_data));
            ...
            if (flag & CUI_INLINE_ITEM_DISABLE_CURSOR)
            {
                switch ((item->common_data.flag) & 0xFF)
                {
                    case INLINE_ITEM_TYPE_TEXT_EDIT:
                    {
                        cui_inline_text_edit_struct *item_data =
                            (cui_inline_text_edit_struct*) (&((p_instance->cui_inline_items[index]).special_data));
                        item_data->wgui_flag_attr |= UI_SINGLE_LINE_INPUT_BOX_DISABLE_CURSOR_DRAW;
                    }
                }
            }
        }
    ...
    if (operation == CUI_INLINE_RESET_ATTRIBUTE)
    {
        ...
        if (cui_inline_is_edit_main_screen(p_instance->gid))
        {
            ...
            if(flag & CUI_INLINE_ITEM_SELECT_NO_LOOP)
            {
                if((item->common_data.flag & 0xFF) == INLINE_ITEM_TYPE_SELECT)
                {
                    wgui_inline_set_selector_no_loop(&(wgui_inline_items[index]), (MMI_BOOL)0);
            }
            }
            if(flag & CUI_INLINE_ITEM_DISPLAY_NO_RESPONSE_NUMKEY)
            {
            ...
            MMI_ASSERT((flag & CUI_INLINE_ITEM_DOTTED_UNDERLINE) == 0);
            if (flag & CUI_INLINE_ITEM_DISABLE_CURSOR)
            {
                wgui_inline_text_enable_cursor_display(index);
            }
            cui_inline_redraw_screen(gid);
        }
        else
...
U32 cui_inline_get_item_attributes(mmi_id gid, U16 item_id)
{
    ...
    return p_instance->cui_inline_items[index].common_data.flag;
}
 ...
 *  MMI_RET_OK
 *****************************************************************************/
static mmi_ret cui_inline_leave_proc_cb(mmi_event_struct *evt)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void cui_inline_entry_screen_ext(mmi_scrn_essential_struct *scrn_data)
{
         ...
         MMI_FRM_FULL_SCRN))
    {
        ...
        if (!(p_instance->screen_flag & CUI_INLINE_SCREEN_DISABLE_DONE))
        {
            DisableCategory57ScreenDone();
...
/* under construction !*/
#endif
#endif
		wgui_inline_set_op_parent_group(p_instance->gid);
        ...
        mmi_frm_scrn_set_leave_proc(inline_gid, screen_id, cui_inline_leave_proc_cb);
    }
...
void cui_inline_redraw_item(mmi_id gid, S32 index)
{
    ...
    if ((cui_inline_main_screen_is_locked(gid)) || (gui_screen_smooth_scrolling_moved_by_pen()))
    {
        return;
    }
					...
					PU8 buffer_p)
{
    ...
    /*----------------------------------------------------------------*/
    U16 index = 0;
    cui_inline_caption_tn_struct *caption_tn_data = NULL;
    ...
    caption_tn_data = (cui_inline_caption_tn_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);

    cui_inline_set_item_type(common_data, INLINE_ITEM_TYPE_CAPTION_THUMBNAIL);

    caption_tn_data->style = style;
    caption_tn_data->text_p = text_p;
	caption_tn_data->default_id = default_id;
	caption_tn_data->thumbnail_path = thumbnail_path;
	caption_tn_data->buffer_p = buffer_p;

    cui_inline_set_item_default_activation(CUI_INLINE_ITEM_TYPE_CAPTION_THUMBNAIL, common_data);

    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        cui_inline_reconfig_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) caption_tn_data);
...
void cui_inline_set_item_button(mmi_id gid, U16 item_id, PU8 text_p)
{
    ...
    /*----------------------------------------------------------------*/
    U16 index = 0;
    cui_inline_button_struct *button_data = NULL;
    cui_inline_item_common_data_struct *common_data = NULL;
    cui_inline_instance_struct *inline_instance = (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    ...
    button_data = (cui_inline_button_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);
    
    cui_inline_set_item_type(common_data, INLINE_ITEM_TYPE_BUTTON);
    cui_inline_set_item_default_activation(CUI_INLINE_ITEM_TYPE_BUTTON, common_data);
    
    button_data->text_p = text_p;
    
    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        cui_inline_reconfig_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) button_data);
        cui_inline_redraw_item(gid, index);
    }
}
#endif
        ...
        U16 default_text_id)
{
    ...
    /*----------------------------------------------------------------*/
    U16 index = 0;
    cui_inline_text_edit_struct *text_edit_data = NULL;
    cui_inline_item_common_data_struct *common_data = NULL;
    cui_inline_instance_struct *inline_instance = (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    ...
    /* get instance pointer; */
    text_edit_data = (cui_inline_text_edit_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);
	...
	text_edit_data->input_extended_type = input_extended_type;
...
static void cui_inline_evt_item_checkbox_changed(S32 selected)
{
    ...
    evt.event_type = CUI_INLINE_NOTIFY_CHECKBOX_CHANGED;
...
static S32 cui_inline_set_item_checkbox(mmi_id gid, U16 item_id, MMI_BOOL IsSeld, PU8 string)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    cui_inline_checkbox_struct *checkbox_data = NULL;
    cui_inline_item_common_data_struct *common_data = NULL;
    cui_inline_instance_struct *inline_instance = 
    ...
    /* get instance pointer; */
    checkbox_data = (cui_inline_checkbox_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);

    cui_inline_set_item_type(common_data, INLINE_ITEM_TYPE_CHECKBOX);
    cui_inline_set_item_default_activation(CUI_INLINE_ITEM_TYPE_CHECKBOX, common_data);

	checkbox_data->string = string;
	checkbox_data->IsSeld = IsSeld;

    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        cui_inline_reconfig_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) checkbox_data);
 ...
 *****************************************************************************/
S32 cui_inline_set_item_checkbox_string(mmi_id gid, U16 item_id, PU8 text_p)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);
    if ((common_data->flag & 0xff) != INLINE_ITEM_TYPE_CHECKBOX)
    {
        return CUI_INLINE_RETURN_ERROR;
    }
    checkbox_data = (cui_inline_checkbox_struct*) & (inline_instance->cui_inline_items[index].special_data);
    cui_inline_set_item_checkbox(
        gid,
        item_id,
        checkbox_data->IsSeld,
        text_p);
    return 1;
}
#endif  /* __MMI_INLINE_ITEM_CHECKBOX__ */
...
static void cui_inline_evt_item_radio_selected(S32 select_index)
{
    ...
    /*----------------------------------------------------------------*/
    S32 first_index;
    cui_inline_radio_struct *radio_data = NULL;  
    cui_inline_instance_struct *p_instance =
        (cui_inline_instance_struct*) mmi_frm_group_get_user_data(g_cui_inline_current_instance->gid);
    ...
    cui_event_inline_notify_struct evt;
    radio_data = (cui_inline_radio_struct *)&(p_instance->cui_inline_items[p_instance->highlight_item].special_data);
    first_index = radio_data->first_item;
    MMI_FRM_INIT_GROUP_EVENT(&evt, EVT_ID_CUI_INLINE_NOTIFY, p_instance->gid);
    evt.event_type = CUI_INLINE_NOTIFY_RADIO_SELECTED;
    evt.item_id = p_instance->cui_inline_items[first_index].common_data.item_id;
...
static S32 cui_inline_set_item_radio(mmi_id gid, U16 item_id, S32 first_item, S32 n_items, MMI_BOOL IsSeld, PU8 string)
{
    ...
    /* get instance pointer; */
    radio_data = (cui_inline_radio_struct*) & (inline_instance->cui_inline_items[index].special_data);
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);

    cui_inline_set_item_type(common_data, INLINE_ITEM_TYPE_RADIO);
    cui_inline_set_item_default_activation(CUI_INLINE_ITEM_TYPE_RADIO_LIST, common_data);

	radio_data->first_item = first_item;
	radio_data->string = string;
	radio_data->IsSeld = IsSeld;
	radio_data->n_items = n_items;

    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        cui_inline_reconfig_item_to_pluto_inline(index, common_data, (cui_inline_item_data_union*) radio_data);
        /* Because this function is extern to App, so we remove redraw item to avoid App call this
        function for highlight item, because it will redraw nothing for highlight item.
        */
		if(index != inline_instance->highlight_item)
...
S32 cui_inline_set_item_radio_string(mmi_id gid, U16 item_id, S32 curr_index, PU8 text_p)
{
    ...
    common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[index].common_data);
    if ((common_data->flag & 0xff) != INLINE_ITEM_TYPE_RADIO)
    {
        return CUI_INLINE_RETURN_ERROR;
    }
    radio_data = (cui_inline_radio_struct*) & (inline_instance->cui_inline_items[index].special_data);
    cui_inline_set_item_radio(
        gid,
        item_id,
        radio_data->first_item,
        radio_data->n_items,
        radio_data->IsSeld,
        text_p);
    return 1;
...
S32 cui_inline_set_item_radio_select(mmi_id gid, U16 item_id, S32 selected_item)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    cui_inline_radio_struct *radio_data, *temp_data;
    cui_inline_item_common_data_struct *common_data = NULL;
    cui_inline_instance_struct *inline_instance = 
        (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    U16 index, i, item_index;
    S32 vResult = 1;
    ...
    radio_data = (cui_inline_radio_struct*) & (inline_instance->cui_inline_items[index].special_data);
    for(i = 0; i < radio_data->n_items; i++)
    {
        item_index = i + radio_data->first_item;
        common_data = (cui_inline_item_common_data_struct*) & (inline_instance->cui_inline_items[item_index].common_data);
        if ((common_data->flag & 0xff) != INLINE_ITEM_TYPE_RADIO)
        {
            break;
        }
        temp_data = (cui_inline_radio_struct*) & (inline_instance->cui_inline_items[item_index].special_data);
        if (i == selected_item)
        {
            if (temp_data->IsSeld == MMI_FALSE)
            {
                temp_data->IsSeld = MMI_TRUE;
                cui_inline_set_item_radio(gid, 
                    common_data->item_id, 
                    temp_data->first_item,
                    temp_data->n_items,
                    temp_data->IsSeld,
                    temp_data->string);
            }
        ...
        else if (temp_data->IsSeld)
        {
            temp_data->IsSeld = MMI_FALSE;
            cui_inline_set_item_radio(gid, 
                common_data->item_id, 
                temp_data->first_item,
                temp_data->n_items,
...
#endif  /* __MMI_INLINE_ITEM_RADIO__ */
...
S32 cui_inline_set_softkey_text(mmi_id gid, U16 item_id, WGUI_SOFTKEY_ENUM key, U16 string_id)
{
    ...
    {
        if (string_id != CUI_INLINE_SOFTKEY_DEFAULT_VALUE)
        {
...
void cui_inline_set_characters_filter(mmi_id gid, MMI_BOOL is_allowed, const UI_character_type *characters_list)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_imm_set_characters(is_allowed, characters_list);
}
...
S32 cui_inline_set_value(mmi_id gid, U16 item_id, void *value)
{
    ...
    if (cui_inline_is_edit_main_screen(inline_instance->gid))
    {
        if ((index == inline_instance->highlight_item) &&
            ...
            ((common_data->flag & 0xff) != INLINE_ITEM_TYPE_RADIO) &&
            ((common_data->flag & 0xff) != INLINE_ITEM_TYPE_CHECKBOX)
           )
        {
            return CUI_INLINE_RETURN_ERROR;
        }
    ...
    switch (common_data->flag & 0xff)
    {
		...
		case INLINE_ITEM_TYPE_BUTTON:
        {
            cui_inline_button_struct *button_data = 
                (cui_inline_button_struct*) & (inline_instance->cui_inline_items[index].special_data);
            cui_inline_set_item_button(gid, item_id, (PU8)(value));
            break;
        }
#endif
        ...
        case INLINE_ITEM_TYPE_CHECKBOX:
        {
            cui_inline_checkbox_struct *checkbox_data =
                (cui_inline_checkbox_struct*) & (inline_instance->cui_inline_items[index].special_data);
            cui_inline_set_item_checkbox(gid, item_id, (MMI_BOOL)(value), checkbox_data->string);
            break;
        }
#endif
        ...
        case INLINE_ITEM_TYPE_RADIO:
		{
			cui_inline_set_item_radio_select(gid, item_id, (S32)(value));
			break;
		}
#endif		
        case INLINE_ITEM_TYPE_CAPTION:
        ...
        case INLINE_ITEM_TYPE_CAPTION_THUMBNAIL:
		{
			cui_inline_item_caption_tn_struct *caption_tn_data = 
				(cui_inline_item_caption_tn_struct*)value;
			cui_inline_set_item_caption_thumbnail(
				gid, 
				item_id, 
				caption_tn_data->style,
				(PU8)GetString(caption_tn_data->string_id),
				caption_tn_data->default_id,
				caption_tn_data->thumbnail_path,
				caption_tn_data->buffer_p);
			break;
		}
	#endif /* __MMI_PHB_PHOTO_STICKER_SUPPORT__ */
        case INLINE_ITEM_TYPE_DISPLAY_ONLY:
        ...
        case INLINE_ITEM_TYPE_TEXT_EDIT:
        {
            cui_inline_text_edit_struct *text_edit_data =
                (cui_inline_text_edit_struct*) & (inline_instance->cui_inline_items[index].special_data);
            cui_inline_set_item_text_edit(
                gid,
                item_id,
                (U8*) value,
                text_edit_data->buffer_size,
                text_edit_data->input_type,
                text_edit_data->input_extended_type,
                text_edit_data->required_input_mode_set,
                text_edit_data->default_text_id);
            break;
        }
#if defined(__MMI_INLINE_ITEM_MULTILINE_READ_ONLY__) || defined(__MMI_INLINE_ITEM_MULTILINE_EDIT__)		
        case INLINE_ITEM_TYPE_MULTI_LINE_EDIT:
...
S32 cui_inline_get_value(mmi_id gid, U16 item_id, void *value)
{
    ...
    switch (common_data->flag & 0xff)
    {
        ...
        {
            cui_inline_checkbox_struct *checkbox_data;
            MMI_BOOL *return_value = (MMI_BOOL*)value;
            
            checkbox_data = (cui_inline_checkbox_struct*) & (inline_instance->cui_inline_items[index].special_data);
            *return_value = checkbox_data->IsSeld;
            break;
        }
#endif
#ifdef __MMI_INLINE_ITEM_RADIO__
        case INLINE_ITEM_TYPE_RADIO:
        {
            cui_inline_radio_struct *radio_data, *temp_data;
            S32 i;
            S32 *return_value = (S32*) value; 
            radio_data = (cui_inline_radio_struct*) & (inline_instance->cui_inline_items[index].special_data);
            for(i = 0; i < radio_data->n_items; i++)
            {
                temp_data = (cui_inline_radio_struct*) & (inline_instance->cui_inline_items[i + radio_data->first_item].special_data);
                if (temp_data->IsSeld)
                {
                    break;
                }
        ...
        case INLINE_ITEM_TYPE_TEXT_EDIT:
        {
            ...
            cui_inline_text_edit_struct *text_edit_data =
                (cui_inline_text_edit_struct*) & (inline_instance->cui_inline_items[index].special_data);
            mmi_ucs2cpy((S8*) return_buf, (S8*) (text_edit_data->buffer));
            break;
        }
#if defined(__MMI_INLINE_ITEM_MULTILINE_READ_ONLY__) || defined(__MMI_INLINE_ITEM_MULTILINE_EDIT__)		
        case INLINE_ITEM_TYPE_MULTI_LINE_EDIT:
...
U32 cui_inline_get_text_len(mmi_id gid, U16 item_id)
{
    ...
    switch (common_data->flag & 0xff)
    {
        case INLINE_ITEM_TYPE_TEXT_EDIT:
        {
            cui_inline_text_edit_struct *text_edit_data =
                (cui_inline_text_edit_struct*) & (inline_instance->cui_inline_items[index].special_data);
            return text_edit_data->buffer_size;
        }
    #if defined(__MMI_INLINE_ITEM_MULTILINE_READ_ONLY__) || defined(__MMI_INLINE_ITEM_MULTILINE_EDIT__)
        case INLINE_ITEM_TYPE_MULTI_LINE_EDIT:
        {
 ...
 *  void
 *****************************************************************************/
static S32 cui_inline_insert_radio_items(mmi_id gid, U16 pre_id, cui_inline_set_item_struct *new_item)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    cui_inline_instance_struct *inline_instance = 
        (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    U16 insert_index, index, n_items;
    cui_inline_item_radio_list_struct *item_data;
    ...
    if (((new_item->item_flag) & 0xFF) != CUI_INLINE_ITEM_TYPE_RADIO_LIST)
    {
        return 0;
    }
    
    item_data = (cui_inline_item_radio_list_struct*)new_item->item_data;
    
    n_items = item_data->n_items;
    if (inline_instance->item_count + n_items >= CUI_INLINE_MAX_ITEM_COUNT)
    {
        return CUI_INLINE_RETURN_ERROR;
    }
    ...
    if(pre_id != (U16)CUI_INLINE_INSERT_TAIL)
    {
        ...
        {
            cui_inline_move_instance_data_list(inline_instance, (insert_index), (MMI_BOOL)1);
    ...
    else
    {
		...
		(inline_instance->item_count) += n_items;
    }
    if(inline_instance->highlight_item >= insert_index + n_items - 1)
    {
        inline_instance->highlight_item += n_items;
        inline_instance->highlight_item_id = 
			inline_instance->cui_inline_items[inline_instance->highlight_item].common_data.item_id;
    }
    cui_inline_lock_main_screen(gid);
    cui_inline_initialize_radio_list(gid, insert_index, new_item);
...
S32 cui_inline_insert_item(mmi_id gid, U16 pre_id, cui_inline_set_item_struct *new_item)
{
    ...
    /*----------------------------------------------------------------*/
#if defined (__MMI_INLINE_ITEM_RADIO__)
	vResult = cui_inline_insert_radio_items(gid, pre_id, new_item);
    if (vResult != 0)
    {
        return vResult;
    }
 ...
 *  void
 *****************************************************************************/
static S32 cui_inline_delete_radio_items(mmi_id gid, U16 item_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    cui_inline_instance_struct *inline_instance = 
        (cui_inline_instance_struct*) mmi_frm_group_get_user_data(gid);
    U16 index, del_index, n_items, first_item_id;
    ...
    if (inline_instance->cui_inline_items[del_index].common_data.flag
        != CUI_INLINE_ITEM_TYPE_RADIO_LIST)
    {
        return 0;
    }
    
    index = inline_instance->cui_inline_items[del_index].special_data.radio_data.first_item;
    first_item_id = inline_instance->cui_inline_items[del_index].common_data.item_id;
    
    n_items = inline_instance->cui_inline_items[del_index].special_data.radio_data.n_items;
    if ((inline_instance->history_item_id >= first_item_id) 
        && (inline_instance->history_item_id < first_item_id + n_items))
    {
        /* delete highlight item and screen is in history. */
        inline_instance->history_item_id = CUI_INLINE_INVALID_ID;
    }
    
    if ((inline_instance->highlight_item_id >= first_item_id) 
        && (inline_instance->highlight_item_id <= first_item_id + n_items))
    {
        old_highlight_index = del_index + n_items - 1;
        ...
        if ((new_highlight_index >= del_index) 
            && (new_highlight_index <= old_highlight_index))
        {
            return CUI_INLINE_RETURN_ERROR;
        }
...
S32 cui_inline_delete_item(mmi_id gid, U16 item_id)
{
    ...
    /*----------------------------------------------------------------*/
#if defined (__MMI_INLINE_ITEM_RADIO__)
	vResult = cui_inline_delete_radio_items(gid, item_id);
    if (vResult != 0)
    {
        return vResult;
    }
        ...
        if(highlight_list->hilite_list != NULL)
        {
            ...
            if(multiline_rdonly_data->highlight_list_info.hilite_list != NULL)
            {
                ...
                {   
                    ...
                    multiline_rdonly_data->highlight_list_info.hilite_list[i].str_addr = (PS8)multiline_rdonly_data->buffer + highlight_list->hilite_list[i].str_offset;
                } 
            }
            else
            {
        ...
        S16 input_ext_type)
{
    ...
    if(inline_instance != NULL)
    {
        ...
        {
            cui_inline_text_edit_struct * item_data = (cui_inline_text_edit_struct*) & (inline_instance->cui_inline_items[index].special_data);
            item_data->input_type = input_type;
            item_data->input_extended_type = input_ext_type;
...
void cui_inline_item_save_gui_buffer(S32 index, wgui_inline_item *inline_item, PU8 history_buffer)
{
    ...
    switch (common_data->flag & 0xFF)
    {
        case INLINE_ITEM_TYPE_TEXT_EDIT:
        {
            cui_inline_text_edit_struct *p_data =
                (cui_inline_text_edit_struct*) & (g_cui_inline_current_instance->cui_inline_items[index].special_data);
            p_data->wgui_flag_attr = MMI_inline_singleline_inputbox.flags;
            break;
        }
    }
}
        ...
        g_cui_inline_current_instance->cui_inline_items[index].common_data.item_id)
    {
        switch ((inline_item->flags) & 0xff)
        {
            case INLINE_ITEM_TYPE_TEXT_EDIT:
            {
                ...
                p_data =
                    (cui_inline_text_edit_struct*) & (g_cui_inline_current_instance->cui_inline_items[index].
                                                       special_data);
                if (p_data->invalid_gui_buffer == 0)
                {
                    inline_text_edit_set_history(INLINE_TEXT_EDIT_HISTORY_ID, *history_buffer);
                }
                MMI_inline_singleline_inputbox.flags = p_data->wgui_flag_attr;
                break;
            }
            case INLINE_ITEM_TYPE_MULTI_LINE_EDIT:
            {
    ...
    for (i = 0; i < g_cui_inline_current_instance->item_count; i++)
    {
        ...
        switch (p_common_data->flag & 0xff)
        {
            case INLINE_ITEM_TYPE_TEXT_EDIT:
            {
                ...
                cui_inline_text_edit_struct *special_data =
                    (cui_inline_text_edit_struct*) & (g_cui_inline_current_instance->cui_inline_items[i].special_data);
            ...
            case INLINE_ITEM_TYPE_FULL_SCREEN_EDIT:
            {
                ...
                wgui_inline_item_text_edit *ii = (wgui_inline_item_text_edit*) wgui_inline_items[i].item;
                cui_inline_fullscreen_edit_struct *special_data =
                    (cui_inline_fullscreen_edit_struct*) & (g_cui_inline_current_instance->cui_inline_items[i].
                                                             special_data);
                special_data->ucs2_count = ii->UCS2_count;
				...
				if (wgui_inline_get_full_screen_changed() 
					&& (wgui_inline_item_highlighted_index == i))
                {
                    special_data->flags |= CUI_INLINE_ITEM_IS_FULLSCREEN_CHANGE;
                }
				else
				{
					special_data->flags &= ~CUI_INLINE_ITEM_IS_FULLSCREEN_CHANGE;
				}
                if (wgui_inline_items[i].flags & INLINE_ITEM_OPEN)
                {
                    special_data->flags |= CUI_INLINE_ITEM_IS_FULLSCREEN_OPEN;
                    special_data->temp_edit_buffer = cui_inline_malloc_fullscreen_buffer();
                    MMI_ASSERT(special_data->temp_edit_buffer != NULL);
                    gui_memcpy(
                        (U8*) special_data->temp_edit_buffer,
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_item_replace_input_buffer
 * DESCRIPTION
 *  
 * PARAMETERS
 *  index           [IN]        
...
void cui_inline_item_replace_input_buffer(S32 index, wgui_inline_item *inline_item)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    /* index = cui_inline_convert_id_to_index(g_cui_inline_current_instance->gid, index); */
    switch ((inline_item->flags) & 0xff)
    {
        case INLINE_ITEM_TYPE_FULL_SCREEN_EDIT:
        {
            ...
            p_data =
                (cui_inline_fullscreen_edit_struct*) & (g_cui_inline_current_instance->cui_inline_items[index].
                                                         special_data);
            inline_item->flags = p_data->input_buffer_flag;
            break;
        }
...
void cui_inline_lsk_function()
{
    ...
    if (((p_common_data->flag & 0xFF) == INLINE_ITEM_TYPE_DOW_SELECT) ||
        ((p_common_data->flag & 0xFF) == INLINE_ITEM_TYPE_FULL_SCREEN_EDIT) ||
...
void cui_inline_csk_function()
{
        ...
        )
    {
     ...
     if(((p_common_data->flag & 0xFF) == INLINE_ITEM_TYPE_TEXT_EDIT) ||
        ((p_common_data->flag & 0xFF) == INLINE_ITEM_TYPE_MULTI_LINE_EDIT))
    {
...
void cui_inline_set_item_default_softkey_attribute(S32 index)
{
...
#if defined (__MMI_INLINE_ITEM_DOW__)
    if (item_type == CUI_INLINE_ITEM_TYPE_DOW)  /* lsk attribute is set by pluto */
    {
...
#endif		
		if ((item_type == CUI_INLINE_ITEM_TYPE_FULLSCREEN_EDIT)
          || (item_type == CUI_INLINE_ITEM_TYPE_IMAGE_TEXT)
          )
    {
    ...
    else if ((item_type == CUI_INLINE_ITEM_TYPE_RADIO_LIST)
          || (item_type == CUI_INLINE_ITEM_TYPE_CHECKBOX)
          )
    {
...
#endif	
#if defined(__MMI_PHB_PHOTO_STICKER_SUPPORT__)	
	else if (item_type == CUI_INLINE_ITEM_TYPE_CAPTION_THUMBNAIL)
	{
	...
	else
	{
        ...
        set_softkey_icon(get_image(IMG_GLOBAL_SAVE_CSK), MMI_CENTER_SOFTKEY);
        set_right_softkey_label(get_string(STR_GLOBAL_BACK));
    }	
...
void cui_inline_replace_item_softkey_by_app(S32 index)
{
	...
	if (p_softkey->softkey[MMI_LEFT_SOFTKEY].string_id == 0)
	{
	    set_softkey_icon((PU8)NULL, MMI_CENTER_SOFTKEY);
	}
    if (cui_inline_is_edit_main_screen(p_instance->gid))
    {
        cui_inline_draw_softkey(MMI_LEFT_SOFTKEY);
...
void cui_inline_highlight_handler(S32 index)
{
	...
	common_data = &(g_cui_inline_current_instance->cui_inline_items[index].common_data);
#if defined (__MMI_INLINE_ITEM_RADIO__)	
	if (common_data->flag == CUI_INLINE_ITEM_TYPE_RADIO_LIST)
	{
	    cui_inline_radio_struct *radio_data;
	    radio_data = (cui_inline_radio_struct *)&(g_cui_inline_current_instance->cui_inline_items[index].special_data);
	    evt.item_id = g_cui_inline_current_instance->cui_inline_items[radio_data->first_item].common_data.item_id;
	}
	else
#endif		
	{
	    evt.item_id = common_data->item_id;
	}
...
/*****************************************************************************
 * FUNCTION
 *  cui_inline_evt_item_user_defined_select_focus_changed
 * DESCRIPTION
 *  
 * PARAMETERS
 *  flag        [IN]        
...
U8 *cui_inline_evt_item_user_defined_select_focus_changed(cui_inline_user_defined_select_highlight_enum flag, S16 index)
{
    ...
    //cui_event_inline_user_defined_select_highlight_struct select_flag = {0};
    // select_flag.locate_measure = flag;
    MMI_FRM_INIT_GROUP_EVENT(&evt, EVT_ID_CUI_INLINE_NOTIFY, p_instance->gid);
    evt.event_type = CUI_INLINE_NOTIFY_USER_DEFINED_SELECT_SET_FOCUS;
    evt.item_id = p_instance->cui_inline_items[index].common_data.item_id; /* p_instance->highlight_item */
    /* evt.param = &select_flag; */
    evt.param = flag;
    return (U8*) mmi_frm_group_send_to_parent(p_instance->gid, (mmi_group_event_struct*) & evt);
}
 ...
 *****************************************************************************/
U16 cui_inline_get_item_default_lsk_strind_id(S32 index)
{
	/*----------------------------------------------------------------*/
	/* Local Variables												  */
	/*----------------------------------------------------------------*/
