...
void cui_sms_set_save_address(mmi_id sms_gid, U16 *ucs2_addr)
{
    ...
    #elif defined(__MMI_TELEPHONY_SUPPORT__) /* __MMI_BT_MAP_CLIENT__ */
...
static void cui_sms_save_msg(void)
{
    ...
    sms_handle = (SMS_HANDLE)srv_sms_btmapc_get_save_handle();
    srv_sms_btmapc_set_status(sms_handle, SRV_SMS_STATUS_DRAFT);
    srv_sms_btmapc_set_address(sms_handle, hd_data->number);
    srv_sms_btmapc_set_content(sms_handle, hd_data->content_buff, hd_data->content_buff_size);
