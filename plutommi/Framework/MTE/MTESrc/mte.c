...
//title_bg_id || 
        ...
        if (!strcmp(tc->name, "title_filler") && 
            ((g_wgui_title_bar.style & GUI_TITLE_STYLE_DISABLEBG)))
        {
            continue;   
        }
...
//        #ifndef __MMI_OP01_DCD__
  ...
  //      #endif /* __MMI_OP01_DCD__ */
         ...
         */
//huking    && !defined(__MMI_BI_DEGREE_MAIN_MENU_STYLE__)       
...
//huking  && !defined(__MMI_BI_DEGREE_MAIN_MENU_STYLE__)
    #if defined(__MMI_MAINMENU_PAGE_SUPPORT__)
...
/* under construction !*/
        ...
        case MMI_MTE_EXAMPLE_SCREEN_MULTIROW_LIST:
            mmi_mte_example_screen_entry_multirow_list();
            break;
//huking defined(__MMI_IMPS__) ||
 //   #if  defined(__MMI_UCM__) || defined(__MMI_VOIP__)
