                 ...
                 mmi_frm_screen_rotate_enum rotation, mmi_proc_func receiver_proc, void *user_data, U32 flags)
{
    ...
    SetKeyDownHandler(endKeyDownFuncPtr, KEY_END);
    SetKeyUpHandler(endKeyUpFuncPtr, KEY_END);
...
void mmi_frm_highlight_inline_generic_done(void)
{
    ...
    SetKeyDownHandler(ConfirmInlineFullScreenEdit, KEY_RIGHT_ARROW);
...
void mmi_frm_highlight_input_method_generic(void)
{
    ...
    SetKeyDownHandler(EntryInputMethodScreen, KEY_RIGHT_ARROW);
    SetRightSoftkeyFunction(mmi_frm_scrn_close_active_id, KEY_EVENT_UP);
    SetKeyDownHandler(mmi_frm_scrn_close_active_id, KEY_LEFT_ARROW);
}
...
void DisplayCascadingMenu(U16 cascading_menu_id, CascadingMenuCmdHdlrFuncPtr command_handler)
{
	...
	{
		SetKeyDownHandler(mmi_cascading_menu_right_handler, KEY_LEFT_ARROW);
		SetKeyDownHandler(mmi_cascading_menu_left_handler, KEY_RIGHT_ARROW);
	}
	else
	{
		SetKeyDownHandler(mmi_cascading_menu_left_handler, KEY_LEFT_ARROW);
		SetKeyDownHandler(mmi_cascading_menu_right_handler, KEY_RIGHT_ARROW);
	} 
}
#endif
                                ...
                                CascadingMenubydataHLHdlrFuncPtr highlight_handler)
{
    ...
    SetRightSoftkeyFunction(mmi_cascading_menu_rsk_handler, KEY_EVENT_UP);
    SetKeyDownHandler(mmi_cascading_menu_left_handler, KEY_LEFT_ARROW);
    SetKeyDownHandler(mmi_cascading_menu_data_right_handler, KEY_RIGHT_ARROW);
}
...
void mmi_ime_entry_symbol_picker_screen_with_sg(mmi_id g_id)
{
    ...
    SetRightSoftkeyFunction(SymbolPickerHandleRSK, KEY_EVENT_UP);
       ...
       SetKeyUpHandler(SymbolPickerHandleRSK, KEY_BACK);
        SetKeyUpHandler(SymbolPickerHandleLSK, KEY_CSK);
    #endif 
...
void HighlightInLineMultilineEditorOption(S32 nIndex)
{
    ...
    switch (nIndex)
    {
        case 0:
            ...
            SetKeyDownHandler(wgui_common_screen_inline_edit_DONE_function, KEY_RIGHT_ARROW);
            SetRightSoftkeyFunction(mmi_frm_scrn_close_active_id, KEY_EVENT_UP);
            SetKeyDownHandler(mmi_frm_scrn_close_active_id, KEY_LEFT_ARROW);
            break;
        case 1:
...
void mmi_ime_entry_input_method_screen_with_sg(mmi_id g_id)
{
...
#endif
   {
    ...
    SetRightSoftkeyFunction(InputMethodScreenHandleRSK, KEY_EVENT_UP);
      #if defined(__COSMOS_MMI_PACKAGE__)
       SetKeyUpHandler(InputMethodScreenHandleRSK, KEY_BACK);
	   SetKeyUpHandler(InputMethodScreenHandleLSK, KEY_CSK);
    #endif 
    EnableCenterSoftkey(0, IMG_GLOBAL_COMMON_CSK);
...
ShowCategory353Screen_ext(
	...
	SetKeyUpHandler(mmi_ime_commonscreens_screen_close, KEY_BACK);
...
void mmi_ime_commonscreens_highlight_writinglanguage(void)
{
    ...
    SetLeftSoftkeyFunction(mmi_ime_commonscreens_entry_main_language_screen, KEY_EVENT_UP);
   		...
   		if( !dm_is_fixed_layer_mode_enabled() )
   		{
    SetKeyDownHandler(mmi_ime_commonscreens_entry_main_language_screen, KEY_RIGHT_ARROW);
		}
	#else
			SetKeyDownHandler(mmi_ime_commonscreens_entry_main_language_screen, KEY_RIGHT_ARROW);
	#endif 
    ...
    SetKeyDownHandler(mmi_ime_commonscreens_entry_writing_language_screen, KEY_RIGHT_ARROW);
...
void mmi_ime_commonscreens_highlight_imeoptions(void)
{
    ...
    SetKeyDownHandler(mmi_ime_commonscreens_entry_imeoptions, KEY_RIGHT_ARROW);
}
...
void mmi_ime_commonscreens_highlight_sublanguage(void)
{
    ...
    SetKeyDownHandler(mmi_ime_commonscreens_entry_sub_language_screen, KEY_RIGHT_ARROW);
    SetRightSoftkeyFunction(mmi_frm_scrn_close_active_id, KEY_EVENT_UP);
    SetKeyDownHandler(mmi_frm_scrn_close_active_id, KEY_LEFT_ARROW);
}
...
void mmi_ime_commonscreens_highlight_newword(void)
{
    ...
    SetLeftSoftkeyFunction(mmi_imc_entry_add_new_word_screen, KEY_EVENT_UP);
		...
		if(!dm_is_fixed_layer_mode_enabled())
		{
    SetKeyDownHandler(mmi_imc_entry_add_new_word_screen, KEY_RIGHT_ARROW);
		}	
	#else
			SetKeyDownHandler(mmi_imc_entry_add_new_word_screen, KEY_RIGHT_ARROW);
	#endif
...
void mmi_ime_commonscreens_highlight_advancedoptions(void)
{
    ...
    if(!dm_is_fixed_layer_mode_enabled())
    {
        SetKeyDownHandler(mmi_ime_commonscreens_entry_advancedoptions, KEY_RIGHT_ARROW);
    }	
    #else
    SetKeyDownHandler(mmi_ime_commonscreens_entry_advancedoptions, KEY_RIGHT_ARROW);
    #endif
...
void mmi_ime_commonscreens_highlight_keyboard(void)
{
    ...
    SetLeftSoftkeyFunction(mmi_ime_commonscreens_entry_keyboardtype, KEY_EVENT_UP);
   		...
   		if(!dm_is_fixed_layer_mode_enabled() )
   		{
    SetKeyDownHandler(mmi_ime_commonscreens_entry_keyboardtype, KEY_RIGHT_ARROW);
		}
	#else
			SetKeyDownHandler(mmi_ime_commonscreens_entry_keyboardtype, KEY_RIGHT_ARROW);
	#endif 
...
void mmi_ime_commonscreens_highlight_dictionary(void)
{
    ...
    SetLeftSoftkeyFunction(mmi_imc_entry_config_smart_input_method_screen, KEY_EVENT_UP);
		...
		if(!dm_is_fixed_layer_mode_enabled())
		{
		    SetKeyDownHandler(mmi_imc_entry_config_smart_input_method_screen, KEY_RIGHT_ARROW);
		}
#else
			SetKeyDownHandler(mmi_imc_entry_config_smart_input_method_screen, KEY_RIGHT_ARROW);
#endif 
...
#if defined(__MMI_IME_FTE_ENHANCE__)
#if defined(__MMI_UI_VIRTUAL_KEYBOARD_DEFAULT_VERSION_3__)	&& defined(__COSMOS_MMI__) && defined(__MMI_VUI_ENGINE__)
...
#if defined(__MMI_UI_VIRTUAL_KEYBOARD_DEFAULT_VERSION_3__)	&& defined(__COSMOS_MMI__) && defined(__MMI_VUI_ENGINE__)  && !defined(__MMI_NO_HANDWRITING__)
    mmi_imm_handwriting_set_current_stroke_color(pen_color);
#else
...
mmi_frm_group_create(
	...
	//get the Pen color 
	#if defined(__MMI_UI_VIRTUAL_KEYBOARD_DEFAULT_VERSION_3__)	&& defined(__COSMOS_MMI__) && defined(__MMI_VUI_ENGINE__)  && !defined(__MMI_NO_HANDWRITING__)
    pen_color =  mmi_imm_handwriting_get_current_color_id();
    #else
...
color PhnsetGetHandwritingColor(void)
{
    ...
    /*----------------------------------------------------------------*/
	//get the Pen color 
    return mmi_imm_handwriting_get_current_stroke_color();
}
#else
/*****************************************************************************
 * FUNCTION
