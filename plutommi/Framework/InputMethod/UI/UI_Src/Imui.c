...
#include "imui.h"
#include "Imc.h"
#if defined(__COSMOS_MMI__) && defined(__MMI_RESOURCE_IMAGE_THIRD_ROM__)
...
#undef MMI_IMUI_UI_CONPONENT_INFORMATION_BAR_HINT

#if defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__) || defined(__MMI_IME_SCROLLING_COMPOSITION__)
#define MMI_IMUI_UI_CONPONENT_COMPOSITION
#else /*#if defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__)*/
#undef MMI_IMUI_UI_CONPONENT_COMPOSITION
#endif/*#if defined(__MMI_LANG_SM_CHINESE__) || defined(__MMI_LANG_TR_CHINESE__)*/

#if defined(__MMI_IME_FTE_ENHANCE__)
#define MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_SEPARATOR
#else
#undef MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_SEPARATOR
#endif
...
#define MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_CANDIDATE_FIX_GRID
#else
#undef MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_CANDIDATE_FIX_GRID
#endif
...
#define MMI_IMUI_UI_CONPONENT_COMPOSITION
#define MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_CANDIDATE_FIX_GRID
#define MMI_IMUI_UI_CONPONENT_INFORMATION_BAR_HINT
...
#if defined(MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_LABEL) || defined(MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_STAR)    
...
#if defined(__MMI_IME_SCROLLING_COMPOSITION__)
static  UI_filled_area  scrolling_box_backgroud_filler=
{
...
static S32 scrolling_composition_count = 0;
#endif
...
#if defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)
...
static void mmi_imui_cache_theme_image(void);
...
#if defined(MMI_IMUI_UI_CONPONENT_INFORMATION_BAR_HINT)
...
U32  mmi_imui_send_message( mmi_imui_message_struct_p msg_ptr, mmi_imui_command_funcptr command_callback )
{
    ...
    case MMI_IMUI_MESSAGE_COMPOSITION_CANCEL_FOCUS:
        ...
        break;
#endif /*#if defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)*/
...
/* under construction !*/
#endif
        g_imui_control_set.showed_flag &= MMI_IMUI_CONTROL_MASK(MMI_IMUI_IME_INDICATOR_AREA) | MMI_IMUI_CONTROL_MASK(MMI_IMUI_INFORMATION_BAR) | MMI_IMUI_CONTROL_MASK(MMI_IMUI_IME_HINT_AREA);
        break;
...
#else
    case MMI_IMUI_MESSAGE_DRAW_INFORMATION_BAR:
        memcpy(&g_imui_information_bar_display_rect, (mmi_imc_rect *)msg_ptr->param_0, sizeof(mmi_imc_rect));
        ((mmi_imc_rect *)msg_ptr->param_0)->width = mmi_imui_get_ime_hint_width();
        mmi_imui_draw_ime_hint((mmi_imc_rect *)msg_ptr->param_0);
        g_imui_control_set.showed_flag |= MMI_IMUI_CONTROL_MASK(MMI_IMUI_INFORMATION_BAR);        
        break;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_imui_cache_theme_image
 * DESCRIPTION
 * when theme image on third rom, we need cache all theme image on rom first.
 * PARAMETERS
 * RETURNS
 *  void
 *****************************************************************************/
static void mmi_imui_cache_theme_image(void)
{
    ...
    {
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_BG_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_BG_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_BG_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_FOCUS_FRAME_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_FOCUS_FRAME_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_FOCUS_FRAME_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_SEP_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_SEP_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_SEP_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_DOWN_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_DOWN_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_DOWN_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_NORMAL_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_NORMAL_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_NORMAL_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_DISABLE_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_DISABLE_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_LEFT_ARROW_DISABLE_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_DOWN_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_DOWN_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_DOWN_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_NORMAL_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_NORMAL_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_NORMAL_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_DISABLE_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_DISABLE_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_RIGHT_ARROW_DISABLE_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_HIGHLIGHT_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_HIGHLIGHT_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_HIGHLIGHT_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_DULL_HIGHLIGHT_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_DULL_HIGHLIGHT_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CAND_DULL_HIGHLIGHT_LARGE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_INPUT_BG_SMALL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_INPUT_BG_MEDIUM);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_INPUT_BG_LARGE);
        #if defined(__MMI_IME_CANDIDATE_GRID__)
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_ARROWDOWN);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_ARROWUP);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_ARROWDOWNDIS);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_ARROWUPDIS);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_BACK);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_BACKSPACE);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_CAND_BG);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_CAND_BG_HL);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_EXPAND);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_CG_BG);
        mmi_res_venus_theme_cache_refresh_require(IMG_ID_FUNCTION_BKG_9SLICE);
        #endif
        #if defined(__MMI_IME_SCROLLING_COMPOSITION__)
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_SC_BG);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_SC_CAND_BG);
        mmi_res_venus_theme_cache_refresh_require(VADP_IMG_IME_SC_CAND_BG_HL);
        #endif
        mmi_res_venus_theme_cache_refresh_require(IMG_ID_IME_VK_CHANGE_SETTING);
        mmi_res_venus_theme_cache_refresh_require(IMG_ID_IME_VK_CHANGE_MODE);
...
static void mmi_imui_update_ui_theme(void)
{
...
#endif
    #if defined(MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_SEPARATOR)
    ...
    #endif /*#if defined(MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_SEPARATOR)*/
...
static void mmi_imui_create_composition_box(U32 style)
{
    ...
    //g_imui_vertical_candidate_list.item_highlighted = dummy_highlight_handler;
    scrolling_box_backgroud_filler.b = g_imui_ui_theme.scrolling_comp_background;
	...
	g_imui_vertical_composition_list.normal_filler = &scrolling_box_backgroud_filler;
...
#endif
#if defined(__MMI_IME_SCROLLING_COMPOSITION__)
    gui_list_pen_enum list_event = GUI_LIST_PEN_NONE; 
#endif
#ifdef __MMI_IME_PLUG_IN__
            ...
            switch(g_imui_control_set.control_set[no_of_control_set])
            {
                ...
                case MMI_IMUI_COMPOSITION_AREA:
                    if (g_imui_control_set.showed_flag & MMI_IMUI_CONTROL_MASK(MMI_IMUI_COMPOSITION_AREA))
                    {
                        ...
                        {
                            if (scrolling_composition_count < g_imui_vertical_composition_list.n_items)
                            {
                                ret = (MMI_BOOL) PEN_CHECK_BOUND(
                                    pos->x,
                                    pos->y,
                                    ...
                                    scrolling_composition_count * g_imui_vertical_composition_list_data.height); //g_imui_vertical_composition_list.top did this should be count?
                                if (ret)
                                {
                                    (MMI_BOOL) gui_fixed_list_menu_translate_pen_event(
                                        &g_imui_vertical_composition_list,
                                        MMI_PEN_EVENT_DOWN,
                                        pos->x, pos->y, &list_event);
                                }
        ...
        mmi_imui_arrow_state_enum arrow_state)
{
    ...
    {
        arrow_disable_color = g_imui_ui_theme.arrow_disable_color;
    }
    else if (arrow_state == MMI_IMUI_ARROW_PRESSED)
    {
        arrow_disable_color = g_imui_ui_theme.arrow_down_color;
    }
    else if (arrow_state == MMI_IMUI_ARROW_NORMAL)
    {
        arrow_disable_color = g_imui_ui_theme.arrow_up_color;
    }
    
    draw_resizeable_arrow(x, y, direction, arrow_disable_color, g_imui_ui_param.arrow_width, g_imui_ui_param.arrow_height);
}
...
#if defined(__MMI_IME_FLOATING_CAND_BOX__) && defined(__MMI_IME_FTE_ENHANCE__) && defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)
...
#endif  /* #if defined(__MMI_IME_FLOATING_CAND_BOX__) && defined(__MMI_IME_FTE_ENHANCE__) && defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)*/
...
static U32 mmi_imui_redraw_all(void)
{
    ...
    /*Resize input box*/
    {
        ...
        imc_message.message_id = MMI_IMC_MESSAGE_NONE;
   ...
   if (mmi_imc_get_state() == MMI_IMC_STATE_MULTITAP) 
   {
...
#endif
    {
            ...
            && (g_imui_control_set.showed_flag & MMI_IMUI_CONTROL_MASK(MMI_IMUI_COMPOSITION_AREA)))/*Draw composition box area*/
        {
            ...
            #if defined(__MMI_IME_FLOATING_CAND_BOX__) && defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)
                if ((g_imui_candidate_box.flags & MMI_IMUI_SELECTION_AREA_FLAG_FLOATING) &&
...
#endif
    {
    #if defined(__MMI_IME_FTE_ENHANCE__) && defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)
        if ((g_imui_control_set.showed_flag & MMI_IMUI_CONTROL_MASK(MMI_IMUI_COMPOSITION_AREA)) &&
            (g_imui_composition_box.flags & MMI_IMUI_SELECTION_AREA_FLAG_AUTO_RESIZABLE)
			)
        {
...
#endif /* #if defined(__MMI_IME_VERTICAL_CAND_BOX__) */
#if defined(__MMI_IME_SCROLLING_COMPOSITION__) && defined(MMI_IMUI_UI_CONPONENT_COMPOSITION)
/*****************************************************************************
 * FUNCTION
...
static S32 mmi_imui_update_vertical_composition_list(mmi_imui_update_selection_area_struct_p update_ptr)
{
    ...
    wgui_virtual_keyboard_get_dimension(&vk_width, &vk_height);
#endif
    scrolling_composition_count = update_ptr->count;
    for (i = 0; i < update_ptr->count; i++)
    {
    ...
    for (; i < 4; i++)
    {
        g_imui_vertical_composition_list_items[i].item_text = NULL;
        g_imui_vertical_composition_list_items[i].flags &= ~UI_LIST_MENU_STATE_FOCUSSED;
        g_imui_vertical_composition_list_items[i].flags &= ~UI_LIST_MENU_DISABLE_SCROLLBAR;
        g_imui_vertical_composition_list_items[i].text_width = 0;
        g_imui_vertical_composition_list_items[i].text_height = 0;
    }
    unit_heigh = (vk_height - (vk_height/4))/4;
    ...
    g_imui_vertical_composition_list.top = top_margin;
    ...
    g_imui_vertical_composition_list.n_items = i;
    ...
    gui_resize_fixed_icontext_menuitem(&g_imui_vertical_composition_list_data, wgui_virtual_keyboard_return_floating_composition_box_width(), unit_heigh);
...
static U32 mmi_imui_update_selection_area(mmi_imui_selection_area_struct_p area_ptr, mmi_imui_update_selection_area_struct_p update_ptr)
{
    ...
    #if defined(MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_CANDIDATE_FIX_GRID)
    ...
    #endif /*#if defined(MMI_IMUI_SELECTION_AREA_CONFIG_STYLE_CANDIDATE_FIX_GRID)*/
    temp_str = update_ptr->str_ptr;
...
static void mmi_imui_show_selection_area(mmi_imui_selection_area_struct_p area_ptr)
{
    ...
    MMI_BOOL is_dither;
#endif
    mmi_imui_arrow_state_enum temp_state;
...
#if 1
    {
        S32 offset_x[5]; //= {bg_x, bg_x + bg_width -1, bg_x + bg_width -1, bg_x, bg_x};
        S32 offset_y[5]; //= {area_ptr->y, area_ptr->y, area_ptr->y + area_ptr->height - 1, area_ptr->y + area_ptr->height - 1, area_ptr->y};
        offset_x[0] = bg_x;
        offset_y[0] = area_ptr->y;
        offset_x[1] = bg_x + bg_width -1;
        offset_y[1] = area_ptr->y;
        offset_x[2] = bg_x + bg_width -1;
        offset_y[2] = area_ptr->y + area_ptr->height - 1;
        offset_x[3] = bg_x;
        offset_y[3] = area_ptr->y + area_ptr->height - 1;
        offset_x[4] = bg_x;
        offset_y[4] = area_ptr->y;
        ...
        gui_draw_filled_area(offset_x[0], offset_y[0], 
    ...
    for (i = 0; i < area_ptr->item_count; i++)
    {
        switch (area_ptr->items_type[i])
        {
            case MMI_IMUI_SELECTION_AREA_ITEM_TYPE_LEFT_ARROW:
                ...
                {
                    temp_state = area_ptr->left_arrow_state;
                }
                #if defined (__MMI_BIDI_ALG__)
                ...
                {
                    temp_state = MMI_IMUI_ARROW_DISABLE;
                }
            ...
            case MMI_IMUI_SELECTION_AREA_ITEM_TYPE_RIGHT_ARROW:
                if ((area_ptr->flags & MMI_IMUI_SELECTION_AREA_FLAG_NEXT_PAGE || (area_ptr->highlight_index >= 0 && area_ptr->highlight_index < area_ptr->cand_count - 1))
                    && !(area_ptr->flags & MMI_IMUI_SELECTION_AREA_FLAG_R2L))
                {
                    temp_state = area_ptr->right_arrow_state;
                }
                #if defined (__MMI_BIDI_ALG__)
            ...
            case MMI_IMUI_SELECTION_AREA_ITEM_TYPE_SEPARATOR:
                ...
                #endif
                {
                    temp_x = area_ptr->items[i].indicator.x;
                }
                #if defined(__MMI_IME_FTE_ENHANCE__) 
                    gui_push_clip();
            ...
            case MMI_IMUI_SELECTION_AREA_ITEM_TYPE_CANDIDATE:
                ...
                if (candidate_index == area_ptr->highlight_index)
                {
                    ...
                    #endif /*#if defined (__MMI_BIDI_ALG__)*/
                    {
                        temp_x = area_ptr->items[i].candidate.x;
                    }
#if !defined(GDI_9SLICE_USING_LINEAR_TRANSFORM)
                    is_dither = gdi_image_9slice_get_dither();
                    gdi_image_9slice_set_dither(MMI_FALSE);
                ...
                #endif /*#if defined (__MMI_BIDI_ALG__)*/
                {
                    temp_x = area_ptr->items[i].candidate.x + offset_x;
                }
                #if defined(__MMI_IME_USER_DATABASE__)
...
static void mmi_imui_get_ime_hint_icon(mmi_imm_input_mode_hint_item_struct_p hint_item_s, UI_string_type* inputmode_string, PU8* inputmode_icon)
{
    mmi_imm_input_mode_hint_item_struct_p hint_item = hint_item_s;
    while ((hint_item->display_flag != MMI_IME_HINT_FLAG_NONE))
    {
...
static void mmi_imui_get_ime_hint_size(S32 *hint_width, S32 *hint_height)
{
    ...
    *hint_height = 0;
    ...
    mmi_imui_get_ime_hint_icon(hint_info->hint_item_ptr, &inputmode_string, &inputmode_icon);
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
