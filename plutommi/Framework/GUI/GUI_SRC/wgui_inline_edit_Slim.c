...
UI_list_menu_theme wgui_inline_fixed_list_menu_theme = { 
...
//huking
UI_menuitem_theme wgui_inline_fixed_icontext_menuitem_theme =
...
#ifdef __INLINE_DATETIME_SLIM__
extern UI_single_line_input_box_theme datetime_input_theme;
extern UI_filled_area datetime_input_field_filler;
extern UI_filled_area datetime_input_background_filler;
#else
...
extern UI_filled_area menuitem_transparent_filled_area;
...
#if defined(__MMI_INLINE_ITEM_DATE__) && !defined(__INLINE_DATETIME_SLIM__)
	extern void date_input_move_to_x_y(date_input *d, S32 x, S32 y);
#endif

#if defined(__MMI_INLINE_ITEM_TIME__) && !defined(__INLINE_DATETIME_SLIM__)
...
#if defined (__MMI_INLINE_ITEM_IP4__) && !defined (__INLINE_DATETIME_SLIM__)
...
void wgui_inline_restore_history(U8* gui_buffer)
{
    ...
    switch (wgui_current_inline_item_type)
    {
        ...
        case INLINE_ITEM_TYPE_IP4_EDIT:
            inline_datetime_edit_get_history(gui_buffer);
            break;
#else /*__INLINE_DATETIME_SLIM__*/
        case INLINE_ITEM_TYPE_DATE:
...
#endif
            break;
#endif /*__INLINE_DATETIME_SLIM__*/
...
#ifdef __MMI_INLINE_HIGHLIGHT_CAPTION__
void show_item_backgroud(S32 x,S32 y,S32 width,S32 height);
                ...
                wgui_inline_item *item)
{
    ...
    if(mmi_fe_get_r2l_state())
    {
        ...
        //gui_move_text_cursor(right_text_x, y + (height - text_height)/2);
        //gui_print_text((UI_string_type)(item->text_p));
        gui_print_truncated_text_ex(right_text_x,y + (height - text_height)/2,width,(UI_string_type)(item->text_p));                                   
    }
    else
    {
        left_text_x = left_x;
        //gui_move_text_cursor(left_text_x, y + (height - text_height)/2);
        //gui_print_text((UI_string_type)(item->text_p));
        gui_print_truncated_text_ex(left_text_x,y + (height - text_height)/2,width,(UI_string_type)(item->text_p));                                   
    }
}    
#endif
...
#ifdef __INLINE_DATETIME_SLIM__
S16 g_inline_datetime_current_position = 0;
#endif
...
#ifndef __MMI_FTE_SUPPORT__		
#ifdef __MMI_INLINE_HIGHLIGHT_CAPTION__  
	show_item_backgroud(x,y,width,height);			
#endif
#endif
    show_date_input(&wgui_inline_date_input);
...
#define MAX_INLINE_DATE_ITEMS 4
#else
#define MAX_INLINE_DATE_ITEMS 0
#endif

#ifdef __MMI_INLINE_ITEM_TIME__
#define MAX_INLINE_TIME_ITEMS 4
#else
#define MAX_INLINE_TIME_ITEMS 0
#endif

#ifdef __MMI_INLINE_ITEM_IP4__
#define MAX_INLINE_IP4_ITEMS 5
#else
#define MAX_INLINE_IP4_ITEMS 0
#endif



#define MAX_INLINE_DATETIME_ITEMS                   MAX_INLINE_DATE_ITEMS + MAX_INLINE_TIME_ITEMS + MAX_INLINE_IP4_ITEMS 
#define MAX_INLINE_DATE_IP4_DISPLAY_STRING_SIZE     48 // 23 chars with null terminator */
 ...
 * Typedef 
 *****************************************************************************/
typedef struct _inline_datetime_edit_history
{
    U16 history_ID;
    S16 current_focus;
    S16 current_position;
    ...
    U32 flags;
    mmi_imc_history ime_history;
} inline_datetime_edit_history;


/***************************************************************************** 
 * Local Variable
 *****************************************************************************/
static S32 n_inline_datetime_items = 0;
static wgui_inline_item_datetime *current_wgui_inline_datetime_item;
static PU8 *current_wgui_inline_datetime_text_p;

datetime_input wgui_inline_datetime_input;
...
void wgui_set_date_time_input_unfocussed_theme(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    datetime_input_theme.disabled_filler = current_MMI_theme->inline_datatime_unfocussed_filler;

    /* changed the date time normal filler in case of default text effect is enabled. */
#ifdef __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__
    if (IsInlineItemDefaultTextEnable())
    {
        datetime_input_theme.normal_filler = &temp_inline_edit_normal_filler;
    }
    else
#endif /* __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__ */ 

    datetime_input_theme.normal_filler = &datetime_input_field_filler;
    datetime_input_theme.normal_filler->c = current_MMI_theme->inline_datatime_unfocussed_filler->c;
    datetime_input_theme.selected_filler = current_MMI_theme->inline_datatime_unfocussed_filler;
    datetime_input_theme.disabled_text_color = wgui_inline_singleline_inputbox_unfocussed_theme.disabled_text_color;
    datetime_input_theme.normal_text_color = wgui_inline_singleline_inputbox_unfocussed_theme.normal_text_color;
    datetime_input_theme.selected_text_color = wgui_inline_singleline_inputbox_unfocussed_theme.selected_text_color;
    datetime_input_background_filler = *current_MMI_theme->inline_datatime_unfocussed_filler;
#ifdef  __MMI_FTE_SUPPORT__
    datetime_input_background_filler = *(current_MMI_theme->inline_item_textedit_unhighlighted_bg_filler);
    datetime_input_theme.selection_text_color= wgui_inline_singleline_inputbox_focussed_theme.selection_text_color;
    datetime_input_theme.selection_color = wgui_inline_singleline_inputbox_focussed_theme.selection_color;
    datetime_input_theme.normal_text_color = wgui_inline_singleline_inputbox_focussed_theme.normal_text_color;
#endif 
    datetime_input_background_filler = MMI_inputbox_normal_filler;   
    datetime_input_theme.cursor_color = *current_MMI_theme->inline_edit_cursor_color;
    datetime_input_theme.selection_text_color = *current_MMI_theme->inline_edit_selected_text_color;
    datetime_input_theme.selection_color = *current_MMI_theme->inline_edit_selector_color;
}
...
void wgui_set_date_time_input_focussed_theme(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    datetime_input_theme.disabled_filler = &datetime_input_field_filler;
    datetime_input_theme.disabled_filler->c = current_MMI_theme->inline_datatime_focussed_filler->c;
    datetime_input_theme.normal_filler = &datetime_input_field_filler;
    datetime_input_theme.normal_filler->c = current_MMI_theme->inline_datatime_focussed_filler->c;    
    datetime_input_theme.selected_filler = &datetime_input_field_filler;
    datetime_input_theme.selected_filler->c = current_MMI_theme->inline_datatime_focussed_filler->c;
    datetime_input_theme.disabled_text_color = wgui_inline_singleline_inputbox_focussed_theme.disabled_text_color;
    datetime_input_theme.normal_text_color = wgui_inline_singleline_inputbox_focussed_theme.normal_text_color;
    datetime_input_theme.selected_text_color = wgui_inline_singleline_inputbox_focussed_theme.selected_text_color;
    datetime_input_background_filler = *current_MMI_theme->inline_datatime_focussed_filler;
#ifdef  __MMI_FTE_SUPPORT__
    datetime_input_background_filler = *(current_MMI_theme->inline_item_textedit_highlighted_bg_filler);
    datetime_input_theme.selection_text_color = wgui_inline_singleline_inputbox_focussed_theme.selection_text_color;
    datetime_input_theme.selection_color = wgui_inline_singleline_inputbox_focussed_theme.selection_color;
    datetime_input_theme.normal_text_color = wgui_inline_singleline_inputbox_focussed_theme.normal_text_color;
#endif   
...
#ifdef __MMI_INLINE_HIGHLIGHT_CAPTION__
	datetime_input_background_filler = *wgui_inline_fixed_icontext_menuitem_theme.focussed_filler;  
#endif
 ...
 *  void
 *****************************************************************************/
void handle_inline_datetime_edit_complete(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    register_inline_fixed_list_keys();
    current_wgui_inline_datetime_item->string_construct_callback(
                                    *current_wgui_inline_datetime_text_p,
                                    current_wgui_inline_datetime_item->buffer_1,
                                    current_wgui_inline_datetime_item->buffer_2,
                                    current_wgui_inline_datetime_item->buffer_3,
                                    current_wgui_inline_datetime_item->buffer_4);
    MMI_fixed_icontext_menuitems[wgui_inline_item_highlighted_index].item_text =
        (UI_string_type) * current_wgui_inline_datetime_text_p;
   // clear_left_softkey();
   // clear_right_softkey();
    ...
    redraw_current_inline_item = UI_dummy_function;
    complete_inline_item_edit = UI_dummy_function;
    set_current_datetime_input(NULL);
    clear_datetime_input_callback();
    mmi_imc_disconnect();
    g_inline_current_input_box_handler = NULL;
}
 ...
 *  void
 *****************************************************************************/
void redraw_inline_datetime_edit(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    datetime_input_show_background(&wgui_inline_datetime_input);
    show_datetime_input(&wgui_inline_datetime_input);
}
 ...
 *  void
 *****************************************************************************/
void inline_datetime_edit_handle_down_arrow(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if(wgui_inline_edit_is_able_to_switch_highlight(1))
    {
        ...
        wgui_inline_get_vk_status(&g_inline_vk_status);
#endif
        handle_inline_datetime_edit_complete();
        inline_fixed_list_goto_next_item();
    }
}
 ...
 *  void
 *****************************************************************************/
void inline_datetime_edit_handle_up_arrow(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void inline_datetime_input_key_handler(S32 vkey_code, S32 key_state)
{
#if(MMI_BUILD_TYPE == BUILD_TYPE_X86WIN32)
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    ...
    if (key_state)
    {
        switch (vkey_code)
        {
            case 37:
                ...
                break;
            case 38:
                inline_datetime_edit_handle_up_arrow();
                break;
            case 39:
                datetime_input_next_character();
                break;
            case 40:
                inline_datetime_edit_handle_down_arrow();
                break;
            case 36:    /* home */
                break;
            case 35:    /* end */ 
 ...
 *  history buffer
 *****************************************************************************/
U8 *inline_datetime_edit_get_history(U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (history_buffer != NULL)
    {
        U16 hID = (U16) (INLINE_DATETIME_HISTORY_ID | 0x8000);
        inline_datetime_edit_history *h = (inline_datetime_edit_history*) history_buffer;

        h->history_ID = hID;
        h->current_focus = (S16) wgui_inline_datetime_input.current_focus;
        //if (wgui_inline_datetime_input.is_focus == MMI_TRUE)
        {
            h->current_position = 0;
               // (S16) (wgui_inline_datetime_input.current_text_p -
                      // wgui_inline_datetime_input.text);
        }
        h->flags = wgui_inline_datetime_input.flags;
        mmi_imc_get_input_method_history(&(h->ime_history));
    }
    return (history_buffer);
}
 ...
 *  1->success 0->fail
 *****************************************************************************/
U8 inline_datetime_edit_set_history(U16 history_ID, U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (history_buffer != NULL)
    {
        ...
        if (history_valid(h->history_ID, history_ID))
        {
            wgui_inline_datetime_input.current_focus = h->current_focus;
            datetime_input_reset_focus((void*)&wgui_inline_datetime_input);
            datetime_input_set_focus((void*)&wgui_inline_datetime_input);
            //if (wgui_inline_date_input.focus_input_box != NULL)
            //if (wgui_inline_datetime_input.is_focus == MMI_TRUE)
            {
                wgui_inline_datetime_input.current_text_p =
                    wgui_inline_datetime_input.text + h->current_position;
            }
            wgui_inline_datetime_input.flags= h->flags;
            return (1);
        }
    }
    return (0);
 ...
 *  void
 *****************************************************************************/
void handle_inline_datetime_edit(
        S32 x,
        S32 y,
        S32 width,
        S32 height,
        ...
        U8 *history_buffer)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    wgui_inline_item_datetime *i = (wgui_inline_item_datetime*) item;
    S32 xx;
    U32 dtflags = 0;
    U32 type = flags & INLINE_ITEM_TYPE_MASK;
    ...
    UI_UNUSED_PARAMETER(key_event);
    UI_UNUSED_PARAMETER(flags);
    wgui_current_inline_item_type = type;
    ...
    complete_inline_item_edit = handle_inline_datetime_edit_complete;
    current_wgui_inline_datetime_item = i;
    current_wgui_inline_datetime_text_p = text_p;

    //////
    wgui_inline_datetime_input.flags = i->flags;
    wgui_inline_datetime_input.is_focus = MMI_TRUE;

    

    if(type == INLINE_ITEM_TYPE_DATE)
    {
        wgui_inline_datetime_input.detail.date.date_type = DATE_INPUT_TYPE_YYYY_MM_DD;
    	wgui_inline_datetime_input.detail.date.day = i->buffer_1;
        wgui_inline_datetime_input.detail.date.month = i->buffer_2;
        wgui_inline_datetime_input.detail.date.year = i->buffer_3;    
        wgui_inline_datetime_input.seperator = (UI_character_type) '/';//L"/";
        wgui_inline_datetime_input.type = DATETIME_INPUT_TYPE_DATE;
        dtflags |= DATE_INPUT_TYPE_YYYY_MM_DD;
    }
    else if (type == INLINE_ITEM_TYPE_TIME)
    {
    	wgui_inline_datetime_input.detail.time.hour = i->buffer_1;
        wgui_inline_datetime_input.detail.time.minute = i->buffer_2;
        wgui_inline_datetime_input.detail.time.AM_PM_flag = i->buffer_3;
        wgui_inline_datetime_input.seperator = (UI_character_type) ':';
        wgui_inline_datetime_input.type = DATETIME_INPUT_TYPE_TIME;
        dtflags |= TIME_INPUT_TYPE_HH_MM;
    }
    else if (type == INLINE_ITEM_TYPE_IP4_EDIT)
    {
        wgui_inline_datetime_input.detail.ip4.IP1 = i->buffer_1;
        wgui_inline_datetime_input.detail.ip4.IP2 = i->buffer_2;
        wgui_inline_datetime_input.detail.ip4.IP3 = i->buffer_3;
        wgui_inline_datetime_input.detail.ip4.IP4 = i->buffer_4;
        wgui_inline_datetime_input.seperator = (UI_character_type) '.';
        wgui_inline_datetime_input.type = DATETIME_INPUT_TYPE_IP4;
    }

    //current_wgui_inline_datetime_text_p = &(item->text_p);
    i->string_construct_callback(
        *current_wgui_inline_datetime_text_p,  //item->text_p
        ...
        i->buffer_3,
        i->buffer_4);
    wgui_inline_datetime_input.text = *current_wgui_inline_datetime_text_p;  
        
    wgui_inline_datetime_input.y = y;   
    wgui_inline_datetime_input.height = height;
    
    if (mmi_fe_get_r2l_state())
    {
        if (flags & INLINE_ITEM_LEFT_ALIGN)
        {
            wgui_inline_datetime_input.x = x + xx;
            wgui_inline_datetime_input.width = width - xx;
            
            create_datetime_input(           
                &wgui_inline_datetime_input,
                //DATETIME_INPUT_TYPE_DATE,
                dtflags);
        }
        else
        {
            wgui_inline_datetime_input.x = x + xx;
            wgui_inline_datetime_input.width = width - MMI_fixed_icontext_menuitem.text_x;
    ...
    //datetime_input_set_seperator(&wgui_inline_datetime_input, (UI_character_type) '/');
	set_current_datetime_input(&wgui_inline_datetime_input);
    datetime_input_register_keys();
    mmi_imc_key_register_ime_keys();
    register_keyboard_key_handler(inline_datetime_input_key_handler);

    /* key rule. 09.10.17 */
    SetKeyHandler(inline_datetime_edit_handle_down_arrow, KEY_DOWN_ARROW, KEY_EVENT_REPEAT);
    SetKeyHandler(inline_datetime_edit_handle_up_arrow, KEY_UP_ARROW, KEY_EVENT_REPEAT);
    SetKeyHandler(inline_datetime_edit_handle_down_arrow, KEY_VOL_DOWN, KEY_EVENT_REPEAT);
    SetKeyHandler(inline_datetime_edit_handle_up_arrow, KEY_VOL_UP, KEY_EVENT_REPEAT);
    
    SetKeyHandler(inline_datetime_edit_handle_down_arrow, KEY_DOWN_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(inline_datetime_edit_handle_up_arrow, KEY_UP_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(inline_datetime_edit_handle_down_arrow, KEY_VOL_DOWN, KEY_EVENT_DOWN);
    SetKeyHandler(inline_datetime_edit_handle_up_arrow, KEY_VOL_UP, KEY_EVENT_DOWN);
    redraw_current_inline_item = redraw_inline_datetime_edit;
    register_datetime_input_callback(set_wgui_inline_list_menu_changed);
    mmi_imc_redraw_screen_by_state();
...
void SetInlineItemDatetime(
        ...
        U8 *buffer_3,
        U8 *buffer_4,
        void (*f) (PU8 string_buffer, PU8 buffer_1, PU8 buffer_2, PU8 buffer_3, PU8 buffer_4))
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    wgui_inline_item_datetime *i;

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (n_inline_datetime_items >= MAX_INLINE_DATETIME_ITEMS)
    {
        return;
    }

    wgui_inline_mem_alloc_info[wgui_inline_mem_alloc_number] = item->item = wgui_inline_malloc(sizeof(wgui_inline_item_datetime));
    wgui_inline_mem_alloc_number++; 
    item->flags = type;
    if(type != INLINE_ITEM_TYPE_TIME)
        wgui_inline_mem_alloc_info[wgui_inline_mem_alloc_number] = item->text_p = (U8*)wgui_inline_malloc(MAX_INLINE_DATE_IP4_DISPLAY_STRING_SIZE * sizeof(U8));
    else
    ...
    wgui_inline_mem_alloc_number++;  
    n_inline_datetime_items++;
    i = (wgui_inline_item_datetime*) item->item;
    i->buffer_1= buffer_1;
    i->buffer_2= buffer_2;
    i->buffer_3 = buffer_3;
    i->buffer_4 = buffer_4;
    i->flags = INLINE_ITEM_LEFT_JUSTIFY;
    i->string_construct_callback = f;
    i->string_construct_callback(item->text_p, i->buffer_1, i->buffer_2, i->buffer_3,i->buffer_4);
    item->handler = handle_inline_datetime_edit;
}
 ...
 *  void
 *****************************************************************************/
void ReConfigureInlineItemDatetime(
        U32 type,
        InlineItem *item,
        U8 *buffer_1,
        U8 *buffer_2,
...
void wgui_show_inline_datetime_list_menuitem(U32 type, S32 x1, S32 y1, S32 width, S32 height, wgui_inline_item *item)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    wgui_inline_item_datetime *i = (wgui_inline_item_datetime*) item->item;
    S32 xx;
    U32 dtflags = 0;//
    datetime_input wgui_inline_datetime_input_display = {0};
    ...
    wgui_inline_datetime_input_display.flags = i->flags;

    

    if(type == INLINE_ITEM_TYPE_DATE)
    {
        wgui_inline_datetime_input_display.detail.date.date_type = DATE_INPUT_TYPE_YYYY_MM_DD;
    	wgui_inline_datetime_input_display.detail.date.day = i->buffer_1;
        wgui_inline_datetime_input_display.detail.date.month = i->buffer_2;
        wgui_inline_datetime_input_display.detail.date.year = i->buffer_3;    
        wgui_inline_datetime_input_display.seperator = (UI_character_type) '/';//L"/";
        wgui_inline_datetime_input_display.type = DATETIME_INPUT_TYPE_DATE;
        dtflags |= DATE_INPUT_TYPE_YYYY_MM_DD;
    }
    else if (type == INLINE_ITEM_TYPE_TIME)
    {
    	wgui_inline_datetime_input_display.detail.time.hour = i->buffer_1;
        wgui_inline_datetime_input_display.detail.time.minute = i->buffer_2;
        wgui_inline_datetime_input_display.detail.time.AM_PM_flag = i->buffer_3;
        wgui_inline_datetime_input_display.seperator = (UI_character_type) ':';
        dtflags |= TIME_INPUT_TYPE_HH_MM;
        wgui_inline_datetime_input_display.type = DATETIME_INPUT_TYPE_TIME;
    }
    else if (type == INLINE_ITEM_TYPE_IP4_EDIT)
    {
        wgui_inline_datetime_input_display.detail.ip4.IP1 = i->buffer_1;
        wgui_inline_datetime_input_display.detail.ip4.IP2 = i->buffer_2;
        wgui_inline_datetime_input_display.detail.ip4.IP3 = i->buffer_3;
        wgui_inline_datetime_input_display.detail.ip4.IP4 = i->buffer_4;
        wgui_inline_datetime_input_display.seperator = (UI_character_type) '.';
        wgui_inline_datetime_input_display.type = DATETIME_INPUT_TYPE_IP4;
    }

    current_wgui_inline_datetime_text_p = 
        &((wgui_inline_items[MMI_fixed_list_menu.current_displayed_item]).text_p);
    i->string_construct_callback(
        *current_wgui_inline_datetime_text_p,  //item->text_p
        i->buffer_1,
        i->buffer_2,
        i->buffer_3,
        i->buffer_4);
    wgui_inline_datetime_input_display.text = *current_wgui_inline_datetime_text_p;  
        
    wgui_inline_datetime_input_display.seperator = (UI_character_type) '/'; //L"/";

    
    wgui_inline_datetime_input_display.y = y1;    
    wgui_inline_datetime_input_display.height = height;

#ifndef __MMI_FTE_SUPPORT__    

    wgui_inline_datetime_input_display.x = x1 + xx;
    wgui_inline_datetime_input_display.width = width - xx;
    
    create_datetime_input(    
        &wgui_inline_datetime_input_display,
       // DATETIME_INPUT_TYPE_DATE,
        dtflags);
#else

    wgui_inline_datetime_input_display.x = x1;
    wgui_inline_datetime_input_display.width = width;
...
#ifdef __MMI_FTE_SUPPORT__
    wgui_inline_datetime_input_display.flags |= DATE_INPUT_USE_PRESET_CLIP;
#endif
    ...
    {
        inline_item_default_text_show_background(
            wgui_inline_datetime_input_display.x,
            wgui_inline_datetime_input_display.y,
            wgui_inline_datetime_input_display.x + wgui_inline_datetime_input_display.width - 1,
            wgui_inline_datetime_input_display.y + wgui_inline_datetime_input_display.height - 1);
    }
    else
#endif /* __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__ */ 

    datetime_input_show_background(&wgui_inline_datetime_input_display);
    datetime_input_reset_focus((void*)&wgui_inline_datetime_input_display);
    show_datetime_input(&wgui_inline_datetime_input_display);
 ...
 *  U32
 *****************************************************************************/
static U32 mmi_input_box_msg_call_back_inline_datetime(datetime_input  * editor_ptr, mmi_imc_message_struct_p msg_ptr)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    MMI_ASSERT(editor_ptr == &wgui_inline_datetime_input);

    switch(msg_ptr->message_id)
    {
    case MMI_IMC_MESSAGE_INSERT_CHAR:
        
        datetime_input_direct_input_nodraw((UI_character_type)msg_ptr->param_0);

        redraw_inline_datetime_edit();
    ...
    case MMI_IMC_MESSAGE_INSERT_STRING_NO_DRAW:    
        ...
        {
            if (datetime_input_test_last_position(editor_ptr))
            {
                is_last = MMI_TRUE;
            }
            
            datetime_input_direct_input_nodraw((UI_character_type)temp_str[0]);
            ...
            show_datetime_input(editor_ptr);
        }
        else
        {
            datetime_input_direct_input((UI_character_type)temp_str[0]);
        }
    ...
    case MMI_IMC_MESSAGE_IS_LAST_POSITION:
        lresult = (U32)datetime_input_test_last_position(editor_ptr);
        break;
    ...
    case MMI_IMC_MESSAGE_INSERT_MULTITAP_CHAR:
        ...
        lresult = datetime_input_direct_input_nodraw(ch);
        break;
    ...
    case MMI_IMC_MESSAGE_CLEAR_ALL:    
        datetime_input_first_character();
        break;
       
    case MMI_IMC_MESSAGE_REDRAW:
        
        wgui_inline_datetime_input.current_focus = g_inline_date_current_focus;
        ...
        datetime_input_set_focus((void*)&wgui_inline_datetime_input);
			...
			MMI_multiline_inputbox.cursor_p = MMI_multiline_inputbox.text + g_inline_date_current_position;
            wgui_inline_datetime_input.current_focus =  g_inline_datetime_current_position ;
        //if (wgui_inline_date_input.focus_input_box != NULL)
        //if (wgui_inline_datetime_input.is_focus == MMI_TRUE)
        {
            //wgui_inline_datetime_input.current_text_p =
            //wgui_inline_datetime_input.text + g_inline_datetime_current_position;
        }
		} 
        wgui_inline_datetime_input.flags = g_inline_date_flags;
...
/* under construction !*/
    ...
    case MMI_IMC_MESSAGE_PEN_EVENT:
        ...
        else if (((mmi_imc_editor_pen_event_struct_p)msg_ptr->param_0)->mmi_pen_event == MMI_PEN_EVENT_UP)
        {
            if (PEN_CHECK_BOUND(((mmi_imc_editor_pen_event_struct_p)msg_ptr->param_0)->pos.x, 
                                ((mmi_imc_editor_pen_event_struct_p)msg_ptr->param_0)->pos.y, 
                                editor_ptr->x, editor_ptr->y, 
                                editor_ptr->width,
                                editor_ptr->height))
            {
                datetime_input_move_to_x_y(editor_ptr, 
...
#ifdef __MMI_INLINE_HIGHLIGHT_CAPTION__  
	date_time_input_theme.selection_color = current_MMI_theme->inline_datatime_focussed_filler->c;
	date_time_input_background_filler  = *wgui_inline_fixed_icontext_menuitem_theme.focussed_filler; 
#endif
...
#define reverse_pixtel_UI_strcpy(s1,s2)   UI_strcpy(s2,s1)
...
S32 wgui_get_inline_history_size(void)
{
    ...
    switch (wgui_current_inline_item_type)
    {
        ...
        case INLINE_ITEM_TYPE_IP4_EDIT:
            inline_history_size = sizeof(inline_datetime_edit_history);
            break;
...
U8 *wgui_get_inline_history(U16 history_ID, U8 *history_buffer)
{
    ...
    switch (wgui_current_inline_item_type)
    {
        ...
        case INLINE_ITEM_TYPE_TIME_PERIOD:
        case INLINE_ITEM_TYPE_IP4_EDIT:            
            inline_datetime_edit_get_history((U8*) (history_buffer + start_offset));
            break;
#else /* __INLINE_DATETIME_SLIM__  */   
#if defined(__MMI_INLINE_ITEM_DATE__)    
        case INLINE_ITEM_TYPE_DATE:
...
U8 *wgui_inline_edit_get_current_item_history(U8 *history_buffer)
{
    ...
    switch (wgui_current_inline_item_type)
    {
        ...
        case INLINE_ITEM_TYPE_TIME_PERIOD:
        case INLINE_ITEM_TYPE_IP4_EDIT:            
            inline_datetime_edit_get_history((U8*) (history_buffer));
            break;
#else /* __INLINE_DATETIME_SLIM__  */   
#if defined(__MMI_INLINE_ITEM_DATE__)
        case INLINE_ITEM_TYPE_DATE:
...
/* under construction !*/
            ...
            case INLINE_ITEM_TYPE_IP4_EDIT:
            {
                ...
                size =
                    ...
                    4 * ENCODING_LENGTH;
                gui_memcpy((U8*) & data[offset], (U8*) & ID, INLINE_ITEM_DATA_ID_LENGTH);
                gui_strcpy((UI_string_type) & data[offset + INLINE_ITEM_DATA_ID_LENGTH], (UI_string_type) ii->buffer_1);
                gui_strcpy(
...
void wgui_set_inline_data(wgui_inline_item *inline_items, S32 n_items, U8 *data)
{
    ...
    #ifdef __INLINE_DATETIME_SLIM__
                U16 ID = INLINE_ITEM_DATE_DATA_ID;
                wgui_inline_item_datetime *ii = (wgui_inline_item_datetime*) inline_items[i].item;
...
/* under construction !*/
            ...
            case INLINE_ITEM_TYPE_IP4_EDIT:
            {
                ...
                reverse_pixtel_UI_strcpy(
                    (UI_string_type) & data[offset + INLINE_ITEM_DATA_ID_LENGTH + 4 * ENCODING_LENGTH + 4 * ENCODING_LENGTH + 4 * ENCODING_LENGTH],
                    (UI_string_type) ii->buffer_4);
                ii->string_construct_callback(inline_items[i].text_p, 
                    ii->buffer_1, ii->buffer_2, ii->buffer_3, ii->buffer_4);
    #else
...
/* under construction !*/
        ...
        {            
            ...
            {
                #ifdef __INLINE_DATETIME_SLIM__  
                inline_datetime_edit_history *h = (inline_datetime_edit_history*) wgui_current_history_buffer;
                #else
        ...
        #ifdef __INLINE_DATETIME_SLIM__  
            g_mmi_editor_hanler.input_box_handler = &wgui_inline_datetime_input;
        #else
...
#if defined(__MMI_INLINE_ITEM_DATE__)            
#ifdef __INLINE_DATETIME_SLIM__           
            wgui_show_inline_datetime_list_menuitem(
...
#if defined(__MMI_INLINE_ITEM_DATE__)                 
#ifdef __INLINE_DATETIME_SLIM__   
                lresult = mmi_input_box_msg_call_back_inline_datetime((datetime_input  *)(((mmi_editor_handler_struct *)input_box_handle)->input_box_handler), msg_ptr);
#else
...
static void mmi_input_box_keep_current_item_info(void)
{
    ...
    switch(g_inline_current_inline_item_type)
    {
        ...
        case MMI_EDITOR_TIME:
             ...
             #ifdef __INLINE_DATETIME_SLIM__
             g_inline_time_current_focus = 0; //(S16) wgui_inline_time_input.current_focus;
             g_inline_time_flags = wgui_inline_datetime_input.flags;
			 g_inline_date_current_position = MMI_multiline_inputbox.cursor_p - MMI_multiline_inputbox.text;
			 g_inline_datetime_current_position = wgui_inline_datetime_input.current_focus;
             #else
        ...
        case MMI_EDITOR_DATE:    
             ...
             g_inline_date_current_position = MMI_multiline_inputbox.cursor_p - MMI_multiline_inputbox.text;
             g_inline_datetime_current_position = wgui_inline_datetime_input.current_focus;
             g_inline_date_flags = wgui_inline_datetime_input.flags;
#endif
             g_is_item_info_kept = MMI_TRUE;
...
#if defined (__MMI_INLINE_ITEM_IP4__)
#ifdef __INLINE_DATETIME_SLIM__ 
            g_inline_IP4_current_focus = (S16) wgui_inline_datetime_input.current_focus;

            if (wgui_inline_datetime_input.is_focus != MMI_FALSE)
            {
               // g_inline_datetime_current_position =
                  //  (S16) (wgui_inline_datetime_input.current_text_p -
                   // wgui_inline_datetime_input.text);
            }

            g_inline_IP4_flags = wgui_inline_datetime_input.flags;
			g_inline_date_current_position = MMI_multiline_inputbox.cursor_p - MMI_multiline_inputbox.text;
			g_inline_datetime_current_position = wgui_inline_datetime_input.current_focus;
#else
...
/* under construction !*/
    ...
    case MMI_EDITOR_IP4:
    case MMI_EDITOR_TIME:       
        mmi_input_box_msg_call_back_inline_datetime((datetime_input *)g_inline_current_input_box_handler, &msg);
        break;
#else
    case MMI_EDITOR_DATE:
#if defined(__MMI_INLINE_ITEM_DATE__)         
        ...
        U16 history_id)
{
    ...
    UI_menuitem_theme *saved_themedata1 = current_menuitem_theme;
    UI_list_menu_theme *saved_themedata2 = current_fixed_list_menu_theme;
...
//huking
    current_menuitem_theme = &wgui_inline_fixed_icontext_menuitem_theme;
    current_fixed_list_menu_theme = &wgui_inline_fixed_list_menu_theme;
	MMI_fixed_list_menu.flags |= WGUI_LIST_MENU_DISABLE_SHORTCUT;
...
#ifdef __MMI_UI_INLINE_EDIT_DEFAULT_TEXT_EFFECT__
    temp_inline_edit_normal_filler.border_color = current_menuitem_theme->focussed_filler->c;
...
/* under construction !*/
	...
	//huking
    current_menuitem_theme = saved_themedata1;
...
void wgui_inline_menu_cui_select(MMI_ID parent_id, S32 item_index)
{
	...
	{
	    cui_title_string = g_cui_inline_current_instance->title_string;
		if((!cui_title_string)&&(g_cui_inline_current_instance->title))
		{
            cui_title_string = (PU8) get_string(g_cui_inline_current_instance->title);
		}			
	}
