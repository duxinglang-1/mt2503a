...
static void gui_icontext_button_get_display_area_ex(
	icontext_button *b, 
	S32 *display_x1, 
	S32 *display_y1, 
	S32 *display_x2, 
...
static void gui_button_auto_caculate_icon_pos(
	void* button,
	PU8 button_icon);
 ...
 *  void
 *****************************************************************************/
void gui_text_button_set_text_position(
	text_button *b, 
	S32 x, 
	S32 y)
{
...
/*****************************************************************************
 * FUNCTION
 *  gui_button_auto_caculate_text_pos
 * DESCRIPTION
 *  gui_button_auto_caculate_text_pos
 * PARAMETERS
 ...
 *  void
 *****************************************************************************/
void gui_resize_icontext_button(
	icontext_button *b, 
	S32 width, 
	S32 height)
{
 ...
 *  void
 *****************************************************************************/
void gui_icontext_button_set_icon_positon(
	icontext_button *b, 
	S32 x, 
	S32 y)
{
 ...
 *  void
 *****************************************************************************/
void gui_icontext_button_set_text_position(
	icontext_button *b, 
	S32 x, 
	S32 y)
{
    ...
    if (!(b->flags & UI_BUTTON_DISABLE_TEXT_DISPLAY))
    {
       ...
       // gui_push_text_clip();
        ...
        if (need_truncate == MMI_FALSE)
        {
            ...
            #else/*defined(__MMI_FTE_SUPPORT__) && defined(__MMI_VECTOR_FONT_SUPPORT__)*/
                gui_move_text_cursor(tx - GUI_BUTTON_TEXT_BORDER, ty);
            #endif/*defined(__MMI_FTE_SUPPORT__) && defined(__MMI_VECTOR_FONT_SUPPORT__)*/
            }
            else
            {
            #if defined(__MMI_FTE_SUPPORT__) && defined(__MMI_VECTOR_FONT_SUPPORT__)
 ...
 *  
 *****************************************************************************/
void gui_icontext_button_get_display_area(
	icontext_button *b, 
	S32 *display_x1, 
	S32 *display_y1, 
	S32 *display_x2, 
