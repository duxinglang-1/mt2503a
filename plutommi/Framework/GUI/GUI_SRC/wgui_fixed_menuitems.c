 ...
 * 11 28 2011 wei.fu
 * removed!
 * Add default highlight half item threshold. Fix build error.
 *
 * 11 28 2011 wei.fu
 * removed!
 * .
 ...
 * .
 *
 * 09 02 2011 lin.jiang
 * removed!
 * change non-FTE two state list menu behavior to FTE behaviro.
 *
 * 06 16 2011 lin.jiang
 * removed!
 * remove unused parameter and code.
 *
...
//#define GUI_TWO_LINE_MENUITEM_GAP           6
//#else
#define GUI_TWO_LINE_MENUITEM_GAP           2
//#endif
#define GUI_TWO_LINE_MENUITEM_TEXT_GAP      2
/***************************************************************************** 
 * Global Variable
 *****************************************************************************/ 
...
MMI_BOOL wgui_list_menu_slow_data_mode = MMI_FALSE;
...
//add by huking
typedef void (*wgui_list_menu_show_func)(fixed_list_menu *m);
 ...
 * Local Function
 *****************************************************************************/
static void associate_fixed_list(void* common_item_data);
static void associate_fixed_matrix(void*common_item_data);
static void associate_fixed_list_list(S32 IS_multirow, S32 item_height);

//add by huking
static void wgui_reset_menuitem_icontext_center_aligned(S32 *flags);
 ...
 *  void
 *****************************************************************************/
void fixed_text_menuitem_apply_theme(UI_menuitem_theme *t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
MMI_BOOL fixed_matrix_auto_disable_scrollbar(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void disable_fixed_icontext_list_menuitem_transparent_effect(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_fixed_icontext_list_disable_transparent_effect(&MMI_fixed_icontext_list_menuitem);
    gui_block_transparency_effect();
}
 ...
 *  void
 *****************************************************************************/
void enable_fixed_icontext_list_menuitem_transparent_effect(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------*/
    gui_unblock_transparency_effect();
    gui_fixed_icontext_list_enable_transparent_effect(&MMI_fixed_icontext_list_menuitem);
}
 ...
 *  void
 *****************************************************************************/
void fixed_icontext_menuitem_apply_theme(UI_menuitem_theme *t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void create_fixed_icontext_menuitems(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_create_fixed_icontext_menuitem(&MMI_fixed_icontext_menuitem, 108, MMI_MENUITEM_HEIGHT);//18
    ...
    {
        memset(&MMI_fixed_icontext_menuitems[i], 0, sizeof(fixed_icontext_menuitem_type));
 ...
 * DESCRIPTION
 *  Associate the common list of fixed icontext menu items with the fixed list.
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
static void associate_fixed_list(void*common_item_data)
{
   ...
   clear_menu_highlight_handler(&MMI_fixed_list_menu);
   //clear_fixed_list_highlight_handler();
    ...
    MMI_fixed_list_menu.last_displayed_item = 0;
	
#if defined(__MMI_UI_LIST_SCROLL_BY_PIXEL__)
#if defined(GUI_LIST_MENU_SMOOTH_SCROLLING_BY_PEN)
    gui_ssp_set_highlight_threshold(GUI_SSP_DEFAULT_HIGHLIGHT_THRESHOLD, GUI_SSP_DEFAULT_HIGHLIGHT_THRESHOLD);
#endif/*GUI_LIST_MENU_SMOOTH_SCROLLING_BY_PEN*/
//    MMI_fixed_list_menu.first_displayed_offset = 0;
//    MMI_fixed_list_menu.last_displayed_offset = 0;
#endif
...
void associate_fixed_icontext_list(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    associate_fixed_list(&MMI_fixed_icontext_menuitem);
...
void associate_fixed_icontext_matrix(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	associate_fixed_matrix(&MMI_fixed_icontext_menuitem);
...
void center_fixed_icontext_positions(U8 tx, U8 ty, U8 ix, U8 iy)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	wgui_reset_menuitem_icontext_center_aligned(&MMI_fixed_icontext_menuitem.flags);
/*
 ...
 *  void
 *****************************************************************************/
void wgui_menuitem_set_icontext_list_checkbox_position(S32 x_offset, S32 y_offset)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_fixed_icontext_list_menuitem.ext_flags |= UI_MENUITEM_EXT_SHOW_ICONTEXT_CHECKBOX;
    
    MMI_fixed_icontext_list_menuitem.checkbox_x = x_offset;
    MMI_fixed_icontext_list_menuitem.checkbox_y = y_offset;
}
 ...
 *  void
 *****************************************************************************/
void wgui_menuitem_register_icontext_list_checkbox_callback(
        checkbox_clicked_funcptr_type clicked_cb, 
        checkbox_get_image_funcptr_type get_image_cb)
{
    /*----------------------------------------------------------------*/
    ...
    if (clicked_cb)
    {
        MMI_fixed_icontext_list_menuitem.checkbox_clicked_callback = clicked_cb;    
    }

    if (get_image_cb)
    {
        MMI_fixed_icontext_list_menuitem.checkbox_get_image_callback = get_image_cb;    
    }
}
...
//    #ifdef __MMI_SLIM_LISTMENU__
//        MMI_fixed_icontext_menuitems[i].item_icon = (PU8) wgui_get_list_menu_icon(i, IMG_GLOBAL_L1+i);//(PU8) GetImage(IMG_GLOBAL_L1 + i);
//    #else
        if (img == NULL)
        {
...
void create_fixed_icontext_list_menuitems(S32 n_text_columns, S32 n_icon_columns)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_create_fixed_icontext_list_menuitem(&MMI_fixed_icontext_list_menuitem, 108, MMI_MENUITEM_HEIGHT, n_text_columns, n_icon_columns);
    MMI_fixed_icontext_list_menuitem.flags |= (UI_MENUITEM_CENTER_TEXT_Y|UI_MENUITEM_CENTER_ICON_Y);
 //   MMI_fixed_icontext_list_menuitem.flags |= ;

    for (i = 0; i < MAX_FIXED_ICONTEXT_LIST_MENU_ITEMS && i < MAX_FIXED_MENU_ITEM_POINTERS; i++)
    {
        memset(&MMI_fixed_icontext_list_menuitems[i], 0, sizeof(fixed_icontext_list_menuitem_type));
 ...
 *  void
 *****************************************************************************/
void set_fixed_icontext_menuitems_post_display(void (*post_display_function)(void *item, void *common_item_data, S32 x, S32 y))
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_fixed_icontext_menuitem_set_post_display(&MMI_fixed_icontext_menuitem, post_display_function);
}
...
static void associate_fixed_list_list(S32 IS_multirow, S32 item_height)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	associate_fixed_list(&MMI_fixed_icontext_list_menuitem);
	...
	else
	{
		...
		gui_asyncdynamic_list_menu_set_item_get_height_function(&MMI_fixed_list_menu, NULL);
#ifdef __MMI_TOUCH_SCREEN__
		gui_asyncdynamic_list_menu_set_pen_check_bound_function(&MMI_fixed_list_menu, NULL);
#endif/*__MMI_TOUCH_SCREEN__*/
#endif/*__MMI_UI_LIST_SUPPORT_UNEQUAL_HEIGHT_ITEM__*/

		gui_asyncdynamic_list_menu_set_goto_functions(&MMI_fixed_list_menu, NULL, NULL, NULL);
	}
...
void associate_fixed_icontext_list_list(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	associate_fixed_list_list(0, get_menu_item_height());
}
...
/*****************************************************************************
 * FUNCTION
 *  associate_fixed_matrix
 * DESCRIPTION
 *  Associate associate_fixed_matrix
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
static void associate_fixed_matrix(void*common_item_data)
{
	...
	//memset(&MMI_fixed_matrix_menu, 0, sizeof(fixed_matrix_menu));

	clear_menu_highlight_handler(&MMI_fixed_matrix_menu);
...
/* under construction !*/
	...
	//flags
	//m->parent_list = NULL;
    m->parent_matrix = &MMI_fixed_matrix_menu;  

    m->flags |= UI_MENUITEM_DISABLE_BACKGROUND;

    MMI_fixed_matrix_menu.common_item_data = common_item_data;
...
void associate_fixed_icontext_list_matrix(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    associate_fixed_matrix(&MMI_fixed_icontext_list_menuitem);
...
void remove_all_fixed_icontext_item(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if ((*fixed_icontext_list_menu_n_items) > 0)//need??
    {
        (*fixed_icontext_list_menu_n_items) = 0;
    }
}
 ...
 *  void
 *****************************************************************************/
void fixed_twostate_menuitem_apply_theme(UI_menuitem_theme *t)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void associate_fixed_twostate_list(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    associate_fixed_list(&MMI_fixed_twostate_menuitem);
...
void associate_fixed_twostate_matrix(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    associate_fixed_matrix(&MMI_fixed_twostate_menuitem);
...
void center_fixed_twostate_positions(U8 tx, U8 ty, U8 ix, U8 iy)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	wgui_reset_menuitem_icontext_center_aligned(&MMI_fixed_twostate_menuitem.flags);
	/*
...
void select_fixed_twostate_item(S32 index)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (gui_is_index_in_menu_valid_region(index, &MMI_fixed_list_menu))//(index >= 0 && index < (*fixed_twostate_menu_n_items))
    {
 ...
 *****************************************************************************/
MMI_BOOL get_fixed_twostate_item_state(S32 index)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	return (gui_is_index_in_menu_valid_region(index, &MMI_fixed_list_menu) &&
			(MMI_fixed_twostate_menuitems[index].flags & UI_MENUITEM_STATE_SELECTED));
/*	
    if (gui_is_index_in_menu_valid_region(index, &MMI_fixed_list_menu))//(index >= 0 && index < (*fixed_twostate_menu_n_items))
    {
...
void resize_fixed_icontext_menuitems_to_list_width(void)
{
    ...
    {
    	wgui_show_list_menu_no_draw(gui_show_fixed_list_menu);
#if 0    
/* under construction !*/
/* under construction !*/
/* under construction !*/
        ...
        {
            resize_fixed_icontext_menuitems(MMI_fixed_list_menu.width - MMI_fixed_list_menu.vbar.width -
...
/* under construction !*/
        ...
        if (MMI_fixed_list_menu.vbar.scale >= MMI_fixed_list_menu.vbar.range)
        {
            resize_fixed_icontext_list_menuitems(MMI_fixed_list_menu.width, MMI_fixed_icontext_list_menuitem.height);
        }
#ifndef __MMI_UI_MENU_AUTO_DISABLE_SCROLLBAR__			
    }
    else if (MMI_fixed_list_menu.flags & UI_LIST_MENU_DISABLE_SCROLLBAR)
...
/* under construction !*/
        ...
        if (MMI_fixed_list_menu.vbar.scale >= MMI_fixed_list_menu.vbar.range)
        {
            resize_fixed_twostate_menuitems(MMI_fixed_list_menu.width - 4, MMI_fixed_twostate_menuitem.height);
        }
#ifndef __MMI_UI_MENU_AUTO_DISABLE_SCROLLBAR__			
    }
    else if (MMI_fixed_list_menu.flags & UI_LIST_MENU_DISABLE_SCROLLBAR)
...
void associate_fixed_multirow_list_list(S32 menu_item_height)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	associate_fixed_list_list(1, menu_item_height);
}
...
wgui_get_display_style get_current_menu_item_displaystyle = NULL;
#ifdef __MMI_UI_TWO_LINE_MENUITEM_STYLES__
...
/* under construction !*/
#endif//0
	SetKeyDownHandler(wgui_two_line_level_select_volume_move_next_item,KEY_RIGHT_ARROW);
	SetKeyDownHandler(wgui_two_line_level_select_volume_move_previous_item,KEY_LEFT_ARROW);
	SetKeyRepeatHandler(wgui_two_line_level_select_volume_move_next_item,KEY_RIGHT_ARROW);
	SetKeyRepeatHandler(wgui_two_line_level_select_volume_move_previous_item,KEY_LEFT_ARROW);
...
void reset_fixed_icontext_menuitem_type(void)
{
    ...
    gui_set_current_two_line_menuitem_data = UI_dummy_function;
    gui_reset_current_two_line_menuitem_data = UI_dummy_function;
        ...
        wgui_two_line_menuitem_complete_callback complete_callback)
{
    ...
    two_line_horizontal_select_menuitem.menuitem_down_event = GUI_LIST_PEN_NONE;
...
/* under construction !*/
#endif//0
		SetKeyDownHandler(wgui_two_line_horizontal_select_move_next_item, KEY_RIGHT_ARROW);
		SetKeyDownHandler(wgui_two_line_horizontal_select_move_previous_item,KEY_LEFT_ARROW);
		SetKeyRepeatHandler(wgui_two_line_horizontal_select_move_next_item,KEY_RIGHT_ARROW);
		SetKeyRepeatHandler(wgui_two_line_horizontal_select_move_previous_item,KEY_LEFT_ARROW);
...
void wgui_show_two_line_horizontal_select(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
#define THUMBNAIL_GAP_FROM_SIDES 3
...
#endif /* __MMI_TOUCH_SCREEN__ */
//#ifdef __MMI_UI_TWO_LINE_MENUITEM_IMG_SELECTOR__
//    lx = GUI_TWO_LINE_MENUITEM_GAP;
//#else
    lx = GUI_TWO_LINE_MENUITEM_GAP;
//#endif
    text_x = lx + width + GUI_TWO_LINE_MENUITEM_TEXT_GAP;
...
#endif /* __MMI_TOUCH_SCREEN__ */
//#ifdef __MMI_UI_TWO_LINE_MENUITEM_IMG_SELECTOR__
//    rx = width_for_horizontal_select - width - GUI_TWO_LINE_MENUITEM_GAP;
//#else
    rx = width_for_horizontal_select - width - GUI_TWO_LINE_MENUITEM_GAP;
//#endif
    text_end_x = rx - GUI_TWO_LINE_MENUITEM_TEXT_GAP;
    ...
    if (two_line_horizontal_select_menuitem.no_of_items > 1)
    {
        if (two_line_horizontal_select_menuitem.menuitem_current_event == GUI_LIST_PEN_TWO_LINE_PREVIOUS)
        {
            gui_show_transparent_image(x1 + lx + 1, y1 + ly + 1, left_arrow, 0);
            gui_show_transparent_image(x1 + rx, y1 + ry, right_arrow, 0);
        }
        else if (two_line_horizontal_select_menuitem.menuitem_current_event == GUI_LIST_PEN_TWO_LINE_NEXT)
        {
            gui_show_transparent_image(x1 + lx, y1 + ly, left_arrow, 0);
            gui_show_transparent_image(x1 + rx + 1, y1 + ry + 1, right_arrow, 0);
        }
        else
        {
            gui_show_transparent_image(x1 + lx, y1 + ly, left_arrow, 0);
...
//#endif
    ...
    {
#if  0//__MMI_UI_TWO_LINE_MENUITEM_IMG_SELECTOR__
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
...
#ifdef  __MMI_PHB_TWO_LINE_MENUITEM_DISPLAY__ // jianglin
    if (current_menu_item_properties.image_flags & UI_TWO_LINE_MENUITEM_THUMBNAIL_IS_ID)
    {
        ...
        //gui_push_clip();
        gui_push_and_set_clip(thumb_x - THUMBNAIL_GAP_FROM_SIDES, thumb_y, thumb_x + thumb_width, thumb_y + thumb_height);
    ...
    if (current_menu_item_properties.image_flags & UI_TWO_LINE_MENUITEM_THUMBNAIL_IS_FILE)
    {
        S32 tw, th;
 ...
 *****************************************************************************/
MMI_BOOL get_two_line_menuitem_height(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return (get_current_menu_item_displaystyle &&
    	get_current_menu_item_displaystyle(MMI_fixed_list_menu.highlighted_item))
 ...
 *  Return 1 for two line; otherwise, 0 for single line.
 *****************************************************************************/
MMI_BOOL get_two_line_asyncdynamic_menuitem_height(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (MMI_fixed_list_menu.current_displayed_item == -1)
    {
        ...
        menuitem_index = (MMI_fixed_list_menu.highlighted_item - asyncdynamic_item_buffer.head_item_index +
                          asyncdynamic_item_buffer.head) & MASK_ASYNCDYNAMIC_ITEMS_BUFF;
        if (two_line_display_asyncdynamic_menuitem_callback)
        {
            if (two_line_display_asyncdynamic_menuitem_callback(MMI_fixed_list_menu.highlighted_item, menuitem_index))
            {
 ...
 *  Return 1 for two line; otherwise, 0 for single line.
 *****************************************************************************/
MMI_BOOL get_two_line_dynamic_menuitem_height(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    S32  menuitem_index;//index,
    ...
    {
        //index = MMI_fixed_list_menu.highlighted_item;
        menuitem_index = (MMI_fixed_list_menu.highlighted_item - dynamic_item_buffer.head_item_index +
                          dynamic_item_buffer.head) & MASK_DYNAMIC_ITEMS_BUFF;
        if (two_line_display_dynamic_menuitem_callback)
        {
            if (two_line_display_dynamic_menuitem_callback(MMI_fixed_list_menu.highlighted_item, menuitem_index))
            {
        ...
        U32 flags)
{
    ...
    //gui_push_text_clip();
    gui_push_and_set_clip(hint_x1, hint_y1, hint_x2, hint_y2);
    ...
    {
        gui_set_text_color(*current_MMI_theme->two_line_second_line_highlight_text_color);
    }
    else
    {
        gui_set_text_color(*current_MMI_theme->two_line_second_line_text_color);
    }
    ...
    else
    {
        gui_create_scrolling_text(
            ...
            two_line_scrolling_text_timer_handler,
            wgui_scrolling_text_draw_two_line_background,
            *current_MMI_theme->two_line_second_line_highlight_text_color,
            *current_MMI_theme->two_line_second_line_highlight_text_color);
        gui_show_scrolling_text(&wgui_two_line_scroll_text);
    }
    gui_pop_text_clip();
...
/*****************************************************************************
 * FUNCTION
 *  wgui_menuitem_register_icontext_list_display_callback
 * DESCRIPTION
 *  Register the icontext checkbox callback function.
 * PARAMETERS
 *  highlight_twoline_display_function      [IN]    highlight twoline display callback function pointer
 * RETURNS
 *  void
 *****************************************************************************/
void wgui_menuitem_register_icontext_list_display_callback(
        void (*highlight_twoline_display_function) (void *item, S32 x1, S32 y1, S32 x2, S32 y2))
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (highlight_twoline_display_function)
    {
        MMI_fixed_icontext_list_menuitem.highlight_twoline_display_function = highlight_twoline_display_function;    
    }
}
 ...
 *  void
 *****************************************************************************/
void wgui_show_list_menu_no_draw(void (*show_func) (fixed_list_menu *m))
{
