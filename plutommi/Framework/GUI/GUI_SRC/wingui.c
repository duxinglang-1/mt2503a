...
#if defined (__MMI_UI_TRANSPARENT_EFFECT__) || defined (__MMI_UI_LIST_HIGHLIGHT_EFFECTS__) ||  defined (UI_SCROLLBAR_STYLE_4)
...
extern void get_image_start_values_dummy (
	int * offset_x, 
	int * offset_y);

extern void draw_bootup_pbm_image(
	int offset_x, 
	int offset_y, 
	const kal_uint8 *dev_bmp_src, 
 ...
 *  void
 *****************************************************************************/
void UI_cross_hatch_fill_rectangle(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
	color c)
{
    ...
    gdi_fill_dot_rect(
    	...
    	x2,
    	y2,
    	gdi_act_color_from_rgb(UI_translate_gui_alpha_to_gdi_alpha(c.alpha),c.r,c.g,c.b));
}
 ...
 *  void
 *****************************************************************************/
void UI_alternate_cross_hatch_fill_rectangle(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
 ...
 *  void
 *****************************************************************************/
void UI_alternate_hatch_fill_rectangle(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
 ...
 *  void
 *****************************************************************************/
void flat_triangle_horizontal_line(
	S32 x1, 
	S32 x2, 
	S32 y, 
	color c)
 ...
 *  void
 *****************************************************************************/
void UI_draw_dotted_horizontal_line(
	S32 x1, 
	S32 x2, 
	S32 y, 
	color c)
 ...
 *  void
 *****************************************************************************/
void UI_draw_dotted_vertical_line(
	S32 y1, 
	S32 y2, 
	S32 x, 
	color c)
 ...
 *  void
 *****************************************************************************/
void UI_draw_dashed_horizontal_line(
	S32 x1, 
	S32 x2, 
	S32 y, 
	color c)
 ...
 *  void
 *****************************************************************************/
void UI_draw_dashed_vertical_line(
	S32 y1, 
	S32 y2, 
	S32 x, 
	color c)
 ...
 *  void
 *****************************************************************************/
void UI_draw_horizontal_line_type(
	S32 y1, 
	S32 y2, 
	S32 x, 
	color c, 
 ...
 *  void
 *****************************************************************************/
void UI_draw_vertical_line_type(
	S32 y1, 
	S32 y2, 
	S32 x, 
	color c, 
 ...
 *  void
 *****************************************************************************/
void UI_set_clip_with_bounding_box(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
...
///TODO: caller no need to set width and height to zero!!!	
	//add by huking
    *width = *height = 0;
	//end huking add
...
//huking defined (__MMI_UI_TRANSPARENT_EFFECT_IN_DALMATIAN_CALENDAR__) ||
#if defined (__MMI_UI_TRANSPARENT_EFFECT__) || defined (__MMI_UI_LIST_HIGHLIGHT_EFFECTS__) ||  defined (UI_SCROLLBAR_STYLE_4) || defined(UI_SCROLLBAR_STYLE_6)
 ...
 *  TRUE/FALSE
 *****************************************************************************/
MMI_BOOL gui_is_current_transparency_with_multi_layer(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    return (non_default_layer != GDI_LAYER_EMPTY_HANDLE); 
}
 ...
 *  void
 *****************************************************************************/
void gui_fill_transparent_color(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
	color c)
{
    ...
    else
    {
        ...
        gdi_effect_alpha_blending_rect_ex(
			active_layer, 
			x1, 
			y1, 
			x2, 
 ...
 *  void
 *****************************************************************************/
void gui_transparent_color_filler(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
	color c)
{
    ...
    if (GDI_LCD->act_handle != GDI_LCD_MAIN_LCD_HANDLE)
    {
        ...
        gdi_draw_solid_rect(
			...
			x2, 
			y2, 
			gdi_act_color_from_rgb(alpha_value, c.r, c.g, c.b));
    }
    else
#endif /* __MMI_SUBLCD__ */ 
    {
