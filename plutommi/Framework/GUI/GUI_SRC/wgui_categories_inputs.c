...
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__    
UI_single_line_input_box_theme PIN_singleline_inputbox_theme = { 
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
UI_multi_line_input_box_theme PIN_singleline_inputbox_theme = { 
    &PIN_inputbox_BG_filler,
    &PIN_inputbox_BG_filler,
    &PIN_inputbox_BG_filler,
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
        gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox, &PIN_singleline_inputbox_theme);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */  
...
void wgui_cat112_control_area_callback(dm_coordinates *coordinate)
{
    ...
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/        
    S32 total_height, left_space, y_space, multiline_h;
    S32 sl_start_y =0 ;
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__    
    S32 len;    
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/
    ...
    wgui_inputs_ml_show();
    sl_start_y = MMI_multiline_inputbox.y + MMI_multiline_inputbox.height + y_space;  
...
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/
    /* single-line editor */
    wgui_inputs_sl_move(coordinate->s16X, sl_start_y);
        ...
        U8 *history_buffer)
{
    ...
    message_len = gui_strlen((UI_string_type) g_wgui_cat112_cntx_ptr->multiline_message);
    wgui_inputs_ml_create_set_buffer((UI_string_type) g_wgui_cat112_cntx_ptr->multiline_message, message_len, message_len, 0);
    MMI_multiline_inputbox.normal_text_color = *(current_MMI_theme->popup_text_color);
    MMI_multiline_inputbox.flags |=
        UI_MULTI_LINE_INPUT_BOX_DISABLE_CURSOR_DRAW | UI_MULTI_LINE_INPUT_BOX_DISABLE_BACKGROUND | 
        UI_MULTI_LINE_INPUT_BOX_DISABLE_SCROLLBAR | UI_MULTI_LINE_INPUT_BOX_VIEW_MODE;
    ...
    wgui_inputs_ml_save_category_only_show_data();
    ...
    wgui_inputs_ml_save_category_input_data();
   ...
   void RedrawCategoryControlledArea111Screen_IME_HINT(dm_coordinates *coordinate)
       {
           ...
           S32 Margin_WIDTH = 3;
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__  
           S32 editor_x =	   MMI_singleline_inputbox.x;
		   S32 editor_y =	   MMI_singleline_inputbox.y;
		   S32 editor_width =  MMI_singleline_inputbox.width; 
		   S32 editor_height = MMI_singleline_inputbox.height; 
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
           S32 editor_x =	   MMI_multiline_inputbox.x;
		   S32 editor_y =	   MMI_multiline_inputbox.y;	
		   S32 editor_width =  MMI_multiline_inputbox.width;
		   S32 editor_height = MMI_multiline_inputbox.height;
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
       ...
       
           {
               ...
               y1 = editor_y;
               y2 = editor_y + editor_height - 1;
               ime_w = mmi_imc_get_input_mode_hint_width();
               x1 = x2 - ime_w ;
               //sl_w = x1 - editor_x + 1;
               sl_w = UI_device_width - UI_device_width/5 - 22 ;
               sl_x =  1 + Margin_WIDTH;
           }
       
           /* draw IME background */ 
			#if defined(__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__) 
			gui_one_layer_draw_filled_bg_area(editor_x + sl_w , y1, x2, y2);
			#else
			gui_fill_rectangle(editor_x + sl_w , y1, x2, y2,current_information_bar_theme->background_color);
			#endif
		   
           mmi_imc_draw_input_mode_hint(x1, y1, x2, y2);
       
           if (editor_width > sl_w )
           {
               	wgui_inputs_sl_resize(sl_w, editor_height);
               	//wgui_inputs_sl_move(sl_x, editor_y);
...
void (*g_wgui_cat111_show_vk_bg_func)(mmi_imc_rect_p rect_p) = NULL;


void RedrawCategoryControlledArea111Screen_IME_VK_BG(mmi_imc_rect_p rect_p);
/*****************************************************************************
* FUNCTION
*  RedrawCategoryControlledArea111Screen_IME_VK_BG
* DESCRIPTION
*  redraw category111 VK BG
* PARAMETERS
*  coordinate	   [IN] 	Area to redraw	   
* RETURNS
*  void
...
void RedrawCategoryControlledArea111Screen_IME_VK_BG(mmi_imc_rect_p rect_p)
{
...
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__  
	S32 editor_y =	  MMI_singleline_inputbox.y;
	S32 editor_h =	  MMI_singleline_inputbox.height;

#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
	S32 editor_y =	  MMI_multiline_inputbox.y;    
	S32 editor_h =	  MMI_multiline_inputbox.height;
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
   ...
   /*----------------------------------------------------------------*/ 
	...
	gdi_layer_lock_frame_buffer();
	{
		...
		{
			y1 = editor_y + editor_h;
		}	
		//y2 = UI_device_height - ime_vk_h - MMI_softkey_height + 1;
		if(rect_p->y > 1)
		{
			y2 = rect_p->y - 1;
		}
		...
		{
			y2 = UI_device_height - MMI_softkey_height + 1;
		}
		x1 = 0;
	}
...
#ifndef __MMI_EDITOR_SINGLINE_SUPPORT__    
        wgui_inputs_ml_save_category_input_data();
	wgui_inputs_ml_load_category_only_show_data_resize_fit_ml();
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
...
#if defined(__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__) 
//#ifdef  __MMI_VIRTUAL_KEYBOARD__
	g_wgui_cat111_show_vk_bg_func = RedrawCategoryControlledArea111Screen_IME_VK_BG;
//#endif				   
#endif/*__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__*/
...
#if defined(__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__) 
//#ifdef  __MMI_VIRTUAL_KEYBOARD__
	g_wgui_cat111_show_vk_bg_func = NULL;
	scrol_text_y2 = 0; 
//#endif				   
#endif/*__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__*/
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    static UI_multi_line_input_box_theme g_wgui_cat2001_singleline_inputbox_theme = { 
        &g_wgui_cat2001_inputbox_BG_filler,
        &g_wgui_cat2001_inputbox_BG_filler,
        &g_wgui_cat2001_inputbox_BG_filler,
        {0, 0, 0, 100},  /* special_text_color */
...
static void wgui_cat2001_redraw_counter(void)
{
    ...
    if(mmi_fe_get_r2l_state())
    {
        gui_move_text_cursor(
            UI_device_width - 4, 
            editor_y - ((WGUI_CAT2001_INFO_BAR_HEIGHT + h)>>1) - panel_h);
    }
    else
    {
        gui_move_text_cursor(
    ...
    gdi_layer_unlock_frame_buffer();
    gui_BLT_double_buffer(0, editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT - panel_h, UI_device_width - 1, editor_y);
}
...
/* draw the background of the info-bar and singleline inputbox */  
    ...
    gui_draw_filled_area(
		0, 
		editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT - panel_h, 
		UI_device_width - 1, 
		editor_y - 1,
		&g_wgui_cat2001_inputbox_BG_filler);
    ...
    gdi_draw_line(
		0, 
		editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT - panel_h - 1, 
		UI_device_width - 1, 
		editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT - panel_h - 1,
		WGUI_CAT2001_BORDER_COLOR);
    ...
    mmi_imc_draw_input_mode_infor(
        ...
        editor_y - ((WGUI_CAT2001_INFO_BAR_HEIGHT + WGUI_CAT2001_INPUT_MODE_ICON_MAX_HEIGHT)>>1) - panel_h - 1, 
        UI_device_width - WGUI_CAT2001_COUNTER_MAX_WIDTH,
        editor_y - ((WGUI_CAT2001_INFO_BAR_HEIGHT - WGUI_CAT2001_INPUT_MODE_ICON_MAX_HEIGHT)>>1) - panel_h - 1);

    /* show the logo of info-bar */
    gui_show_image(2, editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT  - panel_h + 1, g_wgui_cat2001_info_bar_icon);
    gdi_pop_and_restore_alpha_blending_source_layer();
    ...
    if (wgui_cat2001_is_show_panel())
    {
        ...
        cat2001_panel->x = 0;
        cat2001_panel->y = editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT - 1;
        for (i = 0; i < g_wgui_cat2001_num_of_element; i++)
        {
            gdi_image_get_dimension(g_wgui_cat2001_element_list[i].off_imageid, &img_w, &img_h);
            cat2001_panel->elements[i].y1 = editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT + ((WGUI_CAT2001_INFO_BAR_HEIGHT - img_h) >> 1) - 1;
        ...
        {
            cat2001_panel->elements[i].x1 = editor_x;
            cat2001_panel->elements[i].y1 = editor_y;
            cat2001_panel->elements[i].x2 = editor_x + editor_width - 1;
            cat2001_panel->elements[i].y2 = editor_y + editor_height - 1;
        }
...
U8 category2001_cache_flag = 0 ;
gdi_image_cache_bmp_struct category2001_img_bmp_cache;
U32 category2001_cache_editor_x = 0;
U32 category2001_cache_editor_y = 0;

static void category2001_free_image_cache(void)
{
	if(category2001_img_bmp_cache.buf_ptr)
	{
		category2001_img_bmp_cache.buf_ptr = NULL;	
		category2001_img_bmp_cache.width = 0;
		category2001_img_bmp_cache.height = 0;
        category2001_cache_editor_x = 0;
		category2001_cache_editor_y = 0;		
	}
	category2001_cache_flag = 0;
}

static void category2001_create_bg_image_cache(S32 x_1,S32 y_1,S32 x_2,S32 y_2)
{
	S32 cache_sz = (x_2 - x_1 + 1) * (y_2- y_1 + 1) * gdi_layer_get_bit_per_pixel() >> 3;
	S32 x1 = x_1;
	S32 y1 = y_1;
	S32 x2 = x_2;
	S32 y2 = y_2;	
    category2001_img_bmp_cache.buf_ptr= (U8*)med_alloc_temp_ext_mem(cache_sz, category2001_free_image_cache);
             
	if( category2001_img_bmp_cache.buf_ptr)
	{
		category2001_img_bmp_cache.width = (x2 - x1) + 1;
		category2001_img_bmp_cache.height = (y2 - y1 + 1);
        category2001_cache_editor_x = x1;
		category2001_cache_editor_y = y1;
		//get cache
		gdi_image_cache_bmp_get(
			...
			x2, 
			y2, 
			&category2001_img_bmp_cache);
	}
}


static void category2001_free_image_cache_buff(void)
{
	if(category2001_img_bmp_cache.buf_ptr)
	{
		med_free_temp_ext_mem((void**)&category2001_img_bmp_cache.buf_ptr);	
		category2001_img_bmp_cache.buf_ptr = NULL;	
		category2001_img_bmp_cache.width = 0;
		category2001_img_bmp_cache.height = 0;
        category2001_cache_editor_x = 0;
...
static void wgui_cat2001_resize_and_draw(S32 virtual_keyboard_h)
{
...
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__    
    editor_y =      MMI_singleline_inputbox.y;    
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    editor_y =      MMI_multiline_inputbox.y;    
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
    ...
    wgui_category_clear_region_with_transparent_color(
        ...
        0, 
        UI_device_width - 1, 
        editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT);
#else
   ...
   //draw idle cache
    ...
    if (wgui_cat2001_is_show_panel())
    {
     ...
     if(!category2001_cache_flag)
     {
         category2001_cache_flag = 1;
#ifdef __MMI_VIRTUAL_KEYBOARD__
			 ...
			 category2001_create_bg_image_cache(
				 0, 
				 0,
				 UI_device_width - 1,
				 UI_device_height - 1);
			 ...
			 category2001_create_bg_image_cache(
				 0, 
				 editor_y - (WGUI_CAT2001_INFO_BAR_HEIGHT + WGUI_CAT2001_INPUT_MODE_ICON_MAX_HEIGHT)*2 - panel_h - 1,
				 UI_device_width - 1,
				 editor_y - ((WGUI_CAT2001_INFO_BAR_HEIGHT + WGUI_CAT2001_INPUT_MODE_ICON_MAX_HEIGHT)>>1) - panel_h - 1);
#endif
     ...
     if(category2001_img_bmp_cache.buf_ptr)
     {
          gdi_image_cache_bmp_draw(category2001_cache_editor_x, 
		  	                       category2001_cache_editor_y, 
		  	            			 &category2001_img_bmp_cache);
    ...
    else
    {
					...
					gui_draw_filled_area(
						...
						editor_y, 
						UI_device_width - 1, 
						editor_y + MMI_SINGLELINE_INPUTBOX_HEIGHT + gap,
					    &g_wgui_cat2001_inputbox_BG_filler);
    ...
    if ((bt_w > 0) && (bt_h > 0))
    {
        gui_move_icontext_button(
            ...
            editor_y + (((MMI_SINGLELINE_INPUTBOX_HEIGHT) - (bt_h)) >> 1));
...
static U8 *wgui_cat2001_get_history(U8 *history_buffer)
{
    ...
    wgui_inputs_ml_get_category_history((U16) MMI_CAT2001_ID, history_buffer);
    sl_s = sizeof(multiline_inputbox_category_history);  
...
void wgui_cat2001_get_inputbox_coordinate(wgui_cat_inputbox_coordinate_struct *inputbox)
{
    ...
    inputbox->x = MMI_multiline_inputbox.x;
    inputbox->y = MMI_multiline_inputbox.y;
    inputbox->width = MMI_multiline_inputbox.width;
    inputbox->height = MMI_multiline_inputbox.height;
...
static void wgui_cat2001_exit(void)
{
	...
	if(category2001_cache_flag)
	{
		category2001_free_image_cache_buff();
	}
#endif/*__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__ */
...
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/        
    {
        ...
        if (wgui_cat2001_is_show_panel())
        {
            ...
            else if (msg_ptr->message_id == MMI_IMC_MESSGAE_GET_EXT_INPUT_BOX_RECT)
            {
			    ...
			    rect->x = 0;
			    rect->y = editor_y - WGUI_CAT2001_INFO_BAR_HEIGHT * 2;
			    rect->width = editor_width;
        ...
        U32 category_flags)
{
    ...
    MMI_multiline_inputbox.highlight_start_position = buffer;
    MMI_multiline_inputbox.highlight_end_position = buffer + buffer_size;
            
    #ifndef __MMI_FTE_SUPPORT__
        MMI_multiline_inputbox.text_x = 1;
        gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox, &g_wgui_cat2001_singleline_inputbox_theme);
    #endif /* __MMI_FTE_SUPPORT__ */ 
...
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__    
    editor_x =      MMI_singleline_inputbox.x;   
    editor_y =      MMI_singleline_inputbox.y;    
    editor_width =  MMI_singleline_inputbox.width; 
    editor_height = MMI_singleline_inputbox.height; 
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    editor_x =      MMI_multiline_inputbox.x;   
    editor_y =      MMI_multiline_inputbox.y;    
    editor_width =  MMI_multiline_inputbox.width; 
    editor_height = MMI_multiline_inputbox.height;
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
        MMI_multiline_inputbox.change_callback = wgui_cat2001_change_callback;
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
