...
#ifdef  __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__

extern MMI_BOOL get_wgui_inputs_sl_disable_left_right_key_flag(void);

extern MMI_BOOL get_wgui_inputs_sl_disable_up_down_key_flagr(void);

#endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
...
#ifndef __MMI_EDITOR_SINGLINE_SUPPORT__    

    UI_buffer_type    wgui_cat_info_ml_text = NULL;
    S32               wgui_cat_info_ml_text_size = 0;
    U32               wgui_cat_info_ml_ext_flags = 0;
    U32               wgui_cat_info_ml_flags     = 0;
    color             wgui_cat_info_ml_normal_text_color ;

    UI_buffer_type    wgui_cat_input_ml_text = NULL;
    S32               wgui_cat_input_ml_text_size = 0;
    U32               wgui_cat_input_ml_ext_flags = 0;
    U32               wgui_cat_input_ml_flags     = 0;
    U32               wgui_cat_input_ml_height    = 0; 
    U32               wgui_cat_input_ml_width     = 0;
    color             wgui_cat_input_ml_normal_text_color ;

    S32               wgui_cat_need_resize_height = 0;
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
/***************************************************************************** 
 * Global Function
 *****************************************************************************/

#ifndef __MMI_EDITOR_SINGLINE_SUPPORT__    
void wgui_inputs_ml_load_category_only_show_data_resize_fit_ml()
{
	wgui_cat_need_resize_height = 1;	
}

void wgui_inputs_ml_save_category_only_show_data()
{
    wgui_cat_info_ml_text = MMI_multiline_inputbox.text;
    wgui_cat_info_ml_text_size = MMI_multiline_inputbox.text_length;
    wgui_cat_info_ml_ext_flags = MMI_multiline_inputbox.flags;
    wgui_cat_info_ml_flags     = MMI_multiline_inputbox.ext_flags;
    wgui_cat_info_ml_normal_text_color = MMI_multiline_inputbox.normal_text_color;
}
void wgui_inputs_ml_load_category_only_show_data()
{
    if(wgui_cat_info_ml_text)
    {
        MMI_multiline_inputbox.text = wgui_cat_info_ml_text;
        MMI_multiline_inputbox.text_length = wgui_cat_info_ml_text_size;
        MMI_multiline_inputbox.flags = wgui_cat_info_ml_ext_flags;
        MMI_multiline_inputbox.ext_flags = wgui_cat_info_ml_flags;
        MMI_multiline_inputbox.normal_text_color = wgui_cat_info_ml_normal_text_color;

        wgui_cat_info_ml_text = 0;
        wgui_cat_info_ml_text_size = 0;
        wgui_cat_info_ml_ext_flags = 0;
        wgui_cat_info_ml_flags     = 0;
        //wgui_cat111_info_ml_normal_text_color = NULL;
    } 
	if(wgui_cat_need_resize_height)
	{
	    S32 fit_width , fit_height ;
		if(wgui_cat_need_resize_height > 1)
		{
			MMI_multiline_inputbox.height = wgui_cat_need_resize_height;
		}
		
		wgui_cat_need_resize_height = 0;
	}
}
void wgui_inputs_ml_save_category_input_data()
{
    wgui_cat_input_ml_text = MMI_multiline_inputbox.text;
    wgui_cat_input_ml_text_size = MMI_multiline_inputbox.text_length;
    wgui_cat_input_ml_ext_flags = MMI_multiline_inputbox.flags;
    wgui_cat_input_ml_flags     = MMI_multiline_inputbox.ext_flags;
    wgui_cat_input_ml_height    = MMI_multiline_inputbox.height;
    wgui_cat_input_ml_width    = MMI_multiline_inputbox.width;
    wgui_cat_input_ml_normal_text_color = MMI_multiline_inputbox.normal_text_color;
}
void wgui_inputs_ml_load_category_input_data()
{
    if(wgui_cat_input_ml_text)
    {
        MMI_multiline_inputbox.text = wgui_cat_input_ml_text;
        MMI_multiline_inputbox.text_length = wgui_cat_input_ml_text_size;
        MMI_multiline_inputbox.flags = wgui_cat_input_ml_ext_flags;
        MMI_multiline_inputbox.ext_flags = wgui_cat_input_ml_flags;
        MMI_multiline_inputbox.normal_text_color = wgui_cat_input_ml_normal_text_color;
        MMI_multiline_inputbox.height = wgui_cat_input_ml_height;
        MMI_multiline_inputbox.width = wgui_cat_input_ml_width;


        wgui_cat_input_ml_text = 0;
        wgui_cat_input_ml_text_size = 0;
        wgui_cat_input_ml_ext_flags = 0;
        wgui_cat_input_ml_flags     = 0;
        wgui_cat_input_ml_height = 0;
        wgui_cat_input_ml_width = 0;
        //wgui_cat111_input_ml_normal_text_color = NULL;
    }
}
...
void  wgui_inputs_ml_enable_read_language(mmi_font_engine_read_lang_enum lang)
{
	gui_inputs_ml_enable_read_language(lang);
}

void  wgui_inputs_ml_disable_read_language()
{
	gui_inputs_ml_disable_read_language();
}
#endif
/*****************************************************************************
 * FUNCTION
...
void wgui_inputs_ml_resize_fit(S32 width, S32 height, S32 *fit_width, S32 *fit_height)
{
    ...
    *fit_height = MMI_multiline_inputbox.text_height + MULTILINE_INPUTBOX_HEIGHT_PAD + MMI_multiline_inputbox.text_y + MMI_multiline_inputbox.margin.down_margin;
	...
	if(wgui_cat_need_resize_height)
	{
		wgui_cat_need_resize_height = *fit_height;
	} 
#endif	
}
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
    if(MMI_multiline_inputbox.ext_flags & GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE)
    {
         multiline_inputbox_input_callback();
    }
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/    
...
void wgui_inputs_ml_next_character(void)
{
    ...
    if (mmi_imc_is_append_one_more_space_input_mode(mmi_imm_get_curr_input_mode())&&
        ...
        !(MMI_multiline_inputbox.ext2_flags & UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE) &&            
...
{
#ifdef __MMI_MULTILINE_IN_INLINE_SCEEN_SLIM__    
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    hilited_item_changed = 0;
    return;
#endif /*__MMI_MULTILINE_IN_INLINE_SCEEN_SLIM__*/    
}
...
void wgui_inputs_ml_register_keys(void)
{
    ...
    SetKeyDownHandler(wgui_inputs_ml_delete_character, KEY_CLEAR);
    SetKeyLongpressHandler(wgui_inputs_ml_delete_all_characters, KEY_CLEAR);
  ...
  //  SetKeyHandler(wgui_inputs_ml_delete_all_characters, KEY_VOL_DOWN, KEY_LONG_PRESS);
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
    if(!((MMI_multiline_inputbox.ext_flags & GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE)
             &&(get_wgui_inputs_sl_disable_left_right_key_flag() == MMI_TRUE)))
#endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
    {
    SetKeyDownHandler(wgui_inputs_ml_previous_character, KEY_LEFT_ARROW);
    SetKeyDownHandler(wgui_inputs_ml_next_character, KEY_RIGHT_ARROW);
    SetKeyRepeatHandler(wgui_inputs_ml_handle_left_arrow_repeat, KEY_LEFT_ARROW);
    SetKeyRepeatHandler(wgui_inputs_ml_handle_right_arrow_repeat, KEY_RIGHT_ARROW);
    SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_LEFT_ARROW);
    SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_RIGHT_ARROW);
    }
#if defined(__MMI_INSCREEN_MULTILINE_TEXTBOX__)
    #ifdef __MMI_MULTILINE_IN_INLINE_SCEEN_SLIM__
    if (MMI_multi_line_inputbox_present)
    {
        SetKeyDownHandler(wgui_inputs_ml_inline_previous_line, KEY_UP_ARROW);
        SetKeyDownHandler(wgui_inputs_ml_inline_previous_line, KEY_VOL_UP);
        SetKeyDownHandler(wgui_inputs_ml_inline_next_line, KEY_DOWN_ARROW);
        SetKeyDownHandler(wgui_inputs_ml_inline_next_line, KEY_VOL_DOWN);

        SetKeyRepeatHandler(wgui_inputs_ml_inline_handle_up_arrow_repeat, KEY_UP_ARROW);
        SetKeyRepeatHandler(wgui_inputs_ml_inline_handle_down_arrow_repeat, KEY_DOWN_ARROW);
        SetKeyRepeatHandler(wgui_inputs_ml_inline_handle_up_arrow_repeat, KEY_VOL_UP);
        SetKeyRepeatHandler(wgui_inputs_ml_inline_handle_down_arrow_repeat, KEY_VOL_DOWN);
        SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_UP_ARROW);
        SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_DOWN_ARROW);
        SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_VOL_UP);
        SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_VOL_DOWN);        
    }
    else
    #endif /*__MMI_MULTILINE_IN_INLINE_SCEEN_SLIM__*/    
#endif /* defined(__MMI_INSCREEN_MULTILINE_TEXTBOX__) */ 
    {
            ...
            if(!((MMI_multiline_inputbox.ext_flags & GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE)
        &&(get_wgui_inputs_sl_disable_up_down_key_flagr() == MMI_TRUE))) 
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
            {
        SetKeyDownHandler(wgui_inputs_ml_previous_line, KEY_UP_ARROW);
        SetKeyDownHandler(wgui_inputs_ml_next_line, KEY_DOWN_ARROW);
        
        SetKeyRepeatHandler(wgui_inputs_ml_handle_up_arrow_repeat, KEY_UP_ARROW);
        SetKeyRepeatHandler(wgui_inputs_ml_handle_down_arrow_repeat, KEY_DOWN_ARROW);
        SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_UP_ARROW);
        SetKeyLongpressHandler(wgui_inputs_fast_del_nav_reset_repeat_count, KEY_DOWN_ARROW);
            }    
    //#if defined(__MMI_INSCREEN_MULTILINE_TEXTBOX__)
...
{   /* multiline inputbox viewer supports only two way navigation  */
    ...
    SetKeyDownHandler(wgui_inputs_ml_previous_line, KEY_UP_ARROW);
    SetKeyDownHandler(wgui_inputs_ml_next_line, KEY_DOWN_ARROW);
    SetKeyDownHandler(wgui_inputs_ml_previous_line, KEY_VOL_UP);
    SetKeyDownHandler(wgui_inputs_ml_next_line, KEY_VOL_DOWN);

    SetKeyRepeatHandler(wgui_inputs_ml_previous_line, KEY_UP_ARROW);
    SetKeyRepeatHandler(wgui_inputs_ml_next_line, KEY_DOWN_ARROW);
    SetKeyRepeatHandler(wgui_inputs_ml_previous_line, KEY_VOL_UP);
    SetKeyRepeatHandler(wgui_inputs_ml_next_line, KEY_VOL_DOWN );

    if (MMI_multiline_inputbox.flags & UI_MULTI_LINE_INPUT_BOX_INSIDE_INLINE_MENU)
    {
        SetKeyLongpressHandler(wgui_inputs_ml_home, KEY_UP_ARROW );
    }
...
void wgui_inputs_ml_register_hilite_keys(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SetKeyDownHandler(wgui_inputs_ml_previous_hilite, KEY_LEFT_ARROW);
    SetKeyDownHandler(wgui_inputs_ml_next_hilite, KEY_RIGHT_ARROW);
...
#endif
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
    wgui_inputs_sl_disable_left_right_key_register(MMI_FALSE);
...
S32 wgui_inputs_ml_get_height(void)
{
	...
	if(wgui_cat_need_resize_height > 1)
	{
		return	wgui_cat_need_resize_height ;
	} 
...
void wgui_inputs_ml_handle_right_softkey_down(void)
{
    ...
    if (gui_multi_line_input_box_get_text_length(&MMI_multiline_inputbox) > 0)
    {
        ...
        wgui_inputs_ml_delete_character();
            ...
            if (cat200_search_function 
                && p != MMI_multiline_inputbox.text)
            {                                   
                refresh_search_list(MMI_multiline_inputbox.text);                
            }
...
void wgui_inputs_ml_handle_right_softkey_long_press(void)
{
    ...
    else
    {
        if (mmi_frm_kbd_is_key_supported(KEY_CLEAR))
        {
            ...
            SetKeyRepeatHandler(wgui_inputs_ml_handle_right_softkey_repeat, KEY_CLEAR);
        }
        else
        {
            g_wgui_inputs_repeat_count = 0;
            set_right_softkey_function(wgui_inputs_ml_handle_right_softkey_touch_repeat, KEY_REPEAT);
            SetKeyRepeatHandler(wgui_inputs_ml_handle_right_softkey_repeat, KEY_RSK);
        }
    }
    ...
    if (gui_multi_line_input_box_get_text_length(&MMI_multiline_inputbox) > 0)
    {
        if (mmi_frm_kbd_is_key_supported(KEY_CLEAR))
        {
            if (wgui_inputbox_RSK_label_clear == 0)
            {
                ...
                SetKeyDownHandler(wgui_inputs_ml_handle_right_softkey_down, KEY_CLEAR);
                SetKeyUpHandler(UI_dummy_function, KEY_CLEAR);
                SetKeyLongpressHandler(wgui_inputs_ml_handle_right_softkey_long_press, KEY_CLEAR);
    ...
    else
    {
        if (mmi_frm_kbd_is_key_supported(KEY_CLEAR))
        {
            if (wgui_inputbox_RSK_label_clear == 1)
            {
                ...
                SetKeyDownHandler(wgui_inputs_ml_handle_right_softkey_down, KEY_CLEAR);
                SetKeyUpHandler(UI_dummy_function, KEY_CLEAR);
                SetKeyLongpressHandler(UI_dummy_function, KEY_CLEAR);
...
void wgui_inputs_ml_show_with_information_bar(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifndef __MMI_EDITOR_SINGLINE_SUPPORT__    
    wgui_inputs_ml_load_category_only_show_data();   
	wgui_inputs_ml_show_no_draw();
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
#if(UI_DOUBLE_BUFFER_SUPPORT)
    gui_lock_double_buffer();
...
#endif
#ifndef __MMI_EDITOR_SINGLINE_SUPPORT__    
    wgui_inputs_ml_load_category_input_data();    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
}
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
#ifdef __MMI_PHB_QUICK_SEARCH__
        else if (cat200_search_function)
        {            
            #if defined(__MMI_TOUCH_SCREEN__)
...
/* under construction !*/
    ...
    case MMI_IMC_MESSAGE_GET_CURSOR_RECT:
        ...
        if ((editor_ptr->ext2_flags & UI_MULTI_LINE_INPUT_BOX_SHOW_BLOCK_CURSOR)
             && (editor_ptr->ext_flags & GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE))
        {
...
#else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/ 
        {
    ...
    case MMI_IMC_MESSAGE_MOVE_CURSOR:
            ...
            &&(mmi_frm_is_key_event()))
        {
            ...
            if ((keycode == KEY_LEFT_ARROW || keycode == KEY_RIGHT_ARROW) && keytype == KEY_EVENT_DOWN && get_wgui_inputs_sl_disable_left_right_key_flag())
                return lresult;
        }
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/  
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
#ifdef __MMI_PHB_QUICK_SEARCH__       
        else  if (((mmi_editor_handler_struct *)input_box_handle)->input_box_sub_type == MMI_EDITOR_QUICK_SEARCH_SINGLE_LINE_INPUT_BOX)
        {
            #ifdef __MMI_UI_LIST_HIGHLIGHT_EFFECTS__
        ...
        else
        {
            ...
            && ((mmi_editor_handler_struct *)input_box_handle)->input_box_sub_type != MMI_EDITOR_LINE_BASED_IN_MULTLINE_INPUT_BOX)
            {
                ...
                else
                {
					...
					if(g_wgui_cat111_show_vk_bg_func)
					{
						g_wgui_cat111_show_vk_bg_func((mmi_imc_rect_p)(msg_ptr->param_0));
					}
    ...
    case MMI_IMC_MESSAGE_MODE_CHANGED:
            ...
            {
                if (gui_multi_line_input_box_get_text_length(editor_ptr) > 0)
                {
                    wgui_inputs_ml_delete_all_characters();
                }
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
#ifdef __MMI_EDITOR_SL_AUTO_CLEAR_HILITE_MODE__
                if (editor_ptr->ext2_flags & UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE)
                {
                     gui_multi_line_input_box_disable_auto_clear_hilite_mode(editor_ptr);
                }
#endif /*__MMI_EDITOR_SL_AUTO_CLEAR_HILITE_MODE__*/
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
...
/* under construction !*/
		...
		if (((mmi_editor_handler_struct *)input_box_handle)->input_box_sub_type == MMI_EDITOR_PAGING_IN_MULTLINE_INPUT_BOX)
		{
			if (gui_page_info.scroll_type == WGUI_PAGING_SCROLL_LINE_BY_LINE)
			{
				SetKeyDownHandler(wgui_inputs_ml_paging_previous_line_in_paging, KEY_UP_ARROW);
				SetKeyDownHandler(wgui_inputs_ml_paging_next_line_in_paging_scroll, KEY_DOWN_ARROW);
				SetKeyDownHandler(wgui_inputs_ml_paging_previous_line_in_paging, KEY_VOL_UP);
				SetKeyDownHandler(wgui_inputs_ml_paging_next_line_in_paging_scroll, KEY_VOL_DOWN);
				
			}
			else
			{
				SetKeyDownHandler(wgui_inputs_ml_paging_previous_page, KEY_UP_ARROW);
				SetKeyDownHandler(wgui_inputs_ml_paging_next_page, KEY_DOWN_ARROW);
				SetKeyDownHandler(wgui_inputs_ml_paging_previous_page, KEY_VOL_UP);
				SetKeyDownHandler(wgui_inputs_ml_paging_next_page, KEY_VOL_DOWN);
			}
		}
        ...
        if (((mmi_editor_handler_struct *)input_box_handle)->input_box_sub_type == MMI_EDITOR_LINE_BASED_IN_MULTLINE_INPUT_BOX ||
            ((mmi_editor_handler_struct *)input_box_handle)->input_box_sub_type == MMI_EDITOR_INPUT_BOX_EBOOK)
        {
            SetKeyDownHandler(wgui_inputs_ml_linebase_previous_page, KEY_UP_ARROW);
            SetKeyDownHandler(wgui_inputs_ml_linebase_next_page, KEY_DOWN_ARROW);
            SetKeyDownHandler(wgui_inputs_ml_linebase_previous_page, KEY_VOL_UP);
            SetKeyDownHandler(wgui_inputs_ml_linebase_next_page, KEY_VOL_DOWN);
            SetKeyDownHandler(wgui_inputs_ml_linebase_previous_line, KEY_LEFT_ARROW);
            SetKeyDownHandler(wgui_inputs_ml_linebase_next_line, KEY_RIGHT_ARROW);

            SetKeyRepeatHandler(wgui_inputs_ml_linebase_previous_page, KEY_UP_ARROW);
            SetKeyRepeatHandler(wgui_inputs_ml_linebase_next_page, KEY_DOWN_ARROW);
            SetKeyRepeatHandler(wgui_inputs_ml_linebase_previous_page, KEY_VOL_UP);
            SetKeyRepeatHandler(wgui_inputs_ml_linebase_next_page, KEY_VOL_DOWN);
            SetKeyRepeatHandler(wgui_inputs_ml_linebase_previous_line, KEY_LEFT_ARROW);
            SetKeyRepeatHandler(wgui_inputs_ml_linebase_next_line, KEY_RIGHT_ARROW);
        }
#endif
#if defined(__MMI_CAT203_SUPPORT__)
        if ((((mmi_editor_handler_struct *)input_box_handle)->input_box_sub_type) == MMI_EDITOR_DIALER_SEARCH_MULTI_LINE_INPUT_BOX)
