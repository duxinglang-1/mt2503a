...
static S32 gui_vertical_scrollbar_get_button_height(vertical_scrollbar *v)
{
    ...
    else
    {
        ...
        #if defined (__MMI_MAINLCD_128X160__)
            button_height = v->width + 2;
		#elif defined (__MMI_MAINLCD_240X320__) //add by xl
			button_height = 0;
        #else
            button_height = v->width - GUI_SCROLLBAR_STYLE4_TOUCH_GAP_STYLE4 * 2 + 3;
        #endif
    ...
    #elif defined(UI_SCROLLBAR_STYLE_7) || defined(UI_SCROLLBAR_STYLE_9) //|| defined(UI_SCROLLBAR_STYLE_8)
        button_height = 0;
    #endif 
    }
...
void gui_create_vertical_scrollbar(vertical_scrollbar *v, S32 x, S32 y, S32 width, S32 height)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_create_vertical_scrollbar_ex(v, x, y, width, height, GUI_SCROLLBAR_STYLE_DEFAULT, GDI_NULL_HANDLE, GDI_NULL_HANDLE, GDI_NULL_HANDLE);
}
