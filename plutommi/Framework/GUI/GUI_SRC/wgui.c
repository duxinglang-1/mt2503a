...
void register_MMI_key_input_extend_handler(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SetKeyDownHandler(MMI_key_star_down, KEY_STAR);
    SetKeyUpHandler(MMI_key_star_up, KEY_STAR);

    SetKeyDownHandler(MMI_key_pound_down, KEY_POUND);
    SetKeyUpHandler(MMI_key_pound_up, KEY_POUND);
}
...
void register_MMI_key_input_handler(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SetKeyDownHandler(MMI_key_0_down, KEY_0);
    SetKeyDownHandler(MMI_key_1_down, KEY_1);
    SetKeyDownHandler(MMI_key_2_down, KEY_2);
    SetKeyDownHandler(MMI_key_3_down, KEY_3);
    SetKeyDownHandler(MMI_key_4_down, KEY_4);
    SetKeyDownHandler(MMI_key_5_down, KEY_5);
    SetKeyDownHandler(MMI_key_6_down, KEY_6);
    SetKeyDownHandler(MMI_key_7_down, KEY_7);
    SetKeyDownHandler(MMI_key_8_down, KEY_8);
    SetKeyDownHandler(MMI_key_9_down, KEY_9);

    SetKeyRepeatHandler(MMI_key_0_down, KEY_0);
    SetKeyRepeatHandler(MMI_key_1_down, KEY_1);
    SetKeyRepeatHandler(MMI_key_2_down, KEY_2);
    SetKeyRepeatHandler(MMI_key_3_down, KEY_3);
    SetKeyRepeatHandler(MMI_key_4_down, KEY_4);
    SetKeyRepeatHandler(MMI_key_5_down, KEY_5);
    SetKeyRepeatHandler(MMI_key_6_down, KEY_6);
    SetKeyRepeatHandler(MMI_key_7_down, KEY_7);
    SetKeyRepeatHandler(MMI_key_8_down, KEY_8);
    SetKeyRepeatHandler(MMI_key_9_down, KEY_9);

    SetKeyUpHandler(MMI_key_0_up, KEY_0);
    SetKeyUpHandler(MMI_key_1_up, KEY_1);
    SetKeyUpHandler(MMI_key_2_up, KEY_2);
    SetKeyUpHandler(MMI_key_3_up, KEY_3);
    SetKeyUpHandler(MMI_key_4_up, KEY_4);
    SetKeyUpHandler(MMI_key_5_up, KEY_5);
    SetKeyUpHandler(MMI_key_6_up, KEY_6);
    SetKeyUpHandler(MMI_key_7_up, KEY_7);
    SetKeyUpHandler(MMI_key_8_up, KEY_8);
    SetKeyUpHandler(MMI_key_9_up, KEY_9);
}
