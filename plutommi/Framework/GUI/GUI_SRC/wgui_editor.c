 ...
 * 03 21 2013 ye.tian
 * removed!
 * - update to get right theme data in cosmos  when __NFB_THIRD_ROM_SUPPORT__ on,in wgui_editor_show(wgui_editor_struct *b).
 *
 * 03 06 2013 ye.tian
 * removed!
 * update to get right theme data in cosmos  when __NFB_THIRD_ROM_SUPPORT__ on.
 *
 * 03 04 2013 ye.tian
 * removed!
 * update to get right theme data in cosmos  when __NFB_THIRD_ROM_SUPPORT__ on.
...
#endif
#if defined(__COSMOS_MMI_PACKAGE__) && defined(__NFB_THIRD_ROM_SUPPORT__)
                        ...
                        GDI_HANDLE layer_handle)
{
    ...
    b->RSK_label_clear = 0;
            ...
            {
                mmi_res_venus_theme_cache_refresh_require(VCP_IMG_TEXT_VIEW_HIGHLIGHT_BG);
                mmi_res_venus_theme_cache_refresh_require(VCP_IMG_TEXT_VIEW_NORMAL_BG);
