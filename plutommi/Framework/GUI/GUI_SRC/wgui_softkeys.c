 ...
 * 12 19 2013 hujin.hu
 * removed!
 * lu.xiao newly added for bt dialer.
 *
 * 12 13 2013 hujin.hu
 * removed!
 * .
...
#if !defined(__MMI_MAINLCD_96X64__) && (defined(__MMI_BASIC_UI_STYLE__)) || defined(__MMI_FTE_SUPPORT__)
...
static void ChangeSoftkeyByString(
	UI_string_type s, 
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__	
	PU8 i, 
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/	
	WGUI_SOFTKEY_ENUM key);
static void ChangeSoftkeyByStringLength(
	UI_string_type s, 
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__	
	PU8 i, 
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/	
...
#endif/*#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
	...
	WGUI_SOFTKEY_ENUM key)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	set_softkey_label(get_string(s), key);
/*
	if (s != STRING_ID_NULL)
    {
...
void show_softkey(WGUI_SOFTKEY_ENUM key)
{
    ...
    if ((MMI_softkeys[key].text == NULL)
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__		
		&& (MMI_softkeys[key].normal_up_icon == NULL)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/		
		)
    {
        return;
...
//	return;
	...
	//lu.xiao newly added for BT box
#ifdef __MMI_BTD_BOX_UI_STYLE__
	if(key == MMI_RIGHT_SOFTKEY &&(mmi_ucm_query_call_count_by_call_state_bt(SRV_UCM_BT_CALL_STATE_ALL, NULL) == 0))
		SetKeyHandler(mmi_idle_display, KEY_RSK, KEY_LONG_PRESS);
#endif/*#ifdef __MMI_BTD_BOX_UI_STYLE__*/	
	//end lu.xiao newly added
 ...
 *  void
 *****************************************************************************/
void ChangeSoftkeyByStringLength(
	UI_string_type s, 
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__	
	PU8 i, 
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/	
 ...
 *  void
 *****************************************************************************/
void set_left_softkey_function(void (*f) (void), MMI_key_event_type k)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	set_softkey_function(f, k, MMI_LEFT_SOFTKEY);
}
...
void set_right_softkey_function(void (*f) (void), MMI_key_event_type k)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	set_softkey_function(f, k, MMI_RIGHT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
 ...
 *****************************************************************************/
FuncPtr get_left_softkey_function(MMI_key_event_type k) 
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	return get_softkey_function(k, MMI_LEFT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
FuncPtr get_right_softkey_function(MMI_key_event_type k)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	return get_softkey_function(k, MMI_RIGHT_SOFTKEY);
}
...
void execute_left_softkey_function(MMI_key_event_type k)         
{
	...
	execute_softkey_function(k,MMI_LEFT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
 ...
 *  void
 *****************************************************************************/
void execute_right_softkey_function(MMI_key_event_type k)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	execute_softkey_function(k, MMI_RIGHT_SOFTKEY);
}
 ...
 *  void
 *****************************************************************************/
void redraw_center_softkey(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *****************************************************************************/
UI_string_type get_left_softkey_label(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	return get_softkey_label(MMI_LEFT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
 ...
 *****************************************************************************/
UI_string_type get_right_softkey_label(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	return get_softkey_label(MMI_RIGHT_SOFTKEY);
}
...
PU8 get_center_softkey_icon(void)
{
	...
	return get_softkey_icon(MMI_CENTER_SOFTKEY);
}
#endif/*#ifndef __MMI_WGUI_DISABLE_CSK__*/
...
)
{
	...
	change_softkey(s, icon, MMI_LEFT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
	...
	)
{
	...
	change_softkey(s, icon, MMI_RIGHT_SOFTKEY);
}
...
void clear_left_softkey(void)
{
	...
	clear_softkey_display_functions(MMI_LEFT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
void clear_right_softkey(void)
{
	...
	clear_softkey_display_functions(MMI_RIGHT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
 ...
 *  void
 *****************************************************************************/
void register_hide_left_softkey(void (*f) (void))
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	register_hide_softkey(f, MMI_LEFT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
 ...
 *  void
 *****************************************************************************/
void register_hide_right_softkey(void (*f) (void))
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	register_hide_softkey(f, MMI_RIGHT_SOFTKEY);
}
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
void register_left_softkey_handler(void)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void register_right_softkey_handler(void)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	register_softkey_handler(MMI_RIGHT_SOFTKEY);
}
 ...
 *  void
 *****************************************************************************/
void clear_left_softkey_handler(void)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void clear_right_softkey_handler(void)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 * DESCRIPTION
 *  clear all softkey display function.
 * PARAMETERS
 *  void
 * RETURNS
 *  void
 *****************************************************************************/
void clear_all_softkey_display_functions(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void register_all_softkey_handlers(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void clear_softkey_handlers(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
