...
MMI_BOOL g_wgui_cat199_has_default_hilight_item = MMI_TRUE;
MMI_BOOL g_wgui_cat199_refresh_when_input_complete = MMI_FALSE;
#endif
...
#if defined(__MMI_BT_PBAP_CLIENT__) && defined(__MMI_PHB_QUICK_SEARCH__)
S32(*g_phb_pbapc_search_function) (U8 *) = NULL;
#endif
...
UI_multi_line_input_box_theme cat200_singleline_inputbox_theme = { 
    &cat200_inputbox_BG_filler,
    &cat200_inputbox_BG_filler,
    &cat200_inputbox_BG_filler,
...
void refresh_search_list(U8 *name)
{
    ...
    no_entries = cat200_search_function(name);
        #if defined(__MMI_BT_PBAP_CLIENT__)
    if(!cat200_search_function || no_entries == -1) return;//for 199exit
        #endif
         ...
         || ((g_dm_data.s32CatId == MMI_CATEGORY200_ID) && (g_wgui_cat200_set_specific_highlight == MMI_TRUE)) )
    {
        ...
        #if defined(__MMI_BT_PBAP_CLIENT__)
            if (g_wgui_cat199_has_default_hilight_item == MMI_FALSE)
            {
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    wgui_inputs_sl_move(MMI_multiline_inputbox.x, sl_y);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
}
...
#if defined(__MMI_BT_PBAP_CLIENT__)
    color ccblack_BT = {255, 255, 255, 100};
#endif
...
//         else
        {            
            ...
            input_box_y = MMI_singleline_inputbox.y;
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
            input_box_y = MMI_multiline_inputbox.y;
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */  
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
            gui_fill_rectangle(CAT200_MARGIN_WIDTH + 1, input_box_y, UI_device_width - CAT200_MARGIN_WIDTH - 1 - 1, input_box_y + CAT200_INPUTBOX_H - 1, MMI_multiline_inputbox.normal_filler->c);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */         
        #endif /* __MMI_FTE_SUPPORT__ */
        }
...
#if defined(__MMI_BT_PBAP_CLIENT__)
    g_wgui_cat199_has_default_hilight_item = MMI_TRUE;
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
                no_entries = cat200_search_function((U8*) MMI_multiline_inputbox.text);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
                load_dynamic_item_buffer(no_entries);
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox, &cat200_singleline_inputbox_theme);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
UI_multi_line_input_box_theme g_cat199_singleline_inputbox_theme = { 
    &g_cat199_inputbox_BG_filler,
    &g_cat199_inputbox_BG_filler,
    &g_cat199_inputbox_BG_filler,
    {0, 0, 0, 100},  /* special_text_color */
...
static void wgui_cat199_draw_input_method(void)
{
    ...
    U32 ime_w = 0;
    S32 editor_x = 0,editor_y = 0,editor_height = 0, editor_width = 0 ; 
    UI_filled_area * editor_normal_filler = NULL;
#endif /* __MMI_FTE_SUPPORT__ */  
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/    
    ...
    editor_normal_filler = MMI_singleline_inputbox.normal_filler;
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__*/
    ...
    editor_normal_filler = MMI_multiline_inputbox.normal_filler;
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
    gdi_layer_lock_frame_buffer();
	gdi_layer_push_clip();
...
//     else
    ...
    /* draw IME background */ 
    gui_fill_rectangle(x1, y1, x2, y2, /*gui_color(255,0,0));*/ editor_normal_filler->c);

    mmi_imc_draw_input_mode_hint(x1, y1, x2, y2);

    if (editor_width != sl_w || editor_x != x1)
    {
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    wgui_inputs_ml_move(MMI_multiline_inputbox.x, inputbox_y);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
...
#else
    input_box_y = MMI_TITLE_Y + tab_h + scrolltext_h + MMI_fixed_list_menu.height + 1;                  
#endif /*__MMI_TAB_BARS_SUPPORT__*/
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
        wgui_inputs_sl_resize(input_box_w, MMI_multiline_inputbox.height);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
        gui_fill_rectangle(CAT200_MARGIN_WIDTH + 1, input_box_y, input_box_x, input_box_y + CAT200_INPUTBOX_H - 1, MMI_multiline_inputbox.normal_filler->c);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    ...
    if (g_wgui_cat199_search_button_function)
    {
        ...
        if ((bt_w > 0) && (bt_h > 0))
        {
            ...
            gui_move_icontext_button(
                search_bt, 
                UI_device_width - WGUI_CAT199_SEARCH_BUTTON_GAP_L - WGUI_CAT199_SEARCH_BUTTON_GAP_R- bt_w,
                MMI_multiline_inputbox.y + (((MMI_SINGLELINE_INPUTBOX_HEIGHT) - (bt_h)) >> 1));
...
#else
    list_height = UI_device_height - MMI_TITLE_Y - tab_h - scrolltext_h - CAT199_INPUTBOX_H - MMI_BUTTON_BAR_HEIGHT;
#endif /*__MMI_TAB_BARS_SUPPORT__*/
#if !defined(__MMI_MAINLCD_128X128__)
...
#else
    move_fixed_list(0, MMI_TITLE_Y + tab_h + scrolltext_h);                 
#endif /*__MMI_TAB_BARS_SUPPORT__*/
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox, &g_cat199_singleline_inputbox_theme);
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */  
        ...
        U8 *history_buffer)
{
    ...
    if (wgui_icon_bar_is_created())
    {
        ...
        #else
        list_height = UI_device_height - MMI_TITLE_Y - tab_h - scrolltext_h - CAT199_INPUTBOX_H - MMI_BUTTON_BAR_HEIGHT - MMI_ICON_BAR_HEIGHT;
        #endif /*__MMI_TAB_BARS_SUPPORT__*/
    }
    else
#endif /* __MMI_FTE_SUPPORT__ */
...
void wgui_cat201_register_key_handler(void)
{
    ...
    if (MMI_fixed_list_menu.highlighted_item != 0 || MMI_fixed_list_menu.n_items == 0)
    {
        ...
        SetKeyDownHandler(dynamic_list_goto_previous_item, KEY_VOL_UP);
    }
    else
    {
        /* input method will register key event, disable here */
        SetKeyDownHandler(UI_dummy_function, KEY_UP_ARROW);
        SetKeyDownHandler(UI_dummy_function, KEY_VOL_UP);
    }
    SetKeyDownHandler(dynamic_list_goto_next_item, KEY_DOWN_ARROW);
    SetKeyDownHandler(dynamic_list_goto_next_item, KEY_VOL_DOWN);
}
