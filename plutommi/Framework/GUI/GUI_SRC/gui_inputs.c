...
{
#if defined(__MMI_SLIM_IMG_RES__) && defined(__MMI_MAINLCD_240X320__) && !defined(__MMI_FTE_SUPPORT__) && defined(__DUALMODE_TOUCH_DIAL_SCREEN_WITH_SLAVE_FUNCTION__)
    IMG_DIALING_P,
    IMG_DIALING_P,
    IMG_DIALING_P,
    IMG_DIALING_P,
...
#endif /*#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__*/
        ...
        S32 clip_y2)
{
	...
	if(b->ext_flags & GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE)
	{
		if(b->normal_filler->flags & UI_FILLED_AREA_DOUBLE_BORDER)
		{   
			height = height - 2;	
		}
		else if(b->normal_filler->flags & UI_FILLED_AREA_SINGLE_BORDER)
		{
			height = height - 1;	
		}		
	}								
...
#endif /*__MMI_EDITOR_MULTILINE_SUPPORT_RICH_TEXT__ 00 */
...
#endif
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
   // in singline style not need show scrollbar
   if (b->ext_flags & GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE)
   {
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__    
    saved_text_offset_x = b->text_offset_x;    
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
#endif
    do
    {
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__        
        text_offset_x = b->text_offset_x;        
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
        ...
        move_to_y = -1;
          ...
          ||((!(b->flags&UI_MULTI_LINE_INPUT_BOX_DISABLE_DRAW)) 
              &&(text_offset_x != b->text_offset_x)
              &&(b->ext_flags&GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE))       
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__    
            b->text_offset_x = saved_text_offset_x;    
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
            do
            {
                text_offset_y = b->text_offset_y;
...
#if defined(__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__) && defined(__MMI_EDITOR_SL_AUTO_CLEAR_HILITE_MODE__)
void gui_multi_line_input_box_disable_auto_clear_hilite_mode(multi_line_input_box *b)
{
    b->ext2_flags &= ~UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE;
...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
#ifdef __MMI_EDITOR_SL_AUTO_CLEAR_HILITE_MODE__    
    if (b->ext2_flags & UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE)
    {
        gui_multi_line_input_box_disable_auto_clear_hilite_mode(b);
        gui_multi_line_input_box_delete_all(b);
        return;
    }
#endif /*__MMI_EDITOR_SL_AUTO_CLEAR_HILITE_MODE__*/
#endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
...
MMI_BOOL gui_multi_line_input_box_insert_character_internal(multi_line_input_box *b, UI_character_type c)
{
    ...
    if (b->ext2_flags & UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE)
    {
        if (b->ext_flags & GUI_MULTI_LINE_INPUT_BOX_INPUT_METHOD_MODE)
        {
            gui_multi_line_input_box_stop_input(b);
        }
        gui_multi_line_input_box_delete_all(b);
        if (b->ext_flags & GUI_MULTI_LINE_INPUT_BOX_INPUT_METHOD_MODE)
        {
            gui_multi_line_input_box_start_input(b);
        }
        gui_multi_line_input_box_disable_auto_clear_hilite_mode(b);
    }
#endif /*__MMI_EDITOR_SL_AUTO_CLEAR_HILITE_MODE__*/
...
void gui_show_dialing_key(gui_dialing_key key, BOOL enableFlag)
{
    ...
    for (i = 0; i < MMI_DIALING_KEYPAD_FUNC_ROWS; i++)
    {
        ...
        y1 = MMI_DIALING_KEYPAD_LAYER_Y + MMI_DIALING_KEYPAD_FUNC_Y + (func_key_height + MMI_DIALING_FUNC_KEY_VERTICAL_GAP)*i;
        #else
        ...
        for (j = 0; j < MMI_DIALING_KEYPAD_FUNC_COLOMNS; j++)
        {
            ...
            {
                #if defined(__MMI_IMAGE_CACHE_FOR_ONE_GDI_LAYER__)
                x1 = MMI_DIALING_KEYPAD_LAYER_X + MMI_DIALING_KEYPAD_FUNC_X;
                #else
...
#if (defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_360X640__) || defined(__MMI_MAINLCD_480X800__) || defined(__MMI_FTE_SUPPORT__)) && defined(__MMI_TOUCH_SCREEN__)
/*****************************************************************************
 * FUNCTION
        ...
        gui_pen_event_param_struct *dialing_key_param)
{
    ...
    *menu_event = GUI_DIALING_PEN_NONE;
    ...
    /* 053005 Calvin */
#if defined (__MMI_MAINLCD_240X320__) && defined (__MMI_TOUCH_SCREEN__)
...
#endif
/* under construction !*/
#endif /*#ifdef __MMI_EDITOR_DIALER_SUPPORT__ */
/* under construction !*/
#endif
