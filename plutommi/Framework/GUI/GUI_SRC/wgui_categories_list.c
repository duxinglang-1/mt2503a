...
static void wgui_cat_add_title_and_softkey(
	U8* title, 
	U8* title_icon, 
	U8* left_softkey, 
	U8* right_softkey);
...
//
static MMI_BOOL gui_is_string_empty(UI_string_type text);
static MMI_BOOL wgui_is_all_menuitem_hint_empty(S32 n_items);
static void wgui_reset_list_catgory_context(void);
static void wgui_close_cat_tab_bar(void);
...
void ExitListCategoryScreen(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	wgui_reset_list_catgory_context();
#if 0	
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
#if 0//def __MMI_UI_HINTS_IN_MENUITEM__
/* under construction !*/
#if 0//def __MMI_UI_LIST_HIGHLIGHT_EFFECTS__
/* under construction !*/
...
*****************************************************************************/
static void DrawCate628CategoryControlAreaBackground(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2);
 ...
 *  void
 *****************************************************************************/
static void wgui_cat_load_string(
	S32 number_of_items, 
	U16 *list_of_items)
{
    /*----------------------------------------------------------------*/
...
#define ExitCategoryCommonScreen ExitListCategoryScreen
#endif /* __ATV_SMS_SUPPORT__ */
...
#define wgui_cat_configure_slim_hint() set_force_all_hints_in_menuitem()
#else/*__WGUI_CATE_LIST_ALL_HINTS_IN_MENUITEM__*/
#define wgui_cat_configure_slim_hint()
 ...
 *****************************************************************************/
#if defined(__WGUI_CATE_LIST_ALL_HINTS_IN_MENUITEM__)
static void wgui_cat_set_default_empty_descriptions(
	S32 number_of_items)
{
...
/* under construction !*/
#endif//0
	hints = wgui_is_all_menuitem_hint_empty(number_of_items);	
    ...
    for (i = 0; i < number_of_items; i++)
    {
        if (KAL_FALSE == hints)
        {
           // text = wgui_pop_up_description_strings[i].text_strings[0];
            if (gui_is_string_empty(wgui_pop_up_description_strings[i].text_strings[0]))//((text == NULL) || (*((U8*)(text)) == 0 && *((U8*)(text) + 1) == 0))
            {
...
#else/*__WGUI_CATE_LIST_ALL_HINTS_IN_MENUITEM__*/
#define wgui_cat_set_default_empty_descriptions(_arg)
#endif /* __WGUI_CATE_LIST_ALL_HINTS_IN_MENUITEM__ */
 ...
 *  void
 *****************************************************************************/
static void wgui_cat_set_hint_in_menuitem(
	U8 **list_of_descriptions, 
	S32 number_of_items)
{
    /*----------------------------------------------------------------*/
...
/* under construction !*/
#endif//		
        if (!wgui_is_all_menuitem_hint_empty(number_of_items))//(hints)
        {
 ...
 *  void
 *****************************************************************************/
void wgui_cat_register_get_flags_callback(
	wgui_cat_get_list_menu_flags_funcptr_type get_flags_callback)
{
...
MMI_BOOL wgui_cat_is_user_empty_string(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	return (MMI_list_empty_string != NULL);
#if 0	
/* under construction !*/
/* under construction !*/
/* under construction !*/
 ...
 *****************************************************************************/
static MMI_BOOL wgui_set_twostate_radio_list_history(
	U16 history_ID, 
	U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void get_twostate_radio_list_history(
	U16 history_ID, 
	U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
...
U8 *wgui_get_twostate_radio_list_history(U8 *history_buffer)
{
    ...
    get_twostate_radio_list_history(
		two_state_radio_list_history_id, 
		history_buffer);
 ...
 *  void
 *****************************************************************************/
static void wgui_cat85_add_button(
	U16 up_id, 
	U16 down_id, 
	FuncPtr func_handler)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void wgui_cat85_post_display_menuitem(
	void *item, 
	...
	S32 y)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	item_index = wgui_get_current_menuitem_index(&MMI_fixed_list_menu);
#if 0	
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    gui_measure_image(
		...
		&left_icon_h);
    gui_measure_image(
		get_image(right_icon_2), 
		&right_icon_2_w, 
		&right_icon_2_h);
    gui_measure_image(
		get_image(right_icon_1), 
		&right_icon_1_w, 
		&right_icon_1_h);
    ...
    set_fixed_icontext_list_text_coordinates(
		0, 
		CAT85_MENUITEM_OFFSET*2 + left_icon_w, 
		CAT85_TEXT_Y, 
		text_width, 
		text_0_h);
    set_fixed_icontext_list_text_coordinates(
		1, 
		CAT85_MENUITEM_OFFSET*2 + left_icon_w, 
		CAT85_TEXT_Y+text_0_h, 
		text_width, 
		MMI_fixed_icontext_list_menuitem.height-text_0_h);
    set_fixed_icontext_list_icon_coordinates(
		0, 
		CAT85_MENUITEM_OFFSET*3 + left_icon_w + text_width, 
		CAT85_RIGHT_ICON_Y, right_icon_1_w, 
		right_icon_1_h);
    set_fixed_icontext_list_icon_coordinates(
		1, 
    ...
    set_fixed_icontext_list_icon_coordinates(
		2, 
		CAT85_MENUITEM_OFFSET*3 + left_icon_w + text_width + right_icon_1_w, 
		CAT85_RIGHT_ICON_Y, 
		right_icon_2_w, 
		right_icon_2_h);
 ...
 *  void
 *****************************************************************************/
void DrawCate384CategoryControlAreaBackground(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
        ...
        U8 *history_buffer)
{
   ...
   // U8 h_flag = 0;    
    ...
    if (!set_list_menu_category_history(
				MMI_CATEGORY384_ID, 
				history_buffer))
    {
    ...
    set_fixed_icontext_positions(
		GUI_ICONTEXT_MENUITEM_TEXT_X + MMI_ICONTEXT_MENUITEM_HEIGHT, 
		0, 
		GUI_ICONTEXT_MENUITEM_ICON_X + MMI_ICONTEXT_MENUITEM_HEIGHT, 
		0);
...
#ifdef __MMI_MAINLCD_128X128__
            UI_COLOR_BLACK,//gui_color(0, 0, 0),
            UI_COLOR_WHITE//gui_color(255, 255, 255)
#else /* __MMI_MAINLCD_128X128__ */
    ...
    wgui_dynamic_list_move_icontext_menu(
		MMI_content_x, 
		MMI_content_y);
    wgui_dynamic_list_resize_icontext_menu(
		MMI_content_width, 
		MMI_content_height - scroll_height);
 ...
 *  void
 *****************************************************************************/
static void wgui_matv_draw_background(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2, 
 ...
 *  void
 *****************************************************************************/
static void wgui_matv_scrolling_background(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
...
static void wgui_matv_create_preview_time(matv_rect *pos)
{
    ...
    if (MMI_fixed_list_menu.n_items > 0)
    {
        gui_util_painter_create_callback(
			&bg_painter, 
			wgui_matv_draw_time_background);
    }
	else
        ...
        U8 *history_buffer)
{
   ...
   // U8 h_flag;
    ...
    set_fixed_icontext_list_text_coordinates(
		0, 
		CAT265_TEXT_0_X+CAT265_TEXT_0_OFFSET, 
		row_start_y, 
		CAT265_TEXT_0_WIDTH-(CAT265_TEXT_0_OFFSET*2), 
		get_menu_item_height());
    set_fixed_icontext_list_icon_coordinates(
		0, 
		CAT265_ICON_X+CAT265_ICON_OFFSET, 
		row_start_y, 
		CAT265_ICON_WIDTH-(CAT265_ICON_OFFSET*2), 
		get_menu_item_height());
    ...
    set_fixed_icontext_list_text_coordinates(
		1, 
		CAT265_TEXT_1_X+CAT265_TEXT_1_OFFSET, 
		row_start_y, 
		text_width, 
		get_menu_item_height());
    ...
    if (double_line_list_flag)//MMI_TRUE == 
    {
        ...
        set_fixed_icontext_list_text_coordinates(
			2, 
			CAT265_TEXT_2_X+CAT265_TEXT_2_OFFSET, 
			Get_CharHeightOfAllLang(MEDIUM_FONT) + 7 /* line gap */ , 
			text_width, 
			Get_CharHeightOfAllLang(MEDIUM_FONT));
    ...
    else
    {
        ...
        wgui_async_list_resize_multi_icontext_menu(
			MMI_CONTENT_WIDTH, 
			CAT265_LIST_HEIGHT + CAT265_CONTROL_AREA_HEIGHT);
    }
 ...
 *  void
 *****************************************************************************/
void wgui_cat265_refresh_list(
	S32 number_of_items, 
	S32 highlighted_item, 
	MMI_BOOL redraw_flag)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/* under construction !*/
    ...
    wgui_async_list_move_multi_icontext_menu(
		MMI_content_x, 
		MMI_content_y);
    wgui_async_list_resize_multi_icontext_menu(
		MMI_content_width, 
 ...
 *  void
 *****************************************************************************/
void wgui_cattab_get_space_and_tab_width(
	S16 *space, 
	S16 *tab_w, 
	S8 n_tabs)
{
...
//	wgui_create_horizontal_tab_bar_with_style(FALSE, (UI_string_type)title, n_tabs, highlighted_tab, MMI_FALSE, GUI_TAB_BAR_STYLE_AUTO_RESIZE_ITEM_WIDTH | GUI_TAB_BAR_STYLE_SHOW_ONLY_TEXT_IN_TAB_ITEM);
   ...
   // h_flag = set_list_menu_category_history(MMI_CAT1008_ID, history_buffer);
    if (!set_list_menu_category_history(MMI_CAT1008_ID, history_buffer))
    {
        MMI_fixed_list_menu.highlighted_item = highlighted_item;
    }
    ...
    *category_error_flag = 0;
    ...
    if(number_of_items > 0)
    {
        wgui_matv_redraw_preview_area(
			CAT1008_PREVIEW_X, 
			CAT1008_PREVIEW_Y, 
			CAT1008_PREVIEW_WIDTH, 
			CAT1008_PREVIEW_HEIGHT);
    }
}
...
static S32 wgui_cat1009_create_infomsg(UI_string_type string)
{
	...
	//huking
    MMI_multiline_inputbox.normal_text_color = current_menuitem_theme->normal_text_color;
...
/* under construction !*/
    ...
    set_fixed_icontext_list_icon_coordinates(
		...
		i_start_y + 0, 
		/*CAT1008_ICON_WIDTH*/icon_width,
		line_h);
    set_fixed_icontext_list_icon_coordinates(
		1, 
		GUI_ICONTEXT_MENUITEM_ICON_X, 
		i_start_y + line_h, /*CAT1008_ICON_WIDTH*/
		icon_width, 
		line_h);
    if (flag == 0)
    {
        set_fixed_icontext_list_icon_coordinates(
			2, 
			GUI_ICONTEXT_MENUITEM_ICON_X, 
			menuitem_h - line_h - 1, /*CAT1008_ICON_WIDTH*/
			icon_width, 
			line_h);
    }
...
//    MMI_fixed_icontext_list_menuitem.focussed_without_sc_filler = current_MMI_theme->menuitem_two_line_highlight_filler;//menuitem_two_line_highlight_without_scroll_filler
    ...
    if(n_tabs > 0)
    {
        ...
        wgui_async_list_move_multi_icontext_menu(
			0, 
			MMI_TITLE_Y + MMI_TITLE_HEIGHT + MMI_HORIZONTAL_TAB_BAR_TAB_AREA_HEIGHT + control_area_h);
        wgui_async_list_resize_multi_icontext_menu(
			MAIN_LCD_DEVICE_WIDTH, 
			MMI_CONTENT_HEIGHT - MMI_HORIZONTAL_TAB_BAR_TAB_AREA_HEIGHT - control_area_h);
    }
    else
#endif/*__MMI_TAB_BARS_SUPPORT__*/		
    {
 ...
 *****************************************************************************/
MMI_BOOL wgui_cat1023_set_history_buffer(
	S32 size, 
	void *buffer)
{
    /*----------------------------------------------------------------*/
 ...
 *****************************************************************************/
static S32 wgui_cat1023_get_item_func_ptr(
	S32 start_index, 
 ...
 *  MMI_BOOL        return MMI_TRUE if construct success, else return MMI_FALSE
 *****************************************************************************/
static S32 wgui_cat1023_get_hint_func_ptr(
	S32 start_index, 
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1023_get_date_area_x_and_width(
	S32 *x, 
	S32 *width)
{
    /*----------------------------------------------------------------*/
...
static void wgui_cat1023_control_area_callback(dm_coordinates *coordinate)
{
	...
	gui_set_font(&MMI_small_font);
    gui_measure_string(
		(UI_string_type)cat1023_date_text[g_cat1023_cntx.h_date], 
		&tw, 
		&th);
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1023_map_curr_tab_bar(
	S8 *f_tab, 
	S8 *h_tab)
{
	//huking	
...
static void wgui_cat1023_create_tab_bar(void)
{
	...
	g_cat1023_cb_func.get_tab_count_ptr(
		g_cat1023_cntx.h_date, 
		&g_cat_tab_num);
	...
	g_cat1023_cb_func.get_tab_items_ptr(
		f_tab, 
		n_tabs, 
		cat1023_tab_text);
...
/* under construction !*/
    ...
    g_cat1023_cb_func.get_menuitem_count_ptr(
    	g_cat1023_cntx.h_date, 
    	g_cat1023_cntx.h_tab, 
	...
	ret = wgui_cat1023_construct_list_history(
			&l_history, 
			MMI_CAT1023_ID, 
			g_cat1023_cntx.list_m_count);
...
//huking	
    ...
    {
	    h_flag = set_list_menu_category_history(
					MMI_CAT1023_ID,
					(U8 *)&l_history);
    }
 ...
 //   MMI_fixed_icontext_list_menuitem.focussed_without_sc_filler = current_MMI_theme->menuitem_thick_with_tab_highlight_filler;//menuitem_thick_with_tab_highlight_without_scroll_filler
    ...
    if(g_cat_tab_num > 0)
	{
        ...
        wgui_async_list_resize_multi_icontext_menu(
			MAIN_LCD_DEVICE_WIDTH, 
			MMI_CONTENT_HEIGHT - MMI_HORIZONTAL_TAB_BAR_TAB_AREA_HEIGHT);
    }
    else
#endif/*__MMI_TAB_BARS_SUPPORT__*/		
    {
    ...
    SetKeyUpHandler(wgui_cat1023_star_key_handler, KEY_STAR); /* register '*' key handler */
    SetKeyUpHandler(wgui_cat1023_pound_key_handler, KEY_POUND); /* register  '#' key handler */

    SetKeyUpHandler(wgui_cat1023_larrow_key_handler, KEY_LEFT_ARROW);
    SetKeyUpHandler(wgui_cat1023_rarrow_key_handler, KEY_RIGHT_ARROW);
	//huking	
#ifdef __MMI_TAB_BARS_SUPPORT__	
#ifdef __MMI_TOUCH_SCREEN__ 
...
*  void
*****************************************************************************/
static void DrawCate1048CategoryControlAreaBackground(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
...
*****************************************************************************/
static S32 wgui_cat1048_get_item(
	S32 start_index, 
	gui_iconlist_menu_item *menu_data, 
	S32 data_size)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    number = g_cat1048_cntx.GetItemFunc(
    			start_index, 
    			menu_data, 
    			data_size);
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1048_ckey_pen_handler(
	void *btn_object, 
	S32 flags)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1048_setup_and_draw_button_bar(
	U16 center_button_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* right */
    move_softkey(
    	MAIN_LCD_DEVICE_WIDTH - right_gap - button_width, 
    	y, 
    	MMI_RIGHT_SOFTKEY);
    resize_softkey(
		button_width, 
    ...
    /* center */
    btn_id = dm_add_button(
    			(UI_string_type)GetString(center_button_id), 
    			0, 
    			0, 
    			0);
    dm_move_button(
		btn_id, 
		left_gap + button_width, 
		y);
    dm_resize_button(
		btn_id, 
		button_width, 
    ...
    dm_register_button_functions(
    	...
    	KEY_EVENT_UP, 
    	wgui_cat1048_ckey_up_func);
	SetKeyDownHandler(wgui_cat1048_ckey_down, KEY_ENTER);
	SetKeyUpHandler(wgui_cat1048_ckey_up, KEY_ENTER);
...
/* under construction !*/
	...
	gui_set_multi_line_input_box_default_bg_color(
		...
		gui_color(48, 48, 48),
		MMI_TRUE);
	MMI_multiline_inputbox.normal_text_color = UI_COLOR_WHITE;//gui_color(255, 255, 255);
    ...
    #endif /* __MMI_TOUCH_SCREEN__ */
        SetKeyUpHandler(wgui_cat1048_star_key_handler, KEY_STAR);
...
/* under construction !*/
#endif//0
#define wgui_cat1050_exit wgui_reset_list_catgory_context
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1050_post_display_menuitem(
	void *item, 
	void *common_item_data, 
	S32 x, 
	S32 y)
...
/* under construction !*/
    ...
    set_fixed_icontext_list_text_coordinates(
		0, 
		GUI_ICONTEXT_MENUITEM_ICON_X + CAT1008_ICON_WIDTH + 2, 
		text_fh, 
		w, 
		h);
...
/* under construction !*/
#endif//0
#define ExitCategory427Screen wgui_reset_list_catgory_context
        ...
        U8 *history_buffer)
{
    ...
    set_fixed_icontext_list_icon_coordinates(
		0, /* state icon */
        var0 - MMI_MENUITEM_HEIGHT /* icon width */ + 2 /* gap */, 
        2 /* gap */,
        MMI_MENUITEM_HEIGHT, 
        MMI_MENUITEM_HEIGHT);
 ...
 *  void
 *****************************************************************************/
static void wgui_cascading_menu_darken_full_screen(
...
//huking /*!defined(__MMI_CASCADING_MENU_ROUNDED_BORDER__) &&*/ 
#if (!defined(__MMI_FTE_SUPPORT__))
...
static void DrawCategory800Shadow(S32 shadow_x1, S32 shadow_y1, S32 shadow_width, S32 shadow_height)
{
  ...
  //  S32 shadow_alpha_end = CASCADING_MENU_SHADOW_ALPHA_END;
    ...
    shadow_alpha = CASCADING_MENU_SHADOW_ALPHA_START;

    if (CASCADING_MENU_SHADOW_DEPTH == 1)
    {
        shadow_alpha_step = 0;
    }
    else
    {
        shadow_alpha_step = (CASCADING_MENU_SHADOW_ALPHA_END - CASCADING_MENU_SHADOW_ALPHA_START) / (CASCADING_MENU_SHADOW_DEPTH - 1);
    }
 
    for (i = 0; i < CASCADING_MENU_SHADOW_DEPTH; i++)
    {
        /* bottom shadow */
        gdi_effect_alpha_blending_rect(
            active_layer, 
            shadow_x1 + CASCADING_MENU_SHADOW_OFFSET, 
        ...
        gdi_effect_alpha_blending_rect(
            active_layer, 
            shadow_x1 + shadow_width + i, 
            shadow_y1 + CASCADING_MENU_SHADOW_OFFSET, 
            shadow_x1 + shadow_width + i, 
...
#endif /*  !define(__MMI_FTE_SUPPORT__) */
 ...
 *  void
 *****************************************************************************/
static void wgui_cat800_get_arrow_image(
	PU8 *arrow, 
	PU8 *disabled_arrow, 
	PU8 *highlight_arrow)
{
 ...
 *  void
 *****************************************************************************/
static void wgui_cat800_draw_background(
	S32 x, 
	S32 y, 
	S32 w, 
	S32 h, 
...
#ifdef __MMI_FTE_SUPPORT__
static void CategoryCascadingHideFunction(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
 ...
 *  void
 *****************************************************************************/
static void wgui_cat800_calc_menu_height(
	MMI_BOOL rotated, 
	S32 n_items, 
	S32 *menu_height, 
	MMI_BOOL *show_scrollbar)
        ...
        U8 *history_buffer)
{
	...
	wgui_cat_add_title_and_softkey(
		title, 
		title_icon, 
		left_softkey, 
		right_softkey);
...
#endif/*__MMI_SCREEN_ROTATE__*/
    /* add menu items */
	wgui_cat_list_add_twostate_items(
		number_of_items,
		list_of_items,
		NULL);
...
/* under construction !*/
        ...
        if(is_rotated || current_cm_level != 0)
        {
            ...
            gui_measure_string(
				(UI_string_type)list_of_items[i], 
				&text_width, 
				&text_height);
        ...
        U8 *history_buffer)
{
 ...
 //   MMI_fixed_icontext_list_menuitem.focussed_without_sc_filler = current_MMI_theme->cascade_menu_highlight_filler;
	...
	wgui_cat800_get_arrow_image(
		&arrow_image, 
		&disabled_arrow_image, 
		&highlight_arrow_image);
    ...
    set_fixed_icontext_list_text_coordinates(
		0, 
		CASCADING_MENU_TEXT_LEFT_GAP, 
		0, 
		max_item_text_width - CASCADING_MENU_TEXT_LEFT_GAP - CASCADING_MENU_TEXT_RIGHT_GAP, 
		MMI_MENUITEM_HEIGHT);
    set_fixed_icontext_list_icon_coordinates(
		0, 
		max_item_text_width + CASCADING_MENU_ARROW_TO_TEXT_GAP, 
		0, 
		arrow_width, 
		arrow_height);  
...
#if 0//def MMI_CASCADING_MENU_FIXED_WIDTH
/* under construction !*/
/* under construction !*/
#else//
    if (mmi_fe_get_r2l_state())
        ...
        U8 *history_buffer)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
//huking 	__WGUI_CATE_LIST_SIMPLE_TEXT_MAP__
...
/* under construction !*/
#endif//0
#define wgui_cat353_stop_scroll wgui_stop_list_menuitem_scrolling
        ...
        U8 *history_buffer)
{
	...
	for (i = 0; i < number_of_items; i++)
	{
		img_list[i] = NULL;
		if (list_of_icons != NULL)
			img_list[i] = wgui_get_list_menu_icon(i, list_of_icons[i]);
		
		if(img_list[i] != NULL)
			flag = MMI_TRUE;
	}

	wgui_cat_list_add_icontext_items(
		number_of_items,
		list_of_items,
		img_list,
		list_of_descriptions);
...
void ShowCategory36Screen_ext_int(
                ...
                U8 *history_buffer)
{
//huking __WGUI_CATE_LIST_RADIO_BOX_MAP__
    ...
    h_flag = wgui_set_twostate_radio_list_history(
		(U16)CatId, 
		history_buffer);
#else /* __ATV_SMS_SUPPORT__ */
    h_flag = wgui_set_twostate_radio_list_history(
...
void ShowCategory15Screen_int(
        ...
        U8 *history_buffer)
{
//huking __WGUI_CATE_LIST_SIMPLE_LIST_MAP__
#if defined(__MMI_BASIC_UI_STYLE__)
    ShowCategory52Screen_int(
        title,
        title_icon,
        ...
        switch (MMI_current_menu_type)
        {
            case LIST_MENU:
				...
				for (i = 0; i < number_of_items; i++)
				{
					...
					//if(img_list[i] != NULL)
					//	flag = MMI_TRUE;
					str_list[i] = (U8*)get_string(list_of_items[i]);
				}
    ...
    if((flags == UI_FILLED_AREA_TYPE_BITMAP) || (flags == UI_FILLED_AREA_TYPE_IMAGE_LEFT_ALIGN) || (flags == UI_FILLED_AREA_TYPE_IMAGE_RIGHT_ALIGN))
    {
        ...
        if(current_MMI_theme->small_list_menu_normal_filler->flags != UI_FILLED_AREA_TYPE_BITMAP)
        {
            gui_draw_rectangle(
				...
				x1 + w, 
				y1 + h - 1, 
				current_MMI_theme->small_list_screen_border_filler->c);
        }
    }
    else
    {
        if(current_MMI_theme->small_list_menu_normal_filler->flags != UI_FILLED_AREA_TYPE_BITMAP)
        {
            gui_draw_filled_area(
				...
				x1 + w-1, 
				y1 + h - 2, 
				(current_MMI_theme->small_list_screen_border_filler));
        }
        gui_draw_filled_area(
            MMI_fixed_list_menu.x,
...
void DrawCate10CategoryControlArea(dm_coordinates *coordinate)
{
    ...
    y1 = UI_device_height - MMI_button_bar_height - MMI_title_height - 
    		(4 +get_menu_item_height() * cat10_list_item_num + 4 + 5) - 2;
    ...
    gui_draw_filled_area(
		...
		x2, 
		y2, 
		(current_MMI_theme->small_list_screen_border_filler/*current_MMI_theme->cascade_menu_background_filler*/));
#endif /* __MMI_FTE_SUPPORT__ */
}
 ...
 *  void
 *****************************************************************************/
static void wgui_cat10_menu_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
...
static void wgui_cat10_vertical_scrollbar_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
{
  ...
  //  gdi_layer_push_clip();
    ...
    gui_fill_transparent_color(
    	...
    	x2, 
    	y2, 
    	gui_color32(255, 255, 255, 0));
#else/*defined (__MMI_UI_TRANSPARENT_EFFECT__) || defined (__MMI_UI_LIST_HIGHLIGHT_EFFECTS__)*/
    gui_fill_rectangle(
    	x1, 
    	y1, 
    	x2, 
...
/* under construction !*/
    ...
    resize_fixed_icontext_menuitems(
		MMI_SMALL_LIST_SCREEN_WIDTH - 3  - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP, 
		0);
#ifdef __MMI_FTE_SUPPORT__
    wgui_fixed_list_move_icontext_menu(
    	MMI_SMALL_LIST_LEFT_OFFSET + MMI_FTE_TOOLBAR_START_X,
 ...
 *  void
 *****************************************************************************/
static void wgui_cat110_menu_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
...
/* under construction !*/
    ...
    if (number_of_items <= MMI_SMALL_LIST_MAX_ITEM_COUNT)
    {
        ...
        MMI_fixed_list_menu.flags |= UI_LIST_MENU_DISABLE_SCROLLBAR;
        resize_fixed_icontext_menuitems(
			MAIN_LCD_DEVICE_WIDTH - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP, 
			0);
    }
    else
    {
        ...
        resize_fixed_icontext_menuitems(
			MAIN_LCD_DEVICE_WIDTH - UI_SCROLLBAR_WIDTH - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP,
			0);
    }
    wgui_fixed_list_resize_icontext_menu(
        MAIN_LCD_DEVICE_WIDTH,
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1001_menu_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
{
  ...
  //  gdi_layer_push_clip();
    ...
    gui_fill_rectangle(
		...
		x2, 
		y2, 
		*(current_MMI_theme->lite_disp_scr_bg_color));
...
/* under construction !*/
    ...
    if (inputbox->y >= ref_point_y)
    {
        ...
        if (max_item_count < number_of_items)
        {
            wgui_fixed_list_resize_icontext_menu(
				inputbox->width, 
				get_menu_item_height() * max_item_count);
            resize_fixed_icontext_menuitems(
				inputbox->width - UI_SCROLLBAR_WIDTH - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP, 
				0);
            wgui_fixed_list_move_icontext_menu(
                inputbox->x,
        ...
        else
        {
            ...
            wgui_fixed_list_resize_icontext_menu(
				inputbox->width, 
				get_menu_item_height() * number_of_items);
            resize_fixed_icontext_menuitems(
				inputbox->width - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP, 
				0);
            wgui_fixed_list_move_icontext_menu(
                inputbox->x,
 ...
 *  byte              Returns true if the history ID is valid
 *****************************************************************************/
U8 set_list_menu_category140_history(
	U16 history_ID, 
	U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void get_list_menu_category_history140(
	U16 history_ID, 
	U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
                ...
                U8 *history_buffer)
{
    ...
    h_flag = set_list_menu_category140_history(
				(U16)CatId, 
				history_buffer);
#else /* __ATV_SMS_SUPPORT__ */
    h_flag = set_list_menu_category140_history(
...
/* under construction !*/
	...
	{
		gui_measure_string(
			(UI_string_type) list_of_items1[i], 
			&w1, 
			&h1);
		gui_measure_string(
			(UI_string_type) list_of_items2[i], 
			&w2, 
			&h2);
		if(w1_max < w1)
		{
    ...
    MMI_fixed_list_menu.item_highlight_function = UI_fixed_menuitem_dummy_function;
...
void ShowCategory172Screen_int(
        ...
        U8 *history_buffer)
{
//huking __WGUI_CATE_LIST_RADIO_WITH_SCROLL_TITLE_MAP__
#if defined(__MMI_BASIC_UI_STYLE__)
    ShowCategory109Screen_ext_int(
        title,
        title_icon,
        ...
        U8 *history_buffer)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
//huking	__WGUI_CATE_LIST_NUMBERED_LIST_MAP__
...
//huking __WGUI_CATE_LIST_NUMBERED_LIST_MAP__
    ...
    set_fixed_icontext_list_text_coordinates(
		1,
        GUI_TEXT_MENUITEM_TEXT_X + text1_width, 
        0,
        MMI_fixed_icontext_list_menuitem.width - (GUI_TEXT_MENUITEM_TEXT_X + 1) - text1_width, 
        MMI_MENUITEM_HEIGHT);
...
static void wgui_cat155_list_highlight_handler(S32 item_index)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	g_cat155_highligt_menu_id = GetSeqItemId_Ext(
									g_cat155_paraent_id, 
									(U16)item_index);
 ...
 *  byte              Returns true if the history ID is valid
 *****************************************************************************/
U8 set_list_menu_category155_history(
	U16 history_ID, 
	U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void get_list_menu_category_history155(
	U16 history_ID, 
	U8 *history_buffer)
{
    /*----------------------------------------------------------------*/
    ...
    U8 *history_buffer)
{
    ...
    if (set_list_menu_category155_history(MMI_CATEGORY52_ID, history_buffer))
    {
        if(GetSeqItemId_Ext(
			g_cat155_paraent_id, 
			(U16)MMI_fixed_list_menu.highlighted_item) != g_cat155_highligt_menu_id)
        {
            i = GetChildMenuIDIndexByParentMenuID_Ext(
					g_cat155_paraent_id, 
					g_cat155_highligt_menu_id);
            if (-1 != i)
            {
	...
	for (i = 0; i < item_count; i++)
	{
		img_list[i] = NULL;
		if (item_icons != NULL)
			img_list[i] = wgui_get_list_menu_icon(i, item_icons[i]);
		if(img_list[i] != NULL)
			flags = MMI_TRUE;
		str_list[i] = (U8*)get_string(item_texts[i]);
	}
...
static void wgui_cat73_DrawScreen(
	S32 width1, 
	S32 height1, 
	S32 width2, 
	S32 height2)
...
{
//huking __WGUI_CATE_LIST_TWO_ICONS_MAP__
#if defined(__MMI_BASIC_UI_STYLE__) || defined(__MMI_MAINLCD_128X64__)
    RedrawCategoryFunction();
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1003_menu_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
...
static void wgui_cat1003_vertical_scrollbar_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
        ...
        U8 *history_buffer)
{
    ...
    gui_vertical_scrollbar_register_hide_callback(
		&MMI_fixed_list_menu.vbar, 
		wgui_cat1003_vertical_scrollbar_hide_function);
...
/* under construction !*/
#endif//0
    max_item_count = (MMI_CONTENT_HEIGHT - MMI_TITLE_HEIGHT - MMI_ICON_BAR_HEIGHT - MMI_FTE_SMALLLIST_GAP)/get_menu_item_height();
    ...
    wgui_fixed_list_resize_icontext_menu(
		MMI_CONTENT_WIDTH - MMI_FTE_TOOLBAR_START_X*2, 
		list_height);
    resize_fixed_icontext_list_menuitems(
		list_width - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP, 
		0);
    wgui_fixed_list_move_icontext_menu(
        MMI_FTE_TOOLBAR_START_X,
        MAIN_LCD_DEVICE_HEIGHT - MMI_BUTTON_BAR_HEIGHT - MMI_ICON_BAR_HEIGHT - (MMI_FTE_SMALLLIST_GAP>>1) - list_height);
 ...
 *  void
 *****************************************************************************/
static MMI_BOOL wgui_cat1004_touch_close_icon(
	mmi_pen_point_struct point)
{
    ...
    gui_measure_image(
		get_image(IMG_CAT1004_CLOSE_ICON_UP), 
		&close_icon_w, 
		&close_icon_h);
    close_icon_x = MMI_fixed_list_menu.x + popup_width - CASCADING_MENU_BORDER_SIZE*2 - ((popup_title_h + close_icon_w)>>1);
    close_icon_y = MMI_fixed_list_menu.y - CASCADING_MENU_TOP_GAP - ((popup_title_h + close_icon_h)>>1);
 ...
 *  void
 *****************************************************************************/
static void wgui_cat_add_softkey(
	U8* lsk_text, 
	U8* lsk_icon, 
	U8* rsk_text, 
	U8* rsk_icon, 
 ...
 *  void
 *****************************************************************************/
static void wgui_cat1004_menu_hide_function(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
...
#define wgui_cat183_stop_scroll wgui_stop_list_menuitem_scrolling
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
	...
	U8 str_img_mask)
{
    ...
    {
        ret_val = wgui_cat_187_img_callback(
					item_index,
					wgui_cat186_p->states[item_index],
					img_buff_p);
    }
...
/* under construction !*/
	...
	wgui_add_title_and_softkey_id(
		title, 
		title_icon,
		((number_of_items > 0)?STR_GLOBAL_ON:0),
		STR_GLOBAL_BACK);
...
/* under construction !*/
        ...
        if (new_num_of_items <= MMI_SMALL_SCREEN_MAX_LIST_ITEMS_COUNT)
        {
            ...
            wgui_fixed_list_resize_icontext_menu(
				MMI_SMALL_LIST_SCREEN_WIDTH - 3, 
				get_menu_item_height() * new_num_of_items);
            resize_fixed_icontext_menuitems(
				MMI_SMALL_LIST_SCREEN_WIDTH - 3  - GUI_MENUITEM_X1_GAP - GUI_MENUITEM_X2_GAP, 
				0);
            wgui_fixed_list_move_icontext_menu(
        ...
        else
        {
            ...
            resize_fixed_icontext_menuitems(
				MMI_SMALL_LIST_SCREEN_WIDTH - 3 - MMI_fixed_list_menu.vbar.width, 
				0);
            wgui_fixed_list_move_icontext_menu(
                MMI_SMALL_LIST_LEFT_OFFSET + 1,
...
/* under construction !*/
		...
		for (i = 0; i < new_num_of_items; i++)
		{  	
			img_list[i] = wgui_get_list_menu_icon(i, new_list_of_icons[i]);
		}
 ...
 *  void
 *****************************************************************************/
void SetCategoryEditorOptionListHistory(
	U8 *history_buffer, 
	U16 highlighted_item)
{
    /*----------------------------------------------------------------*/
...
#endif/*defined(__MMI_EDITOR_OPTION_MENU_STYLE_2__) && defined(__MMI_SMART_ALPHABETIC_INPUT_METHODS__) && defined(__MMI_IME_USER_DATABASE__) && defined(__MMI_NORMAL_KEYPAD__)*/
...
static void mmi_cat22_caculate_item_width_height(
	S32 nums, 
	S32 *w, 
	S32 *h)
{
...
#if defined(__MMI_FTE_SUPPORT__)
    mmi_cat22_caculate_item_width_height(
    	num_of_symbols, 
    	&w, 
    	&h);
 ...
 *  void
 *****************************************************************************/
static void wgui_catEMS_scrolling_text_draw_background(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2)
 ...
 *  void
 *****************************************************************************/
static void wgui_cat32_create_and_setup_multiline_inputbox(
...
/* under construction !*/
    ...
    resize_fixed_list(
		MMI_content_width, 
		UI_device_height - (MMI_title_height << 1) - MMI_button_bar_height);
...
/* under construction !*/
  ...
  //  MMI_title_string = (UI_string_type) title;
    ...
    wgui_cat32_create_and_setup_multiline_inputbox(
		MMI_title_string, 
		var, 
		var, 
		flag, 
...
/* under construction !*/
/* under construction !*/
#if 1//(UI_BLINKING_CURSOR_SUPPORT)
/* under construction !*/
...
#endif/*#if defined(__MMI_UCM_MO_FAIL_POST_ACTION__) || defined(__J2ME__) || defined(__MMI_MOBILE_TV_CMMB_SUPPORT__)   */
...
#else/*(defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))*/
        wgui_create_horizontal_tab_bar(TRUE, (UI_string_type)title, n_tabs, highlighted_tab, MMI_FALSE);
        list_height = CAT_MMI_CONTENT_HEIGHT_WITH_H_TAB;
#endif/*(defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))*/
    }
    else
#endif/*__MMI_TAB_BARS_SUPPORT__*/		
    {
...
#if (defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))
        wgui_fixed_list_move_icontext_menu(
        	CAT_MMI_CONTENT_X_WITH_H_TAB, 
        	CAT_MMI_CONTENT_Y_WITH_H_TAB - MMI_HORIZONTAL_TAB_BAR_HINT_AREA_HEIGHT);
#else/*(defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))*/
        wgui_fixed_list_move_icontext_menu(
        	CAT_MMI_CONTENT_X_WITH_H_TAB, 
        	CAT_MMI_CONTENT_Y_WITH_H_TAB);
#endif/*(defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))*/
        wgui_fixed_list_resize_icontext_menu(
        	CAT_MMI_CONTENT_WIDTH_WITH_H_TAB, 
        	list_height);
    }
    else
#endif/*__MMI_TAB_BARS_SUPPORT__*/		
...
//huking	
    ...
    wgui_dynamic_list_move_icontext_menu(
    	CAT_MMI_CONTENT_X_WITH_H_TAB, 
    	CAT_MMI_CONTENT_Y_WITH_H_TAB - MMI_HORIZONTAL_TAB_BAR_HINT_AREA_HEIGHT);
#else/*(defined(__MMI_FTE_SUPPORT__) && (__MMI_MAINLCD_320X240__))*/
    wgui_dynamic_list_move_icontext_menu(
    	CAT_MMI_CONTENT_X_WITH_H_TAB, 
    	CAT_MMI_CONTENT_Y_WITH_H_TAB);
#endif/*(defined(__MMI_FTE_SUPPORT__) && (__MMI_MAINLCD_320X240__))*/
...
static MMI_BOOL wgui_caculate_width_and_height(
					S32 *width, 
					S32 *height, 
					S32 menu_height)
{
...
static void wgui_cat1006_post_display_menuitem(
				void *item, 
				void *common_item_data, 
				S32 x, 
				S32 y)
...
//    gui_push_clip();
    gui_push_and_set_clip(x, y, x2, y2);
    ...
    if(mmi_cat1006_get_img_path != NULL)
    {
        ...
        gdi_image_get_dimension_file(
			...
			&img_width, 
			&img_height);
        wgui_caculate_width_and_height(
			&img_width, 
			&img_height, 
			MMI_MENUITEM_THICK_WITH_TAB_HEIGHT);
    ...
    {
    	MMI_ASSERT(mmi_cat1006_get_img_id != NULL);
#if 0    
/* under construction !*/
/* under construction !*/
/* under construction !*/
 ...
 *  void
 *****************************************************************************/
static void wgui_cat426_show_check_box(
				S32 x1, 
				S32 y1, 
				S32 x2, 
				S32 y2, 
 ...
 *  void
 *****************************************************************************/
static void wgui_cat426_show_thumbnail_image(
				S32 x1, 
				S32 y1, 
				S32 x2, 
				S32 y2, 
 ...
 *  void
 *****************************************************************************/
static void wgui_cat426_nb_display_callback(
				GDI_RESULT result, 
				gdi_handle handle)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
static void wgui_cat426_post_display_callback(
				void *item, 
				void *common_item_data, 
				S32 x, 
				S32 y)
                ...
                if (g_wgui_cat426_p->icon_handle[buffer_ind] == GDI_NULL_HANDLE)
                {
                    ...
                    if (g_wgui_cat426_p->cache_buffer != NULL)
                    {
                        ...
                        gdi_draw_solid_rect(
                        	cache_x, 
                        	0, 
                        	cache_x + WGUI_CAT426_IMAGE_WIDTH, 
 ...
 *****************************************************************************/
static S32 wgui_cat426_get_hints(
				S32 start_index, 
				UI_string_type *hint_array)
{
    /*----------------------------------------------------------------*/
...
#endif /* __MMI_MAINLCD_128X128__ */
#endif/*#ifdef __BIP_PULL_SUPPORT__*/
//###############################################################
...
/* under construction !*/
#endif//0
#define wgui_cat1011_atv_sms_cb wgui_cat_disable_list_empty_if_needed
...
static void wgui_cat1014_atv_sms_cb(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    wgui_fixed_list_move_twostate_menu(
    	WGUI_CAT_MATV_CONTENT_X, 
    	WGUI_CAT_MATV_CONTENT_Y);
    wgui_fixed_list_resize_twostate_menu(
		WGUI_CAT_MATV_CONTENT_W, 
		WGUI_CAT_MATV_CONTENT_H);
}
...
static S32 wgui_cat_get_async_config(void)
{
    ...
    /*----------------------------------------------------------------*/
#if defined(__WGUI_CATE_LIST_ALL_HINTS_IN_MENUITEM__)
    return WGUI_CAT_ASYNC_DYN_ALL_HINTS_IN_MENUITEMS;
#elif defined(__WGUI_CATE_LIST_HIGHLIGHTED_HINTS_IN_MENUITEM__)
    return WGUI_CAT_ASYNC_DYN_HIGHLIGHTED_TWO_LINE;
#else/*defined(__WGUI_CATE_LIST_HIGHLIGHTED_HINTS_IN_MENUITEM__)*/ 
    return WGUI_CAT_ASYNC_DYN_SINGLE_LINE;
#endif/*defined(__WGUI_CATE_LIST_ALL_HINTS_IN_MENUITEM__)*/ 

   // return flags;
}

static S32 wgui_cat_get_AsyncItem(
				S32 start_index, 
				gui_iconlist_menu_item *menu_data, 
				S32 data_size)
{
    ...
    for (i = 0; i < ret; i++)
    {
        ...
        wgui_cat_AsyncHintFuncPtr(
			start_index + i, 
			&menu_data[i].item_list[1]);
    }
    return ret;
}

static void wgui_cat_async_list_create_menu(
				S32 number_of_items, 
				GetAsyncItemFuncPtr get_item_func, 
				GetAsyncHintFuncPtr get_hint_func, 
				S32 flags, 
...
//huking	
    ...
    wgui_cat_async_list_create_menu(
		number_of_items, 
		get_item_func, 
		get_hint_func, 
		flags, 
    ...
    if(g_cat_list_is_show_thumbnail)
    {   
		MMI_fixed_icontext_list_menuitem.disabled_text_colors[0] = 
			MMI_fixed_icontext_list_menuitem.normal_text_colors[0];
	...
	var = 0;
#endif/*defined(__MMI_MAINLCD_96X64__)*/
    ...
    fir_fh = Get_CharHeightOfAllLang(
					gui_font_get_type(GUI_FONT_SIZE_LIST)->size);
	var = 2;
    if (get_hint_func)
    {
        if (flags == WGUI_CAT_ASYNC_DYN_ALWAYS_TWO_LINE)
        ...
        {
            MMI_fixed_icontext_list_menuitem.text_fonts[1] = 
				&MMI_medium_font;
    ...
    set_fixed_icontext_list_text_coordinates(
		...
		text1_x, 
		var, 
		icon2_x - text1_x - GUI_MENUITEM_TEXT_RIGHT_GAP, 
		fir_fh);
#ifdef __MMI_TAB_BARS_SUPPORT__
	if(n_tabs > 0)
    {
	...
	wgui_cat_disable_list_empty_if_needed();
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
					...
					GetAsyncHintFuncPtr get_hint_func)
{
  ...
  //  S32 flags;
    ...
    if (get_hint_func)
    {
       // if(flags == WGUI_CAT_ASYNC_DYN_ALWAYS_TWO_LINE ||
		//	flags == WGUI_CAT_ASYNC_DYN_ALL_HINTS_IN_MENUITEMS)
		if(wgui_cat_get_async_config() &
			(WGUI_CAT_ASYNC_DYN_ALWAYS_TWO_LINE|WGUI_CAT_ASYNC_DYN_ALL_HINTS_IN_MENUITEMS))
        {
            wgui_cat_AsyncItemFuncPtr = get_item_func;
            wgui_cat_AsyncHintFuncPtr = get_hint_func;
            getAsyncItem = wgui_cat_get_AsyncItem;
...
//huking	
    ...
    wgui_menuitem_register_icontext_list_checkbox_callback(
		set_state_func, 
		get_state_func);
    ...
    if (n_tabs > 0)
    {
        ...
        wgui_async_list_move_multi_icontext_menu(
        	...
        	MMI_CONTENT_Y_WITH_H_TAB - MMI_HORIZONTAL_TAB_BAR_HINT_AREA_HEIGHT);
        wgui_async_list_resize_multi_icontext_menu(
			MMI_CONTENT_WIDTH_WITH_H_TAB, 
			MMI_CONTENT_HEIGHT_WITH_H_TAB + MMI_HORIZONTAL_TAB_BAR_HINT_AREA_HEIGHT - var);
#else/*(defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))*/
        wgui_async_list_move_multi_icontext_menu(
        	MMI_CONTENT_X_WITH_H_TAB, 
        ...
        wgui_async_list_resize_multi_icontext_menu(
			MMI_CONTENT_WIDTH_WITH_H_TAB, 
			MMI_CONTENT_HEIGHT_WITH_H_TAB - var);
#endif/*(defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X240__))*/
    }
    else
#endif/*__MMI_TAB_BARS_SUPPORT__*/		
    {
        ...
        wgui_async_list_resize_multi_icontext_menu(
			MMI_content_width, 
			MMI_content_height - var);
    }
	wgui_cat_setup_category_default_history(
		CatId, 
		DM_CLEAR_SCREEN_BACKGROUND, 
		wgui_cat1024_tab_exit);
    /* redraw category screen */
    dm_redraw_category_screen();
...
/* under construction !*/
#endif//0
pBOOL(*wgui_cat1047_get_text_callback) (
		S32 item_index, 
		UI_string_type str_buff);
...
*  void
*****************************************************************************/
static S32 wgui_cat1047_get_item(
				S32 start_index, 
				gui_iconlist_menu_item *menu_data, 
				S32 data_size)
{
    ...
    {
        index = start_index + i;
        wgui_cat1047_get_text_callback(
			index, 
...
U8 wgui_cat1047_set_history(U8 *history_buffer)
{
    ...
    if (history_buffer)
    {
        ...
        return set_list_menu_category_history(
					MMI_CAT1031_NO_TAB_ID, 
					history_buffer + sizeof(S32));
    }
    else
...
*  void
*****************************************************************************/
static void wgui_cat1047_tap_hdlr(
...
/* under construction !*/
    ...
    set_fixed_icontext_list_text_coordinates(
		...
		w, 
		0, 
		MMI_content_width - MMI_fixed_list_menu.vbar.width - w, 
		MMI_MENUITEM_HEIGHT);
		...
		U8 *history_buffer)
{
    ...
    move_multiline_inputbox(
    	MMI_title_x, 
    	MMI_title_y + MMI_title_height + WGUI_CATE_ML_GAP_HEIGHT);
    var1 = MMI_title_y + MMI_title_height + WGUI_CATE_ML_GAP_HEIGHT + var2 + WGUI_CATE_ML_GAP_HEIGHT;
#else/*MMI_SHOW_STATUS_ICON_IN_TITLE*/
    move_multiline_inputbox(
    	MMI_title_x, 
    	MMI_title_y + WGUI_CATE_ML_GAP_HEIGHT);
 ...
 *  void
 *****************************************************************************/
static void wgui_cat_list_menu_goto_item(
				fixed_list_menu *m, 
				S32 i)
{
    /*----------------------------------------------------------------*/
	...
	if ((!gui_asyncdynamic_list_loading_error) && 
...
static void wgui_cat_list_menu_goto_next_item(fixed_list_menu *m)
{
	...
	else
	{
		...
		{
		    if ((last_highlighted_item >= m->last_displayed_item) && 
				(offset > 0))
		    {
		        m->first_displayed_offset = 0;
		    }
			...
			{
				if ((m->highlighted_item >= m->n_items) || 
					(iheight > m->height))
				{
					m->first_displayed_offset = 0;
				}
		...
		else
		{
			...
			{
			    if (m->first_displayed_offset + m->height + offset == 
					iheight)
			    {
			        goto_item = MMI_TRUE;
			    }
...
*****************************************************************************/
static S32 wgui_cat_conversation_calc_mi_height(
				UI_string_type text, 
				S32 align, 
				S32 *t_width, 
				S32 *t_height)
...
static S32 wgui_cat_conversation_get_mi_height(S32 index)
{
    ...
    return wgui_cat_conversation_calc_mi_height(
				_text, 
				align, 
				&width, 
				&height);
 ...
 *****************************************************************************/
static MMI_BOOL wgui_cat_conversation_pen_check_bound(
					void *item, 
					void *common_item_data, 
					S32 index, 
					S16 x, 
 ...
 *  void
 *****************************************************************************/
static void wgui_cat_conversation_post_display_menuitem(
				void *item, 
				void *common_item_data, 
				S32 x, 
				S32 y)
{
	...
	if (align == 0) /* left align */
	{
 		if (mi->flags & UI_MENUITEM_STATE_FOCUSSED)
		{
		    text_color = UI_COLOR_BLACK;//gui_color(0, 0, 0);
			image_id = IMG_SMS_CONVERSATION_L_HIGHLIGHTED;
		}
		else
		{
		    text_color = UI_COLOR_WHITE;//gui_color(255, 255, 255);
		...
		if (mi->item_texts[0])
		{
		    ...
		    gui_measure_string(
				(UI_string_type)mi->item_texts[0], 
				&dt_width, 
				&dt_height);
		}
		if (mi->item_icons[0])
		...
		if (mi->item_icons[0])
		{
			...
			gui_set_clip_preset(
				clip_x1, 
				clip_y1 - CAT_CONVERSATION_TEXT_TO_TEXT, 
				clip_x2, 
				clip_y2);
			gdi_image_draw(
				clip_x1, 
 ...
 *  The number of items
 *****************************************************************************/
static S32 wgui_cat_conversation_get_item(
				S32 start_index, 
				gui_iconlist_menu_item *menu_data, 
				S32 data_size)
{
	...
	for (i = 0; i < get_size; i++)
	{
		...
		wgui_cat_conversation_calc_mi_height(
			(UI_string_type)md_ext[index].string_ptr, 
			md[i].lr_flag, 
			&width, 
			&height);
...
static void wgui_cat_conversation_exit(void)
{
    ...
    MMI_fixed_icontext_list_menuitem.ext_flags &= 
		~UI_MENUITEM_EXT_INEQUAL_HEIGHT;
 ...
 *  
 *****************************************************************************/
static void wgui_cat1071_set_displayable(
				S32 index, 
				MMI_BOOL displayable)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static S32 wgui_cat1071_get_item_func(
				S32 start_index, 
				gui_iconlist_menu_item *menu_data, 
				S32 data_size)
{
    ...
    if(cut_index >= 0 && cut_index < MAX_SUBMENU_CHARACTERS - 3 &&
...
#ifdef __MMI_PHONEBOOK_LIST_THUMBNAIL__
    wgui_cat_thumbnail_set_image_box_size(
    	left_icon_w, 
    	left_icon_h);
#endif/*__MMI_PHONEBOOK_LIST_THUMBNAIL__*/
...
static MMI_BOOL wgui_is_all_menuitem_hint_empty(S32 n_items)
{
	...
	for (i = 0; i < n_items; i++)
	{
		if (!gui_is_string_empty(wgui_pop_up_description_strings[i].text_strings[0]))
		{
			return MMI_FALSE;
		}
	}
 ...
 * PARAMETERS
 *  number_of_items              [IN]        number of items.
 *  list_of_items            [IN]        text of current item
 *  list_of_icons                   [IN]        icon of current item
 *  list_of_descriptions     [IN]        Descriptions of current item
 * RETURNS
 *  void
 *****************************************************************************/
void wgui_cat_list_add_icontext_items(
		S32 number_of_items, 
		U8 **list_of_items,
		PU8 *list_of_icons,
		U8 **list_of_descriptions)
{
    ...
    if(list_of_icons == NULL)
    {
        ...
        { 
            U8* descliption = NULL;
			if(list_of_descriptions != NULL)
				descliption = list_of_descriptions[i];
 ...
 *  void
 *****************************************************************************/
void wgui_cat_list_add_twostate_items(
		S32 number_of_items, 
		U8 **list_of_items,
		U8 **list_of_descriptions)
{
 ...
 *  wgui_cat_disable_list_empty_if_needed
 * DESCRIPTION
 *  disable empty label when redrawing, and in list cp end if cat end has
 * PARAMETERS
 *  number_of_items              [IN]        number of items.
 *  list_of_items            [IN]        text of current item
 *  list_of_icons                   [IN]        icon of current item
 ...
 *  void
 *****************************************************************************/
void wgui_cat_disable_list_empty_if_needed(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	//disable empty label in list cp end if cat end has
 ...
 *  void
 *****************************************************************************/
void wgui_add_title_and_softkey_id(
		MMI_STR_ID title,//id
