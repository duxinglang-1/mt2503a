...
#if (MMI_MAX_SIM_NUM >= 3) && !defined(__COSMOS_MMI_PACKAGE__)
...
/* under construction !*/
    ...
    {STATUS_ICON_BT_INCOMING_SMS, IMG_SI_BT_MESSAGE_UNREAD, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif
...
#else  //!defined(__MMI_COSMOS_STATUS_BAR_SLIM__)
...
#if (defined(__HSDPA_SUPPORT__) || defined(__HSUPA_SUPPORT__)) && !defined(__MMI_COSMOS_STATUS_BAR_SLIM__)
#if (MMI_MAX_SIM_NUM >= 2)
...
#endif  //(MMI_MAX_SIM_NUM >= 2)
#endif  //(defined(__HSDPA_SUPPORT__) || defined(__HSUPA_SUPPORT__)) && !defined(__MMI_COSMOS_STATUS_BAR_SLIM__)
...
#endif  //defined(__MMI_HFP_SUPPORT__) || defined(__MMI_A2DP_SUPPORT__)
...
#else  //(MMI_MAX_SIM_NUM >= 2) && !defined(__MMI_STATUS_ICON_BAR_SLIM__)
    {STATUS_ICON_SIGNAL_STRENGTH, IMG_SI_SIGNAL_STRENGTH, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
...
//#if !defined(__MMI_STATUS_ICON_BAR_SLIM__)
    ...
    {STATUS_ICON_SLAVE_CALLFORWARD_L1, IMG_SLAVE_CALL_FORWARD_L1, GUI_STATUS_ICON_BAR_ICON_CALL_GROUP},
    {STATUS_ICON_SLAVE_CALLFORWARD_L2, IMG_SLAVE_CALL_FORWARD_L2, GUI_STATUS_ICON_BAR_ICON_CALL_GROUP},
    #else  //(MMI_MAX_SIM_NUM >= 2)
    {STATUS_ICON_SLAVE_CALLFORWARD, IMG_SI_CALL_DIVERT_L1L2, GUI_STATUS_ICON_BAR_ICON_CALL_GROUP},
    ...
    {STATUS_ICON_SIM3_CALL_DIVERT_L2, IMG_SI_CALL_DIVERT_L2, GUI_STATUS_ICON_BAR_ICON_CALL_GROUP},
#endif  //(MMI_MAX_SIM_NUM >= 3)
...
/* under construction !*/
    ...
    {STATUS_ICON_UNREAD_VIDEO_L1, IMG_SI_UNREAD_VIDEO_L1, GUI_STATUS_ICON_BAR_ICON_VIDEO_GROUP},
    {STATUS_ICON_UNREAD_VIDEO_L2, IMG_SI_UNREAD_VIDEO_L2, GUI_STATUS_ICON_BAR_ICON_VIDEO_GROUP},
    {STATUS_ICON_UNREAD_VIDEO_L1L2, IMG_SI_UNREAD_VIDEO_L1L2, GUI_STATUS_ICON_BAR_ICON_VIDEO_GROUP},
...
#if !((MMI_MAX_SIM_NUM >= 3) && (!defined(__MMI_FTE_SUPPORT__)) && (!defined(__MMI_STATUS_ICONBAR_COSMOS_STYLE__)))
...
void wgui_status_icon_bar_initialize(void)
{
    ...
    bar->n_sms_full = 0;
#endif
#if (defined(__MMI_FTE_SUPPORT__) && (MMI_MAX_SIM_NUM >= 3))
    bar->new_icon_id = -1;
#endif
...
#endif /* defined(__MMI_FTE_SUPPORT__) && (MMI_MAX_SIM_NUM >= 3) */
...
#endif /* defined(__MMI_FTE_SUPPORT__) && (MMI_MAX_SIM_NUM >= 2) */
...
#if !defined(__MMI_NCENTER_SUPPORT__) && defined(__MMI_SLIM_IMG_RES__) && !defined(__MMI_STATUS_ICON_BAR_SLIM__) && (MMI_MAX_SIM_NUM >= 2)
...
#endif  //(MMI_MAX_SIM_NUM >= 4)
#endif  //!defined(__MMI_NCENTER_SUPPORT__) && defined(__MMI_SLIM_IMG_RES__) && !defined(__MMI_STATUS_ICON_BAR_SLIM__) && (MMI_MAX_SIM_NUM >= 2)
...
#endif  //(MMI_MAX_SIM_NUM >= 4)
#endif  //!defined(__MMI_STATUS_ICON_BAR_SLIM__)
#endif  //!defined(__MMI_SLIM_IMG_RES__) && (MMI_MAX_SIM_NUM >= 2)
#endif  //__MMI_STATUS_ICONBAR_COSMOS_STYLE__
