...
static void gui_calendar_adjust_switch_enable_state(gui_calendar_struct *c)
{
    ...
    {
        if (c->start_time.nDay == min_time.nDay)
        {
    ...
    {
        if (c->end_time.nDay == max_time.nDay)
        {
...
#else
    c->vertical_select.x = GUI_CALENDAR_FRAME_LINE_PIXEL;
    c->vertical_select.y = GUI_CALENDAR_FRAME_LINE_PIXEL; //0;
    c->vertical_select.width = GUI_CALENDAR_VERTICAL_SELECT_WIDTH;
    c->vertical_select.height = c->height - GUI_CALENDAR_FRAME_LINE_PIXEL * 2;
#endif /*title*/
...
/* under construction !*/
    ...
    c->horizontal_string.bg_alpha = 0;
#else
...
void gui_calendar_set_key_handler(gui_calendar_struct* c)
{
    ...
    SetKeyDownHandler(gui_calendar_left_arrow_key_handler, KEY_LEFT_ARROW);
    SetKeyRepeatHandler(gui_calendar_left_arrow_key_handler, KEY_LEFT_ARROW);
    SetKeyLongpressHandler(gui_calendar_left_arrow_key_handler, KEY_LEFT_ARROW);

    SetKeyDownHandler(gui_calendar_right_arrow_key_handler, KEY_RIGHT_ARROW);
    SetKeyRepeatHandler(gui_calendar_right_arrow_key_handler, KEY_RIGHT_ARROW);
    SetKeyLongpressHandler(gui_calendar_right_arrow_key_handler, KEY_RIGHT_ARROW);

    SetKeyDownHandler(gui_calendar_up_arrow_key_handler, KEY_UP_ARROW);
    SetKeyRepeatHandler(gui_calendar_up_arrow_key_handler, KEY_UP_ARROW);
    SetKeyLongpressHandler(gui_calendar_up_arrow_key_handler, KEY_UP_ARROW);

    SetKeyDownHandler(gui_calendar_down_arrow_key_handler, KEY_DOWN_ARROW);
    SetKeyRepeatHandler(gui_calendar_down_arrow_key_handler, KEY_DOWN_ARROW);
    SetKeyLongpressHandler(gui_calendar_down_arrow_key_handler, KEY_DOWN_ARROW);

    SetKeyDownHandler(gui_calendar_side_up_key_handler, KEY_VOL_UP);
    SetKeyRepeatHandler(gui_calendar_side_up_key_handler, KEY_VOL_UP);
    SetKeyLongpressHandler(gui_calendar_side_up_key_handler, KEY_VOL_UP);
    
    SetKeyDownHandler(gui_calendar_side_down_key_handler, KEY_VOL_DOWN);
    SetKeyRepeatHandler(gui_calendar_side_down_key_handler, KEY_VOL_DOWN);
    SetKeyLongpressHandler(gui_calendar_side_down_key_handler, KEY_VOL_DOWN);

#ifdef __MMI_BTD_BOX_UI_STYLE__ // __MMI_BT_BOX_MULTIMEDIA_CAT_STYLE__
    SetKeyHandler(gui_calendar_left_arrow_key_handler, KEY_UP_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(gui_calendar_left_arrow_key_handler, KEY_UP_ARROW, KEY_EVENT_REPEAT);
    SetKeyHandler(gui_calendar_left_arrow_key_handler, KEY_UP_ARROW, KEY_LONG_PRESS);

    SetKeyHandler(gui_calendar_right_arrow_key_handler, KEY_DOWN_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(gui_calendar_right_arrow_key_handler, KEY_DOWN_ARROW, KEY_EVENT_REPEAT);
    SetKeyHandler(gui_calendar_right_arrow_key_handler, KEY_DOWN_ARROW, KEY_LONG_PRESS);
...
#else
    if(c->cell_detail_query_handler != NULL && c->detail.detail_info.detail_list != NULL)
    {
            U8 i;
