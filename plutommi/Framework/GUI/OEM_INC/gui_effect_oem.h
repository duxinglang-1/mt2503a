 ...
 * Global Function
 *****************************************************************************/
extern S32 gui_rect_get_intersection(
	gui_rect *rect1, 
	gui_rect *rect2, 
	gui_rect *result_rect);
extern void gui_draw_image_with_alpha(
	S32 x, 
	S32 y, 
	gui_rect *out_rect, 
	PU8 image, 
...
extern void gui_effect_slide_create(
	S32 start_x, 
	S32 start_y, 
	S32 end_x, 
	S32 end_y, 
...
extern void gui_screen_switch_effect_get_frame_buffer_info(
	U32 frame_buf_index, 
	PU8 *buf_p, 
	S32 *buf_size);
...
extern void gui_ssp_set_highlight_threshold(
...
//add by huking
#ifdef GUI_LIST_MENU_SMOOTH_SCROLLING_BY_PEN
extern void wgui_reset_ssp_and_sync_menu_display_when_freerun(void);
#else
#define wgui_reset_ssp_and_sync_menu_display_when_freerun()
#endif

extern void* gui_list_menu_get_menuitem(
				S32 index, 
