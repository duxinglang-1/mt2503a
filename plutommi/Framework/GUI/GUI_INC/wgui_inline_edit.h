...
typedef struct _wgui_inline_item_datetime
{
    U32 flags;
    PU8 buffer_1;//day,hours,b1
    PU8 buffer_2;//month,minutes,b2
    PU8 buffer_3;//year,seconds,b3
    PU8 buffer_4;//b4,AM_PM_flag
    void (*string_construct_callback) (PU8 string_buffer, PU8 buffer_1, PU8 buffer_2, PU8 buffer_3, PU8 buffer_4);
} wgui_inline_item_datetime;
#endif
