...
#if defined(__MMI_MOBILE_TV_CMMB_SUPPORT__) || defined(__CTM_SUPPORT__) //|| defined(__IMPS__)
...
#define __MMI_MULTILINE_IN_INLINE_SCEEN_SLIM__
#endif
...
#if  defined(__MMI_FTE_SUPPORT__) || defined(__MMI_DIALER_SEARCH__)|| defined(__MMI_BRW_URL_AUTO_COMPLETION__)|| \
defined(__MMI_BRW_SEARCH_HISTORY_SUPPORT__)|| defined(__MMI_MSG_EDITOR_WITH_RECIPIENT__ )||\
defined(__MMI_MOBILE_TV_CMMB_SUPPORT__ )|| defined(__MMI_SNS_CONTACTS__ )||defined(__WGUI_CAT280_SUPPORT_RECIPIENTS__)||\
defined(__MMI_USSD_REPLY_IN_SAME_SCREEN__  )||(!defined(__MMI_INLINE_SLIM__ ))||defined(__FMGR_FTE_TOOLBAR_SUPPORT__  )||\
((!defined(__DISABLE_SANDBOX_LIB__ ))&&(!defined(__MRE_PACKAGE_SLIM__)))||(defined(__MCARE_COMMON__ ))||\
defined(__MMI_EM_AUDIO__ )|| defined(__MMI_BT_DIALER_SUPPORT__ )						
	
	#define  __MMI_EDITOR_SINGLINE_SUPPORT__  // use singline editor
 
#else

	#define  __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__  //multline input box can support singleine 					 
...
#define GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE                  0x20000000
/* these are used in ext2_flags , they are for singline style*/
#define UI_MULTI_LINE_INPUT_BOX_SHOW_BLOCK_CURSOR                0x00000001
        /* Baidu Search requirement */
#define UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE        0x00000002
...
/* slim_2_2 */ //    extern U8 gui_multi_line_input_box_test_overflow(multi_line_input_box *b);
    ...
    extern void gui_multi_line_input_box_disable_auto_clear_hilite_mode(multi_line_input_box *b);
#endif
