...
#if defined(__MMI_UCM_BT_CALL_RECORDER__)
#ifndef __MMI_DIALER_TWO_DT_DIS__
#define __MMI_DIALER_TWO_DT_DIS__
#endif
#endif
...
typedef struct
{
    ...
    S32 blink_duration;
#endif
} cm_tab_bar_item_type;
 
typedef struct _wgui_cat403_call_tab_info_struct
{
    U8 *title;
    S8 n_tabs;
    S8 highlighted_tab;
    cm_tab_bar_item_type tab_items[CATE_CM_MAX_GROUP];
}wgui_cat403_call_tab_info_struct;
#endif
#endif
...
#if defined(__MMI_DIALER_TWO_DT_DIS__)
#define WGUI_CAT403_MENU_Y  (WGUI_CAT403_IMG_Y + WGUI_CAT403_IMG_H + 1)
#else
#define WGUI_CAT403_MENU_Y  (WGUI_CAT403_IMG_Y + WGUI_CAT403_IMG_H)
#endif /* __MMI_DIALER_TWO_DT_DIS__ */ 
/* DOM-NOT_FOR_SDK-END */
...
#else
#define ShowCategory403Screen(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg12, _arg13, _arg14, _arg15,_arg16, _arg17, _arg18)	\
    ShowCategory403Screen_int(_arg0, _arg1, _arg2, _arg4, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg12, _arg13, _arg14, _arg15,_arg16, _arg17, _arg18)
#endif /* __MMI_DIALER_TWO_DT_DIS__ */ 
#else
extern void ShowCategory4031Screen(
                U8 *title,
                U16 title_icon,
                U16 left_softkey,
                U16 left_softkey_icon,
                ...
                U16 highlighted_item,
                U8 *history_buffer);
#define ShowCategory4031Screen(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg12, _arg13, _arg14, _arg15)	\
	ShowCategory4031Screen_int(_arg0, _arg1, _arg2, _arg4, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg12, _arg13, _arg14, _arg15)
#endif
...
#ifdef __MMI_CATE_CM_TAB_BAR_SLIM__
#if 0//wgui.h will remain the same as before,we can use these 
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
