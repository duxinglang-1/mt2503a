 ...
 *  void
 *****************************************************************************/
extern void SetIdleScreenBTDialerPairingName(const WCHAR *s);
 ...
 *  void
 *****************************************************************************/
extern void SetIdleScreenBTDialerConnectionStatus(MMI_BOOL status);
 ...
 *  void
 *****************************************************************************/
extern MMI_BOOL GetIdleScreenBTDialerConnectionStatus(void);
 ...
 *  void
 *****************************************************************************/
extern void idle_screen_show_BT_dailer_details(void);
