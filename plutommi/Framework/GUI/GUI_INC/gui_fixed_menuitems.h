...
extern UI_menuitem_theme* current_menuitem_theme;
...
/* DOM-NOT_FOR_SDK-BEGIN */ 
//extern void gui_set_fixed_text_menuitem_theme(fixed_text_menuitem *m, UI_menuitem_theme *t);
#define gui_set_fixed_text_menuitem_theme(_arg0, _arg1) gui_set_fixed_icontext_menuitem_theme(_arg0, _arg1)
//extern void gui_set_fixed_text_menuitem_current_theme(fixed_text_menuitem *m);
#define gui_set_fixed_text_menuitem_current_theme(_arg) gui_set_fixed_icontext_menuitem_current_theme(_arg)
//extern void gui_create_fixed_text_menuitem(fixed_text_menuitem *m, S32 width, S32 height);
#define gui_create_fixed_text_menuitem(_arg0, _arg1, _arg2) gui_create_fixed_icontext_menuitem(_arg0, _arg1, _arg2)
...
#define gui_show_fixed_text_menuitem(_arg0, _arg1, _arg2) gui_show_fixed_icontext_menuitem(_arg0, _arg1, _arg2)
//extern void gui_measure_fixed_text_menuitem(void *item, void *common_item_data, S32 *width, S32 *height);
#define gui_measure_fixed_text_menuitem(_arg0, _arg1, _arg2, _arg3) gui_measure_fixed_icontext_menuitem(_arg0, _arg1, _arg2, _arg3)
//extern void gui_highlight_fixed_text_menuitem(void *item, void *common_item_data);
#define gui_highlight_fixed_text_menuitem(_arg0, _arg1) gui_highlight_fixed_icontext_menuitem(_arg0, _arg1)
//extern void gui_remove_highlight_fixed_text_menuitem(void *item, void *common_item_data);
#define gui_remove_highlight_fixed_text_menuitem(_arg0, _arg1) gui_remove_highlight_fixed_icontext_menuitem(_arg0, _arg1)
//extern void gui_fixed_text_menuitem_stop_scroll(void);
#define gui_fixed_text_menuitem_stop_scroll gui_fixed_icontext_menuitem_stop_scroll
 ...
 */
/* DOM-NOT_FOR_SDK-BEGIN */
extern void gui_set_fixed_icontext_menuitem_current_theme(void *m);
extern void gui_set_fixed_icontext_menuitem_theme(void *m, UI_menuitem_theme *t);
...
extern  void gui_menuitem_set_icon_position(void *common_item_data, S32 x, S32 y);
#define gui_fixed_icontext_menuitem_set_icon_position(_arg1, _arg2, _arg3) gui_menuitem_set_icon_position(_arg1, _arg2, _arg3)
extern void gui_resize_fixed_icontext_menuitem(void *m, S32 width, S32 height);
 ...
 */
/* DOM-NOT_FOR_SDK-BEGIN */
#define gui_set_fixed_twostate_menuitem_current_theme(arg) gui_set_fixed_icontext_menuitem_current_theme(arg)
#define gui_set_fixed_twostate_menuitem_theme(_arg1, _arg2) gui_set_fixed_icontext_menuitem_theme(_arg1, _arg2)
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
#define gui_fixed_twostate_menuitem_set_text_position(_arg0,_arg1, _arg2) gui_menuitem_set_text_position(_arg0,_arg1, _arg2)
#define gui_fixed_twostate_menuitem_set_icon_position(_arg0,_arg1, _arg2) gui_menuitem_set_icon_position(_arg0,_arg1, _arg2)
//extern void gui_resize_fixed_twostate_menuitem(fixed_twostate_menuitem *m, S32 width, S32 height);
#define gui_resize_fixed_twostate_menuitem(_arg0, _arg1, _arg2) gui_resize_fixed_icontext_menuitem(_arg0, _arg1, _arg2)
...
/* DOM-NOT_FOR_SDK-BEGIN */
extern MMI_BOOL gui_list_effect_is_blocked(void);
extern void gui_stop_list_highlight_effect(void);
#if  0//__MMI_UI_LIST_ANIMATE_HIGHLIGHT_EFFECTS__
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
//extern void gui_fixed_two_line_set_filler(UI_filled_area *filler);
#define gui_fixed_two_line_set_filler(arg) 
/* DOM-NOT_FOR_SDK-END */
#endif /* defined(__MMI_UI_TWO_LINE_MENUITEM_STYLES__) || defined(__MMI_UI_HINTS_IN_MENUITEM__) */
...
extern MMI_BOOL (*gui_get_two_line_menuitem_height)(void);
...
extern MMI_BOOL UI_dummy_get_two_line_menuitem_height(void);
...
//add by huking
#ifndef __MMI_UI_MENU_ENHANCEMENT_SLIM__
extern MMI_BOOL gui_list_is_hide_menu_callback_executed(S32 x1,S32 y1, S32 x2, S32 y2);
#else
#define gui_list_is_hide_menu_callback_executed(_arg0, _arg1, _arg2, _arg3)
#endif/*__MMI_UI_MENU_ENHANCEMENT_SLIM__*/
extern S32 wgui_get_current_menuitem_index(fixed_list_menu *m);
extern void wgui_resize_menuitem(void);
extern MMI_BOOL gui_is_matrix_menu_show_vbar(S32 flags);

#ifdef __MMI_HORIZONTAL_SCROLL_BAR_SUPPORT__    
extern MMI_BOOL gui_is_matrix_menu_show_hbar(S32 flags);
#endif/*#ifdef __MMI_HORIZONTAL_SCROLL_BAR_SUPPORT__    */

#ifdef __MMI_UI_TRANSPARENT_EFFECT__
extern void gui_menu_disable_transparent_effect_when_multilayer(void *m);
#else/*__MMI_UI_TRANSPARENT_EFFECT__*/
#define gui_menu_disable_transparent_effect_when_multilayer(_arg)
#endif/*__MMI_UI_TRANSPARENT_EFFECT__*/

extern void gui_push_and_set_list_menu_act_handle_active(void);
extern MMI_BOOL gui_is_fixed_list_menu_empty(void);
//end huking add
