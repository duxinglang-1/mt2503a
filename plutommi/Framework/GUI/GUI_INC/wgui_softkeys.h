...
#else
#define wgui_softkey_set_icon_for_IME(_arg0, _arg1)
...
#ifndef __MMI_WGUI_DISABLE_CSK__
#define EnableCenterSoftkey EnableCenterSoftkey_ex 
#else
#define EnableCenterSoftkey(_arg0, _arg1) EnableCenterSoftkey_ex()
#endif/*__MMI_WGUI_DISABLE_CSK__*/
...
#ifndef __MMI_WGUI_DISABLE_CSK__
#define ChangeCenterSoftkey ChangeCenterSoftkey_ex
#else
#define ChangeCenterSoftkey(_arg0, _arg1) ChangeCenterSoftkey_ex()
#endif
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__ 
#define EnableLeftSoftkey EnableLeftSoftkey_ex
#else
#define EnableLeftSoftkey(_arg0, _arg1) EnableLeftSoftkey_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__
#define DisableLeftSoftkey DisableLeftSoftkey_ex
#else
#define DisableLeftSoftkey(_arg0, _arg1) DisableLeftSoftkey_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__ 
#define EnableRightSoftkey EnableRightSoftkey_ex
#else
#define EnableRightSoftkey(_arg0, _arg1) EnableRightSoftkey_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__
#define DisableRightSoftkey DisableRightSoftkey_ex
#else
#define DisableRightSoftkey(_arg0, _arg1) DisableRightSoftkey_ex(_arg0) 
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
extern void set_left_softkey_function(void (*f) (void), MMI_key_event_type k);
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
extern void set_right_softkey_function(void (*f) (void), MMI_key_event_type k);
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
extern FuncPtr get_left_softkey_function(MMI_key_event_type k) ;
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
extern FuncPtr get_right_softkey_function(MMI_key_event_type k);
...
extern void execute_left_softkey_function(MMI_key_event_type k);
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
extern void execute_right_softkey_function(MMI_key_event_type k);
 ...
 *****************************************************************************/
#ifndef __MMI_WGUI_DISABLE_CSK__
extern void redraw_center_softkey(void);
#else
#define redraw_center_softkey() 
...
extern void set_right_softkey_label(UI_string_type s);
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
extern UI_string_type get_left_softkey_label(void);
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
extern UI_string_type get_right_softkey_label(void);
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__ 
#ifndef __MMI_WGUI_DISABLE_CSK__
PU8 get_center_softkey_icon(void);
#endif/*#ifndef __MMI_WGUI_DISABLE_CSK__*/
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
void set_left_softkey_icon(PU8 icon);
#else
#define set_left_softkey_icon(ICON) 
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
void set_right_softkey_icon(PU8 icon);
#else
#define set_right_softkey_icon(ICON)   
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__
#define change_left_softkey change_left_softkey_ex
#else
#define change_left_softkey(_arg0, _arg1) change_left_softkey_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
/*****************************************************************************
 * <group dom_softkey_macro>
 * FUNCTION
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__
#define change_right_softkey change_right_softkey_ex
#else
#define change_right_softkey(_arg0, _arg1) change_right_softkey_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
 ...
 *  void
 *****************************************************************************/
extern void clear_left_softkey(void);
 ...
 *  void
 *****************************************************************************/
extern void clear_right_softkey(void);
 ...
 *  void
 *****************************************************************************/
extern void show_left_softkey(void);
 ...
 *  void
 *****************************************************************************/
extern void show_right_softkey(void);
 ...
 *  void
 *****************************************************************************/
extern void register_hide_left_softkey(void (*f) (void));
 ...
 *  void
 *****************************************************************************/
extern void register_hide_right_softkey(void (*f) (void));
 ...
 *  void
 *****************************************************************************/
extern void register_left_softkey_handler(void);
 ...
 *  void
 *****************************************************************************/
extern void register_right_softkey_handler(void);
 ...
 *  void
 *****************************************************************************/
extern void clear_left_softkey_handler(void);
 ...
 *  void
 *****************************************************************************/
extern void clear_right_softkey_handler(void);
...
#else
#define set_softkey_icon(_arg0, _arg1)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
/*****************************************************************************
 * <group dom_softkey_wgui_layer_property_setting>
 * FUNCTION
...
#else
#define get_softkey_icon(_arg) NULL
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
/*****************************************************************************
 * <group dom_softkey_wgui_layer_property_setting>
 * FUNCTION
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__	
#define change_softkey  change_softkey_ex
#else
#define change_softkey(_arg0, _arg1, _arg2) change_softkey_ex(_arg0, _arg2)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__
#define ChangeLeftSoftkeyByString ChangeLeftSoftkeyByString_ex
#else
#define ChangeLeftSoftkeyByString(_arg0, _arg1) ChangeLeftSoftkeyByString_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__ 
#define ChangeRightSoftkeyByString ChangeRightSoftkeyByString_ex
#else
#define ChangeRightSoftkeyByString(_arg0, _arg1) ChangeRightSoftkeyByString_ex(_arg0)
#endif/*__MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
...
//huking add
extern void clear_all_softkey_display_functions(void);
extern void register_all_softkey_handlers(void);
extern void clear_softkey_handlers(void);
extern void show_softkeys(void);
//end huking add
#ifdef __cplusplus
}
#endif 
