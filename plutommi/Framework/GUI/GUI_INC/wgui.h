...
#if defined (__MMI_UI_TECHNO_IDLESCREEN_BAR__) && ( defined (__MMI_TOUCH_IDLESCREEN_SHORTCUTS__) || defined(__MMI_BT_BOX_IDLE_SHORTCUTS__))
...
/* under construction !*/
        ...
        #define MMI_IDLE_BT_DAILER_PAIR_NAME_Y              (22)
		#else
        #define MMI_IDLE_BT_DAILER_PAIR_NAME_Y				(44)
		#endif
#endif  
...
#else
    #define MMI_SINGLELINE_INPUTBOX_HEIGHT                  (32)
#endif
...
#define MMI_HORIZONTAL_TAB_BAR_WIDTH                        (MMI_TITLE_WIDTH)
    ...
    #if defined(__MMI_MAINLCD_128X128__) && defined ( __BT_DIALER_SUPPORT__)
        #define MMI_HORIZONTAL_TAB_BAR_TAB_AREA_HEIGHT          (20)
        #define MMI_HORIZONTAL_TAB_BAR_HINT_AREA_HEIGHT         (20)
        #define MMI_HORIZONTAL_TAB_BAR_TAB_WIDTH                (60)
        #define MMI_HORIZONTAL_TAB_BAR_FOCUSED_TAB_WIDTH        (60)
