...
#include "kal_general_types.h"
    ...
    #define __MMI_DATETIME_USE_MULTI_LINE__
    #endif
#endif 
...
/*duration edit is not used in inline, use this option to slim */
#ifdef __DATETIME_MULTI_LINE_SUPPORT_DURATION__
#undef __DATETIME_MULTI_LINE_SUPPORT_DURATION__
#endif
...
typedef enum
{
    DATETIME_INPUT_TYPE_BASE,
    DATETIME_INPUT_TYPE_DATE = DATETIME_INPUT_TYPE_BASE,
    DATETIME_INPUT_TYPE_TIME,
    DATETIME_INPUT_TYPE_IP4,
#ifdef __DATETIME_MULTI_LINE_SUPPORT_DURATION__
    DATETIME_INPUT_TYPE_DURATION,
#endif
    DATETIME_INPUT_TYPE_MAX
}datetime_input_type_enum;


#define DATETIME_INPUT_DATE_LENGTH     (10)    /* eg:  2013.01.01 */
#define DATETIME_INPUT_TIME_LENGTH     (5)     /* eg:  10:10        */
#define DATETIME_INPUT_IP4_LENGTH      (15)    /* eg:  000.000.000.000  */
#ifdef __DATETIME_MULTI_LINE_SUPPORT_DURATION__
#define DATETIME_INPUT_DURATION_LENGTH (8)     /* eg:  01:20:20    */
#endif
#define DATETIME_INPUT_BUF_TEXT_LENGTH (16)    /*the max length of datetime text buffer */
...
typedef struct _Times
{
    PU8 hour;
    PU8 minute;
    PU8 AM_PM_flag; //need discuss with inline edit.
}Times;
...
typedef struct _datetime_input
{
    datetime_input_type_enum type;
    datetime_detail detail;
    S32 x, y, width, height;
    U32 flags;         //text direction is left or right
    MMI_BOOL is_focus; //is edit status.
    U32 current_focus; //cursor position   
    UI_buffer_type text;  //text is the total buffer info in multi line.
    UI_buffer_type current_text_p; //??? no use ?
    UI_character_type seperator;
...
extern void set_inline_date_boundary(S32 date_year_max, S32 date_year_min, S32 date_month_max, S32 date_month_min);
extern void datetime_input_show_background(datetime_input *d);
extern void datetime_input_reset_focus(datetime_input *d);
extern void datetime_input_set_focus(datetime_input *d);
extern void create_datetime_input(datetime_input *d, U32 flags);        
extern void show_datetime_input(datetime_input *d);
extern void datetime_input_set_seperator(datetime_input *d, UI_character_type seperator);
extern void datetime_input_set_hide_function(datetime_input *d, void (*f) (S32 x1, S32 y1, S32 x2, S32 y2));

extern datetime_input *current_datetime_input;
extern void (*current_datetime_input_callback) (void);

extern void set_current_datetime_input(datetime_input *d);
extern void datetime_input_direct_input(UI_character_type c);
extern MMI_BOOL datetime_input_direct_input_nodraw(UI_character_type c);
extern void datetime_input_delete_character(void);
extern S32  datetime_input_test_last_position(datetime_input *d);
extern void datetime_input_previous_character(void);
extern void datetime_input_first_character(void);
extern void datetime_input_next_character(void);
extern void datetime_input_toggle_insert_mode(void);
extern void datetime_input_delete_current_character(void);
extern void datetime_input_delete_all_characters(void);
extern void datetime_input_numeric_keyboard_input_handler(S32 keyc);
extern void datetime_input_handle_key_down(MMI_key_code_type k);
extern void datetime_input_key_handler(S32 vkey_code, S32 key_state);
extern void datetime_input_register_keys(void);
extern void datetime_input_clear_keys(void);
extern void register_datetime_input_callback(void (*f) (void));
extern void clear_datetime_input_callback(void);
