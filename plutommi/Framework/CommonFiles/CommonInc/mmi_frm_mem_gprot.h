...
typedef void    (*mmi_mfree_func_ptr) (void *ptr);
...
#define MMI_FRM_APP_MEM_INCLUDE_HIDE (0x2)
#define MMI_FRM_APP_MEM_SKIP_V10 (0x1)
...
#define mmi_frm_asm_app_hide(app_id) mmi_frm_group_hide(app_id)
void mmi_frm_asm_app_unhide(MMI_ID app_id);
extern U32 mmi_frm_asm_get_asm_usage(MMI_ID requester_id, applib_mem_ap_usage_struct *applist, U32 param);
