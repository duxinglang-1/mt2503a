...
void entry_category199_tab_0(void)
{
    ...
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 1, ExitScreen_Generic, EntryCSBStartView, MMI_FRM_FULL_SCRN))
#else
...
void entry_category199_tab_1(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 2, ExitScreen_Generic, EntryCSBStartView, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
...
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    cui_tab_create(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID, tab_pages_info_array, 2, 1, NULL);
#else
...
void entry_list_tab_0(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 1, NULL, entry_list_tab_0, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
    ...
    #ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
        if(!guiBuffer)
            guiBuffer = (U8*)cui_tab_get_screen_gui_buf(SCR_ID_CSB_DUMMY_SCR_ID, SCR_ID_CSB_DUMMY_SCR_ID + 1);
    #else
...
void entry_list_tab_1(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 2, NULL, entry_list_tab_1, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
    ...
    #ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
        if(!guiBuffer)
            guiBuffer = (U8*)cui_tab_get_screen_gui_buf(SCR_ID_CSB_DUMMY_SCR_ID, SCR_ID_CSB_DUMMY_SCR_ID + 2);
    #else    
        guiBuffer   = mmi_frm_scrn_tab_page_get_active_gui_buf(); 
    #endif
...
void entry_cat628_tab_0(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 1, NULL, entry_cat628_tab_0, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
...
void entry_cat628_tab_1(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 2, NULL, entry_cat628_tab_1, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
...
void entry_cat629_tab_0(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 1, NULL, entry_cat629_tab_0, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
...
void entry_cat629_tab_1(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 2, NULL, entry_cat629_tab_1, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
...
void entry_inline_tab_0(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 1, NULL, exit_inline_tab_0, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
    ...
    #ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
        if(!inputBuffer)
            inputBuffer = (U8*)cui_tab_get_screen_input_buf(SCR_ID_CSB_DUMMY_SCR_ID, SCR_ID_CSB_DUMMY_SCR_ID + 1);
        if(!guiBuffer)
            guiBuffer = (U8*)cui_tab_get_screen_gui_buf(SCR_ID_CSB_DUMMY_SCR_ID, SCR_ID_CSB_DUMMY_SCR_ID + 1);
    #else
...
void entry_inline_tab_1(void)
{
    ...
    /*----------------------------------------------------------------*/
#ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
    if (cui_tab_enter(GRP_ID_CSB_ROOT, SCR_ID_CSB_DUMMY_SCR_ID + 2, NULL, exit_inline_tab_1, MMI_FRM_FULL_SCRN))
#else
    if (mmi_frm_scrn_tab_page_enter(
    ...
    #ifdef __MMI_TAB_BAR_SUPPORT_TAB_PAGE__
        if(!inputBuffer)
            inputBuffer = (U8*)cui_tab_get_screen_input_buf(SCR_ID_CSB_DUMMY_SCR_ID, SCR_ID_CSB_DUMMY_SCR_ID + 2);
        if(!guiBuffer)
            guiBuffer = (U8*)cui_tab_get_screen_gui_buf(SCR_ID_CSB_DUMMY_SCR_ID, SCR_ID_CSB_DUMMY_SCR_ID + 2);
    #else
        inputBuffer = (U8*)mmi_frm_scrn_tab_page_get_active_input_buf();
