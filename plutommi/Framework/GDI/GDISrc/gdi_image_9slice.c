...
#endif
/*
#ifndef GDI_9SLICE_DEBUG
#define GDI_9SLICE_DEBUG
#endif
*/
#ifdef GDI_9SLICE_DEBUG
                    ...
                    S32 sw)
{
    ...
    do
    {
        ...
        if (GDI_FAILED == gdi_layer_test_set_clip(&dest_clip))
        {
            break;
        }
        ...
        #endif /* GDI_SLIM_COLOR_FORMAT */
            else if (GDI_COLOR_FORMAT_32== gdi_act_layer->cf || GDI_COLOR_FORMAT_32_PARGB == gdi_act_layer->cf)
            {
                gdi_image_blending_32_to_32(
                    ...
                    dw,
                    dh);
                if (gdi_act_layer->cf == GDI_COLOR_FORMAT_32)
                {
                    ...
                    S32 sh)
{
    ...
    do{
        ...
        {
            if (GDI_FAILED == gdi_layer_test_set_clip(&dst_area))
            {
                break;
            }
