...
#ifndef GDI_SLIM_SUPPORT
    GDI_TRACE(GDI_TRC_MEM, GDI_MEM_ALLOC_START, size, file_p, line_p);
#else
    GDI_TRACE(GDI_TRC_MEM, GDI_MEM_ALLOC_START, size, 0, 0);
#endif
...
#ifndef GDI_SLIM_SUPPORT
    GDI_TRACE(GDI_TRC_MEM, GDI_MEM_FREE, *pointer, file_p, line_p);
#else
    GDI_TRACE(GDI_TRC_MEM, GDI_MEM_FREE, *pointer, 0, 0);
#endif
    {
        kal_bool is_system_init = KAL_FALSE;
        is_system_init = kal_query_systemInit();
