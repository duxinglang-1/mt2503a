...
typedef struct
{
    MMI_BOOL    cusmiz_supl_enable;
    U8          cusmiz_supl_name[32];
    U16         cusmiz_supl_port;
    MMI_BOOL    cusmiz_use_tls;
} mdi_gps_configuration_struct;
#endif
...
#ifdef __IOT_CUSTOMIZE__
extern void mdi_gps_set_config(MMI_BOOL supl_en, U8 *supl_name, U16 supl_port, MMI_BOOL use_tls);
#endif
