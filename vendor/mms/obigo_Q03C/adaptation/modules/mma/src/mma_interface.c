...
#endif /* !defined( MMA_MMS_CREATION_MODE_FREE_ONLY_SUPPORT ) && defined( __MMI_VCARD__ ) */
/*****************************************************************************
 * FUNCTION
...
#else
    char *filepath_p = (char*)MSF_MEM_CALLOC(mod_id, 1, strlen("c:\\@mms_1\\mms_sys\\xxxxxxxx.s") + 2); /* To reduce size of ram MMA_MAX_INTERNAL_FILENAME_LENGTH); */
#endif /* __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__ */
...
void MMAif_SendFmtFormatInd(void *req)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
#if( defined(MMS_IN_LARGE_STORAGE) && !defined(__MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__) )
...
#endif /* defined(MMS_IN_LARGE_STORAGE) && !defined(__MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__) */
...
#else
    if(drive_enum == MMA_MSG_STORAGE_CARD1)
    {
