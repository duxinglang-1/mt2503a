...
#else
                            externalFileName = (kal_uint8*) MSF_FILE_GET_EXTERNAL_FILENAME_EXT(MSF_MODID_MMA, vFileName,MSF_MMS_STORAGE_MEM_CARD_1 );
#endif /* __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__ */
...
#else
                        externalSrcFileName = (kal_uint8*) MSF_FILE_GET_EXTERNAL_FILENAME_EXT(MSF_MODID_MMA, vFileName, MSF_MMS_STORAGE_MEM_CARD_1);
#endif /* __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__ */
