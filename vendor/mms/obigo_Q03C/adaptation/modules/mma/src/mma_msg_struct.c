...
#else
        externalFilePath = (kal_uint8*) MSF_FILE_GET_EXTERNAL_FILENAME_EXT(MSF_MODID_MMA, filepath, MSF_MMS_STORAGE_MEM_CARD_1);
...
/*transform illegal filenames here and set the extentions here*/
...
#ifndef MMA_MMS_CREATION_MODE_FREE_ONLY_SUPPORT
    obj->is_restricted = mma_is_restricted_type_vf(
                            ...
                            obj->size,
                            storage);
#endif /*MMA_MMS_CREATION_MODE_FREE_ONLY_SUPPORT */
    ...
    switch (gType)
    {
        case MIME_TYPE_TEXT:
           // slide->txt = SLS_OBJECT_TYPE_TEXT;
            ...
            slide->txt.begin = MMA_MIXED_MMS_SLIDE_N_OBJ_START_TIME;
            slide->txt.end = MMA_MIXED_MMS_SLIDE_N_OBJ_END_TIME;
#endif	/* MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE */
            break;
        case MIME_TYPE_AUDIO:
			...
			slide->aud.id = obj->id;        
#ifndef MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE
			slide->aud.begin = MMA_MIXED_MMS_SLIDE_N_OBJ_START_TIME; 
			slide->aud.end = MMA_MIXED_MMS_SLIDE_N_OBJ_END_TIME; 
#endif	/* MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE */
            break;
        case MIME_TYPE_IMAGE:
			...
			slide->img.id = obj->id;            
#ifndef MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE
			slide->img.begin = MMA_MIXED_MMS_SLIDE_N_OBJ_START_TIME; 
			slide->img.end = MMA_MIXED_MMS_SLIDE_N_OBJ_END_TIME;       
#endif	/* MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE */
            break;
        case MIME_TYPE_VIDEO:
#ifdef __MMI_MMS_VIDEO_FEATURE__
			...
			slide->vid.id = obj->id; 
#ifndef MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE
			slide->vid.begin = MMA_MIXED_MMS_SLIDE_N_OBJ_START_TIME;   
			slide->vid.end = MMA_MIXED_MMS_SLIDE_N_OBJ_END_TIME; 
#endif	/* MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE */
            break;
#endif
        case MIME_TYPE_APPLICATION:
			...
			s_obj->id = obj->id;
#ifndef MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE
			s_obj->begin = MMA_MIXED_MMS_SLIDE_N_OBJ_START_TIME;
			s_obj->end = MMA_MIXED_MMS_SLIDE_N_OBJ_END_TIME;
#endif	/* MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE */
...
#else
			obj->file_path_ucs = /*mma_str_trnslt_utf8_to_ucs2(mod_id, obj->file_path);*/ (kal_wchar*)MSF_FILE_GET_EXTERNAL_FILENAME_EXT(mod_id, obj->file_path, MSF_MMS_STORAGE_MEM_CARD_1);
#endif /* __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__ */
		}
		MSF_MEM_FREE(mod_id, obj->file_path);
		obj->file_path = NULL;
    ...
    MmsMsgHandle *msg, MmsTransactionHandle *transaction)
{
    ...
    switch ( tHandle->state)
    {
        ...
        case 2:
            ...
            if ( (MSF_UINT32) tHandle->counter < *size)
            {
                tHandle->bytesLeft = (MSF_UINT32)tHandle->counter;
                *size = (MSF_UINT32) tHandle->counter;
            }
            else
            {
        ...
        case 3:
            ...
            tHandle->bytesLeft = tHandle->counter;
    ...
    MSF_LOG_MSG_ARGS(( MSF_LOG_DETAIL_LOW, modId, 
        MMSL_IF_5CC98D40226FFFBE46558A9B1447B3E1, "MMSlib_getBodyPart( %d, %d)\n", number, mHandle->msgId));
    return result;
} /* MMSlib_getBodyPart */
