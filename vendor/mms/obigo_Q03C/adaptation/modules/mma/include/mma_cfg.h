...
//#define MMA_MMS_ERROR_HNDLNG_AND_RARE_USED_CODE

/*changes for further SLIM MMS, remove SMIL support and unnecessary handling */
//#define MMA_SML_SUPPORT_AND_EXTRA_ERROR_HANDLE
/*MMS on SD card only*/
//#define __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__
/*MMS creation mode free only support*/
#ifdef __MMI_MMS_SIMPLIFIED_UI_SUPPORT__
#define MMA_MMS_CREATION_MODE_FREE_ONLY_SUPPORT
