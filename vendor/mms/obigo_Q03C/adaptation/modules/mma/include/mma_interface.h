...
#if (!defined( __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__ ) && defined( __MMI_MMS_MEMORY_CARD_STORAGE_SUPPORT__ ))
...
#endif /* !defined( __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__ ) && defined( __MMI_MMS_MEMORY_CARD_STORAGE_SUPPORT__ ) */
