...
#define MMS_REPORTS_SUPPORT 1
#define MMS_ROAMING_SUPPORT 1
...
#define MMS_DEFAULT_USER_AGENT NULL // ((char*)wap_custom_get_mms_user_agent())/*"MediaTek Maui MMS Agent"*/
...
#ifdef MMS_REPORTS_SUPPORT
/*! This value is the default value for the registry setting #MMS_REG_KEY_TEXT_FROM. */
#define MMS_DEFAULT_RR_TEXT_FROM            NULL 

/*! This value is the default value for the registry setting #MMS_REG_KEY_TEXT_TO. */
#define MMS_DEFAULT_RR_TEXT_TO              NULL

/*! This value is the default value for the registry setting #MMS_REG_KEY_TEXT_READ. */
#define MMS_DEFAULT_RR_TEXT_READ            NULL

/*! This value is the default value for the registry setting #MMS_REG_KEY_TEXT_MSGID. */
#define MMS_DEFAULT_RR_TEXT_MSGID           NULL

/*! This value is the default value for the registry setting #MMS_REG_KEY_GW_USERNAME. */
#define MMS_DEFAULT_RR_TEXT_SENT            NULL

/*! This value is the default value for the registry setting MMS_REG_KEY_TEXT_YOUR_MSG. */
#define MMS_DEFAULT_RR_TEXT_YOUR_MSG        NULL

/*! This value is the default value for the registry setting #MMS_REG_KEY_TEXT_WAS_READ. */
#define MMS_DEFAULT_RR_TEXT_WAS_READ        NULL

/*! This value is the default value for the registry setting #MMS_REG_KEY_TEXT_SUBJECT. */
#define MMS_DEFAULT_RR_TEXT_SUBJECT         NULL
#endif
...
/* *******************************************************************************
	Old Accept headers List. 
If any one want to add more haeders add in above macro (MMS_DEFAULT_CLIENT_HTTP_HEADER)
********************************************************************************
...
#define MMS_GET_RETRY       0        /*(mmsa_get_max_mms_get_retry_num())*/

/*! Number of retries before a POST operation is considered to have failed. */
#define MMS_POST_RETRY       0       /*(mmsa_get_max_mms_post_pdu_retry_num())*/

/*! Number of retries before a POST operation is considered to have failed if it is a MMS_M_SEND_REQ. */
#define MMS_POST_MSG_RETRY    0      /*(mmsa_get_max_mms_post_msg_retry_num())*/
...
#define MMS_DEFAULT_MESSAGE_SIZE_MAXIMUM            (wap_custom_get_max_mms_msg_size())

/*! The default setting for allowing user defined string in message class. 
 *  "" = not used */
#define MMS_DEFAULT_CLASS_STRING                    ""

 /*! The default setting for allowing immediate retrieval from only one server
 *   "" = not used */
#define MMS_DEFAULT_IMMEDIATE_RETRIEVAL_SERVER      ""
#ifdef MMS_ROAMING_SUPPORT
...
#define MMS_MAX_NO_OF_CARD_MSG       (wap_custom_get_max_mms_num_on_card())
#ifdef MMS_REPORTS_SUPPORT
#define MMS_MAX_REPORT_COUNT    (wap_custom_get_max_report_mms_num())
#endif
...
#define MMS_FLDRMGR_CREATE         1
/*! Deletion of a message */
#define MMS_FLDRMGR_DELETE         1
...
#define MMS_OPER_REQD_MAX_FREE_MEMORY 80*1024
...
/*! Max number of characters for subject. */
#define MAX_SUBJECT_CHAR                40
...
#define MAX_LEN_TRANSACTION_ID          41
 /*! Max Number fo MMS in Get MSG LIST */
#define MAX_MMS_GET_PHONE_LIST_COUNT   25
#define MAX_MMS_GET_CARD_LIST_COUNT   10
/*!
...
#define MMS_SLIM_MAX_OBJ_SUPPORT_IN_PARSE 20
/*only memory card storage for MMS*/
//#define __MMI_MMS_ONLY_MEMORY_CARD_STORAGE_SUPPORT__

/* read and delivery report support*/
//#define MMS_REPORTS_SUPPORT
