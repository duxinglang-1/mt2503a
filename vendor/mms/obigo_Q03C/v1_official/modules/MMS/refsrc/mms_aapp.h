...
#define MMS_TEMPLATES_DEMO_SUPPORT       0 

#define MMS_GET_STR_ID(strId)       MSF_WIDGET_STRING_GET_PREDEFINED(strId)
#define MMS_SYS_FOLDER "/mms_sys/"
#define MMA_MAIN_TIMER_INTERVAL 300 /*30 seconds*/



extern MSF_UINT32 mmsGetFreeSpace(MSF_UINT8 storageType);
extern char MMSa_getDriveLetter(MSF_UINT8 storage_type);
