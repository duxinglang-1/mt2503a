...
/************************************************************************
* FUNCTION                                                            
*get_slim_min_mms_obj
*
* DESCRIPTION                                                           
*  get the minimum no fo SLIM object supported
*
* CALLS  
...
*   None
*************************************************************************/
MSF_UINT32 get_slim_min_mms_obj(MSF_UINT32 nrOfParts)
{

#ifdef __MMI_MMS_NO_SMIL_SUPPORT__ 
	nrOfParts = (nrOfParts < (MMS_SLIM_MAX_OBJ_SUPPORT_IN_PARSE +1)) ? nrOfParts : (MMS_SLIM_MAX_OBJ_SUPPORT_IN_PARSE + 1);
#endif /*__MMI_MMS_NO_SMIL_SUPPORT__*/
...
MSF_UINT32 mmsa_getRoamingmode(MSF_UINT8 simId)
{
    ...
    if(srv_nw_info_is_roaming(translate_mms_sim_to_mma_sim(simId)))
    {
        return MMS_ROAMING;
    }
    else
