...
void wps_receive(MSF_UINT8 srcModule, MSF_UINT16 signal, void *p)
{
    ...
    switch (signal)
    {
        case MSF_SIG_PIPE_NOTIFY:
            wps_pipe_notify((msf_pipe_notify_t *)p);
            break;
        case STK_SIG_HTTP_REPLY:
            ...
            wps_http_reply((stk_http_reply_t *)p);
            break;
        case STK_SIG_HTTP_REQUEST_ABORTED:
            ...
            wps_http_abort((stk_http_request_aborted_t *)p);
            break;
        case STK_SIG_STREAM_CONNECTION_CREATED:
            ...
            wps_stream_connection_created((stk_stream_connection_created_t *)p);
            break;
        case STK_SIG_CONNECTION_CLOSED:
            ...
            wps_stream_connection_closed((stk_connection_closed_t*)p);
            break;
        ...
        case MSF_SIG_MODULE_EXECUTE_COMMAND:
            wps_handle_command((msf_module_execute_cmd_t *)p);
            break;
    #ifdef WAP_SEC_SUPPORT
        case SEC_SIG_GET_SESSION_INFO_RESPONSE:
            wps_get_session_info_rsp((sec_get_session_info_response_t *)p);
            break;
        case SEC_SIG_GET_CURRENT_CERT_RESPONSE:
            wps_get_current_cert_rsp((sec_get_current_cert_response_t *)p);
            break;
        case SEC_SIG_GET_CERT_IDS_RESPONSE:
            wps_get_cert_ids_rsp((sec_get_cert_ids_response_t *)p);
            break;
        case SEC_SIG_GET_CERT_RESPONSE:
            wps_get_cert_rsp((sec_get_cert_response_t *)p);
            break;            
        case SEC_SIG_VERIFY_CERT_CHAIN_RESPONSE:
#ifdef __HTTP_INTERFACE__
            wps_verify_cert_chain_rsp((sec_verify_cert_chain_response_t *)p);
#endif /*__HTTP_INTERFACE__*/
            break;
        case WPS_SIG_SHOW_SEC_CONFIRM_DIALOG:
            wps_sec_handle_show_confirm_dialog((wps_show_sec_confirm_dialog_struct *)p);
            break;
        case SEC_SIG_DELETE_CERT_RESPONSE:
            wps_sec_handle_delete_ca_cert_response((sec_delete_cert_response_t *)p);
            break;
        ...
        case WPS_SIG_HTTP_AUTH_INDICATION:
            wps_http_auth_ind((wps_http_auth_ind_t *)p);
            break;
        default:
            MSF_MEM_FREE(MSF_MODID_WPS, p);
            break;
