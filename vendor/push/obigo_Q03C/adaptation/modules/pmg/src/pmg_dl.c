...
#if (defined (__WAP_PUSH_SUPPORT__) && !defined(__WAP_PUSH_SERVICE_ONLY_SUPPORT__) && !defined(__COSMOS_MMI_PACKAGE__))
    #include "mmi_rp_app_mmi_wap_push_def.h"
#endif /*__WAP_PUSH_SUPPORT__*/
#ifndef __WAP_PUSH_SERVICE_ONLY_SUPPORT__ 
...
#endif /*__WAP_PUSH_SERVICE_ONLY_SUPPORT__*/
...
static void pmg_display_error(int cause)
{
	...
	#elif (!defined(__WAP_PUSH_SERVICE_ONLY_SUPPORT__))
