...
#if defined(BAM_CFG_RECENT_PAGES_SUPPORT) || defined(MSF_CFG_OFFLINE_PAGES_SUPPORT)
#define BAM_CFG_FILE_SUPPORT
#endif

#ifdef __MMI_WAP_IMAGE_CACHE_TCARD_PLUS_SYS_DRIVE__
#define BAM_CFG_CACHE_TCARD_PLUS_SYS_DRIVE_SUPPORT
#endif

#ifdef __MMI_WAP_IMAGE_CACHE_TCARD_PLUS_PHONE_DRIVE__
#define BAM_CFG_CACHE_TCARD_PLUS_PHONE_DRIVE_SUPPORT
#endif

#if (defined(BAM_CFG_CACHE_TCARD_PLUS_SYS_DRIVE_SUPPORT) || defined(BAM_CFG_CACHE_TCARD_PLUS_PHONE_DRIVE_SUPPORT))
#define BAM_CFG_MAX_CACHE_SIZE (50 * 1024)
#endif
#endif /* _bam_cfg_h */
