...
*****************************************************************************/
/*
 * Copyright (C) Teleca AB, 2002-2008.
 * All rights reserved.
 *
 ...
 * Description:
 * ------------
 * This file is intends for BRS configuration.
 *
 * Author:
 * -------
 * 
...
#if (defined(STREAM_SUPPORT) || defined(__OP01__) || !defined(SLIM_WAP_MMS))
#define BRS_CONFIG_PLUGIN
#endif/*(defined(__OP01__) || !defined(SLIM_WAP_MMS))*/
 ...
 */
extern unsigned int bam_cfg_brs_clear_history_on_newcontext(void);
#define BRS_CFG_CLEAR_HISTORY_ON_NEWCONTEXT		(bam_cfg_brs_clear_history_on_newcontext())
...
/* 
 * The above macro has been changed to MSF_CFG_OFFLINE_PAGES_SUPPORT
 */

/* Default "Accept:" header, sent by browser when retrieving a document. */
extern const char * bam_cfg_default_accept_header(void);
#define BRS_CFG_DEFAULT_ACCEPT_HEADER (bam_cfg_default_accept_header())
...
extern const char * bam_cfg_default_charset_header(void);
#define BRS_CFG_DEFAULT_ACCEPT_CHARSET_HEADER (bam_cfg_default_charset_header())
...
const char* bam_cfg_default_accept_language_header (void);
#define BRS_CFG_DEFAULT_ACCEPT_LANGUAGE_HEADER    (bam_cfg_default_accept_language_header())
...
#define BRS_CFG_REDIRECT   (bam_cfg_brs_redirect_handling())
...
*/
extern const char * bam_cfg_supported_image_mime(void);
#define BRS_CFG_SUPPORTED_IMAGE_MIME (bam_cfg_supported_image_mime())
...
/* Default style sheet */
extern const char * bam_cfg_brs_default_css(void);
#define BRS_CFG_CSS_DEFAULT_STYLE_SHEET (bam_cfg_brs_default_css())
...
/* Enable the offscreen focusing */
#define BRS_CFG_LE_SCROLL_TO_FOCUSED_OFFSCREEN
...
#define BRS_CFG_LE_CSS_BORDER_MEDIUM_PIXELS 3
#define BRS_CFG_LE_CSS_BORDER_THICK_PIXELS  5
#define BRS_CFG_LE_CSS_DEFAULT_BORDER_WIDTH BRS_CFG_LE_CSS_BORDER_MEDIUM_PIXELS
...
#define BRS_CFG_LE_DEFAULT_FIELDSET_STYLE BRS_CSS_VALUE_SOLID   /* MAUI_02444904 */
...
/**
 * Defines the default space between the bullet & text
 */
#define BRS_CFG_LE_DEFAULT_LIST_TEXT_SPACING           3 
...
/** 
 * If BRS_CFG_IGNORE_EMPTYOK == 1, Browser will disable the checking of 
 ...
 *
 * Default: BRS_CFG_IGNORE_EMPTYOK == 0
 */
extern unsigned int bam_cfg_brs_ignore_emptyok(void);
#define BRS_CFG_IGNORE_EMPTYOK	(bam_cfg_brs_ignore_emptyok())
#endif /* MTK_TMP_PATCH */
/*
 * 
 * This macro will enable the em & span inline type, so that 
 * They can have heading with in that tag, where as heading h1
 * h2... are block type elements.
 */
#define BRS_CFG_LE_CSS_SUPPORT_CASCADE_DESCENDANTS_SELECTORS
/*
 * This macro defined to enable the pseudo class for ANCHOR
 * A HTML element. All pseudo class will start working 
 * correctly. :link, :focus, :active, :visited 
 * but :hover classes is not possible to implement on handset
 * mouse pointer is not present.
 */
#define BRS_CFG_LE_CSS_SUPPORT_ACTIVE_PSEUDO_CLASS
/*
 * This macro is defined to enable the white-space support.
 */
/* It will increase the memory requirement for parsing/rendering a page, which has many unnecessary whitespaces.
*  Please help to uncomment to support white-space property.
#define BRS_CFG_BROWSER_SUPPORT_WHITESPACE_PRE
*/
/* This macro specifies the max limit of do elements in WML page. i.e At a time max BRS_CFG_LE_MAX_DO_ELEMENT 
 *  do elements will be supported. */
#define BRS_CFG_LE_MAX_DO_ELEMENT   20

/* MAUI_01787780 starts */
#ifndef BRS_CFG_USE_MD5_HASH_SUPPORT
#define BRS_CFG_USE_MD5_HASH_SUPPORT
#endif
/* MAUI_01787780 ends */

#if defined (BRS_CFG_LE_SUPPORT_KEY_NAVIGATION_4WKEY) && defined (MSF_CFG_9W_NAVIGATION_SUPPORT)
#define BRS_CFG_9W_NAV_SUPPORT
#endif


#ifdef MSF_CFG_MOUSE_POINTER_SUPPORT
#define BRS_CFG_LE_MOUSE_PTR_MOVE_PIXELS_VERTICAL    20
#define BRS_CFG_LE_MOUSE_PTR_MOVE_PIXELS_HORIZONTAL  20

#define BRS_CFG_LE_MOUSE_PTR_HOR_MOVE_THRESHOLD      40
#define BRS_CFG_LE_MOUSE_PTR_VER_MOVE_THRESHOLD      40

#define BRS_CFG_LE_MOUSE_PTR_DEFAULT_POS_TOP_LEFT   0
#define BRS_CFG_LE_MOUSE_PTR_DEFAULT_POS_ON_FIRST_MARKABLE_ELEMENT  1
#define BRS_CFG_LE_MOUSE_PTR_DEFAULT_POS_SCREEN_CENTER  2
/*
 * Default pos of mouse pointer.
 * Possible values: 0, 1, 2 ; Default value is 1.
 * 0    -   At 0,0.
 * 1    -   On first markable element, if there is no first markable element, it would center of screen.
 * 2    -   At the center of screen.
 */
#define BRS_CFG_LE_MOUSE_PTR_DEFAULT_POS    BRS_CFG_LE_MOUSE_PTR_DEFAULT_POS_TOP_LEFT


/*
 * Wrapping needs to be disabled incase of mouse pointer.
 */
#undef BRS_CFG_LE_CONTENT_WRAPAROUND

#endif /* MSF_CFG_MOUSE_POINTER_SUPPORT */

#ifdef MSF_CFG_BRW_SMOOTH_SCROLLING_SUPPORT
#define BRS_CFG_BROWSER_FTE_SUPPORT
#undef BRS_CFG_LE_CONTENT_WRAPAROUND    /* COSMOS */
#endif

#if defined BRS_CONFIG_HTML || defined BRS_CONFIG_XHTML
#define BRS_CFG_IMODE_UA_SUPPORT
#endif

#ifdef __BAIDU_TRANSCODING_SUPPORT__
#define BRS_CFG_TRANSCODE_PROXY_REQUEST
#endif

#ifdef SLIM_WAP_MMS
#define BRS_CFG_DISPLAY_INLINE_DO
#endif

#ifndef SLIM_WAP_MMS
#if defined BRS_CONFIG_HTML || defined BRS_CONFIG_XHTML
#define BRS_CFG_LE_IMAGE_MAP_SUPPORT
#endif
#define BRS_CFG_LE_BACKGROUND_IMAGE_SUPPORT
#endif /* SLIM_WAP_MMS */

#if !(defined (__FLAVOR_OBIGOQ03C_SLIM__) || defined (__FLAVOR_OBIGOQ03C_SLIM_DEBUG__) || defined (OBIGO_Q03C_SLIM))
#define BRS_CFG_CSS_SUPPORT
#define BRS_CFG_ABOUT_BRS_INFO_SUPPORT
#endif

#ifdef PGDL_SUPPORT_YOUTUBE
#ifndef BRS_CFG_LE_BACKGROUND_IMAGE_SUPPORT
/* under construction !*/
#endif
#endif

//#define BRS_CFG_CSS_USER_STYLE_SHEET

//#define BRS_CFG_LE_PAGE_SCROLL_SUPPORT

#if defined(BRS_CONFIG_WMLS) || defined(BRS_CONFIG_PLUGIN) || defined(BRS_CFG_CSS_USER_STYLE_SHEET)
//#define BRS_CFG_STREAM_FILE_SUPPORT
//#define BRS_CFG_STREAM_MEM_SUPPORT
#endif /* defined(BRS_CONFIG_WMLS) || defined(BRS_CONFIG_PLUGIN) */

#ifdef MSF_CFG_BRW_MARQUEE_SUPPORT
#define BRS_CFG_LE_MARQUEE_SUPPORT
#endif

#ifndef OBIGO_Q03C_SLIM
#define BRS_CFG_TABLE_SUPPORT
#endif

#ifdef BRS_CFG_CSS_SUPPORT
#define BRS_CFG_LIST_TYPE_IMAGE
#define BRS_CFG_LE_RENDER_FLOAT_SUPPORT
#else
#define BRS_CFG_LE_ONLY_SIMPLE_BORDERS
#define BRS_CFG_LIST_TYPE_DISC_ONLY
#define BRS_CFG_LIST_TYPE_NUMERIC_DECIMAL_ONLY
#endif /* BRS_CFG_CSS_SUPPORT */

//#define BRS_CFG_SCROLL_BY_PAGE_SUPPORT
//#define BRS_CFG_NARROW_RENDERING_SUPPORT

extern unsigned int bam_cfg_brs_wlan_prefer_on(void);

#define BRS_CFG_WLAN_PREFER_ON bam_cfg_brs_wlan_prefer_on()
