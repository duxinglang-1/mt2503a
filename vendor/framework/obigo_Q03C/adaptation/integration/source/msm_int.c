...
#include "brs_env.h"
#include "msf_int.h"
#include "msf_chrs.h"   //MMS_ONLY_BUILD
...
#ifdef WPS_TASK_SUPPORT     //MMS_ONLY_BUILD API added

/*****************************************************************************
 * FUNCTION
 *  msm_send_update_event_to_wps
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
void msm_send_update_event_to_wps(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    while (run)
    {
        ...
        for (i = 0; i < MSF_NUMBER_OF_MODULES; i++)
        {
            ...
            if (isSignalPending(MOD_WPS))
            {
                ...
                {
                    msm_send_update_event_to_wps();     //MMS_ONLY_BUILD
                }
            }
