...
int gmms_adp_STKc_start (void);

int gmms_adp_STKc_wantsToRun (void);

void gmms_adp_STKc_run (void);


void gmms_adp_STKc_kill(void);


int gmms_adp_WPSc_start (void);

int gmms_adp_WPSc_wantsToRun (void);

void gmms_adp_WPSc_run (void);


void gmms_adp_WPSc_kill(void);


int gmms_adp_SECc_start (void);


int gmms_adp_SECc_wantsToRun (void);

void gmms_adp_SECc_run (void);

void gmms_adp_SECc_kill(void);


int gmms_adp_WIDGETc_start (void);


int gmms_adp_WIDGETc_wantsToRun (void);

void gmms_adp_WIDGETc_run (void);


void gmms_adp_WIDGETc_kill(void);

int gmms_adp_BRSc_start (void);


int gmms_adp_BRSc_wantsToRun (void);


void gmms_adp_BRSc_run (void);


void gmms_adp_BRSc_kill(void);

int gmms_adp_BAMc_start (void);


int gmms_adp_BAMc_wantsToRun (void);


void gmms_adp_BAMc_run (void);

void gmms_adp_BAMc_kill(void);



int gmms_adp_DASc_start (void);


int gmms_adp_DASc_wantsToRun (void);

void gmms_adp_DASc_run (void);

void gmms_adp_DASc_kill(void);



int gmms_adp_PHSc_start (void);



int gmms_adp_PHSc_wantsToRun (void);


void gmms_adp_PHSc_run (void);


void gmms_adp_PHSc_kill(void);


int gmms_adp_PMGc_start (void);


int gmms_adp_PMGc_wantsToRun (void);

void gmms_adp_PMGc_run (void);


void gmms_adp_PMGc_kill(void);


int gmms_adp_MMSc_start (void);


int gmms_adp_MMSc_wantsToRun (void);

void gmms_adp_MMSc_run (void);

void gmms_adp_MMSc_kill(void);



int gmms_adp_MMAc_start (void);



int gmms_adp_MMAc_wantsToRun (void);


void gmms_adp_MMAc_run (void);


void gmms_adp_MMAc_kill(void);

int gmms_adp_ASMc_start (void);



int gmms_adp_ASMc_wantsToRun (void);


void gmms_adp_ASMc_run (void);


void gmms_adp_ASMc_kill(void);



int gmms_adp_mma_msg_hdlr(void *p);
...
ExModuleDescr msf_modules[MSF_NUMBER_OF_MODULES] = 
{
    ...
    {MSF_MODID_STK, MOD_WPS, "STK", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_STATE, gmms_adp_STKc_start, gmms_adp_STKc_wantsToRun, gmms_adp_STKc_run, gmms_adp_STKc_kill, NULL, 0, 0},

    {MSF_MODID_SEC, MOD_WPS, "SEC", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_1, gmms_adp_SECc_start, gmms_adp_SECc_wantsToRun, gmms_adp_SECc_run, gmms_adp_SECc_kill, NULL, 0, 0},

    {MSF_MODID_WPS, MOD_WPS, "WPS", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_5, gmms_adp_WPSc_start, gmms_adp_WPSc_wantsToRun, gmms_adp_WPSc_run, gmms_adp_WPSc_kill, NULL, 0, 0},

    {MSF_MODID_WIDGET, MOD_WAP, "WDG", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_9, gmms_adp_WIDGETc_start, gmms_adp_WIDGETc_wantsToRun, gmms_adp_WIDGETc_run, gmms_adp_WIDGETc_kill, NULL, 0, 0},
    {MSF_MODID_PHS, MOD_WPS, "PHS", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_ERROR, gmms_adp_PHSc_start, gmms_adp_PHSc_wantsToRun, gmms_adp_PHSc_run, gmms_adp_PHSc_kill, NULL, 0, 0},

    {MSF_MODID_PMG, MOD_WPS, "PMG", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_2, gmms_adp_PMGc_start, gmms_adp_PMGc_wantsToRun, gmms_adp_PMGc_run, gmms_adp_PMGc_kill, NULL, 0, 0},
    {MSF_MODID_MMS, MOD_MMS, "MMS", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_4, gmms_adp_MMSc_start, gmms_adp_MMSc_wantsToRun, gmms_adp_MMSc_run, gmms_adp_MMSc_kill, NULL, 0, 0},

    {MSF_MODID_MMA, MOD_MMS, "MMA", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_8, gmms_adp_MMAc_start, gmms_adp_MMAc_wantsToRun, gmms_adp_MMAc_run, gmms_adp_MMAc_kill, gmms_adp_mma_msg_hdlr, 0, 0},


    {MSF_MODID_ASM, MOD_MMS, "ASM", HDI_STARTUP_DYNAMIC, 
#ifdef MMS_V02_USE_ASM
	MMS_V02_APP_MEM_POOL, 
#else
	WAP_MEM_POOL,
#endif
	TRACE_GROUP_8, gmms_adp_ASMc_start, gmms_adp_ASMc_wantsToRun, gmms_adp_ASMc_run, gmms_adp_ASMc_kill, NULL, 0, 0},
    ...
    {MSF_MODID_BRS, MOD_WAP, "BRS", HDI_STARTUP_DYNAMIC, 
        ...
        WAP_MEM_POOL,
#endif        
        TRACE_INFO, gmms_adp_BRSc_start, gmms_adp_BRSc_wantsToRun, gmms_adp_BRSc_run, gmms_adp_BRSc_kill, NULL, 0, 0},   

    {MSF_MODID_DAS, MOD_WAP, "DAS", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_GROUP_3, gmms_adp_DASc_start, gmms_adp_DASc_wantsToRun, gmms_adp_DASc_run, gmms_adp_DASc_kill, NULL, 0, 0},

    {MSF_MODID_BAM, MOD_WAP, "BAM", HDI_STARTUP_STATIC, WAP_MEM_POOL, TRACE_WARNING, gmms_adp_BAMc_start, gmms_adp_BAMc_wantsToRun, gmms_adp_BAMc_run, gmms_adp_BAMc_kill, NULL, 0, 0},
 ...
 *  void
 *****************************************************************************/
int gmms_MSMa_createTask(MSF_UINT8 modId)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    if (modId < MSF_NUMBER_OF_MODULES && modId > 0) /* 0 == MSM */
    {
        i = msf_modules[modId].pTaskStart();
		if(i > 0)
		{
