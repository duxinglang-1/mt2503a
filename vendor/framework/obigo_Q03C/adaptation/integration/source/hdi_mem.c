...
/* for KAL ADM */
static const kal_uint32 hdi_mem_pool_chunk_size[13] = 
{
    16, 32, 64, 128, 256, 512, 1024, 2048, 4096,8192,16384, 0xffffffff, 0
};
 ...
 *  void
 *****************************************************************************/
void gmms_msf_reset_mem_list(MSF_UINT8 modId)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
