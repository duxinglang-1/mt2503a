...
#ifndef _FLATTEN_API_INTERNAL_6260_H_
#define _FLATTEN_API_INTERNAL_6260_H_
...
typedef enum
{
  ...
  FLATTEN_GOVL_WMEM_COLOR_ARGB6666_PIXEL_ALPHA = 0xA, /*!< Write to memory with ARGB6666 color format with per-pixel alpha value*/      
  FLATTEN_GOVL_WMEM_COLOR_ARGB8888_PIXEL_ALPHA = 0xC, /*!< Write to memory with ARGB8888 color format with per-pixel alpha value*/  
  FLATTEN_GOVL_WMEM_COLOR_ARGB6666_CONSTANT_ALPHA = 0xE, /*!< Write to memory with ARGB6666 color format with per-pixel alpha value*/	
...
FlattenResultEnum FlattenStart_6260(FlattenLayerStruct *, FlattenCtrlStruct *);
...
#endif //#ifndef _FLATTEN_API_INTERNAL_6260_H_
