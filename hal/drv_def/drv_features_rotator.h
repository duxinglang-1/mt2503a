...
#elif defined(__DRV_GRAPHICS_RGB_ROTATOR_6250_SERIES__)
#if defined(MT6260)
#if defined(__GFX_SLIM_COLOR_FORMAT__)
   #if defined(__MMI_FTE_SUPPORT__)
   #define RGB_ROTATOR_SW_SUPPORT_WITH_SRC_ARGB6666
   #endif   
#else
   #define RGB_ROTATOR_SW_SUPPORT_WITH_SRC_ARGB6666
#endif
...
#if defined(__DRV_GRAPHICS_RGB_ROTATOR_6253_SERIES__) || defined(__DRV_GRAPHICS_RGB_ROTATOR_6250_SERIES__)
...
#if defined(__DRV_GRAPHICS_YUV_ROTATOR_6255_SERIES__)
#if defined(__MTK_TARGET__)
   #define YUV_ROTATOR_HW_SUPPORT
#endif
#endif
...
#define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_180


#if defined(__DRV_GRAPHICS_YUV_ROTATOR_6253_SERIES__)
#if defined(__ATV_SUPPORT__ )
	    #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_000
      #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_090
      #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_270
#endif
#elif defined(__DRV_GRAPHICS_YUV_ROTATOR_6252_SERIES__)
//#if defined(__ATV_SUPPORT__) 
  #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_000
  #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_270
  #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_180  //Matv capture used(preview frame).
  #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_270  //Matv capture used(preview frame).
//#endif
#define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_090
#define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_000 
#define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_090  //Matv capture used(preview frame).
#else
   ...
   #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_270
   #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_000
   #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_090
   #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_180
   #define YUV_ROTATOR_SW_SUPPORT_WITH_SRC_UYVY422_ROTATE_ANGLE_MIRROR_270
#endif
