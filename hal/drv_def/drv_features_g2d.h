...
#if (defined(__DRV_GRAPHICS_G2D_6250_SERIES__) || defined(__DRV_GRAPHICS_G2D_6260_SERIES__))
#define SW_G2D_LT_SUPPORT_WITH_SRC_PARGB6666
#define SW_G2D_LT_SUPPORT_WITH_DST_PARGB6666
#define SW_G2D_LT_DITHERING_SUPPORT
#else
...
#if (defined(__DRV_GRAPHICS_G2D_6250_SERIES__))

   #define G2D_HW_SUPPORT
   //#define G2D_HW_FONT_SUPPORT , don't defint it, Due to the sw performance is better than hw performance.
   #define G2D_HW_AA_FONT_SUPPORT
   #define G2D_HW_BITBLT_SUPPORT
   #define G2D_HW_RECT_FILL_SUPPORT
   #define G2D_HW_OVERLAY_SUPPORT
