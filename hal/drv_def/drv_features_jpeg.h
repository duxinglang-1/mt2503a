...
#define __SW_JPEG_ENCODER_SUPPORT__
...
#if defined(__DRV_GRAPHICS_JPEG_6253_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6252_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6250_SERIES__)|| defined(__DRV_GRAPHICS_JPEG_6260_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6261_SERIES__)
   #define __SW_JPEG_DECODER_BASIC_PROFILE_INTERNAL___
#else
   #define __SW_JPEG_DECODER_FULL_PROFILE_INTERNAL___
#endif

#if defined(__DRV_GRAPHICS_JPEG_6250_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6260_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6261_SERIES__)
   #if defined(__JPG_DECODE_PROGRESSIVE_03M__) || defined(__JPG_DECODE_PROGRESSIVE_1M__) || defined(__JPG_DECODE_PROGRESSIVE_2M__) || defined(__JPG_DECODE_PROGRESSIVE_3M__)
      #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE
      #if defined(__JPG_DECODE_PROGRESSIVE_03M__)
         #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE_03M
      #elif defined(__JPG_DECODE_PROGRESSIVE_1M__)
         #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE_1M
      #elif defined(__JPG_DECODE_PROGRESSIVE_2M__)
         #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE_2M
      #elif defined(__JPG_DECODE_PROGRESSIVE_3M__)
         #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE_3M
      #endif
   #endif
#elif (!defined(__DRV_GRAPHICS_JPEG_6253_SERIES__)) && (!defined(__DRV_GRAPHICS_JPEG_6252_SERIES__))
   #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE
   #define SW_JPEG_DECODER_SUPPORT_WITH_PROGRESSIVE_3M
#endif
   ...
   #undef SW_JPEG_DECODER_SUPPORT_WITH_DST_ARGB6666
   #if defined(__GFX_SLIM_COLOR_FORMAT__)
       #if defined(__MMI_FTE_SUPPORT__)
       #define SW_JPEG_DECODER_SUPPORT_WITH_DST_ARGB6666
       #endif   
   #else
       #define SW_JPEG_DECODER_SUPPORT_WITH_DST_ARGB6666
   #endif
...
#elif defined(__DRV_GRAPHICS_JPEG_6250_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6260_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6261_SERIES__)
...
/// Currently, we only support rotation on MT6253 series...
   ...
   #undef __DRV_GRAPHICS_JPEG_6250_SERIES__
   #undef __DRV_GRAPHICS_JPEG_6260_SERIES__
   #undef __DRV_GRAPHICS_JPEG_6261_SERIES__
#endif

#if defined(EXIF_SUPPORT)
   #define __JAIA_SUPPORT__
#endif
...
/*
NOTES:
(1)cache line pre-fill is used to implement something like write-allocate on
cache, so this can extremely reduce single transactions on AHB bus.
then the EMI bandwidth of MCU will decreased, so that system performance
can be improved.
(2)this feature suitable for MTK L1 cache now.
*/
#if defined(__DRV_GRAPHICS_JPEG_6260_SERIES__) || defined(__DRV_GRAPHICS_JPEG_6261_SERIES__)
#if defined(__MTK_MMU__)
#define __JPEG_PFMC_ENHANCE_USE_CACHE_LINE_PREFILL__
#endif
#endif
      ...
      #define __JPEG_ENC_PATCH_FOR_HQA00011180__                     /// Workaround for HW bug HQA00011180
      ...
      #define __DRV_GRAPHICS_HW_JPEG_ENCODE_SUPPORTED__
      #define __DRV_GRAPHICS_HW_DCT_CONTROL_NEEDED__
      #define __DRV_GRAPHICS_HYBRID_SW_HW_JPEG_ENCODE_SUPPORTED__    /// Support HW DCT and Quantization
#if defined(__MTK_TARGET__)
      #define __DRV_GRAPHICS_HYBRID_SW_HW_JPEG_DECODE_SUPPORTED__ 
#endif
   #endif
#endif
   
//#define __MM_DEBUG_MEASURE__
