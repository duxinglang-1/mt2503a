...
extern kal_uint32 custom_ROM_LV_baseaddr(void);
...
#define BL_SLIM_UDIV_R(N, D, R) (bl_slim_div(N, D, &R))
#define BL_SLIM_UDIV(N, D) (bl_slim_div(N, D, NULL))
#define BL_SLIM_UMOD(N, D) (bl_slim_mod(N, D))
#else
...
#define MAUI_LV_ADDR_NOR            ((kal_uint32)custom_ROM_LV_baseaddr())
...
#define BL_BOOTUP_FAIL_REASON_FUNET_IN_PROGRESS     8
...
extern const kal_uint8 usbdlkey_position;
extern const kal_uint8 usbdlkey_position2;
extern const kal_uint8 usbdlkey_rescue_position;
extern const kal_uint8 usbdlkey_rescue_position2;
extern const kal_uint8  metakey_position;
extern const kal_uint16 usbdlauto_timeout;
extern const kal_bool   usbdl_holding_mode;

#ifdef __SV5_ENABLED__
extern kal_uint32 g_maui_load_addr;
#else
extern const MTK_EXT_BL_INFO_v01 g_ExtBootloaderInfo;
extern kal_uint32 g_ExtBootloaderLen;
#endif /* __SV5_ENABLED__ */

#ifdef __EXT_BL_UPDATE__
extern BL_EXT_BL_UPDATE_INFO g_extBlUpdateInfo;
