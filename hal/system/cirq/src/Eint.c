...
void ADIE_EINT_HW_Initialize_Int(kal_uint8 eintno, kal_bool Dbounce_En, kal_bool ACT_Polarity,kal_uint8 unmask_after_reg);
void EINT_Registration_Int(kal_uint8 eintno, kal_bool Dbounce_En, kal_bool ACT_Polarity, void (reg_hisr)(void), kal_bool auto_umask,kal_uint8 unmask_after_reg);
void ADIE_EINT_Set_HW_Debounce_Int(kal_uint8 eintno, kal_uint32 ms,kal_uint8 autounmask_after_set);
void EINT_Set_HW_Debounce_Int(kal_uint8 eintno, kal_uint32 ms,kal_uint8 autounmask_after_set);
...
{
   	EINT_Registration_Int(eintno,Dbounce_En,ACT_Polarity,reg_hisr,auto_umask,1);
}
...
void EINT_Registration_Int(kal_uint8 eintno, 
								kal_bool Dbounce_En, 
								kal_bool ACT_Polarity, 
								void (reg_hisr)(void), 
								kal_bool auto_umask,
								kal_uint8 unmask_after_reg)
{
...
/*===========================================================*/
      ...
      ADIE_EINT_HW_Initialize_Int(EINT_GLB_TO_ADIE(eintno), Dbounce_En, ACT_Polarity,unmask_after_reg);
...
void EINT_Registration_Ext(kal_uint8 eintno, 
								kal_bool Dbounce_En, 
								kal_bool ACT_Polarity,
                       			void (reg_hisr)(void), 
                       			kal_bool auto_umask)
{
	EINT_Registration_Int(eintno,Dbounce_En,ACT_Polarity,reg_hisr,auto_umask,0);
}
...
{
   	EINT_Set_HW_Debounce_Int(eintno,ms,1);
}
...
void EINT_Set_HW_Debounce_Int(kal_uint8 eintno, kal_uint32 ms,kal_uint8 autounmask_after_set)
{
   ...
   if(IS_ADIE_EINT(eintno))
   {
      ADIE_EINT_Set_HW_Debounce_Int(EINT_GLB_TO_ADIE(eintno), ms,autounmask_after_set);
...
{
	EINT_Set_HW_Debounce_Int(eintno,ms,0);
}
