...
{
		ADIE_EINT_HW_Initialize_Int(eintno, Dbounce_En, ACT_Polarity,1);
}

void ADIE_EINT_HW_Initialize_Int(kal_uint8 eintno, 
										kal_bool Dbounce_En, 
...
{
    	ADIE_EINT_Set_HW_Debounce_Int(eintno,ms,1);
}
