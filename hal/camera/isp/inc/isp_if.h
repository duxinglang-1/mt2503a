...
#include "drv_features.h"
	...
	#include "isp_if_6236_series_hw.h"  
#elif(defined(DRV_ISP_6238_SERIES))
	#include "isp_if_6238_series_hw.h"
#elif(defined(DRV_ISP_MT6276_HW_SUPPORT))
	#include "isp_if_6276_series_hw.h"  
#elif(defined(DRV_ISP_MT6252_HW_SUPPORT))
	#include "isp_if_6252_series_hw.h"  
#elif(defined(DRV_ISP_MT6250_HW_SUPPORT))
	#include "isp_if_6250_series_hw.h"
#elif(defined(DRV_ISP_MT6253EL_HW_SUPPORT))
	#include "isp_if_6253EL_series_hw.h"	
#elif(defined(DRV_ISP_6235_SERIES))
	#include "isp_if_6235_series_hw.h"
#endif
...
#if ((defined(MT6253) && defined(__EMI_CLK_52MHZ__) )||defined(MT6252H)||defined(MT6252))
#define ISP_MAX_DIGITAL_ZOOM_FACTOR  (200)
#define ISP_MAX_DIGITAL_ZOOM_STEP (20)

#elif (defined(MT6253)||defined(MT6235)||defined(MT6235B)||defined(MT6255)||defined(MT6250)||defined(MT6260)||defined(MT6261))
#define ISP_MAX_DIGITAL_ZOOM_FACTOR  (400)
#define ISP_MAX_DIGITAL_ZOOM_STEP  (40)

#else
#define ISP_MAX_DIGITAL_ZOOM_FACTOR  (800)
#define ISP_MAX_DIGITAL_ZOOM_STEP  (40)
#endif
