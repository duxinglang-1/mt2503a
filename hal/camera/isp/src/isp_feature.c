...
//    SET_CPLL_PWR_ON;
	...
	*((volatile unsigned int *) (0xA0010100)) = temp|0x00000100; //POWERFUL_DIV_EN3=1 (reg[A0010100]bit 8 為1)
	
	temp = *((volatile unsigned int *) (0xA001011C));
	temp = temp & 0xFFFFFE7F;
	*((volatile unsigned int *) (0xA001011C)) = temp|0x00000100;//0x0000D101;//設定reg[A001011C]bit [8:7] 為2 

	temp = *((volatile unsigned int *) (0xA0010320));	
	*((volatile unsigned int *) (0xA0010320)) = temp|0x00000400;//0x00000400;//設定reg[A0010320]bit 10 為1
	...
	// default 312MHZ
	  ...
	  { 
	  	temp = *((volatile unsigned int *) (0xA0010100));
		  *((volatile unsigned int *) (0xA0010100)) = temp&0xFFFFFEFF; //POWERFUL_DIV_EN3=0 (reg[A0010100]bit 8 為0)   
		  temp = *((volatile unsigned int *) (0xA001011C)); 
		  *((volatile unsigned int *) (0xA001011C)) = temp&0xFFFFFE7F;//0x0000D001;//設定reg[A001011C]bit [8:7] 為0
		  *((volatile unsigned int *) (0xA0010320)) = 0x00000400;//設定reg[A0010320]bit 10 為1
