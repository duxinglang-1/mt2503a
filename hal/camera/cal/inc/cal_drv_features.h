...
#if (defined(MT6252)||defined(MT6252H)||defined(MT6250)||defined(MT6260)||defined(MT6261))
...
#if (defined(MT6252)||defined(MT6252H)||defined(MT6253)||defined(MT6250)||defined(MT6260)||defined(MT6261))
    #undef __CAL_CAMERA_VIDEO_ROTATE_SUPPORT__
#else
...
#if (!((defined(MT6250) || defined(MT6260)||defined(MT6261)) && defined(__LOW_COST_SUPPORT_COMMON__)))
