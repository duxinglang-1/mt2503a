...
MM_ERROR_CODE_ENUM MdpCallback(CAL_CALLBACK_ID_ENUM CbId, void *pCallbackPara, kal_uint16 CallbackParaLen)
{
    ...
    #if defined(MT6235) || defined(MT6235B) || defined(MT6253) ||defined(MT6252)||defined(MT6252H)||defined(MT6255)||defined(MT6250)||defined(MT6260)||defined(MT6261)
...
#endif
#if !(defined(MT6235) || defined(MT6235B) || defined(MT6253)||defined(MT6252)||defined(MT6252H)||defined(MT6250)||defined(MT6260)||defined(MT6261))
    CAL_SW_JPEG_ENCODE_REQ_STRUCT JpegEncPara;
#endif
