...
#include "common_def.h"
    ...
    #define DP_D2C_VMEPL_REC_INT        (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_REC_EPL)  //  7 // idle or TCH VM EPL record
    #define DP_D2C_PCM_REC_INT          (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_REC_PCM)  //  8 // idle or TCH pcm record	 
    #define DP_D2C_VM_REC_INT           (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_REC_VM)   //  9 // idle or TCH vm record
    #define DP_D2C_3G_DONE_DL           (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_3G_DL)    // 10 // 3G Call DL
    #define DP_D2C_3G_DONE_UL           (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_3G_UL)    // 11 // 3G Call UL
    #define DP_D2C_PCM_EX_DL            (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_PNW_DL)   // 12 // PCMNWAY for DL
    #define DP_D2C_PCM_EX_UL            (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_PNW_UL)   // 13 // PCMNWAY for UL
    #define DP_D2C_DACA_REQ_DL          (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_DACA_DL)  // 14 // DATACARD for DL
    #define DP_D2C_DACA_REQ_UL          (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_DACA_UL)  // 15 // DATACARD for UL 
    #define DP_D2C_BGS_DL               (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_BGS_DL)   // 16 // Background Sound UL
    #define DP_D2C_BGS_UL               (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_BGS_UL)   // 17 // Background Sound UL
    #define D2C_AUDIO_VIA_BT_ID         (DP_D2C_INT_MAPPING_BASIC+PSEUDO_SAL_DSPINT_PRIO_AVBT)     // 18 // Audio via BT
