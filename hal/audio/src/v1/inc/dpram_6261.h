...
#define DP2_Speech_Temp_BASE                      DP2_AUDIO_RESERVED_BASE + 0x002 /* 0x3f48 */

#define SPH_ENH_DDL_test                          DP2_Speech_Temp_BASE + 0x000 /* 0x3f48 */

#define DP2_UNDEFINEDD_BASE                       DP2_Speech_Temp_BASE + 0x002 /* 0x3f4a */
#define SPH_AFE_VDSP_CON_CTRL                     DP2_Speech_Temp_BASE + 0x005 /* 0x3f4d */

#define SHERIF_SIZE                               1358


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6261_SHERIF_SIZE (1376)
#if (SHERIF_SIZE > MT6261_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6261_SHERIF_SIZE)
