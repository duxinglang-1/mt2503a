...
#define DSP_SPH_ENH_DYNAMIC_SWITCH 		DPRAM2_base(SPH_ENH_DYNAMIC_SWITCH)
...
#if DSP_16K_NR_SUPPORT
volatile uint16* Pseudo_SAL_BKF_GetFltCoefAddr_WB_UL(void);
volatile uint16* Pseudo_SAL_BKF_GetFltCoefAddr_WB_DL(void);
#endif
