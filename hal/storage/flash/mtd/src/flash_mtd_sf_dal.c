...
#if defined(IC_MODULE_TEST) && (defined(MT6260) || defined(MT6261) )
//Not build debug code in MT6260/61 SLT to reduce Single Banck Code size
#else
...
#endif //defined(IC_MODULE_TEST) && (defined(MT6260) || defined(MT6261) )
#endif
...
#define SF_PROG_TIME_LIMIT 1500  // Program Time Limit: 1.5 ms, because MT6260/61 use 128byte page program
#else
...
/*!
  @brief
    ...
    Currently, only for MT6250 MT6260/61.
