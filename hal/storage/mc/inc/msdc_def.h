...
#else
#define MSDC_PS2		(MSDC_ADRS2+0x0c)
#define MSDC_DAT2		(MSDC_ADRS2+0x10)
#endif

#define MSDC_IOCON2		(MSDC_ADRS2+0x14)
#define MSDC_IOCON21	(MSDC_ADRS2+0x18)

#define MSDC2_CLKACB_CFG		(MSDC_ADRS2+0x80)


#define MSDC2_IRQMASK0    (MSDC_ADRS2+0x4c)

#define MSDC2_CLKACB_CFG		(MSDC_ADRS2+0x80)
#define MSDC2_CLKACB_STA		(MSDC_ADRS2+0x84)
#define MSDC2_CLKACB_CRCSTA1	(MSDC_ADRS2+0x88)
#define MSDC2_CLKACB_CRCSTA2	(MSDC_ADRS2+0x8C)

#ifdef DRV_MSDC_CHECK_MULTIBLOCK_WRITE_FINISHED
#define MSDC2_DEBUG_SELECTION (MSDC_ADRS2+0x90)
#define MSDC2_DEBUG_REG 		 (MSDC_ADRS2+0x94)
#endif
...
#if defined(DRV_MSDC_MT6238_SERIES)||defined(__MSDC2_SD_MMC__)||defined(__MSDC2_SD_SDIO__)
#define MSDC2_CLR_FIFO()			Reset_MSDC2()
#define MSDC2_IS_FIFO_EMPTY		(MSDC_Reg32(MSDC_STA2) & MSDC_STA_BE)
#define MSDC2_IS_FIFO_FULL		(MSDC_Reg32(MSDC_STA2) & MSDC_STA_BF)
#define MSDC2_IS_BUSY			(MSDC_Reg32(MSDC_STA2) & MSDC_STA_BUSY)
#define MSDC2_SET_FIFO(x)	{MSDC_LSD_ClearBits32(MSDC_CFG2,MSDC_CFG_FIFOTHD);\
									MSDC_SetBits32(MSDC_CFG2, (x << 24));}
...
#define MSDC2_IS_INT		(MSDC_Reg32(MSDC_STA2) & MSDC_STA_INT)
#define EnableMSDC2_DMA()	MSDC_LSD_SetBits32(MSDC_CFG2,MSDC_CFG_DRQEN)
#define DisableMSDC2_DMA()	MSDC_LSD_ClearBits32(MSDC_CFG2,MSDC_CFG_DRQEN)
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
#define MSDC2_ENABLE_INT()		MSDC_LSD_SetBits32(MSDC_CFG2,MSDC_CFG_INTEN)
#define MSDC2_DISABLE_INT()		MSDC_LSD_ClearBits32(MSDC_CFG2,MSDC_CFG_INTEN)
#define MSDC2_ENABLE_CARD_DETECTION()	MSDC_LSD_SetBits32(MSDC_PS2, MSDC_PS_CDEN)
#define MSDC2_DISABLE_CARD_DETECTION()	MSDC_LSD_ClearBits32(MSDC_PS2, MSDC_PS_CDEN)	
...
#elif defined(DRV_MSDC_DUAL_TCARD_BY_SWITCH)||defined(DRV_MSDC2_DUAL_TCARD_BY_SWITCH)
typedef enum{
	SD_EXT = 0,
	SD_MSDC1 = 0,
	SD_T_CARD_2 =1,
...
#if defined(DRV_MSDC_DUAL_TCARD_BY_SWITCH)
#define TCARD_2_MEM_ID		(kal_uint32)(&MSDC_Blk[MSDC1_SD2])
#endif
#if defined(DRV_MSDC2_DUAL_TCARD_BY_SWITCH)// this has not support completely.
//#define TCARD_2_MEM_ID		(kal_uint32)(&MSDC2_Blk[MSDC2_SD2])
#endif
...
extern void MSDC2_PDNControl(kal_bool ON);
//extern	kal_bool MSDC_GetMediaChanged2(sd_select_enum sel);
extern int MSDC2_GetCardStatus(void *slot_id, int AckType);
extern void MSDC2_TimeOutHandler(void *parameter);
extern kal_bool MSDC2_Check_Card_Present(void);
extern void MSDC2_SetClock(kal_uint32 clock);
extern void MSDC2_DMATransferFirst(kal_uint32 adrs,kal_uint32 count, kal_bool isTx);
extern kal_uint32 MSDC2_DMATransferFinal(void);
