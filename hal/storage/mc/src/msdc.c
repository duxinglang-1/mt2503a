...
MSDC_PDNControl(KAL_FALSE);
	...
	MSDC_Blk[MSDC1_SD2].mIsPresent = KAL_TRUE;
	MSDC_Blk[MSDC1_SD2].mIsChanged = KAL_TRUE;
    current_card = SD_EXT;
#endif
...
#ifdef DRV_MSDC_DUAL_TCARD_BY_SWITCH
		MSDC_Blk[MSDC1_SD2].msdc_clkTuneUpperBund = MSDC_CLOCK/2;
#endif		
	#endif
...
MSDC_Blk[MSDC1_SD2].setting_MSDC_CFG =  MSDC_Reg32(MSDC_CFG); //xuehui change it 0x1;
MSDC_Blk[MSDC1_SD2].setting_MSDC_IOCON = MSDC_Reg32(MSDC_IOCON); //xuehui change it  0x0;
MSDC_Blk[MSDC1_SD2].setting_SDC_CFG =  MSDC_Reg32(SDC_CFG); //xuehui change it 0x0;
MSDC_Blk[MSDC1_SD2].mMSDC_type = SD_CARD;
...
*/
	...
	MSDC_Blk[MSDC1_SD2].msdc_dmaport = MSDC_Blk[SD_EXT].msdc_dmaport;
	MSDC_Blk[MSDC1_SD2].msdc_menu.TMOD.burst_mode = KAL_TRUE;
	MSDC_Blk[MSDC1_SD2].msdc_menu.TMOD.cycle = 0x4;
	MSDC_Blk[MSDC1_SD2].msdc_menu.master = DMA_MSDC;
	MSDC_Blk[MSDC1_SD2].msdc_menu.addr = NULL;

	MSDC_Blk[MSDC1_SD2].msdc_input.type = DMA_HWRX;
	MSDC_Blk[MSDC1_SD2].msdc_input.size = DMA_LONG;
	MSDC_Blk[MSDC1_SD2].msdc_input.count = 0;
	MSDC_Blk[MSDC1_SD2].msdc_input.menu = &MSDC_Blk[MSDC1_SD2].msdc_menu;
	//MSDC_Blk[SD_SIM].msdc_menu = MSDC_Blk[SD_EXT].msdc_menu;
	//MSDC_Blk[SD_SIM].msdc_input = MSDC_Blk[SD_EXT].msdc_input	;
#endif
...
#elif defined( DRV_MSDC_DUAL_TCARD_BY_SWITCH)
	MSDC_Blk[MSDC1_SD2].MSDC_Events = gMSDC_Handle->MSDC_Events;
#endif
