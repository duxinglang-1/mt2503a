...
#if 0 // no need to do buffer header movement since this has been done by empty_this_buffer
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
  ...
  va2_comp_video_renderer_cb_t *cb)
{
  ...
  {
// There is no need to call idp_stop API when KMV is support since
// Video Renderer will always query IDP driver(wait busy) before using
#if !defined(IDP_KMV_VIDEO_SUPPORT)
