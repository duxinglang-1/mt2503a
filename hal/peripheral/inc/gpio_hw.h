...
#if defined(MT6260)
#include "gpio_hw_MT6260.h"
#elif defined(MT6261)  
#include "gpio_hw_MT6261.h"
#endif
   
   
#define  GPIO_DINV_ADRS(n) (GPIO_DINV0+GPIO_DINV_OFFSET_TO_NEXT*(n))  //for data invert 
	 
#define  GPIO_DIR_SET(_no)	 (GPIO_DIR0_SET+(GPIO_DIR_OFFSET_TO_NEXT*(_no)))  
#define  GPIO_OUTPUT_LEVEL_SET(_no)  (GPIO_OUTPUT_LEVEL0_SET+(GPIO_OUTPUT_LEVEL_OFFSET_TO_NEXT*(_no)))	
#define  GPIO_PULLEN_SET(_no)  (GPIO_PULL0_SET+(GPIO_PULL_OFFSET_TO_NEXT*(_no)))	
#define  GPIO_PULLSEL_SET(_no)	(GPIO_PULLSEL0_SET+(GPIO_PULL_SEL_OFFSET_TO_NEXT*(_no)))  
															   
		  
#define  GPIO_DIR_CLR(_no)	 (GPIO_DIR0_CLR+(GPIO_DIR_OFFSET_TO_NEXT*(_no)))
#define  GPIO_OUTPUT_LEVEL_CLR(_no)  (GPIO_OUTPUT_LEVEL0_CLR+(GPIO_OUTPUT_LEVEL_OFFSET_TO_NEXT*(_no)))
#define  GPIO_PULLEN_CLR(_no)  (GPIO_PULL0_CLR+(GPIO_PULL_OFFSET_TO_NEXT*(_no)))	
#define  GPIO_PULLSEL_CLR(_no)	(GPIO_PULLSEL0_CLR+(GPIO_PULL_SEL_OFFSET_TO_NEXT*(_no)))  
	 
#define  GPIO_MODE(_no) 	 (GPIO_MODE0+(GPIO_MODE_OFFSET_TO_NEXT*(_no))) 
   
   
#define  GPIO_OUTPUT_LEVEL(_no) 	 (GPIO_OUTPUT_LEVEL0+(GPIO_OUTPUT_LEVEL_OFFSET_TO_NEXT*(_no)))
#define  GPIO_DIR(_no)		 (GPIO_DIR0+(GPIO_DIR_OFFSET_TO_NEXT *(_no)))
#define  GPIO_DIN(_no)		 (GPIO_DIN0+(GPIO_DIN_OFFSET_TO_NEXT*(_no)))
#define  GPIO_PULLEN(_no)	 (GPIO_PULL0+(GPIO_PULL_OFFSET_TO_NEXT*(_no)))
#define  GPIO_PULLSEL(_no)	 (GPIO_PULLSEL0+(GPIO_PULL_SEL_OFFSET_TO_NEXT*(_no)))
#define  GPIO_PUPDEN(_no) 	 (GPIO_PUPD0+(GPIO_PUPD_OFFSET_TO_NEXT*(_no)))   // for  pullup and pulldown
#define  GPIO_RESEN_R0(_no)	 (GPIO_R0_ADDR0+(GPIO_R0_OFFSET_TO_NEXT*(_no)))    // pull up resistor and pull down resistor	
#define  GPIO_RESEN_R1(_no)	 (GPIO_R1_ADDR0+(GPIO_R1_OFFSET_TO_NEXT*(_no)))    // pull up resistor and pull down resistor	
   
   
   
#define  GPIO_PUPDEN_SET(_no)  (GPIO_PUPD0_SET+(GPIO_PUPD_OFFSET_TO_NEXT*(_no)))
#define  GPIO_R0_SET(_no)   (GPIO_R0_SET_REG0+(GPIO_R0_OFFSET_TO_NEXT*(_no))) 
#define  GPIO_R1_SET(_no)   (GPIO_R1_SET_REG0+(GPIO_R1_OFFSET_TO_NEXT*(_no))) 
   
   
#define  GPIO_PUPDEN_CLR(_no)  (GPIO_PUPD0_CLR+(GPIO_PUPD_OFFSET_TO_NEXT*(_no)))
#define  GPIO_R0_CLR(_no)   (GPIO_R0_CLR_REG0+(GPIO_R0_OFFSET_TO_NEXT*(_no))) 
#define  GPIO_R1_CLR(_no)   (GPIO_R1_CLR_REG0+(GPIO_R1_OFFSET_TO_NEXT*(_no))) 
   
#define  CLK_MODE(_no) 	 (CLKO_MODE0+(GPIO_CLK_MODE_OFFSET_TO_NEXT*(_no)))	
   
#if defined(CLK0_DIV0)
#define  CLK_DIV(_no) 	 (CLK0_DIV0+(GPIO_CLK_DIV_OFFSET_TO_NEXT*(_no)))	
#endif
   
   
  
#if defined(GPIO_ADIE_MODE0)
#define  GPIO_ADIE_MODE(_no) 	 (GPIO_ADIE_MODE0+(GPIO_ADIE_MODE_OFFSET_TO_NEXT*(_no))) 
#endif
#if defined(GPIO_ADIE_DIR0)
#define  GPIO_ADIE_DIR(_no) 	 (GPIO_ADIE_DIR0+(GPIO_ADIE_DIR_OFFSET_TO_NEXT*(_no)))
#endif
#if defined(GPIO_ADIE_OUTPUT_LEVEL0) 
#define  GPIO_ADIE_OUTPUT_LEVEL(_no) 	 (GPIO_ADIE_OUTPUT_LEVEL0+(GPIO_ADIE_OUTPUT_LEVEL_OFFSET_TO_NEXT*(_no))) 
#endif
#if defined(GPIO_ADIE_DIN0)
#define  GPIO_ADIE_DIN(_no) 	 (GPIO_ADIE_DIN0+(GPIO_ADIE_DIN_OFFSET_TO_NEXT*(_no))) 
#endif
...
/*********************************************************************/
 ...
 /*******************************************************************/ 
   ...
   #define 	GPIO_PULLEN6      (GPIO_base+0x0150)   
   #define 	GPIO_PULLEN7      (GPIO_base+0x0160) 
   #define 	GPIO_PULLEN8      (GPIO_base+0x0170) 
/*********************************************************************/
   #define 	GPIO_DINV1      	(GPIO_base+0x0200)
   #define 	GPIO_DINV2      	(GPIO_base+0x0210)
   #define 	GPIO_DINV3      	(GPIO_base+0x0220)
   #define 	GPIO_DINV4      	(GPIO_base+0x0230)
   #define 	GPIO_DINV5      	(GPIO_base+0x0240)   
   #define 	GPIO_DINV6      	(GPIO_base+0x0250)   
/*********************************************************************/
   #define 	GPIO_DOUT1      	(GPIO_base+0x0300)
   #define 	GPIO_DOUT2      	(GPIO_base+0x0310)
   #define 	GPIO_DOUT3      	(GPIO_base+0x0320)
   #define 	GPIO_DOUT4      	(GPIO_base+0x0330)
   #define 	GPIO_DOUT5      	(GPIO_base+0x0340)   
   #define 	GPIO_DOUT6      	(GPIO_base+0x0350)   
/*********************************************************************/
   #define 	GPIO_DIN1       	(GPIO_base+0x0400)
   #define 	GPIO_DIN2       	(GPIO_base+0x0410)
   #define 	GPIO_DIN3       	(GPIO_base+0x0420)
   #define 	GPIO_DIN4       	(GPIO_base+0x0430)
   #define 	GPIO_DIN5       	(GPIO_base+0x0440)   
   #define 	GPIO_DIN6       	(GPIO_base+0x0450)   
/*********************************************************************/
   #define 	GPIO_PULLSEL1    	(GPIO_base+0x0500)
   #define 	GPIO_PULLSEL2    	(GPIO_base+0x0510)
   #define 	GPIO_PULLSEL3   	(GPIO_base+0x0520)
   #define 	GPIO_PULLSEL4           (GPIO_base+0x0530)
   #define 	GPIO_PULLSEL5           (GPIO_base+0x0540)
   #define 	GPIO_PULLSEL6            (GPIO_base+0x0550)
   #define 	GPIO_PULLSEL7            (GPIO_base+0x0560)
   #define 	GPIO_PULLSEL8            (GPIO_base+0x0570)
   
/*********************************************************************/  
  #define       GPIO_DRV1            (GPIO_base+0x0800) 
  #define       GPIO_DRV2             (GPIO_base+0x0810) 
  #define       GPIO_DRV3              (GPIO_base+0x0820) 
  #define       GPIO_DRV4            (GPIO_base+0x0830) 
/*********************************************************************/ 
  #define       GPIO_IES1            (GPIO_base+0x0900) 
  #define       GPIO_IES2             (GPIO_base+0x0910) 
  #define       GPIO_IES3             (GPIO_base+0x0920) 
  #define       GPIO_IES4            (GPIO_base+0x0930) 
/*********************************************************************/ 
  #define GPIO_PUPDEN1            (GPIO_base+0x0a00)
  #define GPIO_PUPDEN2            (GPIO_base+0x0a10)
/*********************************************************************/
    #define GPIO_RESEN1           (GPIO_base+0x0b00)
	#define GPIO_RESEN2           (GPIO_base+0x0b10)
	#define GPIO_RESEN3           (GPIO_base+0x0b20)  
/*********************************************************************/
 
   #define 	GPIO_MODE1       	(GPIO_base+0x0c00)
   #define 	GPIO_MODE2       	(GPIO_base+0x0c10)
   #define 	GPIO_MODE3       	(GPIO_base+0x0c20)         
   #define 	GPIO_MODE4       	(GPIO_base+0x0c30)         
   #define 	GPIO_MODE5       	(GPIO_base+0x0c40)         
   #define 	GPIO_MODE6       	(GPIO_base+0x0c50)         
   #define 	GPIO_MODE7       	(GPIO_base+0x0c60)
   #define 	GPIO_MODE8       	(GPIO_base+0x0c70)
   #define 	GPIO_MODE9       	(GPIO_base+0x0c80)
   #define 	GPIO_MODE10      	(GPIO_base+0x0c90)
   #define 	GPIO_MODE11      	(GPIO_base+0x0ca0)

/*********************************************************************/ 
   #define  CLKO_MODE1      (GPIO_base+0x0e00)
   #define  CLKO_MODE2     	(GPIO_base+0x0e10)   
   #define  CLKO_MODE3     	(GPIO_base+0x0e20)   
   #define  CLKO_MODE4    	(GPIO_base+0x0e30)   
   #define  CLKO_MODE5    	(GPIO_base+0x0e40)   
   #define  CLKO_MODE6     	(GPIO_base+0x0e50)   
   #define  CLKO_MODE7     	(GPIO_base+0x0e60)   
/*********************************************************************/      
   ...
   #define  GPIO_PULLEN(_no)    (GPIO_PULLEN1+(0x10*(_no)))
   #define  GPIO_PULLSEL(_no)   (GPIO_PULLSEL1+(0x10*(_no)))
   #define  GPIO_PUPD(_no)      (GPIO_PUPDEN1+(0x10*(_no)))   // for  pullup and pulldown
   #define  GPIO_RESEN(_no)     (GPIO_RESEN1+(0x10*(_no)))    // pull up resistor and pull down resistor   


   #define 	GPIO_PUPDEN1_SET       (GPIO_PUPDEN1+0x04) 
   #define  GPIO_RESEN1_SET        (GPIO_RESEN1+0x04)
   #define 	GPIO_PUPDEN_SET(_no)  (GPIO_PUPDEN1_SET+(0x10*(_no)))
   #define 	GPIO_RESEN_SET(_no)   (GPIO_RESEN1_SET+(0x10*(_no))) 

    #define GPIO_PUPDEN1_CLR       (GPIO_PUPDEN1+0x08) 
   #define  GPIO_RESEN1_CLR        (GPIO_RESEN1+0x08)
   #define 	GPIO_PUPDEN_CLR(_no)  (GPIO_PUPDEN1_CLR+(0x10*(_no)))
   #define 	GPIO_RESEN_CLR(_no)   (GPIO_RESEN1_CLR+(0x10*(_no))) 

   #define  CLKO_MODE(_no)      (CLKO_MODE1+(0x10*(_no)))  
   #define  CLKO_NUM            8
 /*********************************************************************/  
   #define  ACFG_GPIO_CON1   (ANA_CFGSYS_base+0x0160)
   #define  ACFG_GPIO_CON2   (ANA_CFGSYS_base+0x0164)
   #define  ACFG_GPIO_MODE   (ANA_CFGSYS_base+0x0168)
