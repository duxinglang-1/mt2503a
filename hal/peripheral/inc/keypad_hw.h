...
#define  KP_SCAN_TIMING	         (KP_base+0x1C)
#define  KP_SEL		 	 (KP_base+0x20)
#define  KP_EN	 		 (KP_base+0x24)
#define  COL_EXTEND_MASK 0x0001
#ifdef DRV_KBD_PWRKEY_FROM_EINT
#if defined (DRV_KBD_PWRKEY_SATUS_0F00)
#define PWRKEY_STATUS_REG (ANA_CFGSYS_SD_base+0x0F00)  // ANA_CFGSYS_SD_base+0x0F00 =0xA0730F00
#elif defined (DRV_KBD_PWRKEY_SATUS_0048)
#define PWRKEY_STATUS_REG (ANA_CFGSYS_SD_base+0x0048)
#endif
#endif
#endif  // DRV_KP_OFF
