...
#define EFUSE_ADC_BASE 0x801C0100
#define EFUSE_ADC_A 0x801C0100
#define EFUSE_ADC_B 0x801C0100
#define EFUSE_ADC_ENABLE 0x0002
#define EFUSE_ADC_A_MASK 0x7FC00
#define EFUSE_ADC_B_MASK 0x3FC
#define EFUSE_ADC_A_SHIFT 10
...
#define EFUSE_CALI_EN 0xC1019040
...
#elif defined(DRV_ADC_6250_SERIES) || defined(DRV_ADC_6260_SERIES) || defined(DRV_ADC_6261_SERIES)	// 10 bits ADC
...
/*************************************************************************/
   ...
   #define AUXADC_DAT(_line)              (AUXADC_base+0x0018+(4*_line))
	...
	#define AUXADC_SPL_NUM					AUX_CON2
	#define AUXADC_SPL_NUM_SHIFT 				 0
	#define AUXADC_SPL_NUM_MASK 			0x00FF
#elif defined(DRV_ADC_6255_SERIES)
	#define AUX_CON2						(ABBSYS_base+0x8708)
	#define AUXADC_SPL_NUM					AUX_CON2
	#define AUXADC_SPL_NUM_SHIFT 				 0
	#define AUXADC_SPL_NUM_MASK 			0x00FF
#elif defined(DRV_ADC_6260_SERIES)
	#define ABBA_AUX_CON0					(PMU_base + 0x0080)
	#define ABBA_AUX_CON1					(PMU_base + 0x0084)
	#define ABBA_AUX_CON2					(PMU_base + 0x0088)
	#define ABBA_AUX_CON3					(PMU_base + 0x008C)
	#define ABBA_AUX_CON4					(PMU_base + 0x0090)
	#define ABBA_AUX_CON5					(PMU_base + 0x0094)
	#define ABBA_AUX_CON6					(PMU_base + 0x0098)
	#define AUXADC_SPL_NUM					ABBA_AUX_CON5
	#define AUXADC_SPL_NUM_SHIFT 			  	 8
	#define AUXADC_SPL_NUM_MASK 			0xFF00
#elif defined(DRV_ADC_6261_SERIES)

	#define AUXADC_DAT_ZCV					(AUXADC_base+0x0070)
	#define DAT_ZCV							AUXADC_DAT_ZCV
	#define DAT_ZCV_SHIFT					0
	#define DAT_ZCV_MASK					0x03ff
	#define BYPASS_SLP_ZCV_TRIGGER	       AUXADC_CON	
	#define BYPASS_SLP_ZCV_TRIGGER_SHIFT  4
	#define BYPASS_SLP_ZCV_TRIGGER_MASK   0x0010
	...
	#define AUXADC_SPL_NUM_MASK 			0xFF00
#else
	#define ABBA_AUX_CON0					(ABBSYS_base + 0x0080)
	#define ABBA_AUX_CON1					(ABBSYS_base + 0x0084)
	#define ABBA_AUX_CON2					(ABBSYS_base + 0x0088)
	#define ABBA_AUX_CON3					(ABBSYS_base + 0x008C)
	#define ABBA_AUX_CON4					(ABBSYS_base + 0x0090)
	#define ABBA_AUX_CON5					(ABBSYS_base + 0x0094)
	#define ABBA_AUX_CON6					(ABBSYS_base + 0x0098)
	#define AUXADC_SPL_NUM					ABBA_AUX_CON5
	#define AUXADC_SPL_NUM_SHIFT 			  	 8
	#define AUXADC_SPL_NUM_MASK 			0xFF00
#endif
...
#if defined(DRV_DIE_TO_DIE_INTERFACE_V2)

	#define D2D_D_APC_AUX_CON1 (D2D_D_base + 0x04)
	#define D2D_A_APC_AUD_CON1 (D2D_A_base + 0x04)

	#define D2D_D_F26M_AUX_EN 0x0001
	#define D2D_D_AUX_EN 0x8000

	#define D2D_A_AUX_EN 0x8000	


#endif //#if defined(DRV_DIE_TO_DIE_INTERFACE_V2)
