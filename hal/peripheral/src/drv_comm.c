...
#if defined(__L1_STANDALONE__)&&defined(__CLKG_DEFINE__)
...
extern void custom_drv_init_phase2(void);
...
extern void brt_drv_init(void); //BT related unique initialization function 
...
#if (defined(__MSDC_MS__) || defined(__MSDC_SD_MMC__) || defined (__MSDC_MSPRO__)||defined(__MSDC2_SD_MMC__)||defined(__MSDC_SD_SDIO__))
