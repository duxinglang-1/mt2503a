...
void RTC_InitTC_Time(t_rtc *rtctime) // validate
{
    ...
    if (IsOSRunning()) {
        ...
        if (module_reg_ilm_flag == KAL_TRUE)
        {
            ...
            RTC_GetTimeOnly(&cur_rtctime);
            rtc_ind->previous_rtc.rtc_sec = cur_rtctime.rtc_sec;
            rtc_ind->previous_rtc.rtc_min = cur_rtctime.rtc_min;
            rtc_ind->previous_rtc.rtc_hour = cur_rtctime.rtc_hour;
            rtc_ind->previous_rtc.rtc_day = cur_rtctime.rtc_day;
            rtc_ind->previous_rtc.rtc_mon = cur_rtctime.rtc_mon;
            rtc_ind->previous_rtc.rtc_year = cur_rtctime.rtc_year;
    ...
    if (IsOSRunning()) {
        if (module_reg_ilm_flag == KAL_TRUE)
        {
            ...
            RTC_GetTimeOnly(&cur_rtctime);
            rtc_ind->new_rtc.rtc_sec = cur_rtctime.rtc_sec;
            rtc_ind->new_rtc.rtc_min = cur_rtctime.rtc_min;
            rtc_ind->new_rtc.rtc_hour = cur_rtctime.rtc_hour;
            rtc_ind->new_rtc.rtc_day = cur_rtctime.rtc_day;
            rtc_ind->new_rtc.rtc_mon = cur_rtctime.rtc_mon;
            rtc_ind->new_rtc.rtc_year = cur_rtctime.rtc_year;
...
void RTC_GetTimeOnly(t_rtc *rtctime) // validate
{
    ...
    if (DRV_RTC_Reg(RTC_TC_SEC) < rtctime->rtc_sec) {	/* SEC has carried */
        rtctime->rtc_sec = DRV_RTC_Reg(RTC_TC_SEC);
        rtctime->rtc_min = DRV_RTC_Reg(RTC_TC_MIN);
        rtctime->rtc_hour = DRV_RTC_Reg(RTC_TC_HOU);
        rtctime->rtc_day = DRV_RTC_Reg(RTC_TC_DOM);
...
{
	kal_uint32 loop;
    kal_uint16 al_sec_reg, al_min_reg, al_hou_reg, al_dom_reg, al_mth_reg, al_yea_reg;
#if !defined(__FUE__) && !defined(__UBL__)
    kal_uint32 savedMask=0;
#endif /* !defined(__FUE__) && !defined(__UBL__) */
	...
	for (loop = 0; loop < 1000000; loop++)
	{
        ...
        savedMask = SaveAndSetIRQMask();
#endif /* !defined(__FUE__) && !defined(__UBL__) */
        al_sec_reg = (DRV_RTC_Reg(RTC_AL_SEC)&(~RTC_AL_RTC_AL_SEC_MASK))|rtctime->rtc_sec;
        al_min_reg = (DRV_RTC_Reg(RTC_AL_MIN)&(~RTC_AL_RTC_AL_MIN_MASK))|rtctime->rtc_min;
        al_hou_reg = (DRV_RTC_Reg(RTC_AL_HOU)&(~RTC_AL_RTC_AL_HOU_MASK))|rtctime->rtc_hour;
        al_dom_reg = (DRV_RTC_Reg(RTC_AL_DOM)&(~RTC_AL_RTC_AL_DOM_MASK))|rtctime->rtc_day;
        al_mth_reg = (DRV_RTC_Reg(RTC_AL_MTH)&(~RTC_AL_RTC_AL_MTH_MASK))|rtctime->rtc_mon;
        al_yea_reg = (DRV_RTC_Reg(RTC_AL_YEA)&(~RTC_AL_RTC_AL_YEA_MASK))|rtctime->rtc_year;

		DRV_RTC_WriteReg(RTC_AL_SEC, al_sec_reg);
		DRV_RTC_WriteReg(RTC_AL_MIN, al_min_reg);
		DRV_RTC_WriteReg(RTC_AL_HOU, al_hou_reg);
		DRV_RTC_WriteReg(RTC_AL_DOM, al_dom_reg);
		DRV_RTC_WriteReg(RTC_AL_MTH, al_mth_reg);
		DRV_RTC_WriteReg(RTC_AL_YEA, al_yea_reg);
#if !defined(__FUE__) && !defined(__UBL__)
        RestoreIRQMask(savedMask);
#endif /* !defined(__FUE__) && !defined(__UBL__) */
		...
		RTC_write_trigger_wait();
		#endif /*DRV_RTC_HW_CALI*/
		if (((DRV_RTC_Reg(RTC_AL_SEC)&RTC_AL_RTC_AL_SEC_MASK) == rtctime->rtc_sec) &&
            ((DRV_RTC_Reg(RTC_AL_MIN)&RTC_AL_RTC_AL_MIN_MASK) == rtctime->rtc_min) &&
            ((DRV_RTC_Reg(RTC_AL_HOU)&RTC_AL_RTC_AL_HOU_MASK) == rtctime->rtc_hour) &&
            ((DRV_RTC_Reg(RTC_AL_DOM)&RTC_AL_RTC_AL_DOM_MASK) == rtctime->rtc_day) &&
            ((DRV_RTC_Reg(RTC_AL_MTH)&RTC_AL_RTC_AL_MTH_MASK) == rtctime->rtc_mon) &&
            ((DRV_RTC_Reg(RTC_AL_YEA)&RTC_AL_RTC_AL_YEA_MASK) == rtctime->rtc_year))
			break;
	}
...
kal_bool RTC_isFisrtOn(void)        //validate
{
    ...
    if (DRV_RTC_Reg(RTC_TC_SEC) < u2dvt_rtc_seconds_value)	/* SEC has carried */
    {
        u2dvt_rtc_seconds_value = DRV_RTC_Reg(RTC_TC_SEC);
        u2dvt_rtc_minutes_value = DRV_RTC_Reg(RTC_TC_MIN);
        u2dvt_rtc_hours_value = DRV_RTC_Reg(RTC_TC_HOU);
...
void RTC_setXOSC_(void)
{
    ...
    F32K_CLK_CTRL_SET_EMB_OSC32_MODE_T setEmbOsc32Mode;
    ...
    f32k_handler = DclF32K_Open(DCL_F32K_CLK, FLAGS_NONE);
    DclF32K_Control(f32k_handler, F32K_CLK_CMD_OSC32_INIT, NULL);

    DclF32K_Control(f32k_handler, F32K_CLK_CMD_QUERY_IS_XOSC32K, (DCL_CTRL_DATA_T *)&IsXOSC32K);

    if (!IsXOSC32K.f32k_is_xosc32 && (key1 == RTC_POWERKEY1_KEY) && (key2 == RTC_POWERKEY2_KEY))
    {
    ...
    if (!IsXOSC32K.f32k_is_xosc32)
    {
        setEmbOsc32Mode.osc32_mode = F32K_EMB_K_DCXO_MODE;
        DclF32K_Control(f32k_handler, F32K_CLK_CMD_SET_EMB_OSC32_MODE, (DCL_CTRL_DATA_T *)&setEmbOsc32Mode);
    }
...
kal_bool RTC_FT_PowerOff(void)
{
    ...
    // Set GPIO45 to gpio output LOW for power key issue
    reg_value = DRV_RTC_Reg32(0xA0020310);
    reg_value &= (~0x00002000);
    DRV_RTC_WriteReg32(0xA0020310, reg_value);
    
    reg_value = DRV_RTC_Reg32(0xA0020010);
    reg_value |= 0x00002000;
    DRV_RTC_WriteReg32(0xA0020010, reg_value);
    
    reg_value = DRV_RTC_Reg32(0xA0020C50);
    reg_value &= ~(0x00F00000);
    DRV_RTC_WriteReg32(0xA0020C50, reg_value);
...
kal_uint16 RTC_Read_SPAR(DCL_RTC_SPAR_INDEX_T SPARIndex)
{
	kal_uint16 REG_COMM = 0;
	...
	switch(SPARIndex)
	{
        ...
        case DCL_RTC_NEW_SPAR0:
        case DCL_RTC_NEW_SPAR1:
            REG_COMM = (DRV_RTC_Reg(RTC_NEW_SPAR1)&RTC_NEW_SPAR_MASK)>>RTC_NEW_SPAR_OFFSET;
            REG_COMM = REG_COMM << 8;
            REG_COMM |= (DRV_RTC_Reg(RTC_NEW_SPAR0)&RTC_NEW_SPAR_MASK)>>RTC_NEW_SPAR_OFFSET;
            break;
            
        case DCL_RTC_NEW_SPAR2:
            REG_COMM = (DRV_RTC_Reg(RTC_NEW_SPAR2)&RTC_NEW_SPAR_MASK)>>RTC_NEW_SPAR_OFFSET;
            break;
            
        case DCL_RTC_NEW_SPAR3:
            REG_COMM = (DRV_RTC_Reg(RTC_NEW_SPAR3)&RTC_NEW_SPAR_MASK)>>RTC_NEW_SPAR_OFFSET;
            break;
            
        case DCL_RTC_NEW_SPAR4:
            REG_COMM = (DRV_RTC_Reg(RTC_NEW_SPAR4)&RTC_NEW_SPAR_MASK)>>RTC_NEW_SPAR_OFFSET;
            break;
...
void RTC_Write_New_SPAR(DCL_RTC_SPAR_INDEX_T SPARIndex, kal_uint8 flag)
{
    kal_uint32 savedMask;
    kal_uint32 reg_addr;
	...
	{
        case DCL_RTC_NEW_SPAR0:
            reg_addr = RTC_NEW_SPAR0;
            break;
        case DCL_RTC_NEW_SPAR1:
            reg_addr = RTC_NEW_SPAR1;
            break;
        case DCL_RTC_NEW_SPAR2:
            reg_addr = RTC_NEW_SPAR2;
            break;
        case DCL_RTC_NEW_SPAR3:
            reg_addr = RTC_NEW_SPAR3;
            break;
        case DCL_RTC_NEW_SPAR4:
            reg_addr = RTC_NEW_SPAR4;
            break;
		default:
 			ASSERT(0);
 			break;
    ...
    reg_value = DRV_RTC_Reg(reg_addr);
    reg_value &= ~RTC_NEW_SPAR_MASK;
    reg_value |= ((kal_uint16)flag << RTC_NEW_SPAR_OFFSET);
    DRV_RTC_WriteReg(reg_addr, reg_value);

	RestoreIRQMask(savedMask);
}

void RTC_Write_SPAR(DCL_RTC_SPAR_INDEX_T SPARIndex, kal_uint16 flag)
{
#ifndef DRV_RTC_HW_CALI
	kal_uint32 loop;
#endif // #if defined(DRV_RTC_HW_CALI)
	...
	switch(SPARIndex)
	{
        ...
        case DCL_RTC_NEW_SPAR0:
        case DCL_RTC_NEW_SPAR1:
            RTC_Write_New_SPAR(DCL_RTC_NEW_SPAR0, flag&0xFF);
            RTC_Write_New_SPAR(DCL_RTC_NEW_SPAR1, flag>>8);
            break;
        case DCL_RTC_NEW_SPAR2:
        case DCL_RTC_NEW_SPAR3:
        case DCL_RTC_NEW_SPAR4:
            RTC_Write_New_SPAR(SPARIndex, flag);
            break;
		default:
 			ASSERT(0);
 			break;
...
void dump_RTC_EOSC32CON()
{
#if 1
    kal_uint16 reg_value;	
	reg_value = DRV_RTC_Reg(RTC_GPIO);
    reg_value &= ~RTC_CON_POWEROFF_SEQ_EN;
    DRV_RTC_WriteReg(RTC_GPIO, reg_value);
    RTC_write_trigger_wait();
#endif
    
    RTC_reload();
    kal_prompt_trace(MOD_RTC_HISR, "Power off, RTC_OSC32CON = %x, RTC_CON = %x, GPIO_MODE6 = %x",
        DRV_RTC_Reg(RTC_XOSCCAL), DRV_RTC_Reg(RTC_GPIO), DRV_RTC_Reg32(0xA0020C60));
    kal_prompt_trace(MOD_RTC_HISR, "Enter, ACFG_DCXO_PCON0 = %x", DRV_RTC_Reg(0xA0730030));
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
void RTC_PWIC_PowerOff_RTC_INIT(void)
{
    ...
    DclF32K_Control(f32kHandler, F32K_CLK_CMD_QUERY_IS_XOSC32K, (DCL_CTRL_DATA_T *)&IsXOSC32K);

    if (!IsXOSC32K.f32k_is_xosc32)
    {
        setEmbOsc32Mode.osc32_mode = F32K_EMB_K_EOSC32_MODE;
        DclF32K_Control(f32kHandler, F32K_CLK_CMD_SET_EMB_OSC32_MODE, (DCL_CTRL_DATA_T *)&setEmbOsc32Mode);
    }
...
void RTC_PWIC_PowerOn_RTC_INIT(void)
{
...
#if defined(DRV_RTC_LATCH_PWR_POLL) && !defined(__DRV_MISC_POWER_SWITCH__)
	...
	DRV_RTC_WriteReg(RTC_INFO1,BBPU);
        ...
        savedMask = SaveAndSetIRQMask();
#endif /* !defined(__FUE__) && !defined(__UBL__) */
    al_dow_reg = DRV_RTC_Reg(RTC_TC_DOW);
    al_dow_reg |= (DRV_RTC_Reg(RTC_AL_DOW)&RTC_NEW_SPAR_MASK);
	DRV_RTC_WriteReg(RTC_AL_DOW, al_dow_reg);
#if !defined(__FUE__) && !defined(__UBL__)
        RestoreIRQMask(savedMask);
#endif /* !defined(__FUE__) && !defined(__UBL__) */
...
void RTC_PWIC_First_PowerOn_INIT_RTCTime(t_rtc *rtctime)	
{
	kal_uint32 BBPU;
	kal_uint32 count;	   
    #if defined(DRV_RTC_INTERNAL_32K_AS_6255) || defined(DRV_RTC_INTERNAL_32K_AS_6261)
    DCL_HANDLE f32k_handler;
    F32K_CLK_CTRL_F32K_IS_XOSC32_T IsXOSC32K;
    F32K_CLK_CTRL_EOSC32_CALI_VAL_T EOSC32Cali; 
    kal_uint16 reg_val;
    #endif //#if defined(DRV_RTC_INTERNAL_32K_AS_6255) || defined(DRV_RTC_INTERNAL_32K_AS_6261)

	#if defined(DRV_RTC_HW_CALI)
    #if defined(DRV_RTC_INTERNAL_32K_AS_6261)
    DRV_RTC_WriteReg(RTC_CALI, 0x4000);
    #endif //#if defined(DRV_RTC_INTERNAL_32K_AS_6261)
	...
	DRV_RTC_WriteReg(RTC_IRQ_EN, RTC_IRQ_EN_ALLOFF);
    DRV_RTC_WriteReg(DRV_COMM_REG1, DRV_RTC_Reg(DRV_COMM_REG1) & (~DRV_COMM_REG1_META_RESET_RTC)); //clear PDN1[7] if first power on.
	/* clear alarm mask */
