 ...
 * Description:
 * ------------
 *    The header file of ROT_DMA0 HW driver of MT6252 IMGMDA
 *
 * Author:
 * -------
 * -------
...
///power control
#define ROTDMA_POWERON()  mm_enable_power(MMPWRMGR_ROTDMA);
#define ROTDMA_POWEROFF() mm_disable_power(MMPWRMGR_ROTDMA);
