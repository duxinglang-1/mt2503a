...
#OPT_PROJECT
  if (-d ".\\make\\OPT_MAKE\\${custom}") {
#    system("echo OPT_COPY Copying make files from ${custom}...");
    print("OPT_COPY Copying make files from ${custom}...");        
    system("xcopy /e /Y make\\OPT_MAKE\\${custom} make > nul");
#OPT_MEMORY_PATH
    system("xcopy /e /Y custom\\OPT_DRIVER\\OPT_MEMORY_PATH\\MEMORY_PATH_${custom} custom\\system\\OVIPHONE03A_11C_BB > nul");
  }
