...
MHdl *A2DPDec_Strm_Open(void(*handler)( MHdl *handle, Media_Event event ), STFSAL *pstFSAL, void *param){return &mhdl;}
...
bt_a2dp_sbc_codec_cap_struct sbc_cap_snk[1];
...
//[VCH]
kal_bool    L1SP_SetVoiceChangerMode(SPH_VOICE_CHANGER_MODE mode){return KAL_FALSE;}
SPH_VOICE_CHANGER_MODE L1SP_GetVoiceChangerMode(void){return 0;}

//[Karaoke]
kal_bool      Media_SetKaraoke(kal_bool enable){return KAL_FALSE;}
kal_bool      Media_IsKaraoke(void){return KAL_FALSE;}
void          Media_SetKaraOperationMode(Media_Kara_opt_mode mode){}
Media_Kara_opt_mode Media_GetKaraOperationMode(void){return 0;}
void          Media_SetKaraRecMixChannel(Media_KaraRec_Mix_CH channel){}
Media_KaraRec_Mix_CH Media_GetKaraRecMixChannel(void){return 0;}

// Remix
Media_Status AudioPP_Remix_TurnOn( STFSAL *pstFSAL, kal_uint32 msRecordStartTime, kal_uint32 msAudioSeekTime ){return MEDIA_SUCCESS;}
Media_Status AudioPP_Remix_TurnOff( void ){return MEDIA_SUCCESS;}
...
Media_Status Media_PCM_Clock_Enable (kal_bool b_enable) {return MEDIA_FAIL;}
