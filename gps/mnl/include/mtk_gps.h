...
//for lib update
mtk_int32
mtk_gps_sys_timer_create(mtk_uint8 selected_timer);
mtk_int32
mtk_gps_sys_timer_start(mtk_uint32 timer_id, mtk_uint8 periodic, mtk_uint32 timeout, void *timer_expiry, void *arg);
mtk_int32
mtk_gps_sys_timer_stop(mtk_uint32 timer_id);
//end
