...
typedef struct
{
   kal_uint8 context_id;
    ...
    kal_uint8 pri_dns[L4C_CONFIG_OPTION_STRUCT_IPV4_ADDR_LENGTH];
    kal_uint8 sec_dns[L4C_CONFIG_OPTION_STRUCT_IPV4_ADDR_LENGTH];
    kal_uint8 is_chap;
...
{
   kal_uint8          length;
   l4c_config_option_struct     config_option_info[ MMI_TOT_CONTEXT ];
...
kal_bool l4ctcm_test_pri_pdp_info(kal_uint8 const ** rsp_str);
