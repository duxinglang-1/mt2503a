...
#if defined(__FUNET_ENABLE__) || defined(__FUDIFFNET_ENABLE__)
#define FOTA_REBOOT_DELAY			500
#endif
/***************************************************************************** 
* Extern Variable
*****************************************************************************/
...
static void l4cuem_reboot_reset_watchdog(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	DclPW_Control(dcl_pw_handle, PW_CMD_SET_SWITCH_TO_IDLE, NULL);
...
void l4cuem_reboot_req(void)
{
    ...
    #if defined(__FUNET_ENABLE__) || defined(__FUDIFFNET_ENABLE__)
    kal_sleep_task(FOTA_REBOOT_DELAY);
    #endif
            ...
            kal_uint8 reset_type /* pmic_reset_type_enum */ )
{
    ...
    switch (reset_type)
    {
 	...
 	case FORCE_RESET:
 	{
 	    kal_prompt_trace(MOD_L4C, "reboot target");
 	    l4cuem_reboot_req();
 	    break;
 	}
        default:
