...
#define MAX_AUD_MEM_SIZE_WAV            (AUD_MED_OVERHEAD + AUD_DRV_BT_EXT_MEM_SIZE + AUD_DRV_SW_DTMF_EXT_MEM_SIZE + MAXOF(AUD_DRV_DSP_EXT_MEM_SIZE,    AUD_DRV_APM_EXT_MEM_SIZE)      + AUD_WORKING_BUFFER_WAV       + AUD_MED_MPL_OBJ_BUF_SIZE + AUD_MED_PROC_BUF_SIZE + AUD_MED_BUILD_CACHE_BUF_SIZE + MED_RING_BUFFER_SIZE + AUD_WORKING_BUFFER_KARAOKE_REC)  /* WAV */
#define MAX_AUD_MEM_SIZE_MP3            (AUD_MED_OVERHEAD + AUD_DRV_BT_EXT_MEM_SIZE + AUD_DRV_SW_DTMF_EXT_MEM_SIZE + MAXOF(AUD_DRV_DSP_EXT_MEM_SIZE_MP3,AUD_DRV_APM_EXT_MEM_SIZE)      + AUD_WORKING_BUFFER_MP3       + AUD_MED_MPL_OBJ_BUF_SIZE + AUD_MED_PROC_BUF_SIZE + AUD_MED_BUILD_CACHE_BUF_SIZE + MED_RING_BUFFER_SIZE + AUD_WORKING_BUFFER_KARAOKE_REC)  /* MP3 */
...
#define MAX_AUD_MEM_SIZE_FLAC           (AUD_MED_OVERHEAD + AUD_DRV_BT_EXT_MEM_SIZE + AUD_DRV_SW_DTMF_EXT_MEM_SIZE + MAXOF(AUD_DRV_DSP_EXT_MEM_SIZE,    AUD_DRV_APM_EXT_MEM_SIZE)      + AUD_WORKING_BUFFER_FLAC      + AUD_MED_MPL_OBJ_BUF_SIZE + AUD_MED_PROC_BUF_SIZE +                            0 + MED_RING_BUFFER_SIZE + AUD_WORKING_BUFFER_KARAOKE_REC)  /* Flac */
...
#define MAX_AUD_MEM_SIZE_MIDI_FILE      (AUD_MED_OVERHEAD + AUD_DRV_BT_EXT_MEM_SIZE + AUD_DRV_SW_DTMF_EXT_MEM_SIZE + MAXOF(AUD_DRV_DSP_WT_EXT_MEM_SIZE, AUD_DRV_APM_MIDI_EXT_MEM_SIZE) + AUD_WORKING_BUFFER_MIDI_FILE + AUD_MED_MPL_OBJ_BUF_SIZE + AUD_MED_PROC_BUF_SIZE + AUD_WORKING_BUFFER_KARAOKE_REC) /* MIDI file playback */
#define MAX_AUD_MEM_SIZE_IMY_DATA       (AUD_MED_OVERHEAD + AUD_DRV_BT_EXT_MEM_SIZE + AUD_DRV_SW_DTMF_EXT_MEM_SIZE + MAXOF(AUD_DRV_DSP_WT_EXT_MEM_SIZE, AUD_DRV_APM_MIDI_EXT_MEM_SIZE) + AUD_WORKING_BUFFER_IMY_DATA  + AUD_MED_MPL_OBJ_BUF_SIZE + AUD_WORKING_BUFFER_KARAOKE_REC) /* IMY data playback */
...
#define MAX_AUD_MEM_SIZE_MIDI_DATA      (AUD_MED_OVERHEAD + AUD_DRV_BT_EXT_MEM_SIZE + AUD_DRV_SW_DTMF_EXT_MEM_SIZE + MAXOF(AUD_DRV_DSP_WT_EXT_MEM_SIZE, AUD_DRV_APM_MIDI_EXT_MEM_SIZE) + AUD_WORKING_BUFFER_MIDI_DATA + AUD_MED_MPL_OBJ_BUF_SIZE + AUD_WORKING_BUFFER_KARAOKE_REC) /* MIDI/IMY data playback */
#endif
