...
# Constants
#****************************************************************************
my $SYSGEN2_VERNO     = " v1.70 -> p1.71 -> p1.72 -> p1.74 -> p1.75";
                       ...
                       #  p1.72 , 2014/01/17 by Yinli, Replace INT_RetrieveDSPTXRXBaseAddr()& INT_QuerySystemRAMInfo() by scatstruct API 
                       #  p1.71 , 2014/01/17 by Yinli, Bug fixed in get_region_length() and SCAT_C_Gen_TEMPLATE_EXTCODE_ASSIGN()
