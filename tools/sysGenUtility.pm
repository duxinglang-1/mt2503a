...
# Constants
#****************************************************************************
my $SYSGENUTILITY_VERNO     = " v0.42 -> p0.43 -> p0.44 -> p0.45 -> p0.49";
             # p0.49 , 2014/03/24, Adjust intsram distribution to reslove INTSRAM_CODE expired when TINY_SYSTEM is enabled
             # p0.45 , 2014/02/18,  Only support MT6261 on 11CW1352MP 
             # p0.44 , 2014/01/17,  Support MT6261 family
             # p0.43 , 2014/01/17,  Replace INT_RetrieveDSPTXRXBaseAddr()& INT_QuerySystemRAMInfo() by scatstruct API 
...
sub GetIntsramInfo
{
    ...
    my %BB_INTSRAM_tbl =
       (        # $bb => [INTSRAM_CODE_Base, INTSRAM_CODE_Size, INTSRAM_DATA_Base, INTSRAM_DATA_Size]
                ...
                'MT6261'  => ["0x70008000", "0x00001200", "0x70009200", "0x00000E00"],
