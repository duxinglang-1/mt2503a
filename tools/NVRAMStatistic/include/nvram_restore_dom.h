...
typedef enum
{
    ...
    NVRAM_EF_BT_SYS_INFO_LID,              /* (null) */
    NVRAM_EF_AUDIO_EQUALIZER_LID,          /* (null) */
    NVRAM_EF_A2DP_SETTINGS_LID,            /* (null) */
    NVRAM_EF_NITZ_NW_NAME_LID,             /* (null) */
    NVRAM_EF_UMMS_COMPOSE_SETTINGS_LID,    /* (null) */
    NVRAM_EF_UMMS_SENDING_SETTINGS_LID,    /* (null) */
    NVRAM_EF_PUSH_GEN_SETTING_LID,         /* (null) */
    NVRAM_EF_BTHF_CONFIG_LID,              /* (null) */
    NVRAM_EF_GPS_MMI_SETTING_DATA_LID,     /* (null) */
