...
#****************************************************************************
# 16 >>> FOTA configurations gathering
#****************************************************************************
my %FOTA_CONFIG;
&ParseCUSTOM_IMG_CONFIG_H($CUSTOM_IMG_CONFIG_H, \%FOTA_CONFIG);
#****************************************************************************
# 17 >>> Generate MAUI Scatter File
#****************************************************************************
if (!-e $SCATTERFILE)
{
...
#****************************************************************************
# 18 >>> Generate DL Scatter File for flash tool
#****************************************************************************
if (!-e $DL_SCATTERFILE)
{
...
#****************************************************************************
# 19 >>> Generate Bootloader Scatter File
#****************************************************************************
&GenBLScatter();


#****************************************************************************
# 20 >>> Generate FOTA Scatter File
#****************************************************************************
