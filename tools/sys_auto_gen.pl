...
# Constants
#****************************************************************************
my $SYSAUTOGEN_VERNO = " v0.04 -> p0.05";
                       # p0.05 by Yinli, Support BL scatter file re-org
...
$g_exit = system("perl tools\\scatGen.pl $ARGV[0] $ARGV[1] $ARGV[2] $ARGV[3] $ARGV[4] $ARGV[5] $ARGV[6] $ARGV[7] $ARGV[8] $ARGV[9]") if($g_exit == 0);
$g_exit = system("perl tools\\sysgen2.pl $BB_PATH $IMAGELAYOUT $BL_IMAGELAYOUT $themf") if($g_exit == 0);
