...
#define DUMMY_READ_PATCH         ((APBADDR32)(IDMA_base+0x3C00*4))  /* Dummy read addr, 0x3C00*4   */
#endif
...
#define SCTRL_WORD( dev_sel, bit_count )  ((unsigned short)(                ((bit_count-1)<<8)))
#define SCTRL_IMOD( dev_sel, bit_count )  ((unsigned short)(                ((bit_count-1)<<8)|(0x1F)))
#elif IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
...
#define ABB_RSV_CON1             ((APBADDR)(ABB_D_base+0x0004))         /* Analog Baseband System Reserve Bit 1          */
#define ABB_DD_WR_PATH0          ((APBADDR)(ABB_D_base+0x0020))         /* Analog Baseband D-Die Control Path 0 Register */
   #elif IS_CHIP_MT6260 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6256
#define AC_ODS_CON               ((APBADDR)(MIXED_base+0x0000))         /* Analog Chip Output Driving Strength Control Register */
#define ACIF_AC_HW_VER           ((APBADDR)(MIXED_base+0x0004))         /* Mix-signal Chip Version Control               */
...
#define AFC_EV(n)                ((APBADDR)(TDMA_base+0x0020+((n)*4)))                           /* AFC control n [13:0] */
   #endif
   #if IS_NEW_TDMA_CHIP
#define BSI_EV(n)                ((APBADDR)(TDMA_base+0x00B0+((n)*4)+(((n)/20)*624)+(((n)/36)*16)-(((n)/40)*624)))
   #else
...
#define EVENT_ENA(n)             ((APBADDX)(TDMA_base+0x0150+((n)*4)))  /* event enable control n                        */
...
#if IS_CHIP_MT6268T || IS_CHIP_MT6268 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
...
#if IS_SOC_CHIP || IS_CHIP_MT6236 || IS_CHIP_MT6276_S01 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#define BSI_RDCS_CON             ((APBADDR)  (BSI_base+0x0C4C))         /* BSI Read Back CS Waveform                     */
...
/* --------------------------------------------------------------------------------------------------------------------- */
#define ACFG_PIN_DINV0           ((APBADDR)  (ANA_CFGSYS_base+0x0130))  /* Digital IO Polarity Control                   */
   #else
/* ===================================================================================================================== */
...
#define BPI_EN1                  ((APBADDR)  (BPI_base+/*0x0084*/0x00B4))/* BPI event enable register                    */
#define BPI_BASK                 ((APBADDR)  (BPI_base+/*0x0080*/0x00B8))/* Mask for GSM Bus shared output               */
      #if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6268H
...
#define APC_OFS(n)               ((APBADDR)(APC_base+0x0018+((n)*32)))  /* Rampdown Profile #n                           */
   #if IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6276) || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#define FRC_CON                  ((APBADDR32)(TOPSM_base+0x0080))       /* Free Running Counter Control Register         */
...
#define FM_CON                   ((APBADDR)  (TOPSM_base+0x00A0))       /* Frequency Measurement Control Register        */
#define FM_CAL                   ((APBADDR32)(TOPSM_base+0x00A4))       /* Frequency Measurement Calibration Control     */
#define FM_T0                    ((APBADDR32)(TOPSM_base+0x00A8))       /* Frequency Measurement Start Time              */
#define FM_T1                    ((APBADDR32)(TOPSM_base+0x00AC))       /* Frequency Measurement End   Time              */
#define RTCCOUNT                 ((APBADDR32)(TOPSM_base+0x0104))       /* 32K count                                     */
...
#define FRC_CON                  ((APBADDR32)(MCU_TOPSM_base+0x0080))           /* Free Running Counter Control Register         */
...
#define FM_CON                   ((APBADDR32)(MCU_TOPSM_base+0x00A0))           /* Frequency Measurement Control Register        */
#define FM_CAL                   ((APBADDR32)(MCU_TOPSM_base+0x00A4))           /* Frequency Measurement Calibration Control     */
#define FM_T0                    ((APBADDR32)(MCU_TOPSM_base+0x00A8))           /* Frequency Measurement Start Time              */
#define FM_T1                    ((APBADDR32)(MCU_TOPSM_base+0x00AC))           /* Frequency Measurement End   Time              */
#define RTCCOUNT                 ((APBADDR32)(MCU_TOPSM_base+0x0104))           /* 32K count                                     */
#define RM_PWR_CON(n)            ((APBADDR32)(MODEM2G_TOPSM_base+0x0800+(n)*4)) /* Power Control Register n                      */
#define RM_PWR_STA               ((APBADDR32)(MODEM2G_TOPSM_base+0x0820))       /* Power Status Register                         */
...
#define RTCCOUNT                 ((APBADDR32)(SM_base+0x030))
/* --------------------------------------------------------------------------------------------------------------------- */
   #if IS_CHIP_MT6238
...
/*MT6516*/ #define PDN_CON_BSI              0x0008
   ...
   #if IS_CHIP_MT6260 || IS_CHIP_MT6261
/*MT6260*/ #define MODEM_CG_CON2            ((APBADDR32)(MDCONFIG_base+0x008))     /* MODEM_CG_CON2 reg                  */
/*MT6260*/ #define MODEM_CG_CLR2            ((APBADDR32)(MDCONFIG_base+0x018))     /* MODEM_CG_CON2 write 1 clear reg    */
/*MT6260*/ #define MODEM_CG_SET2            ((APBADDR32)(MDCONFIG_base+0x028))     /* MODEM_CG_CON2 write 1 set reg      */
/*MT6260*/ #define MODEM_CG_CON4            ((APBADDR32)(MDCONFIG_base+0x088))     /* MODEM_CG_CON4 reg                  */
/*MT6260*/ #define MODEM_CG_CLR4            ((APBADDR32)(MDCONFIG_base+0x098))     /* MODEM_CG_CON4 write 1 clear reg    */
/*MT6260*/ #define MODEM_CG_SET4            ((APBADDR32)(MDCONFIG_base+0x0A8))     /* MODEM_CG_CON4 write 1 set reg      */
/*MT6260*/ #define PDN_CON2                 MODEM_CG_CON2
/*MT6260*/ #define PDN_CLR2                 MODEM_CG_CLR2
/*MT6260*/ #define PDN_SET2                 MODEM_CG_SET2
/*MT6260*/ #define PDN_CON4                 MODEM_CG_CON4                          /* immediate mode                     */
/*MT6260*/ #define PDN_CLR4                 MODEM_CG_CLR4                          /* immediate mode                     */
/*MT6260*/ #define PDN_SET4                 MODEM_CG_SET4                          /* immediate mode                     */
/*MT6260*/
/*MT6260*/ #define MPERI_PWR_AWARE          ((APBADDR32)(MDCONFIG_base+0x400))     /* Modemsys bus active aware          */
/*MT6260*/
/*MT6260*/ #define PDN_CON_TDMA             0x0001                                 /* The same as MT6276                 */
/*MT6260*/ #define PDN_CON_BSI              0x0004                                 /* The same as MT6276                 */
/*MT6260*/ #define PDN_CON_BPI              0x0008                                 /* The same as MT6276                 */
/*MT6260*/ #define PDN_CON_AFC              0x0010                                 /* The same as MT6276                 */

   #elif IS_CHIP_MT6250
/*MT6250*/ #define MODEM_CG_CON0            ((APBADDR)(MDCONFIG_base+0x000))       /* MODEM_CG_CON0 reg                  */
/*MT6250*/ #define MODEM_CG_SET0            ((APBADDR)(MDCONFIG_base+0x020))       /* MODEM_CG_CON0 write 1 set reg      */
/*MT6250*/ #define MODEM_CG_CLR0            ((APBADDR)(MDCONFIG_base+0x010))       /* MODEM_CG_CON0 write 1 clear reg    */
/*MT6250*/ #define MODEM_CG_CON1            ((APBADDR)(MDCONFIG_base+0x004))       /* MODEM_CG_CON1 reg                  */
/*MT6250*/ #define MODEM_CG_SET1            ((APBADDR)(MDCONFIG_base+0x024))       /* MODEM_CG_CON1 write 1 set reg      */
/*MT6250*/ #define MODEM_CG_CLR1            ((APBADDR)(MDCONFIG_base+0x014))       /* MODEM_CG_CON1 write 1 clear reg    */
/*MT6250*/ #define MODEM_CG_CON2            ((APBADDR)(MDCONFIG_base+0x008))       /* MODEM_CG_CON2 reg                  */
/*MT6250*/ #define MODEM_CG_SET2            ((APBADDR)(MDCONFIG_base+0x028))       /* MODEM_CG_CON2 write 1 set reg      */
/*MT6250*/ #define MODEM_CG_CLR2            ((APBADDR)(MDCONFIG_base+0x018))       /* MODEM_CG_CON2 write 1 clear reg    */
/*MT6250*/ #define MODEM_CG_CON4            ((APBADDR)(MDCONFIG_base+0x088))       /* MODEM_CG_CON4 reg                  */
/*MT6250*/ #define MODEM_CG_SET4            ((APBADDR)(MDCONFIG_base+0x0A8))       /* MODEM_CG_CON4 write 1 set reg      */
/*MT6250*/ #define MODEM_CG_CLR4            ((APBADDR)(MDCONFIG_base+0x098))       /* MODEM_CG_CON4 write 1 clear reg    */
...
/*MT6250*/
/*MT6250*/ #define MPERI_PWR_AWARE          ((APBADDR)(MDCONFIG_base+0x400))       /* Modemsys bus active aware          */
/*MT6250*/
...
/*MT6573*/ #define PDN_CON_AFC              0x0010
   ...
   #elif IS_CHIP_MT6276 || IS_CHIP_MT6575
...
#elif IS_CHIP_MT6236 || IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
/*MT6236~*/ #define MD2GSYS_CG_CLR4         ((APBADDR)(MD2GCONFG_base+0x038))      /* Power Down Enable  4 Register        */
   #if IS_CHIP_MT6260 || IS_CHIP_MT6261
/*MT6260 */ #define HWCG_BYPASS             ((APBADDR)(MD2GCONFG_base+0x058))
   #endif
...
#if IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
#define L1D_MODEMSYS_BUS_CG_ENA()          {uint16 d16 = HW_READ(MPERI_PWR_AWARE );  HW_WRITE(MPERI_PWR_AWARE, (d16|(1<<2)));}
...
#elif IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
#define TDMA_FHSTR(n)            ((APBADDR)(TDMA_base+0x0320+(4*(n))))
#define DSPCLK_CON               ((APBADDR)(MD2GCONFG_base+0x040))      /* DSP Clock Control Register                    */
...
#define TDMA_FHCON5              ((APBADDR)(MIXED_base+0x0514))
      #if IS_CHIP_MT6260
#define TDMA_FHCON6              ((APBADDR)(MIXED_base+0x0518))                /* for EPLL, the same as FHCON4 */
#define TDMA_FHCON7              ((APBADDR)(MIXED_base+0x051C))                /* for EPLL, the same as FHCON5 */
      #endif
#define TDMA_FHCON(m)            ((APBADDR)(MIXED_base+0x0500+(m)*4))          /* m:0~7                        */
...
#define GPIO_PULLEN0             ((APBADDR)(GPIO_base+0x0100))          /* GPIO Pull-up/Pull-down Enable Register 0      */
#define GPIO_PULLEN1             ((APBADDR)(GPIO_base+0x0110))          /* GPIO Pull-up/Pull-down Enable Register 1      */
#define GPIO_PULLEN2             ((APBADDR)(GPIO_base+0x0120))          /* GPIO Pull-up/Pull-down Enable Register 2      */
#define GPIO_PULLEN3             ((APBADDR)(GPIO_base+0x0130))          /* GPIO Pull-up/Pull-down Enable Register 3      */
#define GPIO_PULLEN4             ((APBADDR)(GPIO_base+0x0140))          /* GPIO Pull-up/Pull-down Enable Register 4      */
#define GPIO_DINV0               ((APBADDR)(GPIO_base+0x0200))          /* Data Inversion Control Register 0             */
#define GPIO_DINV1               ((APBADDR)(GPIO_base+0x0210))          /* Data Inversion Control Register 1             */
#define GPIO_DINV2               ((APBADDR)(GPIO_base+0x0220))          /* Data Inversion Control Register 2             */
#define GPIO_DINV3               ((APBADDR)(GPIO_base+0x0230))          /* Data Inversion Control Register 3             */
#define GPIO_DINV4               ((APBADDR)(GPIO_base+0x0240))          /* Data Inversion Control Register 4             */
#define GPIO_DOUT0               ((APBADDR)(GPIO_base+0x0300))          /* GPIO Data Output Register 0                   */
#define GPIO_DOUT1               ((APBADDR)(GPIO_base+0x0310))          /* GPIO Data Output Register 1                   */
#define GPIO_DOUT2               ((APBADDR)(GPIO_base+0x0320))          /* GPIO Data Output Register 2                   */
#define GPIO_DOUT3               ((APBADDR)(GPIO_base+0x0330))          /* GPIO Data Output Register 3                   */
#define GPIO_DOUT4               ((APBADDR)(GPIO_base+0x0340))          /* GPIO Data Output Register 4                   */
#define GPIO_DIN0                ((APBADDR)(GPIO_base+0x0400))          /* GPIO Data input Register 0                    */
#define GPIO_DIN1                ((APBADDR)(GPIO_base+0x0410))          /* GPIO Data input Register 1                    */
#define GPIO_DIN2                ((APBADDR)(GPIO_base+0x0420))          /* GPIO Data input Register 2                    */
#define GPIO_DIN3                ((APBADDR)(GPIO_base+0x0430))          /* GPIO Data input Register 3                    */
#define GPIO_DIN4                ((APBADDR)(GPIO_base+0x0440))          /* GPIO Data input Register 4                    */
#define GPIO_PULLSEL0            ((APBADDR)(GPIO_base+0x0500))          /* GPIO Pull-up/Pull-down Select Register 0      */
#define GPIO_PULLSEL1            ((APBADDR)(GPIO_base+0x0510))          /* GPIO Pull-up/Pull-down Select Register 1      */
#define GPIO_PULLSEL2            ((APBADDR)(GPIO_base+0x0520))          /* GPIO Pull-up/Pull-down Select Register 2      */
#define GPIO_PULLSEL3            ((APBADDR)(GPIO_base+0x0530))          /* GPIO Pull-up/Pull-down Select Register 3      */
#define GPIO_PULLSEL4            ((APBADDR)(GPIO_base+0x0540))          /* GPIO Pull-up/Pull-down Select Register 4      */
#define GPIO_MODE0               ((APBADDR32)(GPIO_base+0x0C00))        /* GPIO Mode Control Register 0                  */
#define GPIO_MODE1               ((APBADDR32)(GPIO_base+0x0C10))        /* GPIO Mode Control Register 1                  */
#define GPIO_MODE2               ((APBADDR32)(GPIO_base+0x0C20))        /* GPIO Mode Control Register 2                  */
#define GPIO_MODE3               ((APBADDR32)(GPIO_base+0x0C30))        /* GPIO Mode Control Register 3                  */
#define GPIO_MODE4               ((APBADDR32)(GPIO_base+0x0C40))        /* GPIO Mode Control Register 4                  */
#define GPIO_MODE5               ((APBADDR32)(GPIO_base+0x0C50))        /* GPIO Mode Control Register 5                  */
#define GPIO_MODE6               ((APBADDR32)(GPIO_base+0x0C60))        /* GPIO Mode Control Register 6                  */
#define GPIO_MODE7               ((APBADDR32)(GPIO_base+0x0C70))        /* GPIO Mode Control Register 7                  */
#define GPIO_MODE8               ((APBADDR32)(GPIO_base+0x0C80))        /* GPIO Mode Control Register 8                  */
#define GPIO_MODE9               ((APBADDR32)(GPIO_base+0x0C90))        /* GPIO Mode Control Register 9                  */
#define GPIO_MODE10              ((APBADDR32)(GPIO_base+0x0CA0))        /* GPIO Mode Control Register 10                 */
#define GPIO_MODE11              ((APBADDR32)(GPIO_base+0x0CB0))        /* GPIO Mode Control Register 11                 */
#define CLK_OUT0                 ((APBADDR)(GPIO_base+0x0E00))          /* CLK_OUT0 Setting                              */
#define CLK_OUT1                 ((APBADDR)(GPIO_base+0x0E10))          /* CLK_OUT1 Setting                              */

   #if MT6261_BSI_DEBUG
#define MODEM_DBG_SEL            ((APBADDR32)(0x83000284))
#define DEBUG_MODED0             ((APBADDR32)(0xA0010238))
   #endif
...
#define GPIO_PULLEN3             ((APBADDR)(GPIO_base+0x0130))          /* GPIO Pull-up/Pull-down Enable Register 3      */
#define GPIO_PULLEN4             ((APBADDR)(GPIO_base+0x0140))          /* GPIO Pull-up/Pull-down Enable Register 4      */
#define GPIO_PULLEN5             ((APBADDR)(GPIO_base+0x0150))          /* GPIO Pull-up/Pull-down Enable Register 5      */
#define GPIO_PULLEN6             ((APBADDR)(GPIO_base+0x0160))          /* GPIO Pull-up/Pull-down Enable Register 6      */
#define GPIO_DINV0               ((APBADDR)(GPIO_base+0x0200))          /* Data Inversion Control Register 0             */
#define GPIO_DINV1               ((APBADDR)(GPIO_base+0x0210))          /* Data Inversion Control Register 1             */
#define GPIO_DINV2               ((APBADDR)(GPIO_base+0x0220))          /* Data Inversion Control Register 2             */
#define GPIO_DINV3               ((APBADDR)(GPIO_base+0x0230))          /* Data Inversion Control Register 3             */
#define GPIO_DINV4               ((APBADDR)(GPIO_base+0x0240))          /* Data Inversion Control Register 4             */
#define GPIO_DINV5               ((APBADDR)(GPIO_base+0x0250))          /* Data Inversion Control Register 5             */
#define GPIO_DINV6               ((APBADDR)(GPIO_base+0x0260))          /* Data Inversion Control Register 6             */
#define GPIO_DOUT0               ((APBADDR)(GPIO_base+0x0300))          /* GPIO Data Output Register 0                   */
#define GPIO_DOUT1               ((APBADDR)(GPIO_base+0x0310))          /* GPIO Data Output Register 1                   */
#define GPIO_DOUT2               ((APBADDR)(GPIO_base+0x0320))          /* GPIO Data Output Register 2                   */
#define GPIO_DOUT3               ((APBADDR)(GPIO_base+0x0330))          /* GPIO Data Output Register 3                   */
#define GPIO_DOUT4               ((APBADDR)(GPIO_base+0x0340))          /* GPIO Data Output Register 4                   */
#define GPIO_DOUT5               ((APBADDR)(GPIO_base+0x0350))          /* GPIO Data Output Register 5                   */
#define GPIO_DOUT6               ((APBADDR)(GPIO_base+0x0360))          /* GPIO Data Output Register 6                   */
#define GPIO_DIN0                ((APBADDR)(GPIO_base+0x0400))          /* GPIO Data input Register 0                    */
#define GPIO_DIN1                ((APBADDR)(GPIO_base+0x0410))          /* GPIO Data input Register 1                    */
#define GPIO_DIN2                ((APBADDR)(GPIO_base+0x0420))          /* GPIO Data input Register 2                    */
#define GPIO_DIN3                ((APBADDR)(GPIO_base+0x0430))          /* GPIO Data input Register 3                    */
#define GPIO_DIN4                ((APBADDR)(GPIO_base+0x0440))          /* GPIO Data input Register 4                    */
#define GPIO_DIN5                ((APBADDR)(GPIO_base+0x0450))          /* GPIO Data input Register 5                    */
#define GPIO_DIN6                ((APBADDR)(GPIO_base+0x0460))          /* GPIO Data input Register 6                    */
#define GPIO_PULLSEL0            ((APBADDR)(GPIO_base+0x0500))          /* GPIO Pull-up/Pull-down Select Register 0      */
#define GPIO_PULLSEL1            ((APBADDR)(GPIO_base+0x0510))          /* GPIO Pull-up/Pull-down Select Register 1      */
#define GPIO_PULLSEL2            ((APBADDR)(GPIO_base+0x0520))          /* GPIO Pull-up/Pull-down Select Register 2      */
#define GPIO_PULLSEL3            ((APBADDR)(GPIO_base+0x0530))          /* GPIO Pull-up/Pull-down Select Register 3      */
#define GPIO_PULLSEL4            ((APBADDR)(GPIO_base+0x0540))          /* GPIO Pull-up/Pull-down Select Register 4      */
#define GPIO_PULLSEL5            ((APBADDR)(GPIO_base+0x0550))          /* GPIO Pull-up/Pull-down Select Register 5      */
#define GPIO_PULLSEL6            ((APBADDR)(GPIO_base+0x0560))          /* GPIO Pull-up/Pull-down Select Register 6      */
#define GPIO_MODE0               ((APBADDR32)(GPIO_base+0x0C00))        /* GPIO Mode Control Register 0                  */
#define GPIO_MODE1               ((APBADDR32)(GPIO_base+0x0C10))        /* GPIO Mode Control Register 1                  */
#define GPIO_MODE2               ((APBADDR32)(GPIO_base+0x0C20))        /* GPIO Mode Control Register 2                  */
#define GPIO_MODE3               ((APBADDR32)(GPIO_base+0x0C30))        /* GPIO Mode Control Register 3                  */
...
#define GPIO_MODE10              ((APBADDR32)(GPIO_base+0x0CA0))        /* GPIO Mode Control Register 10                 */
#define GPIO_MODE11              ((APBADDR32)(GPIO_base+0x0CB0))        /* GPIO Mode Control Register 11                 */
#define GPIO_MODE12              ((APBADDR32)(GPIO_base+0x0CC0))        /* GPIO Mode Control Register 12                 */
#define GPIO_MODE13              ((APBADDR32)(GPIO_base+0x0CD0))        /* GPIO Mode Control Register 13                 */
#define CLK_OUT0                 ((APBADDR)(GPIO_base+0x0E00))          /* CLK_OUT0 Setting                              */
#define CLK_OUT1                 ((APBADDR)(GPIO_base+0x0E10))          /* CLK_OUT1 Setting                              */
#define CLK_OUT2                 ((APBADDR)(GPIO_base+0x0E20))          /* CLK_OUT2 Setting                              */
#define CLK_OUT3                 ((APBADDR)(GPIO_base+0x0E30))          /* CLK_OUT3 Setting                              */
#define CLK_OUT4                 ((APBADDR)(GPIO_base+0x0E40))          /* CLK_OUT4 Setting                              */
#define CLK_OUT5                 ((APBADDR)(GPIO_base+0x0E50))          /* CLK_OUT5 Setting                              */
#define CLK_OUT6                 ((APBADDR)(GPIO_base+0x0E60))          /* CLK_OUT6 Setting                              */
#define CLK_OUT7                 ((APBADDR)(GPIO_base+0x0E70))          /* CLK_OUT7 Setting                              */
#endif
...
#define GPIO_MODE25              ((APBADDR)(GPIO_base+0x0780))          /* GPIO Mode Control Register 25                 */
#define GPIO_MODE26              ((APBADDR)(GPIO_base+0x0790))          /* GPIO Mode Control Register 26                 */
...
/* --------------------------------------------------------------------------------------------------------------------- */
   #if IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
   #elif IS_CACHE_DSP_SUPPORT || IS_DSP_ARCHITECTURE_V4_SUPPORT
...
/*=================================*\
|* MTK hardware reserved Registers *|
\*=================================*/
...
/* for MT6260                                                                                                            */
/* --------------------------------------------------------------------------------------------------------------------- */
#define EFUE_HW_RES0             ((APBADDR32)(EFUSE_base+0x0100))       /* MTK hardware reserved 0                       */
...
/*=================================*\
|* D2D interface Registers          *|
\*=================================*/
   #if IS_CHIP_MT6260
#define D2D_D_APC_AUX_CON0 ((APBADDR32)D2D_D_base)
#define D2D_A_APC_AUX_CON0 ((APBADDR32)D2D_A_base)
   #endif
