...
#define  LEVEL_LOW            KAL_FALSE
   ...
   #define  EINTaddr(_no)  (*(volatile kal_uint32 *)(EINT0_CON+_no))
#else
   ...
   #define EINT_CHANNEL_NOT_EXIST   EINT_ALL_NUMBER
...
typedef struct 
{
 	void (*eint_func[EINT_ALL_NUMBER])(void);
  	kal_bool eint_active[EINT_ALL_NUMBER];
	kal_bool eint_auto_umask[EINT_ALL_NUMBER];
} eint_func;
...
extern void EINT_Registration_Ext(kal_uint8 eintno, kal_bool Dbounce_En, kal_bool ACT_Polarity, void (reg_lisr)(void), kal_bool auto_umask);
...
extern kal_uint64 EINT64_Query_HW_Debounce(void);
extern void EINT_Set_HW_Debounce(kal_uint8 eintno, kal_uint32 ms);
extern void EINT_Set_HW_Debounce_Ext(kal_uint8 eintno, kal_uint32 ms);
...
extern kal_uint64 EINT64_SaveAndMaskAll(void);
extern void EINT_RestoreMaskAll(kal_uint32 val);
extern void EINT64_RestoreMaskAll(kal_uint64 val);
