...
typedef struct
{
    ...
    PW_CTRL_GET_CHARGER_TYPE        rPWChrType; /* Cable type for PW_CMD_GET_CABLE_BOOT_TYPE */
}DCL_CTRL_PW_DATA;
#else /* __BUILD_DOM__ */
#define PW_CTRLS \
	...
	PW_CTRL_GET_CHARGER_TYPE        rPWChrType;
#endif /* __BUILD_DOM__ */	
...
typedef enum {
	...
	PW_CMD_GET_CHARGER_BOOT_TYPE, /* query which is power on reason, AC or USB or non-cable */
} DCL_CTRL_PW_CMD;
#else /* __BUILD_DOM__ */
#define PW_CMDS \
	PW_CMD_POWERON, \
