...
/***************************************************************
  ...
  * This structure is used as the parameter of SPI_IOCTL_SET_CONFIG_PARA .
  ****************************************************************/
typedef struct
{
...
/**************** DCL API for  MRE ***********************************************/
DCL_HANDLE  DclSPI_Open(DCL_DEV device_number, DCL_FLAGS  flags);
...
DCL_STATUS  DclSPI_RegisterCallback(DCL_HANDLE handle, DCL_EVENT event, DCL_CALLBACK*	callback,void* parameter);
