...
typedef struct
{
    ...
    F32K_CLK_CTRL_SET_EMB_OSC32_MODE_T  rSetOSC32Mode;
    F32K_CLK_CTRL_SET_EOSC_CALI_TD_T    rSetEoscCaliTd;
    F32K_CLK_CTRL_SET_EOSC_CALI_RUN_TIME_EN_T   rSetEoscCaliRunTimeEn;
}DCL_CTRL_F32K_CLK_DATA_T;
#else /* __BUILD_DOM__ */
#define F32K_CLK_CTRLS \
    F32K_CLK_CTRL_F32K_IS_XOSC32_T    rF32kIsXOSC32; \
    F32K_CLK_CTRL_EOSC32_CALI_VAL_T    rEosc32CaliVal; \
    F32K_CLK_CTRL_SET_EMB_OSC32_MODE_T  rSetEmbOsc32Mode; \
    F32K_CLK_CTRL_SET_EOSC_CALI_TD_T    rSetEoscCaliTd; \
    F32K_CLK_CTRL_SET_EOSC_CALI_RUN_TIME_EN_T   rSetEoscCaliRunTimeEn;
#endif /* __BUILD_DOM__ */	
...
typedef enum {
    ...
    F32K_CLK_CMD_OSC32_INIT,
    F32K_CLK_CMD_EOSC32_TRIMMING, /* To trimming EOSC32 and get ideal cali value */
    F32K_CLK_CMD_SET_EMB_OSC32_MODE, /* To set embedded osc32 mode */
    F32K_CLK_CMD_SET_EOSC_CALI_TD,
    F32K_CLK_CMD_SET_EOSC_CALI_RUN_TIME_EN,
...
#define F32K_CLK_CMDS \
    ...
    F32K_CLK_CMD_SET_EMB_OSC32_MODE, \
    F32K_CLK_CMD_SET_EOSC_CALI_TD, \
    F32K_CLK_CMD_SET_EOSC_CALI_RUN_TIME_EN,
#endif /* __BUILD_DOM__ */
